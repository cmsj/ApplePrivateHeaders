...
+(id)versionInfoWithDictionary:(id)arg1 isPartial:(char)arg2 ;
+(char)_verifyVersionInfoDictionary:(id)arg1 ;
+(id)blankVersionInfo;
...
-(char)isBlank;
-(id)_initWithVersionInfoDictionary:(id)arg1 isPartial:(char)arg2 ;
