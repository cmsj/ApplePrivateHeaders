...
@property (nonatomic,readonly) char containsFakeRegion; 
@property (assign,nonatomic) int ownerPid;                                            //@synthesize ownerPid=_ownerPid - In the implementation block
@property (nonatomic,readonly) char couldHaveProcessView; 
...
-(void)finalizeUsingRegionDirtySize:(char)arg1 ;
-(char)containsFakeRegion;
-(id)_canonicalRegion;
-(int)ownerPid;
-(void)addRegion:(id)arg1 forProcess:(id)arg2 ;
-(char)couldHaveProcessView;
