...
-(char)_setSharedRegionFromPlatform:(long long)arg1 ;
...
-(char)_enumerateDispositionChunksWithStartAddr:(unsigned long long)arg1 pagesToQuery:(unsigned long long)arg2 block:(/*^block*/id)arg3 ;
-(char)_populateMemoryRegionWithPageQueries:(id)arg1 regionInfo:(vm_region_submap_info_64*)arg2 ;
-(unsigned long long)_lastNonSharedCacheRegion;
-(void)_processMachVMError:(int)arg1 expectingErrorOnExit:(int)arg2 ;
-(char)_addRegionsToArray:(id)arg1 forRegionInSharedRegionStartingAt:(unsigned long long)arg2 withSize:(unsigned long long)arg3 withRegionInfo:(vm_region_submap_info_64*)arg4 imageEnumerator:(id)arg5 ;
