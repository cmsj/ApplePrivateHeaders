...
@property (assign,nonatomic) char isSettledState;                                    //@synthesize isSettledState=_isSettledState - In the implementation block
...
-(char)isSettledState;
-(void)setIsSettledState:(char)arg1 ;
@end
