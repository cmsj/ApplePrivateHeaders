...
-(char)resnapVisitsWithError:(id*)arg1 ;
-(char)useRelabeledInferredMapItem:(id)arg1 oldCandidate:(id)arg2 associate:(char)arg3 error:(id*)arg4 ;
-(char)restoreToOldCandidate:(id)arg1 error:(id*)arg2 ;
-(char)iterativelyCollapseOverlappingRevGeoLOIsWithError:(id*)arg1 ;
-(char)dedupeLOIsWithError:(id*)arg1 ;
-(char)combineSequentialVisitsWithError:(id*)arg1 ;
-(char)fixUnconcreteLOIs:(id*)arg1 ;
-(char)saveWithError:(id*)arg1 ;
-(char)consolidateVisitsToLoisWithKnownPlaceTypesWithError:(id*)arg1 ;
...
-(char)restoreVisit:(id)arg1 transitions:(id)arg2 toOldCandidate:(id)arg3 error:(id*)arg4 ;
-(char)performBlock:(/*^block*/id)arg1 error:(id*)arg2 ;
-(RTRelabelerParameters *)relabelerParameters;
-(char)untrustedVisitMO:(id)arg1 ;
...
-(char)uuidConflicts:(id)arg1 context:(id)arg2 error:(id*)arg3 ;
...
-(char)unassociateOldCandidate:(id)arg1 error:(id*)arg2 ;
-(char)associateNonPlaceholderRelabeledInferredMapItem:(id)arg1 oldCandidate:(id)arg2 error:(id*)arg3 ;
-(char)associatePlaceholderRelabeledInferredMapItem:(id)arg1 oldCandidate:(id)arg2 error:(id*)arg3 ;
...
-(char)combineOverlappingRevGeoLOIsStabilized:(char*)arg1 error:(id*)arg2 ;
...
-(char)moveVisitMOs:(id)arg1 toLOIMO:(id)arg2 error:(id*)arg3 ;
-(id)fetchTransitionMOsOriginatingFromVisitIdentifier:(id)arg1 error:(id*)arg2 ;
-(char)combineEarlierVisitMO:(id)arg1 withLaterVisitMO:(id)arg2 error:(id*)arg3 ;
-(char)cleanUpCombinedPairs:(id)arg1 context:(id)arg2 error:(id*)arg3 ;
