...
-(char)classifyWithError:(id*)arg1 ;
...
-(char)isRottedMeCard:(id)arg1 inferredPlace:(id)arg2 ;
...
-(char)updatePlaces:(id)arg1 error:(id*)arg2 ;
-(id)getExperts;
-(id)getClassificationsFromExperts:(id)arg1 error:(id*)arg2 ;
-(char)processExpertClassifications:(id)arg1 error:(id*)arg2 ;
