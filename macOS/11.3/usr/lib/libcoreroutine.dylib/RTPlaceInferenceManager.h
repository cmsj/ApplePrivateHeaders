...
-(char)_learnedPlaceTypeForInferredMapItem:(id)arg1 placeType:(unsigned long long*)arg2 placeTypeSource:(unsigned long long*)arg3 error:(id*)arg4 ;
...
-(char)_inferUserSpecificPlaceTypeForInferredMapItem:(id)arg1 userSpecificPlaceType:(unsigned long long*)arg2 userSpecificPlaceTypeSource:(unsigned long long*)arg3 error:(id*)arg4 ;
