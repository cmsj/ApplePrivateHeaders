...
@property (assign,nonatomic) char monitorFingerprints;                                                              //@synthesize monitorFingerprints=_monitorFingerprints - In the implementation block
...
-(char)_processVisits:(id)arg1 forLastLearnedVisit:(id)arg2 error:(id*)arg3 ;
...
-(char)_retrainVisitsWithoutPlaces:(id*)arg1 ;
-(char)_trainVisitsFromDate:(id)arg1 toDate:(id)arg2 forLastLearnedVisit:(id)arg3 error:(id*)arg4 ;
-(char)_trainLocationsOfInterestModelWithError:(id*)arg1 ;
-(char)_removeUnusedMapItems:(id*)arg1 ;
-(void)_teardownTrainingMetrics;
-(char)_deferTrainingLOIsDueToCloudStoreNotChangeSinceLastTrainingDate:(id)arg1 ;
-(void)willBeginTraining;
-(char)_reconcileLearnedLocationsWithError:(id*)arg1 ;
-(void)didFinishTraining;
-(char)_relabelWithError:(id*)arg1 ;
-(char)_classifyPlaceTypes:(id*)arg1 ;
-(void)submitVisitMetrics;
-(char)_consolidateKnownPlaceTypesWithError:(id*)arg1 ;
...
-(char)_relabelWithRelabeler:(id)arg1 relabelerPersister:(id)arg2 error:(id*)arg3 ;
-(id)getRelabeledInferredMapItemForCandidate:(id)arg1 relabeler:(id)arg2 loiIdentifierToCoalescedSourceMap:(id)arg3 submitMetrics:(char)arg4 error:(id*)arg5 ;
...
-(void)setMonitorFingerprints:(char)arg1 ;
-(char)_purgeWithReferenceDate:(id)arg1 error:(id*)arg2 ;
...
-(char)_isUpdateLearnedPlaceWithISO3166CountryCodeAndSubdivisionCodeRequired:(id)arg1 ;
