...
@interface RTDaemonClient : NSObject <RTDaemonClientRegistrarVehicleEventProtocol, RTDaemonClientRegistrarScenarioTriggerProtocol, RTDaemonProtocol, NSXPCConnectionDelegate> {
	...
	char _monitorVisits;
	char _leechVisits;
	char _leechLowConfidenceVisits;
...
@property (assign,nonatomic) char monitorVisits;                                                             //@synthesize monitorVisits=_monitorVisits - In the implementation block
@property (assign,nonatomic) char leechVisits;                                                               //@synthesize leechVisits=_leechVisits - In the implementation block
@property (assign,nonatomic) char leechLowConfidenceVisits;                                                  //@synthesize leechLowConfidenceVisits=_leechLowConfidenceVisits - In the implementation block
...
-(void)setMonitorVisits:(char)arg1 ;
-(void)setLeechVisits:(char)arg1 ;
-(void)setLeechLowConfidenceVisits:(char)arg1 ;
-(char)monitorVisits;
-(char)leechVisits;
-(char)leechLowConfidenceVisits;
