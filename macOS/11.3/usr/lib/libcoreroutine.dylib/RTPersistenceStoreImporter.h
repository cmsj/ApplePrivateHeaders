...
-(char)updateRelationshipWithEntity:(id)arg1 relationshipDescription:(id)arg2 relationshipIdentifiers:(id)arg3 context:(id)arg4 error:(id*)arg5 ;
-(char)enumerateRelationshipsInEntityDescription:(id)arg1 sourceObject:(id)arg2 error:(id*)arg3 ;
-(char)importEntityRowsAndAttributes:(id*)arg1 ;
-(char)establishEntityRelationships:(id*)arg1 ;
