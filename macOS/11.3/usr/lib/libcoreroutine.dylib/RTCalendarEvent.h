...
-(id)initWithEventIdentifier:(id)arg1 allDay:(char)arg2 startDate:(id)arg3 endDate:(id)arg4 participantStatus:(unsigned long long)arg5 availability:(long long)arg6 location:(id)arg7 locationTitle:(id)arg8 locationMapItemHandle:(id)arg9 ;
