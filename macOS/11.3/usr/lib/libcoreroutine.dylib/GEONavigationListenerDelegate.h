...
-(void)navigationListener:(id)arg1 didUpdatePositionFromSign:(SCD_Struct_RT6)arg2;
-(void)navigationListener:(id)arg1 didUpdatePositionFromManeuver:(SCD_Struct_RT6)arg2;
-(void)navigationListener:(id)arg1 didUpdatePositionFromDestination:(SCD_Struct_RT6)arg2;
