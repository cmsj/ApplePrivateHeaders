...
-(char)sortedQueryResult:(id)arg1 correspondsToAoi:(id)arg2 poi:(id)arg3 ;
...
-(char)chooseBestAoiInferredMapItem:(id*)arg1 PoiInferredMapItem:(id*)arg2 fromSortedAveragedResults:(id)arg3 error:(id*)arg4 ;
...
-(char)submitHarvest:(id)arg1 error:(id*)arg2 ;
-(char)harvestVisits:(id)arg1 mapItem:(id)arg2 harvestType:(unsigned long long)arg3 error:(id*)arg4 ;
