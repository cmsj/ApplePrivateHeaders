...
+(char)validateModelDescription:(id)arg1 ;
...
-(char)updateModelFromFeatures:(id)arg1 toTarget:(id)arg2 options:(id)arg3 error:(id*)arg4 ;
-(BOOL)setInputFeatureName:(id*)arg1 to:(id)arg2 ;
-(BOOL)setOutputFeatureName:(id*)arg1 to:(id)arg2 ;
-(char)setFeatureCount:(unsigned long long)arg1 ;
...
-(char)updateModelFromFeatures:(id)arg1 toTarget:(id)arg2 error:(id*)arg3 ;
-(char)isEqualToBopr:(id)arg1 ;
