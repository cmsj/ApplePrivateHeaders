...
-(id)initWithDescription:(id)arg1 configuration:(id)arg2 indexToStringLabelArray:(vector<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::allocator<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>>*)arg3 indexToIntLabelArray:(vector<long long, std::__1::allocator<long long>>*)arg4 modelURL:(id)arg5 error:(id*)arg6 ;
-(SCD_Struct_ML58*)xgBoostDataFormatFromFeatureProvider:(id)arg1 error:(id*)arg2 ;
-(SCD_Struct_ML58*)xgBoostDataFormatFromBatchProvider:(id)arg1 needLabels:(BOOL)arg2 error:(id*)arg3 ;
...
-(id)loadLabelsWithStringLabels:(vector<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::allocator<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>>*)arg1 intLabels:(vector<long long, std::__1::allocator<long long>>*)arg2 ;
-(char)initializeAndvalidateObjectiveAndNumClassesWithConfiguration:(id)arg1 error:(id*)arg2 ;
