...
@property (nonatomic,readonly) char ndMode;                                    //@synthesize ndMode=_ndMode - In the implementation block
...
+(id)espressoTensorsToCoremlTensors:(id)arg1 ndMode:(char)arg2 ;
+(id)coremlShapesToEspressoShapes:(id)arg1 ndMode:(char)arg2 ;
+(id)espressoShapesToCoremlShapes:(id)arg1 ndMode:(char)arg2 ;
+(id)espressoShapeToCoremlShape:(id)arg1 ndMode:(char)arg2 ;
+(id)coremlShapeToEspressoShape:(id)arg1 ndMode:(char)arg2 ;
+(id)getStrides:(id)arg1 ;
+(id)espressoTensorToCoremlTensor:(id)arg1 ndMode:(char)arg2 ;
-(NSString *)className;
