...
-(void)observePresenterChange:(char)arg1 atSubitemURL:(id)arg2 ;
-(void)_settleNonCoordinatedChanges;
-(char)shouldSendObservationMessageWithPurposeID:(id)arg1 ;
-(void)forwardRelinquishmentForWritingClaim:(char)arg1 withID:(id)arg2 purposeID:(id)arg3 subitemURL:(id)arg4 options:(unsigned long long)arg5 completionHandler:(/*^block*/id)arg6 ;
-(void)disconnect;
