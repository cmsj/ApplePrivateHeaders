...
+(id)_recoveryQueue;
+(id)_queue;
+(id)createConnection:(const unsigned*)arg1 legacyService:(char)arg2 ;
...
-(void)_connectToServerWithRecovery:(char)arg1 userSession:(const unsigned*)arg2 legacyService:(char)arg3 ;
...
-(char)setServerPropertyForOption:(long long)arg1 value:(id)arg2 error:(id*)arg3 ;
