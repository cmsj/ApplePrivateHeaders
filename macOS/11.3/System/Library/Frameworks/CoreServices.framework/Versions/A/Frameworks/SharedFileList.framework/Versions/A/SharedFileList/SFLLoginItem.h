...
@class BTMLoginItem, NSUUID, NSString, SFLBookmark, NSDictionary;
...
@property (retain) BTMLoginItem * internalLoginItem;                //@synthesize internalLoginItem=_internalLoginItem - In the implementation block
...
-(BTMLoginItem *)internalLoginItem;
-(void)setInternalLoginItem:(BTMLoginItem *)arg1 ;
-(NSString *)name;
