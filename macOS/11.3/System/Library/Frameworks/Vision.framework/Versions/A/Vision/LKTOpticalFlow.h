...
@property (assign,nonatomic) char useNonLocalRegularization;              //@synthesize useNonLocalRegularization=_useNonLocalRegularization - In the implementation block
...
-(char)_validateInputImage:(CVBufferRef)arg1 error:(id*)arg2 ;
-(char)_validateOutputImage:(CVBufferRef)arg1 error:(id*)arg2 ;
-(int)levelCount;
-(int)numScales;
...
-(char)useNonLocalRegularization;
-(void)setUseNonLocalRegularization:(char)arg1 ;
-(int)nlreg_radius;
