...
-(char)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id*)arg3 ;
-(char)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id*)arg3 ;
-(char)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id*)arg3 ;
