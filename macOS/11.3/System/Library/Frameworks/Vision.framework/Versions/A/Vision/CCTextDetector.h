...
@interface CCTextDetector : NSObject {
	...
	char _computeZCVectorHighProbability;
	unsigned char _ii;
...
@property (assign) char computeZCVectorHighProbability;              //@synthesize computeZCVectorHighProbability=_computeZCVectorHighProbability - In the implementation block
...
@property (assign) char debugMatlab;                                 //@synthesize debugMatlab=_debugMatlab - In the implementation block
@property (assign) char debugOut;                                    //@synthesize debugOut=_debugOut - In the implementation block
...
-(unsigned)_extractCharBoxCuts:(_CCBigBox*)arg1 heightConstraint:(unsigned char)arg2 medianHeightTopVector:(unsigned short*)arg3 medianHeightBottomVector:(unsigned short*)arg4 isAdaptive:(char)arg5 ;
...
-(void)fillInOneVector:(vImage_Buffer*)arg1 checkFlag:(unsigned long long)arg2 checkHeight:(char)arg3 ;
...
-(char)computeZCVectorHighProbability;
-(void)setComputeZCVectorHighProbability:(char)arg1 ;
-(int)midRow;
...
-(char)debugMatlab;
-(void)setDebugMatlab:(char)arg1 ;
-(char)debugOut;
-(void)setDebugOut:(char)arg1 ;
