...
@property (assign,nonatomic) char hasSvcbRequested; 
@property (assign,nonatomic) char svcbRequested;                                          //@synthesize svcbRequested=_svcbRequested - In the implementation block
@property (assign,nonatomic) char hasSvcbReceived; 
@property (assign,nonatomic) char svcbReceived;                                           //@synthesize svcbReceived=_svcbReceived - In the implementation block
@property (assign,nonatomic) char hasSvcbDoHURI; 
@property (assign,nonatomic) char svcbDoHURI;                                             //@synthesize svcbDoHURI=_svcbDoHURI - In the implementation block
@property (assign,nonatomic) char hasConnectionReportReason; 
...
@property (assign,nonatomic) char hasIsProbe; 
@property (assign,nonatomic) char isProbe;                                                //@synthesize isProbe=_isProbe - In the implementation block
@property (nonatomic,readonly) char hasParentUUID; 
...
@property (assign,nonatomic) char hasQuicExperimentEnabled; 
@property (assign,nonatomic) char quicExperimentEnabled;                                  //@synthesize quicExperimentEnabled=_quicExperimentEnabled - In the implementation block
+(Class)protocolEstablishmentReportsType;
+(Class)activitiesType;
-(void)setSvcbRequested:(char)arg1 ;
-(void)setHasSvcbRequested:(char)arg1 ;
-(char)hasSvcbRequested;
-(void)setSvcbReceived:(char)arg1 ;
-(void)setHasSvcbReceived:(char)arg1 ;
-(char)hasSvcbReceived;
-(void)setSvcbDoHURI:(char)arg1 ;
-(void)setHasSvcbDoHURI:(char)arg1 ;
-(char)hasSvcbDoHURI;
-(void)setConnectionReportReason:(unsigned long long)arg1 ;
-(void)setHasConnectionReportReason:(char)arg1 ;
-(char)hasConnectionReportReason;
-(void)setIsProbe:(char)arg1 ;
-(void)setHasIsProbe:(char)arg1 ;
-(char)hasIsProbe;
-(char)hasParentUUID;
...
-(void)setQuicExperimentEnabled:(char)arg1 ;
-(void)setHasQuicExperimentEnabled:(char)arg1 ;
-(char)hasQuicExperimentEnabled;
-(char)svcbRequested;
-(char)svcbReceived;
-(char)svcbDoHURI;
