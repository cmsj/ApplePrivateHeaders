...
@property (assign,nonatomic) char hasDelegated; 
@property (assign,nonatomic) char delegated;                                                                      //@synthesize delegated=_delegated - In the implementation block
...
@property (nonatomic,readonly) char hasConnectionStatisticsReport; 
...
@property (nonatomic,readonly) char hasCellularFallbackReport; 
...
-(void)setHasDelegated:(char)arg1 ;
-(char)hasDelegated;
-(id)reportReasonAsString:(int)arg1 ;
-(int)StringAsReportReason:(id)arg1 ;
-(char)hasConnectionStatisticsReport;
-(char)hasCellularFallbackReport;
