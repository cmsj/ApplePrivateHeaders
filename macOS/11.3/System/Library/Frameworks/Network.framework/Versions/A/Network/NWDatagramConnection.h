...
-(char)readDatagramsWithMinimumCount:(unsigned long long)arg1 maximumCount:(unsigned long long)arg2 completionHandler:(/*^block*/id)arg3 ;
-(char)writeDatagrams:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
@end
