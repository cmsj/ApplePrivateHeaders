...
-(char)_canCreateContextOfSize:(CGSize)arg1 forRequest:(id)arg2 ;
-(id)_thumbnailDataDestructionConcurrenQueue;
-(void)_didGenerateThumbnailWithData:(id)arg1 drawingContextSize:(CGSize)arg2 ;
-(void)_executeCompletionHandlerWithThumbnailData:(id)arg1 thumbnailURL:(id)arg2 ioSurface:(id)arg3 drawingContextSize:(CGSize)arg4 didGenerateThumbnail:(char)arg5 error:(id)arg6 ;
