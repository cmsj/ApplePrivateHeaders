...
-(char)addItermediateTuple:(int)arg1 data:(int)arg2 type:(int)arg3 profile:(long long)arg4 index0:(int)arg5 index1:(int)arg6 index2:(int)arg7 ;
-(char)addIntermediateTuple:(id)arg1 ;
@end
