...
@property (assign,getter=isSendingVideo,nonatomic) char sendingVideo;              //@synthesize sendingVideo=_sendingVideo - In the implementation block
...
-(id)initWithCallUUID:(id)arg1 sendingVideo:(char)arg2 ;
@end
