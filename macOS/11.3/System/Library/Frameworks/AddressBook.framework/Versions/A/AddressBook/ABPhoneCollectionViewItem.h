...
@property (nonatomic,retain) ABCollectionItemMessagingAvailabilityHelper * messagingHelper;              //@synthesize messagingHelper=_messagingHelper - In the implementation block
@property (nonatomic,retain) ABRTTServices * ttyServices;                                                //@synthesize ttyServices=_ttyServices - In the implementation block
...
-(void)setMessagingHelper:(ABCollectionItemMessagingAvailabilityHelper *)arg1 ;
-(void)setTtyServices:(ABRTTServices *)arg1 ;
@end
