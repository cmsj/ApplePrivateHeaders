...
-(id)initWithContactStore:(id)arg1 contact:(id)arg2 isContactMeContact:(char)arg3 isContactReadOnly:(char)arg4 isContactCurated:(char)arg5 nonCuratedValueToSave:(id)arg6 forKey:(id)arg7 containerIdentifier:(id)arg8 ignoresGuardianRestrictions:(char)arg9 ;
@end
