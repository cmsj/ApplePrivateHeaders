...
@property (retain) NSTextField * timeIntervalField;                    //@synthesize timeIntervalField=_timeIntervalField - In the implementation block
...
-(void)setTimeIntervalField:(NSTextField *)arg1 ;
-(NSTextField *)timeIntervalField;
@end
