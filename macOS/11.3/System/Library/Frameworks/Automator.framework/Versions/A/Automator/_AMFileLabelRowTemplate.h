...
@class NSPopUpButton, NSLabelView, NSString;
...
@property (retain) NSLabelView * labelView;                            //@synthesize labelView=_labelView - In the implementation block
...
-(NSLabelView *)labelView;
-(void)setLabelView:(NSLabelView *)arg1 ;
-(id)templateViews;
