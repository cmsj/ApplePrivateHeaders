...
-(void)willBatchIndexForFullSyncWithCount:(unsigned long long)arg1 lastOffset:(long long)arg2 doneFullSync:(char)arg3 ;
...
-(void)failedToFetchClientStateFromSpotlight:(id)arg1 willRetry:(char)arg2 ;
-(void)failedToBeginIndexBatchWithSpotlight:(id)arg1 ;
-(void)failedToEndIndexBatchWithSpotlight:(id)arg1 willRetry:(char)arg2 ;
-(void)failedToJournalSearchableItemsForIndexingWithSpotlight:(id)arg1 identifiers:(id)arg2 willRetry:(char)arg3 ;
-(void)failedToJournalItemIdentifiersForDeletionWithSpotlight:(id)arg1 identifiers:(id)arg2 willRetry:(char)arg3 ;
-(void)failedToDeleteAllSearchableItemsWithSpotlight:(id)arg1 willRetry:(char)arg2 ;
...
-(id)_stringForSpotlightError:(id)arg1 willRetry:(char)arg2 ;
@end
