...
+(void)drawAppearance:(int)arg1 ofAnnotation:(id)arg2 withBox:(long long)arg3 inContext:(CGContextRef)arg4 scaleProportional:(char)arg5 ;
+(void)drawAppearance:(int)arg1 ofAnnotation:(id)arg2 withBox:(long long)arg3 inContext:(CGContextRef)arg4 ;
+(void)fillRect:(CGRect)arg1 color:(id)arg2 context:(CGContextRef)arg3 ;
+(char)renderString:(id)arg1 forRect:(CGRect)arg2 font:(id)arg3 color:(id)arg4 alignment:(long long)arg5 rotation:(int)arg6 breaks:(char)arg7 context:(CGContextRef)arg8 withAnnotation:(id)arg9 ;
+(CGPath*)createCGPathArrayWithBezierPaths:(id)arg1 ;
+(void)drawArrowFrom:(CGPoint)arg1 to:(CGPoint)arg2 open:(char)arg3 inContext:(CGContextRef)arg4 withBorder:(id)arg5 ;
...
+(void)drawPushButton:(id)arg1 inContext:(CGContextRef)arg2 withBackgroundColor:(id)arg3 withCaption:(id)arg4 withFont:(id)arg5 withFontColor:(id)arg6 isHighlighted:(char)arg7 ;
+(void)drawRadioButton:(id)arg1 inContext:(CGContextRef)arg2 withState:(long long)arg3 withBackgroundColor:(id)arg4 withBorderColor:(id)arg5 withFontColor:(id)arg6 isHighlighted:(char)arg7 ;
+(void)drawCheckBox:(id)arg1 inContext:(CGContextRef)arg2 withState:(long long)arg3 withBackgroundColor:(id)arg4 withBorderColor:(id)arg5 withFontColor:(id)arg6 isHighlighted:(char)arg7 ;
