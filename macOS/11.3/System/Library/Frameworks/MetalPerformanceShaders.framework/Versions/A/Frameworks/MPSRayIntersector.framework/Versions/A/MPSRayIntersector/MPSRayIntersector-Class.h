...
-(MPSRayIntersectorFunctionHash)getHashForIntersectionType:(unsigned long long)arg1 indexing:(char)arg2 indexType:(unsigned)arg3 instancing:(char)arg4 vertexStride:(unsigned long long)arg5 transformType:(unsigned long long)arg6 rootNodeType:(int)arg7 branchingFactor:(unsigned long long)arg8 nodeLayout:(int)arg9 polygonType:(unsigned long long)arg10 rayIndexing:(char)arg11 useRayTexture:(char)arg12 useResourceBuffer:(char)arg13 ;
...
-(id)getPipelineForIntersectionType:(unsigned long long)arg1 rayIndexing:(char)arg2 useRayTexture:(char)arg3 useResourceBuffer:(char)arg4 accelerationStructure:(id)arg5 commandBuffer:(id)arg6 ;
...
-(void)setUseMultipleThreadsPerRay:(char)arg1 ;
