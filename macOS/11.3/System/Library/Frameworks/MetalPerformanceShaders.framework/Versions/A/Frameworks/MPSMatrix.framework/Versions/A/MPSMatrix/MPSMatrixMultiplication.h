...
@property (assign,nonatomic) char transA;                                    //@synthesize transA=_transA - In the implementation block
@property (assign,nonatomic) char transB;                                    //@synthesize transB=_transB - In the implementation block
...
-(id)initWithDevice:(id)arg1 transposeLeft:(char)arg2 transposeRight:(char)arg3 resultRows:(unsigned long long)arg4 resultColumns:(unsigned long long)arg5 interiorColumns:(unsigned long long)arg6 alpha:(double)arg7 beta:(double)arg8 ;
...
-(char)transA;
-(void)setTransA:(char)arg1 ;
-(char)transB;
-(void)setTransB:(char)arg1 ;
@end
