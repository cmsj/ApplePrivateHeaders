...
@interface MPSNDArrayConvolution2DGradientWithWeights : MPSNDArrayBinarySecondaryGradientKernel {
	...
	MPSGradientWithWeightsAutoTuningParameters _autoTuningParams;
	BOOL _autoTuning;
...
-(void)setAutoTuning:(char)arg1 ;
-(void)setAutoTuningParameters:(MPSGradientWithWeightsAutoTuningParameters*)arg1 ;
@end
