...
-(double)scaleFactorX;
-(double)scaleFactorY;
-(id)initWithDevice:(id)arg1 filterType:(unsigned long long)arg2 integerScaleFactorX:(unsigned long long)arg3 integerScaleFactorY:(unsigned long long)arg4 alignCorners:(char)arg5 ;
-(char)alignCorners;
@end
