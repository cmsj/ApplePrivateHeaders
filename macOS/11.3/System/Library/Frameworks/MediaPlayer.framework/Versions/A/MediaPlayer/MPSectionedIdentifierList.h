...
@interface MPSectionedIdentifierList : NSObject <_MPSectionedIdentifierListEncodableNextEntriesProviding, MPExclusiveAccessible, NSSecureCoding> {
	...
	char _automaticallyReversesNonDestructiveDataSourceEdits;
...
@property (assign,nonatomic) char automaticallyReversesNonDestructiveDataSourceEdits;                                //@synthesize automaticallyReversesNonDestructiveDataSourceEdits=_automaticallyReversesNonDestructiveDataSourceEdits - In the implementation block
...
-(id)_debugDescriptionWithEnumerator:(id)arg1 lengths:(SCD_Struct_MP114*)arg2 ;
...
-(char)hasItem:(id)arg1 inSection:(id)arg2 ;
-(char)hasSection:(id)arg1 ;
-(char)isDeletedItem:(id)arg1 inSection:(id)arg2 ;
...
-(char)automaticallyReversesNonDestructiveDataSourceEdits;
-(void)setAutomaticallyReversesNonDestructiveDataSourceEdits:(char)arg1 ;
