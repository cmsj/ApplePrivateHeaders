...
-(void)addDataSourceAtStart:(id)arg1 section:(id)arg2 sequentially:(char)arg3 completion:(/*^block*/id)arg4 ;
-(void)addDataSource:(id)arg1 section:(id)arg2 sequentially:(char)arg3 afterItem:(id)arg4 inSection:(id)arg5 completion:(/*^block*/id)arg6 ;
-(void)addDataSource:(id)arg1 section:(id)arg2 sequentially:(char)arg3 afterTailOfSection:(id)arg4 completion:(/*^block*/id)arg5 ;
-(void)addDataSourceAtEnd:(id)arg1 section:(id)arg2 sequentially:(char)arg3 completion:(/*^block*/id)arg4 ;
