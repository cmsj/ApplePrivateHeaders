...
@property (assign,setter=_setCompleted:,nonatomic) char _completed;                                            //@synthesize _completed=__completed - In the implementation block
...
-(void)_setTaskCompletedWithSuccess:(char)arg1 actionsIfNotAlreadyCompleted:(/*^block*/id)arg2 ;
-(/*^block*/id)_unsafe_setTaskCompletedWithSuccess:(char)arg1 afterDelay:(double)arg2 ;
