...
@property (copy,readonly) NSString * chargingConnector;              //@synthesize chargingConnector=_chargingConnector - In the implementation block
@property (copy,readonly) NSMeasurement * maximumPower;              //@synthesize maximumPower=_maximumPower - In the implementation block
