...
@property (copy,readonly) INHomeEntity * entity;                    //@synthesize entity=_entity - In the implementation block
@property (copy,readonly) NSArray * taskResponses;                  //@synthesize taskResponses=_taskResponses - In the implementation block
