...
@property (copy,readonly) NSString * bundleVersion;                 //@synthesize bundleVersion=_bundleVersion - In the implementation block
@property (copy,readonly) NSString * appName;                       //@synthesize appName=_appName - In the implementation block
