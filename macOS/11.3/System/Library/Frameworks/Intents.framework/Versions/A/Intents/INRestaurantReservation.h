...
@property (copy,readonly) NSNumber * partySize;                                     //@synthesize partySize=_partySize - In the implementation block
@property (copy,readonly) CLPlacemark * restaurantLocation;                         //@synthesize restaurantLocation=_restaurantLocation - In the implementation block
