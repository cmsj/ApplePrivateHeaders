...
@property (copy) NSString * advisementText;                               //@synthesize advisementText=_advisementText - In the implementation block
...
@property (copy) NSDate * dateStatusModified;                             //@synthesize dateStatusModified=_dateStatusModified - In the implementation block
