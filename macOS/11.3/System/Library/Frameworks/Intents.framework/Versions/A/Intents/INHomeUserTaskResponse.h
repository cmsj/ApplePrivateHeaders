...
@property (copy,readonly) INHomeUserTask * userTask;                //@synthesize userTask=_userTask - In the implementation block
@property (readonly) long long taskOutcome;                         //@synthesize taskOutcome=_taskOutcome - In the implementation block
