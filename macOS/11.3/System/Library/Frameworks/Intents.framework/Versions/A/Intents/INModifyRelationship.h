...
@property (copy,readonly) NSString * targetRelationship;              //@synthesize targetRelationship=_targetRelationship - In the implementation block
@property (copy,readonly) NSNumber * isRemoval;                       //@synthesize isRemoval=_isRemoval - In the implementation block
