...
@property (copy,readonly) INCurrencyAmount * amount;                //@synthesize amount=_amount - In the implementation block
@property (readonly) long long amountType;                          //@synthesize amountType=_amountType - In the implementation block
