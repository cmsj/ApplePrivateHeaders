...
@property (copy,readonly) INRentalCar * rentalCar;                             //@synthesize rentalCar=_rentalCar - In the implementation block
@property (copy,readonly) INDateComponentsRange * rentalDuration;              //@synthesize rentalDuration=_rentalDuration - In the implementation block
@property (copy,readonly) CLPlacemark * pickupLocation;                        //@synthesize pickupLocation=_pickupLocation - In the implementation block
@property (copy,readonly) CLPlacemark * dropOffLocation;                       //@synthesize dropOffLocation=_dropOffLocation - In the implementation block
