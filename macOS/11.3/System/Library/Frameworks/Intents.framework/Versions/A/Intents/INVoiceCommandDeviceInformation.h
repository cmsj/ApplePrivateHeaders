...
@property (readonly) long long deviceIdiom;                                //@synthesize deviceIdiom=_deviceIdiom - In the implementation block
@property (copy,readonly) NSNumber * isHomePodInUltimateMode;              //@synthesize isHomePodInUltimateMode=_isHomePodInUltimateMode - In the implementation block
