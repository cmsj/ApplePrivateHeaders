...
@property (assign,nonatomic) char shouldAlignToBaselines;                             //@synthesize shouldAlignToBaselines=_shouldAlignToBaselines - In the implementation block
...
-(void)setShouldAlignToBaselines:(char)arg1 ;
