...
@class NSString, LPImage, LPArtworkMetadata, NSURL, NSArray, LPLyricExcerptMetadata;
...
@property (nonatomic,copy) LPLyricExcerptMetadata * lyricExcerpt;              //@synthesize lyricExcerpt=_lyricExcerpt - In the implementation block
