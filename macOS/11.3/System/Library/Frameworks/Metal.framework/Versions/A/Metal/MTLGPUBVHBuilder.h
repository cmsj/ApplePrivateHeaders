...
-(void)copyMTLSWBVHWithEncoder:(id)arg1 sourceBuffer:(id)arg2 sourceBufferOffset:(unsigned long long)arg3 toBuffer:(id)arg4 destinationBufferOffset:(unsigned long long)arg5 destinationUniqueIdentifier:(unsigned long long)arg6 compact:(char)arg7 ;
