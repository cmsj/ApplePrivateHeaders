...
-(unsigned char)getGroundAltitudeForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 location:(id)arg3 groundAltitude:(SCD_Struct_CL28*)arg4 ;
-(unsigned char)isLocationServicesCapable;
-(void)setMapMatchingRouteHint:(SCD_Struct_CL29*)arg1 count:(int)arg2 routingType:(int)arg3 stepType:(int)arg4 ;
