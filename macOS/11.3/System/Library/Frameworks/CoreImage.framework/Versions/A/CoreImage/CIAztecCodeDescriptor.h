...
+(id)descriptorWithPayload:(id)arg1 isCompact:(char)arg2 layerCount:(long long)arg3 dataCodewordCount:(long long)arg4 ;
-(NSData *)errorCorrectedPayload;
-(long long)dataCodewordCount;
...
-(long long)layerCount;
-(id)initWithPayload:(id)arg1 isCompact:(char)arg2 layerCount:(long long)arg3 dataCodewordCount:(long long)arg4 ;
-(char)isCompact;
@end
