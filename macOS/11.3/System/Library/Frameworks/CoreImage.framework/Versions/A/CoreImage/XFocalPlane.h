...
@interface XFocalPlane : NSObject {
	...
	SCD_Struct_XF69 _config;

}

@property (assign) SCD_Struct_XF69 config;                           //@synthesize config=_config - In the implementation block
...
-(int)encodeDisparityRefinementPreprocessingOn:(id)arg1 alphaTexture:(id)arg2 inputDisparityTexture:(id)arg3 outputDisparityTexture:(id)arg4 configuration:(SCD_Struct_XF70)arg5 ;
...
-(void)dealloc;
-(SCD_Struct_XF69)config;
-(void)setConfig:(SCD_Struct_XF69)arg1 ;
