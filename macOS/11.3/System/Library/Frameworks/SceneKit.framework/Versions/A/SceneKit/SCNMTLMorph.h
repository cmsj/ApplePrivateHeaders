...
-(void)dealloc;
-(SCD_Struct_SC146)newBufferWithLength:(unsigned long long)arg1 ;
-(char)isCompatibleWithMorph:(C3DMorphRef)arg1 ;
...
-(void)_writeSources:(const _C3DMeshSource*)arg1 dstTypes:(short*)arg2 sourcesCount:(unsigned)arg3 inBuffer:(void*)arg4 stride:(unsigned)arg5 length:(unsigned long long)arg6 sparse:(char)arg7 positionScale:(float)arg8 ;
