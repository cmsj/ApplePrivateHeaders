...
@interface SCNMTLResourceManager : NSObject {
	...
	SCD_Struct_SC137 _availableLightingSystemReflectionProbeTextures;
	SCD_Struct_SC137 _availableIrradianceTextures;
	SCD_Struct_SC137 _availableRadianceTextures;
	SCD_Struct_SC137 _availableImages;
	SCD_Struct_SC137 _availableImageProxy;
	SCD_Struct_SC137 _availableSamplers;
	SCD_Struct_SC137 _availableIESTextures;
	SCD_Struct_SC137 _availableBuffers;
	SCD_Struct_SC137 _availableMeshes;
	SCD_Struct_SC137 _availableMeshSources;
	SCD_Struct_SC137 _availableMeshElements;
	SCD_Struct_SC137 _availableRasterizerStates;
	SCD_Struct_SC137 _availableMorphs;
	SCD_Struct_SC137 _availableSkins;
	SCD_Struct_SC137 _availableComputePipelines;
	SCD_Struct_SC137 _availableComputePipelinesWithStageDescriptor;
	SCD_Struct_SC137 _availableTessellators;
	SCD_Struct_SC137 _availableWireframeMaterials;
	SCD_Struct_SC137 _availableShadables;
...
-(id)newRenderPipelineStateWithDesc:(SCD_Struct_SC139*)arg1 ;
...
-(id)renderResourceForProgramDesc:(SCD_Struct_SC136*)arg1 renderPassDescriptor:(id)arg2 ;
...
-(id)renderResourceForRasterizerState:(C3DRasterizerStatesRef)arg1 reverseZ:(char)arg2 ;
...
-(C3DFXMetalProgramRef)defaultProgramUsingTessellation:(char)arg1 ;
...
-(id)newRadianceTextureForEnvironmentTexture:(id)arg1 engineContext:(C3DEngineContextRef)arg2 cpuAccessible:(char)arg3 commandBuffer:(id)arg4 ;
...
-(void)_bakeStochasticIrradianceTexture:(id)arg1 forEnvironmentTexture:(id)arg2 mipmapLevelForSampling:(unsigned long long)arg3 useTextureView:(char)arg4 renderContext:(id)arg5 ;
...
-(void)_createPipelineStateWithDescriptor:(id)arg1 desc:(SCD_Struct_SC139*)arg2 pipeline:(id)arg3 ;
-(id)_newComputeDescriptorForPipelineDesc:(SCD_Struct_SC142)arg1 library:(id)arg2 ;
-(void)_configureComputePipeline:(id)arg1 withDescriptor:(id)arg2 ;
-(id)newComputePipelineStateForDesc:(SCD_Struct_SC142)arg1 library:(id)arg2 ;
-(id)getUniqueStageDescriptor:(id)arg1 ;
-(id)computePipelineStateForKernel:(id)arg1 threadGroupSizeIsMultipleOfThreadExecutionWidth:(char)arg2 ;
...
-(id)cubemapTextureForLatlongTexture:(id)arg1 pixelFormat:(unsigned long long)arg2 engineContext:(C3DEngineContextRef)arg3 needsMipmap:(char)arg4 ;
...
-(id)_textureDescriptorFromImage:(C3DImageRef)arg1 needsMipMap:(char)arg2 textureOptions:(int)arg3 ;
-(char)_copyImage:(C3DImageRef)arg1 toTexture:(id)arg2 desc:(id)arg3 textureOptions:(int)arg4 needsMipMapGeneration:(char)arg5 ;
-(id)convertTextureToCubeMapIfApplicable:(id)arg1 engineContext:(C3DEngineContextRef)arg2 needsMipmap:(char)arg3 ;
-(void)_enqueueCopyFromTexture:(id)arg1 toTexture:(id)arg2 blitEncoder:(SCNMTLBlitCommandEncoder*)arg3 generateMipMaps:(char)arg4 ;
-(id)latlongTextureForCubemap:(id)arg1 pixelFormat:(unsigned long long)arg2 renderContext:(id)arg3 needsMipmap:(char)arg4 ;
