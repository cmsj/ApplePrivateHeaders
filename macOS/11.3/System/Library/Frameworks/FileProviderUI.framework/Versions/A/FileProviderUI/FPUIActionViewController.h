...
@class NSString, NSArray, FPUIPlaceHolderViewController, NSError, NSURL;
...
@property (assign,nonatomic) char displayInline;                                                //@synthesize displayInline=_displayInline - In the implementation block
...
-(void)setDisplayInline:(char)arg1 ;
