...
@interface GCControllerElement : NSObject {
	...
	char _updatePending;
	char _boundToSystemGesture;
	char _remappable;
	char _mappableToSystemGestures;
	float _pendingValue;
	float _deadzone;
	int _remappingKey;
...
@property (assign,nonatomic) char remappable;                                                      //@synthesize remappable=_remappable - In the implementation block
@property (assign,nonatomic) int remappingKey;                                                     //@synthesize remappingKey=_remappingKey - In the implementation block
@property (assign,nonatomic) char mappableToSystemGestures;                                        //@synthesize mappableToSystemGestures=_mappableToSystemGestures - In the implementation block
@property (assign,getter=isBoundToSystemGesture,nonatomic) char boundToSystemGesture;              //@synthesize boundToSystemGesture=_boundToSystemGesture - In the implementation block
...
-(char)_setPendingValueIfChanged:(float)arg1 ;
...
-(void)setBoundToSystemGesture:(char)arg1 ;
...
-(char)remappable;
-(void)setRemappable:(char)arg1 ;
-(int)remappingKey;
-(void)setRemappingKey:(int)arg1 ;
-(char)mappableToSystemGestures;
-(void)setMappableToSystemGestures:(char)arg1 ;
@end
