...
-(void)getActiveTabWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)getAllTabsWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)openTabWithURL:(id)arg1 makeActiveIfPossible:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)getToolbarItemWithCompletionHandler:(/*^block*/id)arg1 ;
@end
