...
@property (assign,getter=isEnriched,nonatomic) char enriched;                               //@synthesize enriched=_enriched - In the implementation block
@property (assign,getter=isRecent,nonatomic) char recent;                                   //@synthesize recent=_recent - In the implementation block
...
@property (getter=isCurated,nonatomic,readonly) char curated;                               //@synthesize curated=_curated - In the implementation block
...
-(char)isEnriched;
-(void)setEnriched:(char)arg1 ;
-(void)setRecent:(char)arg1 ;
