...
@property (assign,nonatomic) char thumbnailWriteSucceeded;                       //@synthesize thumbnailWriteSucceeded=_thumbnailWriteSucceeded - In the implementation block
...
-(char)thumbnailWriteSucceeded;
-(void)setThumbnailWriteSucceeded:(char)arg1 ;
