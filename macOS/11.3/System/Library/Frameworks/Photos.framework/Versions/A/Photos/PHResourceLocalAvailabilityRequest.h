...
@property (assign,setter=_setDownloadCancelled:,getter=_isDownloadCancelled,nonatomic) char _downloadCancelled;              //@synthesize _downloadCancelled=__downloadCancelled - In the implementation block
...
+(id)_resourceInfoForAsset:(id)arg1 resourcesToShare:(id)arg2 includeAllAssetResources:(char)arg3 fulfillOnDemandResources:(char)arg4 error:(id*)arg5 ;
...
+(char)setValuesInDictionary:(id)arg1 fromDictionary:(id)arg2 keysToCopy:(id)arg3 ;
+(id)originalsAndFullSizeResourcesToShareForAsset:(id)arg1 fromAvailableResources:(id)arg2 options:(id)arg3 error:(id*)arg4 ;
+(id)singularResourcesToShareForAsset:(id)arg1 fromAvailableResources:(id)arg2 options:(id)arg3 useOriginalResources:(char)arg4 knownUnsupported:(char)arg5 error:(id*)arg6 ;
...
-(void)_fetchResourcesWithOptions:(id)arg1 networkAccessAllowed:(char)arg2 handler:(/*^block*/id)arg3 ;
-(void)_fetchResourcesForPickerAsset:(id)arg1 options:(id)arg2 networkAccessAllowed:(char)arg3 handler:(/*^block*/id)arg4 ;
-(void)_fetchResourcesForSharingAsset:(id)arg1 options:(id)arg2 networkAccessAllowed:(char)arg3 handler:(/*^block*/id)arg4 ;
-(void)_fetchResourcesForDuplicatingAsset:(id)arg1 options:(id)arg2 networkAccessAllowed:(char)arg3 handler:(/*^block*/id)arg4 ;
-(void)_handleCompletionOfAssetResourceDataRequestWithId:(int)arg1 error:(id)arg2 ;
-(void)_simulateFetchResourcesWithDuration:(double)arg1 success:(char)arg2 networkAccessAllowed:(char)arg3 handler:(/*^block*/id)arg4 ;
-(void)_didFinishDownloadWithSuccess:(char)arg1 resourceInfo:(id)arg2 error:(id)arg3 ;
-(void)_cancelActiveAssetResourceRequests;
-(void)cancelRetrievalRequest;
-(void)_updateCombinedProgressWithValue:(double)arg1 forRequestIdentifier:(id)arg2 networkAccessAllowed:(char)arg3 ;
...
-(char)_isDownloadCancelled;
-(void)_setDownloadCancelled:(char)arg1 ;
