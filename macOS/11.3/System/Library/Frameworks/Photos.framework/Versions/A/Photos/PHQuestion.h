...
+(id)fetchQuestionsWithOptions:(id)arg1 validQuestionsOnly:(char)arg2 ;
+(id)fetchQuestionsWithLocalIdentifiers:(id)arg1 options:(id)arg2 validQuestionsOnly:(char)arg3 ;
+(id)fetchAnsweredYesOrNoQuestionsWithOptions:(id)arg1 validQuestionsOnly:(char)arg2 ;
+(id)fetchAnsweredQuestionsWithOptions:(id)arg1 validQuestionsOnly:(char)arg2 ;
+(id)fetchUnansweredQuestionsWithOptions:(id)arg1 validQuestionsOnly:(char)arg2 ;
