...
@class NSImage, NSTabBarItem, NSView, NSMorphingDragImageView, NSAnimation, NSWindow, NSTimer, NSTearOffTabWindow, NSString;
...
@property (nonatomic,readonly) NSTearOffTabWindow * dragWindow;              //@synthesize dragWindow=_dragWindow - In the implementation block
