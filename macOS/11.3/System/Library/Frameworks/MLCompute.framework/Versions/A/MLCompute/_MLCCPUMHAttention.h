...
+(id)layerWithDevice:(id)arg1 descriptor:(id)arg2 weights:(id)arg3 bias:(id)arg4 attnBias:(id)arg5 inferenceOnly:(char)arg6 ;
-(id)initWithDevice:(id)arg1 descriptor:(id)arg2 weights:(id)arg3 bias:(id)arg4 attnBias:(id)arg5 inferenceOnly:(char)arg6 ;
@end
