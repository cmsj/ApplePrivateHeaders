...
@property (assign,nonatomic) long long suggestedBatchSize;              //@synthesize suggestedBatchSize=_suggestedBatchSize - In the implementation block
...
-(void)finishEnumeratingChangesUpToSyncAnchor:(id)arg1 moreComing:(char)arg2 ;
