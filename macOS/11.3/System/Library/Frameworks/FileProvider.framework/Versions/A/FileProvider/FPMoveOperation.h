...
@property (nonatomic,readonly) char byCopy; 
...
-(char)byCopy;
-(char)_hasAccessToURL:(id)arg1 readonly:(char)arg2 ;
...
-(char)_preflightCheckNotMovingIntoSelfWithError:(id*)arg1 ;
-(char)_preflightCheckProviderCanMoveWithErrors:(id*)arg1 ;
