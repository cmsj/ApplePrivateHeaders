...
@property (assign,nonatomic) char hasTimeIntervalSinceReferenceDateValue; 
...
@property (nonatomic,readonly) char hasNameComponents; 
...
-(char)hasTimeIntervalSinceReferenceDateValue;
-(double)timeIntervalSinceReferenceDateValue;
-(char)hasNameComponents;
-(void)setHasIntegerValue:(char)arg1 ;
-(void)setHasTimeIntervalSinceReferenceDateValue:(char)arg1 ;
@end
