...
@property (assign) NSPopUpButton * microphoneButton;              //@synthesize microphoneButton=_microphoneButton - In the implementation block
...
-(void)setMicrophoneButton:(NSPopUpButton *)arg1 ;
@end
