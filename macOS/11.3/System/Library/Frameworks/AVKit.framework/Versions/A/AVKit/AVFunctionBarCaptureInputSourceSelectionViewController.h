...
@class NSMutableArray, NSView, NSSegmentedControl, NSStackView, NSArray, AVFunctionBarCaptureInputSourceItem, NSString;
...
@property (assign,nonatomic,__weak) id<AVFunctionBarCaptureInputSourceSelectionViewControllerDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)dealloc;
-(id)init;
-(id<AVFunctionBarCaptureInputSourceSelectionViewControllerDelegate>)delegate;
-(void)setDelegate:(id<AVFunctionBarCaptureInputSourceSelectionViewControllerDelegate>)arg1 ;
...
-(AVFunctionBarCaptureInputSourceItem *)selectedCaptureInputSourceItem;
-(char)showsLabel;
