...
-(id)_ticketForReverseGeocodeCoordinate:(CLLocationCoordinate2D)arg1 includeEntryPoints:(char)arg2 preserveOriginalLocation:(char)arg3 traits:(id)arg4 ;
-(id)_ticketForReverseGeocodeDroppedPinCoordinate:(CLLocationCoordinate2D)arg1 floorOrdinal:(id)arg2 traits:(id)arg3 ;
-(id)_ticketForReverseGeocodeCoordinate:(CLLocationCoordinate2D)arg1 floorOrdinal:(int)arg2 includeEntryPoints:(char)arg3 preserveOriginalLocation:(char)arg4 traits:(id)arg5 ;
