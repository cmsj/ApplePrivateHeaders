...
@interface MKLocalSearchRequest : NSObject <NSCopying> {
	...
	char _hasSentFeedbackForCompletion;
...
@property (assign,nonatomic) char hasSentFeedbackForCompletion;                                                                                                                                                //@synthesize hasSentFeedbackForCompletion=_hasSentFeedbackForCompletion - In the implementation block
...
-(char)hasSentFeedbackForCompletion;
-(void)setHasSentFeedbackForCompletion:(char)arg1 ;
...
-(id)initWithNaturalLanguageQuery:(id)arg1 region:(SCD_Struct_MK34)arg2 ;
