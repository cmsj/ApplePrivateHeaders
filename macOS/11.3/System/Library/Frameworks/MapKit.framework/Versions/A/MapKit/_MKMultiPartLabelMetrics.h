...
-(char)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3 ;
-(void)setCurrentSeparatorIndex:(unsigned long long)arg1 ;
-(NSAttributedString *)originalAttributedString;
-(char)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2 ;
