...
@property (nonatomic,readonly) id<IMKTextDocument> textDocument;                                   //@synthesize textDocument=_textDocument - In the implementation block
@property (nonatomic,readonly) IMKTextDocumentTextInputAdaptor * textDocumentAdaptor; 
...
-(IMKTextDocumentTextInputAdaptor *)textDocumentAdaptor;
...
-(id<IMKTextDocument>)textDocument;
