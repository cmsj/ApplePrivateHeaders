...
@interface VSAccountMetadataRequest : NSObject <NSCopying, NSSecureCoding> {
	...
	char _includeAccountProviderIdentifier;
	char _includeAuthenticationExpirationDate;
	char _interruptionAllowed;
...
@property (assign,nonatomic) char includeAccountProviderIdentifier;                              //@synthesize includeAccountProviderIdentifier=_includeAccountProviderIdentifier - In the implementation block
@property (assign,nonatomic) char includeAuthenticationExpirationDate;                           //@synthesize includeAuthenticationExpirationDate=_includeAuthenticationExpirationDate - In the implementation block
...
@property (assign,getter=isInterruptionAllowed,nonatomic) char interruptionAllowed;              //@synthesize interruptionAllowed=_interruptionAllowed - In the implementation block
@property (assign,nonatomic) char forceAuthentication;                                           //@synthesize forceAuthentication=_forceAuthentication - In the implementation block
...
-(char)includeAccountProviderIdentifier;
-(void)setIncludeAccountProviderIdentifier:(char)arg1 ;
-(char)includeAuthenticationExpirationDate;
-(void)setIncludeAuthenticationExpirationDate:(char)arg1 ;
-(void)setLocalizedVideoTitle:(NSString *)arg1 ;
-(void)setInterruptionAllowed:(char)arg1 ;
