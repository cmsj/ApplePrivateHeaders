...
-(char)_validateNullableValue:(id*)arg1 forKey:(id)arg2 error:(id*)arg3 ;
-(void)setProvidedSubscriptionInfo:(NSString *)arg1 ;
-(void)setMostRecentSaveDate:(NSDate *)arg1 ;
-(char)validateAccessLevel:(id*)arg1 error:(id*)arg2 ;
-(char)validateCreationDate:(id*)arg1 error:(id*)arg2 ;
-(char)validateModificationDate:(id*)arg1 error:(id*)arg2 ;
-(char)validateExpirationDate:(id*)arg1 error:(id*)arg2 ;
-(char)validateSubscriberIdentifierHash:(id*)arg1 error:(id*)arg2 ;
-(char)validateTierIdentifiers:(id*)arg1 error:(id*)arg2 ;
-(char)validateBillingIdentifier:(id*)arg1 error:(id*)arg2 ;
@end
