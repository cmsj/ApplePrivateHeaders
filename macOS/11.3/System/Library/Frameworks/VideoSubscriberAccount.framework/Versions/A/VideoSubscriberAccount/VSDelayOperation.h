...
@property (assign,nonatomic) char shouldIgnoreTolerance;              //@synthesize shouldIgnoreTolerance=_shouldIgnoreTolerance - In the implementation block
...
-(void)setShouldIgnoreTolerance:(char)arg1 ;
-(char)shouldIgnoreTolerance;
@end
