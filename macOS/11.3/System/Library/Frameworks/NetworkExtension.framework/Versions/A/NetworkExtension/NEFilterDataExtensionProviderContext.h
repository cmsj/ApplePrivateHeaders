...
@property (assign,nonatomic) char controlProviderExists;                            //@synthesize controlProviderExists=_controlProviderExists - In the implementation block
