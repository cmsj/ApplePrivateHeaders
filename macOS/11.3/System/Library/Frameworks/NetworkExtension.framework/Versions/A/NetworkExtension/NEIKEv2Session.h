...
@property (assign) char isListening;                                                    //@synthesize isListening=_isListening - In the implementation block
...
@property (assign,nonatomic) char ownsDatabaseSession;                                  //@synthesize ownsDatabaseSession=_ownsDatabaseSession - In the implementation block
...
@property (assign) char ownsIPSecInterface;                                             //@synthesize ownsIPSecInterface=_ownsIPSecInterface - In the implementation block
...
@property (readonly) char hasInterface; 
...
@property (assign) char isAborted;                                                      //@synthesize isAborted=_isAborted - In the implementation block
@property (assign) char isInvalidated;                                                  //@synthesize isInvalidated=_isInvalidated - In the implementation block
@property (assign,nonatomic) char isExpectingConfigBlock;                               //@synthesize isExpectingConfigBlock=_isExpectingConfigBlock - In the implementation block
@property (assign,nonatomic) char hasContactedConfigurationDelegate;                    //@synthesize hasContactedConfigurationDelegate=_hasContactedConfigurationDelegate - In the implementation block
...
@property (assign,nonatomic) char hasOutboundRequestInFlight;                           //@synthesize hasOutboundRequestInFlight=_hasOutboundRequestInFlight - In the implementation block
...
-(int)sendRequest:(id)arg1 retry:(char)arg2 replyHandler:(/*^block*/id)arg3 ;
-(void)reportState;
-(int)sendRequest:(id)arg1 retry:(char)arg2 sendCompletionHandler:(/*^block*/id)arg3 replyHandler:(/*^block*/id)arg4 ;
-(char)sendReply:(id)arg1 replyHandler:(/*^block*/id)arg2 ;
-(char)hasOutboundRequestInFlight;
-(void)initiateMOBIKE:(id)arg1 ;
-(int)sendRequest:(id)arg1 retryIntervalInMilliseconds:(unsigned long long)arg2 maxRetries:(unsigned)arg3 timeoutError:(id)arg4 resend:(char)arg5 sendMessageID:(int)arg6 sendCompletionHandler:(/*^block*/id)arg7 replyHandler:(/*^block*/id)arg8 ;
-(void)reportShortDPD;
...
-(char)generateSPIForChild:(id)arg1 proposals:(id)arg2 ;
-(void)reportAdditionalAddressesInPacket:(id)arg1 ;
-(void)initiateDelete:(id)arg1 ;
-(void)finishConfigurationEstablishment;
-(void)reportConfiguration;
-(char)installChildSA:(id)arg1 ;
-(id<NEIKEv2PacketDelegate>)packetDelegate;
-(char)migrateAllChildSAs;
-(void)reportTrafficSelectorsForChildSA:(id)arg1 ;
-(void)retryDHForIKESA:(id)arg1 validated:(char)arg2 handler:(/*^block*/id)arg3 ;
-(void)retryCookieForIKESA:(id)arg1 validated:(char)arg2 handler:(/*^block*/id)arg3 ;
-(char)isExpectingConfigBlock;
-(void)setHasContactedConfigurationDelegate:(char)arg1 ;
-(void)setIsExpectingConfigBlock:(char)arg1 ;
...
-(char)innerReceiveDeleteIKESA:(id)arg1 ;
-(id)copyChildWithSPI:(id)arg1 ;
-(char)receiveDeleteChildSPI:(id)arg1 remoteSPI:(id)arg2 packet:(id)arg3 ;
...
-(id)initWithIKEConfig:(id)arg1 configurationDelegate:(id)arg2 queue:(id)arg3 saSession:(id)arg4 shouldCopySASession:(char)arg5 transport:(id)arg6 packetDelegate:(id)arg7 ;
...
-(void)invalidateWithCompletionHandler:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)forceRekeyIKE;
-(void)forceRekeyChild:(unsigned)arg1 ;
-(void)sendMOBIKEWithRetries:(unsigned)arg1 retryInterval:(unsigned long long)arg2 interfaceName:(id)arg3 invalidateTransport:(char)arg4 resetEndpoint:(id)arg5 callbackQueue:(id)arg6 callback:(/*^block*/id)arg7 ;
-(NEIPSecSASession *)databaseSession;
-(char)ownsDatabaseSession;
...
-(void)setOwnsDatabaseSession:(char)arg1 ;
-(void)setRttState:(NEIKEv2RTT *)arg1 ;
-(id)initWithIKEConfig:(id)arg1 firstChildConfig:(id)arg2 sessionConfig:(id)arg3 queue:(id)arg4 ipsecInterface:(NEVirtualInterface_sRef)arg5 ikeSocketHandler:(/*^block*/id)arg6 saSession:(id)arg7 shouldOwnSASession:(char)arg8 packetDelegate:(id)arg9 transport:(id)arg10 configurationDelegate:(id)arg11 ;
...
-(char)hasContactedConfigurationDelegate;
-(char)ownsIPSecInterface;
...
-(void)setHasOutboundRequestInFlight:(char)arg1 ;
