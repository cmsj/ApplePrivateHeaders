...
@interface NEHotspotEAPSettings : NSObject <NSCopying, NSSecureCoding> {
	...
	char _tlsClientCertificateRequired;
...
@property (getter=isTLSClientCertificateRequired) char tlsClientCertificateRequired;              //@synthesize tlsClientCertificateRequired=_tlsClientCertificateRequired - In the implementation block
...
-(char)isTLSClientCertificateRequired;
...
-(void)setTlsClientCertificateRequired:(char)arg1 ;
...
-(char)setTrustedServerCertificates:(id)arg1 ;
...
-(NSString *)username;
-(char)setIdentity:(SecIdentityRef)arg1 ;
