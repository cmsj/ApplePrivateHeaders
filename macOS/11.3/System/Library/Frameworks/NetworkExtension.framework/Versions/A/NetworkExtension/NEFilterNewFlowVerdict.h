...
+(id)filterDataVerdictWithFilterInbound:(char)arg1 peekInboundBytes:(unsigned long long)arg2 filterOutbound:(char)arg3 peekOutboundBytes:(unsigned long long)arg4 ;
