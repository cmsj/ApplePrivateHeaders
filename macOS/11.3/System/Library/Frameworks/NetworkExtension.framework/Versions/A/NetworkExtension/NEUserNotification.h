...
@property (assign) char isAlert;                                            //@synthesize isAlert=_isAlert - In the implementation block
...
+(void)cancelCurrentNotificationWithDefaultResponse:(char)arg1 queue:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(char)isAlert;
-(id)initAndShowAlertWithHeader:(id)arg1 message:(id)arg2 alternateMessage:(id)arg3 defaultMessage:(id)arg4 noBoldDefault:(char)arg5 callbackQueue:(id)arg6 callbackHandler:(/*^block*/id)arg7 ;
