...
@class NEIKEv2ConfigurationMessage, NEIKEv2Identifier, NSArray, NEIKEv2AuthenticationProtocol, NSString, NSData, NSNumber;
...
@interface NEIKEv2SessionConfiguration : NSObject <NSCopying> {
	...
	char _initialContactDisabled;
	char _negotiateMOBIKE;
	char _natTraversalKeepaliveDisabled;
	char _natTraversalKeepaliveEnabled;
	char _natTraversalKeepaliveOffloadEnabled;
	char _deadPeerDetectionEnabled;
	char _idleTimeoutEnabled;
	char _blackholeDetectionEnabled;
	char _enableCertificateRevocationCheck;
	char _strictCertificateRevocationCheck;
	char _disableRemoteCertificateValidation;
...
@property (assign) char initialContactDisabled;                                                      //@synthesize initialContactDisabled=_initialContactDisabled - In the implementation block
@property (assign) char negotiateMOBIKE;                                                             //@synthesize negotiateMOBIKE=_negotiateMOBIKE - In the implementation block
...
@property (assign) char natTraversalKeepaliveDisabled;                                               //@synthesize natTraversalKeepaliveDisabled=_natTraversalKeepaliveDisabled - In the implementation block
@property (assign) char natTraversalKeepaliveEnabled;                                                //@synthesize natTraversalKeepaliveEnabled=_natTraversalKeepaliveEnabled - In the implementation block
...
@property (assign) char natTraversalKeepaliveOffloadEnabled;                                         //@synthesize natTraversalKeepaliveOffloadEnabled=_natTraversalKeepaliveOffloadEnabled - In the implementation block
...
@property (assign) char deadPeerDetectionEnabled;                                                    //@synthesize deadPeerDetectionEnabled=_deadPeerDetectionEnabled - In the implementation block
...
@property (assign) char idleTimeoutEnabled;                                                          //@synthesize idleTimeoutEnabled=_idleTimeoutEnabled - In the implementation block
...
@property (assign) char blackholeDetectionEnabled;                                                   //@synthesize blackholeDetectionEnabled=_blackholeDetectionEnabled - In the implementation block
...
@property (assign) char enableCertificateRevocationCheck;                                            //@synthesize enableCertificateRevocationCheck=_enableCertificateRevocationCheck - In the implementation block
@property (assign) char strictCertificateRevocationCheck;                                            //@synthesize strictCertificateRevocationCheck=_strictCertificateRevocationCheck - In the implementation block
@property (assign) char disableRemoteCertificateValidation;                                          //@synthesize disableRemoteCertificateValidation=_disableRemoteCertificateValidation - In the implementation block
...
@property (retain) NSNumber * pduSessionID;                                                          //@synthesize pduSessionID=_pduSessionID - In the implementation block
...
-(char)initialContactDisabled;
-(void)setInitialContactDisabled:(char)arg1 ;
-(char)negotiateMOBIKE;
-(void)setNegotiateMOBIKE:(char)arg1 ;
-(NSArray *)additionalMOBIKEAddresses;
-(void)setAdditionalMOBIKEAddresses:(NSArray *)arg1 ;
-(char)natTraversalKeepaliveDisabled;
-(void)setNatTraversalKeepaliveDisabled:(char)arg1 ;
-(unsigned long long)natTraversalKeepaliveInterval;
-(void)setNatTraversalKeepaliveInterval:(unsigned long long)arg1 ;
-(char)natTraversalKeepaliveOffloadEnabled;
-(void)setNatTraversalKeepaliveOffloadEnabled:(char)arg1 ;
...
-(char)deadPeerDetectionEnabled;
-(void)setDeadPeerDetectionEnabled:(char)arg1 ;
...
-(void)setIdleTimeoutEnabled:(char)arg1 ;
-(unsigned long long)idleTimeoutSeconds;
-(void)setIdleTimeoutSeconds:(unsigned long long)arg1 ;
-(char)blackholeDetectionEnabled;
-(void)setBlackholeDetectionEnabled:(char)arg1 ;
...
-(char)enableCertificateRevocationCheck;
-(void)setEnableCertificateRevocationCheck:(char)arg1 ;
-(char)strictCertificateRevocationCheck;
-(void)setStrictCertificateRevocationCheck:(char)arg1 ;
-(char)disableRemoteCertificateValidation;
-(void)setDisableRemoteCertificateValidation:(char)arg1 ;
...
-(char)natTraversalKeepaliveEnabled;
-(void)setNatTraversalKeepaliveEnabled:(char)arg1 ;
-(void)setPduSessionID:(NSNumber *)arg1 ;
