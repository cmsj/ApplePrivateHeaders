...
@property (assign) char reportAtEnd;                                       //@synthesize reportAtEnd=_reportAtEnd - In the implementation block
@property (assign) char sourceAppIdentifierFromApp;                        //@synthesize sourceAppIdentifierFromApp=_sourceAppIdentifierFromApp - In the implementation block
...
-(char)reportAtEnd;
-(void)setReportAtEnd:(char)arg1 ;
-(void)setSourceAppIdentifierFromApp:(char)arg1 ;
...
-(char)sourceAppIdentifierFromApp;
...
-(char)shouldCloseWithVerdict:(id)arg1 ;
-(id)initWithURL:(id)arg1 sourceAppIdentifier:(id)arg2 ;
-(char)updateCurrentVerdictFromDataVerdict:(id)arg1 direction:(long long)arg2 ;
