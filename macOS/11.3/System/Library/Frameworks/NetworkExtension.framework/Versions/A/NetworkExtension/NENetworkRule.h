...
@property (nonatomic,readonly) char appliesToLoopback;                  //@synthesize appliesToLoopback=_appliesToLoopback - In the implementation block
