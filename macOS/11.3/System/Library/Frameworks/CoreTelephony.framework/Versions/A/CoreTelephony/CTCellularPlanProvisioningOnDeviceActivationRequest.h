...
@property (nonatomic,readonly) char useDS;                          //@synthesize useDS=_useDS - In the implementation block
@property (nonatomic,readonly) char isESim;                         //@synthesize isESim=_isESim - In the implementation block
...
-(char)useDS;
-(char)isESim;
-(id)initWithEid:(id)arg1 installIccid:(id)arg2 sourceIccid:(id)arg3 phoneNumber:(id)arg4 mcc:(id)arg5 mnc:(id)arg6 gid1:(id)arg7 gid2:(id)arg8 smdp:(id)arg9 useDS:(char)arg10 esim:(char)arg11 ;
@end
