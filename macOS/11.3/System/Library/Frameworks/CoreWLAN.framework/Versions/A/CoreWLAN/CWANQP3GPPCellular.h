...
@property (nonatomic,copy) NSArray * cellularInfoList;              //@synthesize cellularInfoList=_cellularInfoList - In the implementation block
+(char)supportsSecureCoding;
-(NSArray *)cellularInfoList;
-(void)setCellularInfoList:(NSArray *)arg1 ;
