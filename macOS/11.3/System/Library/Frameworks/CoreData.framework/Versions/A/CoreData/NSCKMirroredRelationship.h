...
+(char)updateMirroredRelationshipsMatchingRecords:(id)arg1 forStore:(id)arg2 withManagedObjectContext:(id)arg3 usingBlock:(/*^block*/id)arg4 error:(id*)arg5 ;
+(char)purgeMirroredRelationshipsWithRecordIDs:(id)arg1 fromStore:(id)arg2 withManagedObjectContext:(id)arg3 error:(id*)arg4 ;
...
-(char)updateRelationshipValueUsingImportContext:(id)arg1 andManagedObjectContext:(id)arg2 isDelete:(char)arg3 error:(id*)arg4 ;
@end
