...
-(id)generateBatchDeleteUpdateHistoryStatementEntity:(id)arg1 andRelationship:(id)arg2 useInverse:(char)arg3 ;
...
-(id)newCreateIndexStatementsForEntity:(id)arg1 defaultIndicesOnly:(char)arg2 ;
...
-(id)newDropIndexStatementsForEntity:(id)arg1 defaultIndicesOnly:(char)arg2 ;
...
-(char)generateTriggerForEntity:(id)arg1 alreadyCreated:(CFDictionaryRef)arg2 correlations:(CFDictionaryRef)arg3 batchHistory:(CFDictionaryRef)arg4 fragments:(id)arg5 error:(id*)arg6 ;
-(char)generateBatchDeleteUpdateHistoryTriggerForEntity:(id)arg1 andRelationship:(id)arg2 batchHistory:(CFDictionaryRef)arg3 error:(id*)arg4 ;
