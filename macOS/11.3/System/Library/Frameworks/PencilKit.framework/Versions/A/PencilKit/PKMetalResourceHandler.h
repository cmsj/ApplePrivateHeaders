...
@interface PKMetalResourceHandler : NSObject {
	...
	char _deviceSupportsAppleFamily;
	char _deviceSupportsMacFamily;
	char _deviceSupportsCatalystFamily;
	char _deviceSupportsFramebufferFetch;
...
@property (nonatomic,readonly) char deviceSupportsAppleFamily;                                      //@synthesize deviceSupportsAppleFamily=_deviceSupportsAppleFamily - In the implementation block
@property (nonatomic,readonly) char deviceSupportsMacFamily;                                        //@synthesize deviceSupportsMacFamily=_deviceSupportsMacFamily - In the implementation block
@property (nonatomic,readonly) char deviceSupportsCatalystFamily;                                   //@synthesize deviceSupportsCatalystFamily=_deviceSupportsCatalystFamily - In the implementation block
@property (nonatomic,readonly) char deviceSupportsFramebufferFetch;                                 //@synthesize deviceSupportsFramebufferFetch=_deviceSupportsFramebufferFetch - In the implementation block
...
-(id)erasePaintShader;
-(char)deviceSupportsFramebufferFetch;
...
-(char)deviceSupportsAppleFamily;
-(char)deviceSupportsMacFamily;
-(id)paintCircleShader;
-(id<MTLTexture>)paperTexture;
-(id)paperShader;
-(id)fillColorShader;
-(id)linesShader;
-(id)compositeOverShaderWithMode:(long long)arg1 clipping:(char)arg2 colorAttachmentIndex:(unsigned long long)arg3 renderMask:(char)arg4 edgeMask:(char)arg5 ;
-(id)compositeSoftWhiteShaderWithMode:(long long)arg1 clipping:(char)arg2 colorAttachmentIndex:(unsigned long long)arg3 renderMask:(char)arg4 edgeMask:(char)arg5 ;
-(id)compositeMultiplyShaderWithMode:(long long)arg1 clipping:(char)arg2 targetMultiple:(char)arg3 colorAttachmentIndex:(unsigned long long)arg4 renderMask:(char)arg5 edgeMask:(char)arg6 ;
-(id)compositeEraseShaderWithMode:(long long)arg1 clipping:(char)arg2 colorAttachmentIndex:(unsigned long long)arg3 ;
...
-(id)initWithDevice:(id)arg1 pixelFormat:(unsigned long long)arg2 paintAndParticlePixelFormat:(unsigned long long)arg3 stencilPixelFormat:(unsigned long long)arg4 generatePipelineDescriptors:(char)arg5 ;
-(id)_signpostLog;
-(void)_setupCachedQuad;
-(void)_preloadShaders;
-(id)initWithDevice:(id)arg1 pixelFormat:(unsigned long long)arg2 ;
-(id)paintShaderWithColorAttachmentIndex:(unsigned)arg1 liveStrokeMode:(char)arg2 ;
-(id)particleShaderWithColorAttachmentIndex:(unsigned)arg1 aspectRatioSupport:(char)arg2 ;
-(id)newParticleShaderKernelPipelineStateWithVariableSpacing:(char)arg1 ;
-(id)newPaintShaderKernelPipelineState;
-(id)newComputePipelineDescriptor;
-(id)_paintShaderKernelPipelineStateWithLiveStrokeMode:(char)arg1 particles:(char)arg2 ;
-(id)newPaperShader;
-(id)eraseShaderWithColorAttachmentIndex:(unsigned)arg1 ;
-(id)blitShaderWithColorAttachmentIndex:(unsigned)arg1 sharedPipelineDescriptor:(char)arg2 ;
-(id)eraseShaderWithColorAttachmentIndex:(unsigned)arg1 sharedPipelineDescriptor:(char)arg2 ;
...
-(id)uberShaderForKey:(SCD_Struct_PK51)arg1 ;
-(id)constantValuesForKey:(long long)arg1 clipping:(char)arg2 colorAttachmentIndex:(unsigned)arg3 renderMask:(char)arg4 edgeMask:(char)arg5 ;
-(id)_uberShaderForKey:(SCD_Struct_PK51)arg1 ;
-(void)_preloadScribbleUberShadersForBaseKey:(SCD_Struct_PK51)arg1 ;
-(void)_preloadUberShadersForBaseKey:(SCD_Struct_PK51)arg1 ;
...
-(id)initWithDevice:(id)arg1 generatePipelineDescriptors:(char)arg2 ;
...
-(char)deviceSupportsCatalystFamily;
@end
