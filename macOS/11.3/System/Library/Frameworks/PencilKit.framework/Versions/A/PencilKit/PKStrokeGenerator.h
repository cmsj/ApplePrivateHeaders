...
-(id)init;
-(void)reset;
-(void)addPoint:(SCD_Struct_PK35)arg1 ;
...
-(PKStrokePoint)outputCurrentStrokePoint:(SCD_Struct_PK35)arg1 ;
...
-(PKStrokePoint)outputPoint:(SCD_Struct_PK35)arg1 baseValues:(PKStrokePoint)arg2 ;
...
-(void)_drawingAddPoint:(SCD_Struct_PK35)arg1 ;
...
-(void)drawingUpdatePoint:(SCD_Struct_PK35)arg1 ;
-(void)closeStroke;
-(id)strokeFromPoints:(const vector<CGPoint, std::__1::allocator<CGPoint>>*)arg1 sourceStroke:(id)arg2 inputScale:(double)arg3 averageInputPoint:(SCD_Struct_PK35)arg4 ;
