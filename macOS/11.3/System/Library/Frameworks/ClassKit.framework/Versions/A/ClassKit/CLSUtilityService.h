...
-(void)recreateDatabase:(char)arg1 andTerminateDaemonWithCompletion:(/*^block*/id)arg2 ;
...
-(void)addAuthorizationStatus:(unsigned long long)arg1 forHandoutAssignedItem:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)removeAuthorizationStatus:(unsigned long long)arg1 forContextAtPath:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)removeAuthorizationStatus:(unsigned long long)arg1 forHandoutAssignedItem:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)authorizationStatusForContextAtPath:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)authorizationStatusForHandoutAssignedItem:(id)arg1 completion:(/*^block*/id)arg2 ;
@end
