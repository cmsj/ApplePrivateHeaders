...
@class NSObject, NSString, NSArray, TSPObject, NSMapTable, TSPComponentExternalReferenceMap, NSIndexSet, TSPComponentDataReferenceMap, TSPComponentObjectUUIDMap, NSDate, TSPObjectReferenceMap;
...
@property (nonatomic,readonly) char canBeDropped; 
@property (nonatomic,readonly) char isWasteful; 
...
@property (nonatomic,readonly) char incompatibleVersion; 
...
-(void)setPackageIdentifier:(unsigned char)arg1 preferredLocator:(id)arg2 locator:(id)arg3 isStoredOutsideObjectArchive:(char)arg4 compressionAlgorithm:(long long)arg5 rootObjectOrNil:(id)arg6 archivedObjects:(id)arg7 externalReferenceMap:(id)arg8 componentDataReferenceMap:(id)arg9 ambiguousReferences:(id)arg10 documentReadVersion:(unsigned long long)arg11 documentWriteVersion:(unsigned long long)arg12 componentReadVersion:(unsigned long long)arg13 componentRequiredVersion:(unsigned long long)arg14 canBeDropped:(char)arg15 isWasteful:(char)arg16 requiredPackageIdentifier:(unsigned char)arg17 featureInfos:(id)arg18 componentObjectUUIDMap:(id)arg19 objectReferenceMap:(id)arg20 saveToken:(unsigned long long)arg21 encodedLength:(unsigned long long)arg22 lastModificationDate:(id)arg23 wasCopied:(char)arg24 wasModifiedDuringWrite:(char)arg25 ;
...
-(void)setComponentDataReferenceMap:(TSPComponentDataReferenceMap *)arg1 ;
