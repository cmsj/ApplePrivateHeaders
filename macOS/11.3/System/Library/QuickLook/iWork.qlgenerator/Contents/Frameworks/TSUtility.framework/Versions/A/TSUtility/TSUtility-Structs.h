...
typedef struct OpaqueTECSnifferObjectRef* OpaqueTECSnifferObjectRefRef;

typedef struct OpaqueTECObjectRef* OpaqueTECObjectRefRef;
...
typedef struct {
	...
	SCD_Struct_TS75 mNumberFormatStruct;
	SCD_Struct_TS76 mFractionFormatStruct;
	SCD_Struct_TS77 mBaseFormatStruct;
	SCD_Struct_TS78 mDateFormatStruct;
	SCD_Struct_TS79 mDurationFormatStruct;
	SCD_Struct_TS80) mCustomFormatStruct;
} SCD_Struct_TS81;
...
typedef struct {
	...
	/*function pointer*/void* field2;
	= field3;
	SCD_Struct_TS75 field4;
	SCD_Struct_TS76 field5;
	SCD_Struct_TS77 field6;
	SCD_Struct_TS79 field7;
	SCD_Struct_TS82 field8;
	SCD_Struct_TS83) field9;
} SCD_Struct_TS84;
