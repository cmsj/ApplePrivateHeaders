...
@property (nonatomic,readonly) char isShowcastAllowed; 
...
-(void)changeShowThemeUsingTemplate:(id)arg1 themeDocumentRoot:(id)arg2 toSize:(CGSize)arg3 keepChangesToThemeDefaults:(char)arg4 commandGroupActionStringOverride:(id)arg5 ;
...
-(char)validateUIState:(id)arg1 ;
-(unsigned long long)writingDirectionForStorage;
-(char)validateSlideNode:(id)arg1 ;
