...
+(char)verifyHints:(id)arg1 withBodyStorage:(id)arg2 upToPageIndex:(unsigned long long)arg3 ;
-(id)init;
...
-(id)copyForCaching;
-(NSArray *)pageHints;
-(char)hasPageHintOfKind:(long long)arg1 atPageIndex:(unsigned long long)arg2 ;
...
-(char)hasPageHintOfKind:(long long)arg1 beforePageIndex:(unsigned long long)arg2 ;
-(char)hasEndOfTextLayoutBeforePageIndex:(unsigned long long)arg1 ;
-(char)containsDocumentPageIndex:(unsigned long long)arg1 ;
