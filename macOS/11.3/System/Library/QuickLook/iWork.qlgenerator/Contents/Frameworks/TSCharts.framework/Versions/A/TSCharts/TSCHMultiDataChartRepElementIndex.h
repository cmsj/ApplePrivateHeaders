...
@property (nonatomic,readonly) unsigned long long valueIndex;               //@synthesize valueIndex=_valueIndex - In the implementation block
@property (nonatomic,readonly) NSIndexSet * seriesIndexSet; 
@property (nonatomic,readonly) NSIndexSet * valueIndexSet; 
