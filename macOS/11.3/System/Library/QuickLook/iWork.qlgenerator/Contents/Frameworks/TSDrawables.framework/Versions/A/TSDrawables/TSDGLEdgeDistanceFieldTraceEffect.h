...
-(char)p_generateTraceTextureInfoWithStrokeWidth:(double)arg1 clockwise:(char)arg2 randomGenerator:(id)arg3 ;
-(id)initWithTR:(id)arg1 strokeWidth:(double)arg2 downsampleScale:(double)arg3 clockwise:(char)arg4 GLState:(id)arg5 randomGenerator:(id)arg6 ;
-(void)setupShaderWithPercent:(double)arg1 MVPMatrix:(CATransform3D)arg2 opacity:(double)arg3 color:(SCD_Struct_TS21)arg4 strokeFadeHardnessLeading:(double)arg5 strokeFadeHardnessTrailing:(double)arg6 ;
@end
