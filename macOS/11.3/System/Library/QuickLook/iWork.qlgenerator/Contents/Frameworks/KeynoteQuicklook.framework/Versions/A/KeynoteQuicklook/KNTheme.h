...
@interface KNTheme : TSATheme <KNSlideCollection, TSSPresetSource, TSKTransformableObject, TSKDocumentObject, TSDModelContainer> {
	...
	char _defaultMasterSlideNodeIsOurBestGuess;
...
@property (nonatomic,readonly) char defaultMasterSlideNodeIsOurBestGuess;                             //@synthesize defaultMasterSlideNodeIsOurBestGuess=_defaultMasterSlideNodeIsOurBestGuess - In the implementation block
...
-(void)bootstrapThemeOfSize:(CGSize)arg1 alternate:(unsigned long long)arg2 ;
...
-(char)customTimingCurvesContainsName:(id)arg1 ;
