...
@interface TSDMagicMoveMatch : NSObject <TSDMatchingAlgorithmMatch> {
	...
	char _isShapeMatchOnlyWithoutText;
...
@property (assign,nonatomic) char isShapeMatchOnlyWithoutText;                        //@synthesize isShapeMatchOnlyWithoutText=_isShapeMatchOnlyWithoutText - In the implementation block
...
-(char)isShapeMatchOnlyWithoutText;
-(void)setIsShapeMatchOnlyWithoutText:(char)arg1 ;
@end
