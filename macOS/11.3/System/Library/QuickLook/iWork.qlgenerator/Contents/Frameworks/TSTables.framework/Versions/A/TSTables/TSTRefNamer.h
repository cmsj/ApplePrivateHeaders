...
-(id)createNameComponentWithChromeRangeRef:(const RefTypeHolder<TSCERangeRef, 2>*)arg1 rowOrColumnName:(id)arg2 isSticky:(char)arg3 namingContext:(id)arg4 ;
...
-(id)p_symbolicColumnNameForRefPair:(id)arg1 useTopLeft:(char)arg2 isSticky:(char)arg3 foundRange:(TSUModelCellRect*)arg4 inTableModel:(id)arg5 namingContext:(id)arg6 ;
-(id)p_symbolicRowNameForRefPair:(id)arg1 useTopLeft:(char)arg2 isSticky:(char)arg3 foundRange:(TSUModelCellRect*)arg4 inTableModel:(id)arg5 namingContext:(id)arg6 ;
