...
@interface TSTTableFilterSet : TSPObject <TSPCopying> {
	...
	char _isEnabled;
	NSArray* _rules;
	char _needsFormulaRewriteForImport;
...
@property (nonatomic,readonly) char canAddRules; 
...
@property (assign,nonatomic) char needsFormulaRewriteForImport;                //@synthesize needsFormulaRewriteForImport=_needsFormulaRewriteForImport - In the implementation block
...
-(char)rowIsShown:(unsigned)arg1 withHiddenStateExtent:(id)arg2 withCalcEngine:(id)arg3 ;
...
-(int)filterSetType;
-(char)p_thresholdComparisonMatchesFilter:(long long)arg1 withPredicateType:(unsigned char)arg2 ;
-(unsigned long long)numberOfRulesInFilter:(unsigned long long)arg1 ;
-(void)p_addRules:(id)arg1 atRuleIndices:(id)arg2 inFilter:(unsigned long long)arg3 isNew:(char)arg4 ;
