...
@property (nonatomic,readonly) id<TSPFileCoordinatorDelegate> fileCoordinatorDelegate; 
...
+(char)isZeroLengthFileOrEmptyDirectory:(id)arg1 isDirectory:(char*)arg2 ;
...
-(void)enumerateDataUsingBlock:(/*^block*/id)arg1 ;
...
-(id)newReadChannelForComponentLocator:(id)arg1 compressionAlgorithm:(long long)arg2 isStoredOutsideObjectArchive:(char)arg3 error:(id*)arg4 ;
...
-(char)reloadZipArchiveIfNeededWithURLImpl:(id)arg1 isLazyLoading:(char)arg2 forceReload:(char)arg3 error:(id*)arg4 ;
