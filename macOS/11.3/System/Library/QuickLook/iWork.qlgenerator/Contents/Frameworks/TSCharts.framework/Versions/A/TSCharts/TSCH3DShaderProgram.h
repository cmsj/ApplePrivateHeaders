...
@property (nonatomic,retain) NSMutableArray * sortedLinks;                                         //@synthesize sortedLinks=_sortedLinks - In the implementation block
@property (nonatomic,retain) NSMutableDictionary * variableToVertexAttributeLocation;              //@synthesize variableToVertexAttributeLocation=_variableToVertexAttributeLocation - In the implementation block
@property (nonatomic,readonly) NSString * vertex; 
@property (nonatomic,readonly) NSString * fragment; 
@property (nonatomic,readonly) TSCH3DVersion * version;                                            //@synthesize version=_version - In the implementation block
...
-(id)linkedUniformVariablesForType:(TSCH3DShaderType)arg1 isTexture:(char)arg2 ;
...
-(void)addToSection:(id)arg1 variable:(id)arg2 space:(id)arg3 type:(TSCH3DShaderType)arg4 format:(id)arg5 arguments:(_va_list_tag*)arg6 ;
-(void)addDeclaration:(id)arg1 space:(id)arg2 type:(TSCH3DShaderType)arg3 format:(id)arg4 arguments:(_va_list_tag*)arg5 ;
-(void)addToSection:(id)arg1 statement:(id)arg2 type:(TSCH3DShaderType)arg3 ;
-(void)addTemporary:(id)arg1 space:(id)arg2 type:(TSCH3DShaderType)arg3 format:(id)arg4 arguments:(_va_list_tag*)arg5 ;
-(void)addStatement:(id)arg1 space:(id)arg2 type:(TSCH3DShaderType)arg3 format:(id)arg4 arguments:(_va_list_tag*)arg5 ;
-(void)addResolution:(id)arg1 space:(id)arg2 type:(TSCH3DShaderType)arg3 format:(id)arg4 arguments:(_va_list_tag*)arg5 ;
-(void)addOutcome:(id)arg1 space:(id)arg2 type:(TSCH3DShaderType)arg3 format:(id)arg4 arguments:(_va_list_tag*)arg5 ;
-(void)addConclusion:(id)arg1 space:(id)arg2 type:(TSCH3DShaderType)arg3 format:(id)arg4 arguments:(_va_list_tag*)arg5 ;
