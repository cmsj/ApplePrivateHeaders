...
@interface TSCHText : NSObject {
	...
	char _textColorShouldBeBlack;

}

@property (assign,nonatomic) char textColorShouldBeBlack;              //@synthesize textColorShouldBeBlack=_textColorShouldBeBlack - In the implementation block
+(void)clearCachesForDocumentRoot:(id)arg1 ;
+(id)sharedText;
+(id)sharedInteriorWrappingText;
+(TSCHTextLayoutResults)initializeTextLayoutResults;
+(char)shouldLayoutTextForWrapWidth:(double)arg1 textLayoutProperties:(id)arg2 ;
...
-(void)setTextColorShouldBeBlack:(char)arg1 ;
...
-(id)p_wpTextForParagraphStyle:(id)arg1 text:(id)arg2 textBlack:(char)arg3 textCache:(id)arg4 cacheKey:(id)arg5 ;
-(id)p_newWPColumnForText:(id)arg1 wpTextObject:(id)arg2 wrapWidth:(double)arg3 layoutProperties:(id)arg4 ;
-(id)p_wpTextForParagraphStyle:(id)arg1 text:(id)arg2 textBlack:(char)arg3 textCache:(id)arg4 ;
-(id)p_wpColumnForText:(id)arg1 paragraphStyle:(id)arg2 textBlack:(char)arg3 wrapWidth:(double)arg4 textCache:(id)arg5 layoutProperties:(id)arg6 ;
...
-(CGSize)measureText:(id)arg1 paragraphStyle:(id)arg2 wrapWidth:(double)arg3 outErasableFrame:(CGRect*)arg4 checkNumberTemplates:(char)arg5 ;
-(CGSize)measureText:(id)arg1 paragraphStyle:(id)arg2 wrapWidth:(double)arg3 outErasableFrame:(CGRect*)arg4 checkNumberTemplates:(char)arg5 layoutProperties:(id)arg6 outTextLayoutResults:(TSCHTextLayoutResults*)arg7 ;
-(char)p_styleSupportsEqualDigits:(id)arg1 textCache:(id)arg2 ;
