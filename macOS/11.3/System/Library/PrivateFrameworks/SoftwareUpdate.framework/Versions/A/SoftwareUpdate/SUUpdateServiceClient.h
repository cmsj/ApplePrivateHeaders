...
@class NSXPCConnection, NSString, NSMutableArray, NSObject;
...
+(void)authorizeForDaemonManagement:(AuthorizationOpaqueRefRef)arg1 overConnection:(id)arg2 reply:(/*^block*/id)arg3 ;
