...
@interface C2SessionPool : NSObject <C2SessionDelegate> {
	...
	char _cleanUp_running;
	char _testBehavior_disableAutomaticCleanup;
...
@property (assign,nonatomic) char cleanUp_running;                                                       //@synthesize cleanUp_running=_cleanUp_running - In the implementation block
...
@property (assign,nonatomic) char testBehavior_disableAutomaticCleanup;                                  //@synthesize testBehavior_disableAutomaticCleanup=_testBehavior_disableAutomaticCleanup - In the implementation block
...
-(char)_unsafe_isCreating:(id)arg1 ;
...
-(char)cleanUp_running;
-(void)setCleanUp_running:(char)arg1 ;
...
-(char)testBehavior_disableAutomaticCleanup;
-(void)setTestBehavior_disableAutomaticCleanup:(char)arg1 ;
@end
