...
@property (assign,nonatomic) char pushTrigger;                                                               //@synthesize pushTrigger=_pushTrigger - In the implementation block
...
-(char)operationGroupTriggered:(id)arg1 ;
-(char)clientOperationTriggered:(id)arg1 ;
