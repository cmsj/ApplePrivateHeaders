...
-(id)initWithStrokeProvider:(id)arg1 defaultWritingOrientation:(long long)arg2 locales:(id)arg3 isInlineContinuousMode:(char)arg4 inlineContinuousModeTargets:(id)arg5 ;
-(char)isInlineContinuousMode;
-(NSArray *)textInputTargets;
-(void)_updateGroups:(id)arg1 createdGroups:(id)arg2 deletedGroups:(id)arg3 forAddedStroke:(id)arg4 substrokePlacementsByStrokeIdentifier:(id)arg5 reusableIDRemovedGroups:(id)arg6 trySplit:(char)arg7 cancellationBlock:(/*^block*/id)arg8 ;
...
-(id)_textLineStrokeGroupByAddingStroke:(id)arg1 withSubstrokePlacements:(id)arg2 intoStrokeGroup:(id)arg3 mergingEndSubgroup:(char)arg4 bestStrokeMergeEnd:(id)arg5 ;
...
-(void)updateLocalWritingOrientationsForSubstrokes:(id)arg1 useCoalescedCenter:(char)arg2 ;
-(void)sortSubstrokesByWritingDirection:(id)arg1 averageWritingOrientation:(CGVector*)arg2 ;
-(void)refineLocalWritingOrientationsForSubstrokes:(id)arg1 useCoalescedCenter:(char)arg2 ;
-(char)refineWritingOrientationAndResortSubstrokes:(id)arg1 averageWritingOrientation:(CGVector*)arg2 ;
...
-(vector<CGPoint, std::__1::allocator<CGPoint>>*)flippedCenters:(const vector<CGPoint, std::__1::allocator<CGPoint>>*)arg1 ofSubstrokes:(id)arg2 maxStrokesGap:(long long)arg3 begnning:(char)arg4 ;
