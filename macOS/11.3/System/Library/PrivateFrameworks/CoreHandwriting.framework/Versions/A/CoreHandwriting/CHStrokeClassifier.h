...
@property (nonatomic,readonly) char textOnly;                                                                     //@synthesize textOnly=_textOnly - In the implementation block
...
-(id)initWithStrokeProvider:(id)arg1 strokeClassificationLastResult:(id)arg2 textOnly:(char)arg3 ;
...
-(char)textOnly;
-(char)changeableClassificationByRefinement:(long long)arg1 stroke:(id)arg2 ;
