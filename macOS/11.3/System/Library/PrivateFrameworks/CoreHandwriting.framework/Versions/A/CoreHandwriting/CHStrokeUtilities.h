...
+(char)isPointEnumerationSupportedForStroke:(id)arg1 ;
...
+(CGRect)unionStrokeBounds:(const vector<CGRect, std::__1::allocator<CGRect>>*)arg1 usingStrokeCountLimit:(long long)arg2 reverseOrder:(char)arg3 ;
