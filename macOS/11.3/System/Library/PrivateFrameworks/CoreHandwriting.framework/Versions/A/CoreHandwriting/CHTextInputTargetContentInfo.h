...
@interface CHTextInputTargetContentInfo : NSObject <NSMutableCopying> {
	...
	char _isCursorStrong;
	char _containsCommittedStrokes;
	NSRange _activePreviewRange;
	int _contentType;
	int _autoCapitalizationMode;
	int _autoCorrectionMode;
	char _isSingleLine;
	char _supportsAutoLineBreaks;
...
@property (nonatomic,readonly) char isCursorStrong;                                      //@synthesize isCursorStrong=_isCursorStrong - In the implementation block
@property (nonatomic,readonly) char containsCommittedStrokes;                            //@synthesize containsCommittedStrokes=_containsCommittedStrokes - In the implementation block
...
@property (nonatomic,readonly) char isSingleLine;                                        //@synthesize isSingleLine=_isSingleLine - In the implementation block
@property (nonatomic,readonly) char supportsAutoLineBreaks;                              //@synthesize supportsAutoLineBreaks=_supportsAutoLineBreaks - In the implementation block
...
-(id)_initWithTextInputTarget:(id)arg1 contentLength:(long long)arg2 referenceSubstring:(id)arg3 referenceSubstringRange:(NSRange)arg4 charRectsInReferenceSubstring:(CGRect*)arg5 strokeCoveredTextRange:(NSRange)arg6 selectedTextRange:(NSRange)arg7 isCursorStrong:(char)arg8 activePreviewRange:(NSRange)arg9 contentType:(int)arg10 autoCapitalizationMode:(int)arg11 autoCorrectionMode:(int)arg12 isSingleLine:(char)arg13 lastCharacterLevelPosition:(long long)arg14 protectedCharacterIndexes:(id)arg15 ;
-(id)initWithTextInputTarget:(id)arg1 contentLength:(long long)arg2 referenceSubstring:(id)arg3 referenceSubstringRange:(NSRange)arg4 charRectsInReferenceSubstring:(CGRect*)arg5 strokeCoveredTextRange:(NSRange)arg6 selectedTextRange:(NSRange)arg7 isCursorStrong:(char)arg8 activePreviewRange:(NSRange)arg9 contentType:(int)arg10 isSingleLine:(char)arg11 lastCharacterLevelPosition:(long long)arg12 ;
-(long long)lastCharacterLevelPosition;
-(char)isCursorStrong;
-(char)containsCommittedStrokes;
-(char)isSingleLine;
-(char)supportsAutoLineBreaks;
-(void)enumerateCharacterRectsInRange:(NSRange)arg1 reverse:(char)arg2 block:(/*^block*/id)arg3 ;
-(void)enumerateCharacterRectsInRange:(NSRange)arg1 block:(/*^block*/id)arg2 ;
-(id)initWithTextInputTarget:(id)arg1 contentLength:(long long)arg2 referenceSubstring:(id)arg3 referenceSubstringRange:(NSRange)arg4 charRectsInReferenceSubstring:(CGRect*)arg5 strokeCoveredTextRange:(NSRange)arg6 selectedTextRange:(NSRange)arg7 isCursorStrong:(char)arg8 activePreviewRange:(NSRange)arg9 contentType:(int)arg10 autoCapitalizationMode:(int)arg11 autoCorrectionMode:(int)arg12 isSingleLine:(char)arg13 lastCharacterLevelPosition:(long long)arg14 ;
