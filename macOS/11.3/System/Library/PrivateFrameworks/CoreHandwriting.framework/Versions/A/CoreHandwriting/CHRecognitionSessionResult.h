...
@interface CHRecognitionSessionResult : NSObject <NSCopying, NSSecureCoding> {
	...
	char __shouldUseCachedHasCompleteRecognitionResults;
	char __hasCompleteRecognitionResults;
...
-(char)isEqualToSerializableRecognitionSessionResult:(id)arg1 ;
-(CHStrokeClutterFilter *)clutterFilter;
-(char)isEqualToRecognitionSessionResult:(id)arg1 ;
...
-(char)hasCompleteRecognitionResults;
@end
