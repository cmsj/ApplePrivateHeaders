...
-(char)classifyStrokesInDrawing:(id)arg1 minimumDrawingSize:(CGSize)arg2 outDelayedStrokeProbabilities:(vector<double, std::__1::allocator<double>>*)arg3 outSpaceProbabilities:(vector<double, std::__1::allocator<double>>*)arg4 outCharBoundaryProbabilities:(vector<double, std::__1::allocator<double>>*)arg5 ;
