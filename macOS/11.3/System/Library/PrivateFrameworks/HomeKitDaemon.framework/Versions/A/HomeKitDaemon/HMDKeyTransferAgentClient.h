...
@interface HMDKeyTransferAgentClient : HMDKeyTransferAgent <HMFNetServiceDelegate, HMFTimerDelegate, HMFNetMonitorDelegate, HMFNetServiceBrowserDelegate> {
	...
	char _resolutionInProgress;
	char _haveCulledPlist;
...
@property (assign,nonatomic) char resolutionInProgress;                                  //@synthesize resolutionInProgress=_resolutionInProgress - In the implementation block
...
@property (assign,nonatomic) char haveCulledPlist;                                       //@synthesize haveCulledPlist=_haveCulledPlist - In the implementation block
...
-(char)haveCulledPlist;
-(void)setHaveCulledPlist:(char)arg1 ;
...
-(void)setResolutionInProgress:(char)arg1 ;
-(void)_beginBonjourResolution:(char)arg1 ;
-(char)resolutionInProgress;
-(void)_reallyBeginBonjourResolution;
-(NSMutableDictionary *)bonjourKeys;
-(NSMutableSet *)targetsToProcess;
-(char)_newDeviceSeen:(id)arg1 ;
-(long long)tfaState;
...
-(void)_endPairingWithError:(id)arg1 suspendingTimer:(char)arg2 ;
