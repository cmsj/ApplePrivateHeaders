...
@property (getter=isCurrentDeviceConfirmedPrimaryResident,readonly) char currentDeviceConfirmedPrimaryResident; 
...
@property (getter=isRecordingEnabled,readonly) char recordingEnabled; 
...
-(void)_setManuallyDisabledCharacteristicNotificationsEnabled:(char)arg1 ;
...
-(char)_shouldQueryCanEnableRecordingForAccessMode:(unsigned long long)arg1 currentSettings:(id)arg2 ;
-(char)_shouldQueryCanDisableRecordingForAccessMode:(unsigned long long)arg1 isAtHome:(char)arg2 currentSettings:(id)arg3 ;
...
-(void)_updateCurrentAccessModeForSettings:(id)arg1 userInitiated:(char)arg2 reason:(id)arg3 ;
-(HMDCameraProfileSettingsDerivedPropertiesModel *)derivedPropertiesModel;
-(void)_populateCurrentAccessModeFieldForDerivedProperties:(id)arg1 currentSettings:(id)arg2 userInitiated:(char)arg3 didUpdateField:(char*)arg4 ;
...
-(void)_addNightVisionCharacteristicWriteRequestToArray:(id)arg1 nightVisionEnabled:(char)arg2 ;
-(void)_addSnapshotsActiveCharacteristicWriteRequestToArray:(id)arg1 snapshotsAllowed:(char)arg2 ;
-(void)_addOperatingModeIndicatorCharacteristicWriteRequestToArray:(id)arg1 accessModeIndicatorEnabled:(char)arg2 ;
-(void)_addPeriodicSnapshotsActiveCharacteristicWriteRequestToArray:(id)arg1 periodicSnapshotsAllowed:(char)arg2 ;
-(void)_addRecordingAudioEnabledWriteRequestToArray:(id)arg1 recordingAudioEnabled:(char)arg2 ;
...
-(void)_notifyClientsOfChangedSettings:(id)arg1 isInitialSettingsUpdate:(char)arg2 ;
...
-(void)_notifyClientsOfChangedSettingsModel:(id)arg1 isInitialSettingsUpdate:(char)arg2 ;
...
-(void)configureWithMessageDispatcher:(id)arg1 adminMessageDispatcher:(id)arg2 deviceIsResidentCapable:(char)arg3 ;
