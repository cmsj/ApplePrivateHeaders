...
@property (assign,nonatomic) char hasIsExpectedGSN; 
@property (assign,nonatomic) char isExpectedGSN;                                       //@synthesize isExpectedGSN=_isExpectedGSN - In the implementation block
...
-(void)setIsExpectedGSN:(char)arg1 ;
-(void)setHasIsExpectedGSN:(char)arg1 ;
-(char)hasIsExpectedGSN;
-(char)isExpectedGSN;
@end
