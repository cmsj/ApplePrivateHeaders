...
-(void)handleAddedGroupModel:(id)arg1 shouldNotify:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_handleAddedGroupModel:(id)arg1 shouldNotify:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_handleAddedRootGroup:(id)arg1 ;
-(void)handleAddedSettingModel:(id)arg1 shouldNotify:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_handleAddedSettingModel:(id)arg1 shouldNotify:(char)arg2 completion:(/*^block*/id)arg3 ;
-(id)_flattenedSettingControllerRoot:(id)arg1 withCurrentPath:(id)arg2 andReturnDictionary:(id)arg3 ;
-(void)handleAddedConstraintModel:(id)arg1 shouldNotify:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_handleAddedConstraintModel:(id)arg1 shouldNotify:(char)arg2 completion:(/*^block*/id)arg3 ;
