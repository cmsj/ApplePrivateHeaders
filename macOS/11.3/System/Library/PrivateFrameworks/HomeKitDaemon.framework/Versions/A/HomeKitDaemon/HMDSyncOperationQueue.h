...
@property (assign,nonatomic) char hasExponentialBackoff;                             //@synthesize hasExponentialBackoff=_hasExponentialBackoff - In the implementation block
...
-(id)initName:(id)arg1 syncManager:(id)arg2 initialDelay:(double)arg3 initialBackoff:(double)arg4 hasBackoff:(char)arg5 ;
