...
-(char)isAttributeValue:(id)arg1 equalTo:(id)arg2 ;
-(id)serviceFromObject:(id)arg1 ;
-(char)populateResult:(id)arg1 withService:(id)arg2 serviceType:(id)arg3 characteristic:(id)arg4 resultAttribute:(id)arg5 action:(id)arg6 ;
...
-(char)populateResult:(id)arg1 withObject:(id)arg2 serviceType:(id)arg3 action:(id)arg4 ;
...
-(char)populateResultWithEntity:(id)arg1 action:(id)arg2 entity:(id)arg3 ;
...
-(id)updateValueToBoundary:(id)arg1 valueType:(id)arg2 fudgeMinimum:(char)arg3 metadata:(id)arg4 ;
...
-(char)populateResult:(id)arg1 fromResponse:(id)arg2 responses:(id)arg3 forAction:(id)arg4 serviceType:(id)arg5 forObjects:(id)arg6 ;
...
-(id)objectsWithSearchFilter:(id)arg1 inHome:(id)arg2 serviceTypeIsATV:(char)arg3 overrideServiceTypeIfNeeded:(id*)arg4 ;
...
-(char)populateColorResult:(id)arg1 serviceType:(id)arg2 service:(id)arg3 action:(id)arg4 responses:(id)arg5 forObjects:(id)arg6 ;
-(char)populateMediaProfileWriteResult:(id)arg1 withValue:(id)arg2 serviceType:(id)arg3 action:(id)arg4 ;
