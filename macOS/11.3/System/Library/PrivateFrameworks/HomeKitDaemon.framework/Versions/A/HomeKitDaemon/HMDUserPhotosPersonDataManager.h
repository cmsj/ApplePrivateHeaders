...
@interface HMDUserPhotosPersonDataManager : HMFObject <HMFLogging, HMFMessageReceiver> {
	...
	char _supportsFaceClassification;
...
@property (readonly) char supportsFaceClassification;                                         //@synthesize supportsFaceClassification=_supportsFaceClassification - In the implementation block
...
-(id)initWithUser:(id)arg1 messageDispatcher:(id)arg2 localZone:(id)arg3 workQueue:(id)arg4 supportsFaceClassification:(char)arg5 cloudPhotosSettingObserver:(id)arg6 ;
-(id)settingsModel;
-(NSUUID *)zoneUUID;
