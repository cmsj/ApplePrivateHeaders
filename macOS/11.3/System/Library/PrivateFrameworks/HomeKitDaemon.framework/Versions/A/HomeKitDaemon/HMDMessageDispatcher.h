...
+(id)destinationWithTarget:(id)arg1 userID:(id)arg2 destination:(id)arg3 multicast:(char)arg4 ;
-(void)dealloc;
-(void)reset;
...
-(void)_setRemoteAccessDevice:(id)arg1 forHome:(id)arg2 sendNotification:(char)arg3 ;
