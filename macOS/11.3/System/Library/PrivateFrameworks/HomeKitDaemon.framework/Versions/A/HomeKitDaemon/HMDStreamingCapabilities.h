...
@property (assign,nonatomic) char supportsComfortNoise;                          //@synthesize supportsComfortNoise=_supportsComfortNoise - In the implementation block
...
-(void)setSupportsComfortNoise:(char)arg1 ;
