...
-(char)_fetchPrivateZonesWithConfiguration:(id)arg1 ;
-(char)_fetchExistingPrivateZonesWithConfiguration:(id)arg1 ;
-(char)_fetchSharedZonesWithConfiguration:(id)arg1 ;
-(void)_tearDownState;
-(id<HMBLocalZoneDelegate><HMBCloudZoneDelegate>)zoneDelegate;
-(char)_handleFetchZonesResult:(id)arg1 configuration:(id)arg2 ;
