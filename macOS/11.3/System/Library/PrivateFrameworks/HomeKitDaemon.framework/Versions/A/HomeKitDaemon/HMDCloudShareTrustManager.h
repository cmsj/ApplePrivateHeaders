...
@property (getter=isOwnedTrust,readonly) char ownedTrust;                                                 //@synthesize ownedTrust=_ownedTrust - In the implementation block
...
-(char)canUseUntrustedAccountHandlesForParticipantManager:(id)arg1 ;
...
-(id)initWithDatabase:(id)arg1 isOwnedTrust:(char)arg2 messageTargetUUID:(id)arg3 queue:(id)arg4 shareMessenger:(id)arg5 ownerCloudShareID:(id)arg6 ;
...
-(id)initWithDatabase:(id)arg1 isOwnedTrust:(char)arg2 messageTargetUUID:(id)arg3 queue:(id)arg4 ownerCloudShareID:(id)arg5 ;
-(void)removeTrust;
