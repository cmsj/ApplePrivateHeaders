...
-(char)hasQueuedIncomingMessages;
-(void)routeQueuedIncomingMessages;
-(char)hasQueuedOutgoingMessages;
-(void)sendQueuedOutgoingMessages;
-(char)hasQueuedOutgoingMessagesForDevice:(id)arg1 ;
...
-(void)registerForSPIRemoteMessages:(id)arg1 home:(id)arg2 userPrivilege:(unsigned long long)arg3 internalBuildOnly:(char)arg4 ;
-(SEL)selectorForName:(id)arg1 ;
-(NSDictionary *)notificationsToObject;
-(id)queuedIncomingMessages;
-(void)routeMessage:(id)arg1 shouldQueue:(char)arg2 ;
-(void)queueIncomingMessage:(id)arg1 ;
-(char)isReadyForIncomingMessage:(id)arg1 error:(id*)arg2 ;
-(id)dequeueIncomingMessage:(id)arg1 ;
-(char)shouldRelayIncomingMessage:(id)arg1 error:(id*)arg2 ;
-(void)relayMessage:(id)arg1 shouldQueue:(char)arg2 ;
...
-(char)reachableForMessage:(id)arg1 ;
