...
+(id)logCategory;
+(void)cleanDatastoreFilesAt:(id)arg1 everything:(char)arg2 ;
-(void)dealloc;
-(id)_begin;
...
-(id)_instanceResources:(char)arg1 migrate:(char)arg2 ;
-(id)initWithDB:(id)arg1 migrate:(char)arg2 error:(id*)arg3 ;
-(void)_freeResources;
