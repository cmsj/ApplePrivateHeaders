...
-(char)_parseDatabaseFromDictionary:(id)arg1 dataVersion:(long long*)arg2 collectionsByManufacturer:(id*)arg3 entriesByProductData:(id*)arg4 ;
-(void)setCollectionsByManufacturer:(NSDictionary *)arg1 ;
-(void)setEntriesByProductData:(NSDictionary *)arg1 ;
-(char)_loadDatabaseFromDictionary:(id)arg1 ;
-(char)_loadDatabaseFromFileURL:(id)arg1 fileDescription:(id)arg2 ;
-(char)_loadDatabaseFromFilePath:(id)arg1 fileDescription:(id)arg2 ;
...
-(char)_parseManufacturersList:(id)arg1 collectionsByManufacturer:(id*)arg2 entriesByProductData:(id*)arg3 ;
