...
@interface HMDDataStreamController : NSObject <HMDDataStreamHAPSetupOperationDelegate, HMFLogging, HMFTimerDelegate, HMDDataStreamDelegate, HMDDataStreamSocketController> {
	...
	char _supportsDataStreamOverTCP;
	char _supportsDataStreamOverHAP;
...
@property (assign,nonatomic) char supportsDataStreamOverTCP;                             //@synthesize supportsDataStreamOverTCP=_supportsDataStreamOverTCP - In the implementation block
@property (assign,nonatomic) char supportsDataStreamOverHAP;                             //@synthesize supportsDataStreamOverHAP=_supportsDataStreamOverHAP - In the implementation block
...
-(void)dataStreamInitializationSetupOperation:(id)arg1 didCompleteSupportReadWithStatus:(char)arg2 ;
...
-(void)setSupportsDataStreamOverTCP:(char)arg1 ;
-(void)setSupportsDataStreamOverHAP:(char)arg1 ;
-(void)_handleAccessoryConnected;
-(void)_resetTransportInfo;
-(char)supportsDataStreamOverHAP;
...
-(char)supportsDataStreamOverTCP;
