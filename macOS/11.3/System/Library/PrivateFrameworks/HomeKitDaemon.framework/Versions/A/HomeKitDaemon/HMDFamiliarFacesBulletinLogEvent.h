...
@property (readonly) char doorbellPressed;                                        //@synthesize doorbellPressed=_doorbellPressed - In the implementation block
...
-(id)eventName;
-(id)serializedEvent;
-(id)initWithNumberOfKnownPersons:(long long)arg1 numberOfUnknownPersons:(long long)arg2 bulletinReason:(id)arg3 doorbellPressed:(char)arg4 secondsFromDoorbellToFaceClassification:(double)arg5 ;
-(long long)numberOfKnownPersons;
-(long long)numberOfUnknownPersons;
-(NSString *)bulletinReason;
-(char)doorbellPressed;
