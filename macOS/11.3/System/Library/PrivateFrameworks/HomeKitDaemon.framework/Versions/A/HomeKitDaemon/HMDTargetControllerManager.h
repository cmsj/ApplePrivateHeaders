...
@property (assign,nonatomic) char configurationRefreshed;                           //@synthesize configurationRefreshed=_configurationRefreshed - In the implementation block
...
-(void)setConfigurationRefreshed:(char)arg1 ;
...
-(void)_postSelectionChangeNotification:(char)arg1 object:(id)arg2 userInfo:(id)arg3 ;
