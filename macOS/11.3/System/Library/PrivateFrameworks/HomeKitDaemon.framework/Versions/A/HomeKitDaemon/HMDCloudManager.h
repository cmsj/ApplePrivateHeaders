...
@interface HMDCloudManager : HMFObject <HMFLogging, APSConnectionDelegate> {
	...
	char _firstV3FetchRun;
	char _firstDBQueryRun;
...
@property (assign,getter=isFirstV3FetchRun,nonatomic) char firstV3FetchRun;                             //@synthesize firstV3FetchRun=_firstV3FetchRun - In the implementation block
@property (assign,getter=isFirstDBQueryRun,nonatomic) char firstDBQueryRun;                             //@synthesize firstDBQueryRun=_firstDBQueryRun - In the implementation block
...
-(void)_resetCloudZonesIgnoreHomeManager:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)_fetchLegacyTransaction:(id)arg1 forceFetch:(char)arg2 accountCompletionHandler:(/*^block*/id)arg3 dataCompletionHandler:(/*^block*/id)arg4 ;
-(id)cloudMetadataDeletedNotificationHandler;
-(void)_forceCleanCloud:(char)arg1 fetchTransaction:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)_resetHomeDataRecordState;
-(void)_startControllerKeyPollTimer;
-(char)cloudHomeDataRecordExists;
-(char)_processFetchedTransaction:(id)arg1 ;
-(void)_processFetchCompletedWithError:(id)arg1 serverToken:(id)arg2 fetchTransaction:(id)arg3 migrationOptions:(long long)arg4 completionHandler:(/*^block*/id)arg5 moreRecordsComing:(char)arg6 emptyRecord:(char)arg7 ;
-(void)setFirstV3FetchRun:(char)arg1 ;
-(void)setFirstDBQueryRun:(char)arg1 ;
-(char)isFirstV3FetchRun;
...
-(char)_validFetchRetryCKErrorCode:(long long)arg1 ;
...
-(void)verifyAndRemoveZone:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)fetchLegacyTransaction:(id)arg1 forceFetch:(char)arg2 accountCompletionHandler:(/*^block*/id)arg3 dataCompletionHandler:(/*^block*/id)arg4 ;
-(void)updateAccountStatusChanged:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
-(id)_changeTokenFromData:(id)arg1 ;
-(void)updateCloudDataSyncFilterState:(char)arg1 ;
