...
@interface HMDAccessoryBrowser : HMFObject <HAPAccessoryServerBrowserDelegate, HAPAccessoryServerDelegate, HMFMessageReceiver, HMFTimerDelegate, HMDMediaBrowserDelegate, HMDWACBrowserDelegate, HMDWACAccessoryConfigurationDelegate, HMDWatchSystemStateDelegate, HMDAuthServerDelegate, HMFLogging, HMDAccessoryBrowserProtocol, HMDAccessoryBrowserHapProtocol> {
	...
	char _btlePowerState;
	char _internalDiscoveryRequest;
	char _active;
...
@property (assign) char internalDiscoveryRequest;                                                                                                      //@synthesize internalDiscoveryRequest=_internalDiscoveryRequest - In the implementation block
...
@property (nonatomic,retain) HMDAccessoryServerBrowserDemo * demoAccessoryServerBrowser;                                                               //@synthesize demoAccessoryServerBrowser=_demoAccessoryServerBrowser - In the implementation block
@property (nonatomic,readonly) HMFTimer * stopReprovisioningTimer;                                                                                     //@synthesize stopReprovisioningTimer=_stopReprovisioningTimer - In the implementation block
@property (nonatomic,readonly) HMFTimer * stopBrowsingAccessoriesNeedingReprovisioningTimer;                                                           //@synthesize stopBrowsingAccessoriesNeedingReprovisioningTimer=_stopBrowsingAccessoriesNeedingReprovisioningTimer - In the implementation block
...
@property (assign,nonatomic) char btlePowerState;                                                                                                      //@synthesize btlePowerState=_btlePowerState - In the implementation block
...
-(void)configureDemoBrowserWithDemoAccessories:(id)arg1 finalized:(char)arg2 ;
...
-(void)setDemoAccessoryServerBrowser:(HMDAccessoryServerBrowserDemo *)arg1 ;
-(NSMutableArray *)accessoryServerBrowsers;
-(void)addUnassociatedMediaAccessory:(id)arg1 forDeviceSetup:(char)arg2 ;
...
-(void)_stopDiscoveringAccessoriesWithForce:(char)arg1 error:(id)arg2 ;
...
-(void)_associate:(char)arg1 hapAccessoryWithAdvertisement:(id)arg2 ;
-(void)_notifyDelegateOfReachabilityChange:(char)arg1 forAccessoryWithIdentifier:(id)arg2 ;
...
-(void)_continueAfterPPIDValidation:(char)arg1 server:(id)arg2 ;
...
-(void)_notifyDelegateOfReachabilityChangeChange:(char)arg1 forBTLEAccessories:(id)arg2 ;
...
-(void)setBtlePowerState:(char)arg1 ;
...
-(void)_notifyDelegateOfAccessoryServer:(id)arg1 didUpdateValuesForCharacteristics:(id)arg2 stateNumber:(id)arg3 broadcast:(char)arg4 ;
-(void)_checkIfPairingWithPairedAccessoryServer:(id)arg1 errorCode:(long long)arg2 ;
-(void)_notifyDelegateOfNewPairedAccessoryServer:(id)arg1 stateChanged:(char)arg2 stateNumber:(id)arg3 ;
...
-(void)_notifyDelegateOfAccessoryServer:(id)arg1 didUpdateHasPairings:(char)arg2 ;
...
-(char)internalDiscoveryRequest;
-(void)setInternalDiscoveryRequest:(char)arg1 ;
...
-(char)__isCurrentDevicePrimaryResident;
