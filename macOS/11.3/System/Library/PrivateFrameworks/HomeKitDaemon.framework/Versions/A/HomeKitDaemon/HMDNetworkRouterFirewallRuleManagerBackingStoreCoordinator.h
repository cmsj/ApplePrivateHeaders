...
-(void)fetchCloudChangesWithQualityOfService:(long long)arg1 ignoreLastFetchedAccessories:(char)arg2 forceChangeNotifications:(char)arg3 completion:(/*^block*/id)arg4;
-(void)fetchRulesForAccessories:(id)arg1 qualityOfService:(long long)arg2 ignoreOverrides:(char)arg3 completion:(/*^block*/id)arg4;
-(id)fetchPairedMetadataVersionConfigurationsForAccessories:(id)arg1 qualityOfService:(long long)arg2 ignoreOverrides:(char)arg3 error:(id*)arg4;
-(void)dumpCloudRecordsForProductGroup:(id)arg1 productNumber:(id)arg2 rawOutput:(char)arg3 listOnly:(char)arg4 verifySignatures:(char)arg5 completion:(/*^block*/id)arg6;
-(id)dumpLocalRulesForProductGroup:(id)arg1 productNumber:(id)arg2 firmwareVersion:(id)arg3 ignoreOverrides:(char)arg4 rawOutput:(char)arg5 error:(id*)arg6;
-(char)removeAllLocalRulesWithError:(id*)arg1;
-(id)dumpPairedMetadataForProductGroup:(id)arg1 productNumber:(id)arg2 firmwareVersion:(id)arg3 ignoreOverrides:(char)arg4 rawOutput:(char)arg5 error:(id*)arg6;
-(char)addOverrides:(id)arg1 replace:(char)arg2 error:(id*)arg3;
-(char)removeOverridesForProductGroup:(id)arg1 productNumber:(id)arg2 error:(id*)arg3;
-(char)removeAllOverridesWithError:(id*)arg1;
...
+(id)__jsonStringFromDictionary:(id)arg1 rawOutput:(char)arg2 error:(id*)arg3 ;
...
+(id)__jsonFromRecords:(id)arg1 rawOutput:(char)arg2 error:(id*)arg3 ;
+(id)__networkDeclarationDataDictionaryFromRecordDictionary:(id)arg1 ;
+(id)__jsonFromDeclarations:(id)arg1 rawOutput:(char)arg2 error:(id*)arg3 ;
+(id)__pairedMetadataDataDictionaryFromRecordDictionary:(id)arg1 ;
+(id)__jsonFromPairedMetadata:(id)arg1 rawOutput:(char)arg2 error:(id*)arg3 ;
-(char)isRunning;
...
-(void)_fetchCloudChangesWithQualityOfService:(long long)arg1 ignoreLastFetchedAccessories:(char)arg2 forceChangeNotifications:(char)arg3 requiredRecordIDs:(id)arg4 schedulerXpcActivity:(id)arg5 completion:(/*^block*/id)arg6 ;
-(id)_fetchPairedMetadataForAccessories:(id)arg1 options:(id)arg2 ignoreOverrides:(char)arg3 error:(id*)arg4 ;
-(id)pairedMetadataVersionConfigurationForAccessory:(id)arg1 pairedMetadata:(id)arg2 ;
-(id)_fetchNetworkDeclarationsForRecordIDs:(id)arg1 options:(id)arg2 ignoreOverrides:(char)arg3 error:(id*)arg4 ;
-(id)ruleConfigurationForAccessory:(id)arg1 declarations:(id)arg2 ;
-(void)_fetchCloudChangesIfNeededForRecordIDs:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_listCloudRecordsForProductGroup:(id)arg1 rawOutput:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_dumpCloudRecordsForProductGroup:(id)arg1 productNumber:(id)arg2 rawOutput:(char)arg3 verifySignatures:(char)arg4 completion:(/*^block*/id)arg5 ;
