...
@property (nonatomic,readonly) char changedByThisDevice;                  //@synthesize changedByThisDevice=_changedByThisDevice - In the implementation block
+(id)tupleWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(char)arg5 ;
-(id)targetValue;
-(id)initWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(char)arg5 ;
