...
@property (getter=isDemoModeEnabled,readonly) char demoModeEnabled;              //@synthesize demoModeEnabled=_demoModeEnabled - In the implementation block
...
-(void)configure;
-(id)initWithHome:(id)arg1 demoModeEnabled:(char)arg2 ;
-(void)handleResidentDeviceUpdated:(id)arg1 ;
-(id)initWithHome:(id)arg1 workQueue:(id)arg2 demoModeEnabled:(char)arg3 logIdentifier:(id)arg4 notificationCenter:(id)arg5 dataSource:(id)arg6 ;
-(void)initalizeCurve;
...
-(char)areEncodedBrightnessLevelTransitionPointsValid:(id)arg1 ;
