...
@interface HMDUserDataController : NSObject <HMDAssistantAccessControlModelUpdateReceiver, HMDMediaContentProfileAccessControlModelUpdateReceiver, HMFLogging, HMFTimerDelegate> {
	...
	char _assistantAccessControlRequiresAuthenticationForSecureRequests;
...
@property (assign) char assistantAccessControlRequiresAuthenticationForSecureRequests;                //@synthesize assistantAccessControlRequiresAuthenticationForSecureRequests=_assistantAccessControlRequiresAuthenticationForSecureRequests - In the implementation block
...
-(void)setAssistantAccessControlRequiresAuthenticationForSecureRequests:(char)arg1 ;
...
-(char)assistantAccessControlRequiresAuthenticationForSecureRequests;
...
-(void)handleAssistantAccessControlAccessoryUUIDsUpdated:(id)arg1 requireAuthenticationForSecureRequests:(char)arg2 completion:(/*^block*/id)arg3 ;
