...
@property (assign,nonatomic) char broadcastFailure;                                        //@synthesize broadcastFailure=_broadcastFailure - In the implementation block
...
-(void)setBroadcastFailure:(char)arg1 ;
-(NSObject*<OS_dispatch_group>)broadcastGroup;
-(char)broadcastFailure;
-(char)_endAdvertiseUUIDWithError:(id*)arg1 ;
-(char)_startAdvertiseUUIDWithError:(id*)arg1 ;
