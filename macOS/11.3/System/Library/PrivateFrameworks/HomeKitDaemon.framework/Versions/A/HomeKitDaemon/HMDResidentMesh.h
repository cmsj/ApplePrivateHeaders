...
-(void)_sendMessage:(id)arg1 payload:(id)arg2 target:(id)arg3 force:(char)arg4 responseHandler:(/*^block*/id)arg5 ;
...
-(void)_addConnectivityFromDeviceToAccessory:(id)arg1 activateTimer:(char)arg2 ;
-(void)_removeConnectivityFromDeviceToAccessory:(id)arg1 activateTimer:(char)arg2 ;
-(void)_deviceIsReachable:(id)arg1 ;
-(void)_deviceIsNotReachable:(id)arg1 ;
-(char)_checkReachabilityWithTimerActivation:(char)arg1 ;
...
-(id)_dumpState;
-(id)initWithHomeManager:(id)arg1 residentEnabled:(char)arg2 ;
-(id)residentsForCameraAccessory:(id)arg1 excludeResident:(/*^block*/id)arg2 sortedBy:(/*^block*/id)arg3 ;
-(void)_flushWorkQueue;
-(void)setMetricForCurrentDevice:(id)arg1 withValue:(id)arg2 isUrgent:(char)arg3 ;
-(void)_dumpDebug;
