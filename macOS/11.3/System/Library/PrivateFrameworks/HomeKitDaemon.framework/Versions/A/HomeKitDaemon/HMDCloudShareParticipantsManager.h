...
-(char)isAcceptedUser:(id)arg1 error:(id*)arg2 ;
-(void)handleHomeUserRemovedNotification:(id)arg1 ;
-(void)handleHomeUserAddedNotification:(id)arg1 ;
-(id)fetchInvitationToUser:(id)arg1 shouldGrantWriteAccess:(char)arg2 ;
-(id)fetchInvitationContextForUser:(id)arg1 shouldGrantWriteAccess:(char)arg2 ;
-(id)_untrustedInvitationContextForUser:(id)arg1 shouldGrantWriteAccess:(char)arg2 ;
