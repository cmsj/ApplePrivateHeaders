...
@property (nonatomic,readonly) char computedActive; 
@property (assign,nonatomic) char migratedEventsToRecords;                                                  //@synthesize migratedEventsToRecords=_migratedEventsToRecords - In the implementation block
...
+(id)logCategory;
+(char)__validateRecurrences:(id)arg1 ;
...
-(char)addEventsFromMessage:(id)arg1 ;
-(id)generateAnalyticsDataDueToTriggerAddition:(char)arg1 ;
-(char)checkSharedEventTriggerActivationResidentRequirement:(id)arg1 ;
-(char)isEventTriggerOnRemoteGatewayForAccessory:(id)arg1 ;
-(char)isEventTriggerOnLocalDeviceForAccessory:(id)arg1 ;
...
-(char)migratedEventsToRecords;
-(void)setMigratedEventsToRecords:(char)arg1 ;
...
-(void)_handleRemoveEventsFromEventTrigger:(id)arg1 relay:(char)arg2 ;
-(void)_addEventToEventTrigger:(id)arg1 ;
-(id)createEventModel:(id)arg1 endEvent:(char)arg2 message:(id)arg3 checkForSupport:(char)arg4 error:(id*)arg5 ;
-(char)_checkAddEventModel:(id)arg1 message:(id)arg2 ;
...
-(void)_userDidConfirmExecute:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
