...
#import <libobjc.A.dylib/HMDPrimaryResidentMessageRouterFactory.h>
#import <libobjc.A.dylib/HMDPrimaryResidentMessageRouterMetricsDispatcherFactory.h>
#import <libobjc.A.dylib/HMDPrimaryResidentMessageRouterDataSource.h>
...
@interface HMDHome : HMFObject <HMDBulletinIdentifiers, HMDPrimaryResidentMessageRouterFactory, HMDPrimaryResidentMessageRouterMetricsDispatcherFactory, HMDPrimaryResidentMessageRouterDataSource, HMDResidentDeviceManagerDelegate, HMDHomeMediaSystemHandlerDelegate, HMFLogging, HMDAccessoryBrowserDelegate, HMDHomeMessageReceiver, HMDRelayManagerDelegate, HMFTimerDelegate, HMFDumpState, HMDUserManagementOperationDelegate, HMDMediaActionRouterDataSource, NSSecureCoding, HMDBackingStoreObjectProtocol> {
	...
	char _anyBTLEAccessoryReachable;
	char _activeNetworkRouterInitialSetupNeeded;
	char _watchSkipVersionCheck;
	char _ownerTrustZoneCapable;
	char _migrationNeeded;
	...
	char _migratingAfterResidentChange;
	char _currentRemoteReachabilityRegistration;
...
@property (copy,readonly) NSUUID * assistantUniqueIdentifier; 
...
@property (getter=isResidentSupported,nonatomic,readonly) char residentSupported; 
...
@property (assign,getter=isMultiUserEnabled,nonatomic) char multiUserEnabled;                                            //@synthesize multiUserEnabled=_multiUserEnabled - In the implementation block
...
@property (assign,getter=isOwnerTrustZoneCapable,nonatomic) char ownerTrustZoneCapable;                                  //@synthesize ownerTrustZoneCapable=_ownerTrustZoneCapable - In the implementation block
...
@property (assign) char isNetworkAvailable;                                                                              //@synthesize isNetworkAvailable=_isNetworkAvailable - In the implementation block
@property (readonly) HMDHomeMetricsDispatcher * metricsDispatcher;                                                       //@synthesize metricsDispatcher=_metricsDispatcher - In the implementation block
@property (retain) HMDPrimaryResidentMessageRouter * primaryResidentMessageRouter;                                       //@synthesize primaryResidentMessageRouter=_primaryResidentMessageRouter - In the implementation block
...
@property (assign,getter=isSharedAdmin,nonatomic) char sharedAdmin;                                                      //@synthesize sharedAdmin=_sharedAdmin - In the implementation block
@property (assign,nonatomic) char watchSkipVersionCheck;                                                                 //@synthesize watchSkipVersionCheck=_watchSkipVersionCheck - In the implementation block
...
@property (assign,getter=isMigratingAfterResidentChange,nonatomic) char migratingAfterResidentChange;                    //@synthesize migratingAfterResidentChange=_migratingAfterResidentChange - In the implementation block
...
@property (assign,nonatomic) char currentRemoteReachabilityRegistration;                                                 //@synthesize currentRemoteReachabilityRegistration=_currentRemoteReachabilityRegistration - In the implementation block
@property (assign) char migrationNeeded;                                                                                 //@synthesize migrationNeeded=_migrationNeeded - In the implementation block
...
@property (getter=isActiveNetworkRouterInitialSetupNeeded) char activeNetworkRouterInitialSetupNeeded;                   //@synthesize activeNetworkRouterInitialSetupNeeded=_activeNetworkRouterInitialSetupNeeded - In the implementation block
...
@property (nonatomic,copy,readonly) NSUUID * spiClientIdentifier;                                                        //@synthesize spiClientIdentifier=_spiClientIdentifier - In the implementation block
...
@property (getter=isAnyBTLEAccessoryReachable,nonatomic,readonly) char anyBTLEAccessoryReachable;                        //@synthesize anyBTLEAccessoryReachable=_anyBTLEAccessoryReachable - In the implementation block
...
@property (getter=isCurrentDevicePrimaryResident,readonly) char currentDevicePrimaryResident; 
...
+(id)notificationPayloadForChangedCharacterisitics:(id)arg1 destinationIsXPCTransport:(char)arg2 ;
...
-(id)initWithName:(id)arg1 uuid:(id)arg2 defaultRoomUUID:(id)arg3 owner:(id)arg4 homeManager:(id)arg5 presenceAuth:(id)arg6 metricsDispatcherFactory:(id)arg7 currentUserFactory:(/*^block*/id)arg8 residentDeviceManagerFactory:(/*^block*/id)arg9 ;
...
-(void)__registerForRemoteAccessoryReachabilityNotifications:(char)arg1 ;
-(char)_hasPairedReachableBTLEAccessories;
-(void)setAnyBTLEAccessoryReachable:(char)arg1 ;
...
-(void)_addTransactionForActiveNetworkRouterAccessory:(id)arg1 isReplacement:(char)arg2 ;
...
-(void)configureNaturalLightingWithDemoModeEnabled:(char)arg1 ;
...
-(void)_subscribeForNotificationFromRemoteGateway:(char)arg1 ;
...
-(id)_notificationPayloadsForRemoteGateway:(char)arg1 ;
-(void)_modifyCharacteristicNotificationsOnResident:(id)arg1 mediaNotifications:(id)arg2 enableNotification:(char)arg3 ;
-(char)registeredNotificationWithRemoteGateway;
-(void)_subscribeForHomeNotificationsFromRemoteGateway:(char)arg1 ;
-(void)setRegisteredNotificationWithRemoteGateway:(char)arg1 ;
-(void)_enableMediaNotifications:(char)arg1 forMediaAccessory:(id)arg2 ;
-(void)_modifyCharacteristicNotifications:(id)arg1 mediaNotifications:(id)arg2 enableNotification:(char)arg3 withDevice:(id)arg4 ;
-(id)_characteristicNotificationPayloadsOnDirectTransports:(char)arg1 ;
-(NSArray *)residentEnabledDevices;
-(void)_modifyCharacteristicNotificationsOnRemoteGateways:(id)arg1 mediaNotifications:(id)arg2 enableNotification:(char)arg3 ;
-(id)_residentUsers;
...
-(char)_canCurrentDeviceRegisterForReachabilityEventNotification;
-(void)_resubscribeForNotificationsOnResident:(id)arg1 ;
-(void)_handleRemoteGatewayNotificationRegistration:(id)arg1 enable:(char)arg2 ;
...
-(void)_saveSharedHomeToAccountWithReason:(id)arg1 postSyncNotification:(char)arg2 options:(id)arg3 ;
-(id)sharedHomeModel;
-(void)saveWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(char)arg3 ;
-(void)saveWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(char)arg3 objectChange:(char)arg4 ;
-(void)setWatchSkipVersionCheck:(char)arg1 ;
-(void)_updateExpectConfigurationVersion;
-(void)_configureBulletinNotification;
-(char)_isSharedHomeVersionTrustZoneCapable;
-(void)setOwnerTrustZoneCapable:(char)arg1 ;
-(char)isOwnerTrustZoneCapable;
-(void)_removeService:(id)arg1 ;
-(void)_removeAllHomeContentsAndAccessoryPairings:(char)arg1 queue:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)_getRunTimeStateUpdateWithOptions:(unsigned long long)arg1 includeMediaAccessorySessionState:(char)arg2 includeResidentDeviceState:(char)arg3 completion:(/*^block*/id)arg4 ;
...
-(char)currentRemoteReachabilityRegistration;
-(void)_registerForReachabilityChangeNotificationsEnabled:(char)arg1 ;
-(void)setCurrentRemoteReachabilityRegistration:(char)arg1 ;
-(void)redispatchToResidentMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3 ;
-(void)_notifyClientsOfAccessoryInfoUpdatedForAccessories:(id)arg1 shouldRefreshBadge:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
...
-(char)checkForNetworkRouterSupport:(unsigned long long)arg1 error:(id*)arg2 ;
-(NSArray *)wiFiRouterAccessories;
-(void)removeAddAccessoryRequestWithIdentifier:(id)arg1 ;
-(char)__shouldAllowAddingWiFiRouterAccessoryWithRequestMessage:(id)arg1 error:(id*)arg2 ;
-(void)saveAddAccessoryRequest:(id)arg1 ;
-(char)_shouldAllowAddingAccessoryOfCategory:(id)arg1 requestMessage:(id)arg2 error:(id*)arg3 ;
...
-(char)_shouldAllowAddingAccessoryWithDescription:(id)arg1 requestMessage:(id)arg2 error:(id*)arg3 ;
...
-(void)_handleUserConsentForAccessoryReplacement:(id)arg1 consent:(char)arg2 message:(id)arg3 ;
...
-(/*^block*/id)_handleRemoveAccessoryAfterUserConsentCompletion:(id)arg1 message:(id)arg2 ;
...
-(void)_reevaluateAccessoryInfoWithBadgeRefresh:(char)arg1 ;
...
-(void)_processLegacyPairingRequestForMessage:(id)arg1 cancelPairing:(char)arg2 ;
...
-(char)getUpdateTransactionForAccessory:(id)arg1 hapAccessory:(id)arg2 accessoryTransaction:(id)arg3 addSvcTransactions:(id*)arg4 updateSvcTransactions:(id*)arg5 removeSvcTransactions:(id*)arg6 ;
...
-(char)_addOwnerToPrimaryAccessory:(id)arg1 error:(id*)arg2 ;
...
-(void)_postInternalNotificationForChangedCharacterisitics:(id)arg1 modifiedCharacteristics:(id)arg2 changedByThisDevice:(char)arg3 residentShouldNotifyPeers:(char)arg4 message:(id)arg5 ;
-(id)_splitCharacteristicChanges:(id)arg1 changedAccessories:(id)arg2 ;
-(void)_sendClientCharacteristicsChangedNotification:(id)arg1 identifier:(id)arg2 request:(id)arg3 entitledClientsOnly:(char)arg4 multiPartResponse:(char)arg5 moreMessagesInMultipart:(char)arg6 withCompletionHandler:(/*^block*/id)arg7 ;
-(char)shouldRelayNotificationToRegisteredDevicesForSource:(id)arg1 ;
-(void)notifyRemoteUsersOfChangedCharacteristics:(id)arg1 message:(id)arg2 ;
-(char)_shouldSendToDestination:(id)arg1 device:(id)arg2 remoteSourceDevice:(id)arg3 ;
...
-(char)_shouldRegisterForNotificationsWithDevice:(id)arg1 ;
-(void)disableNotificationsForDevices:(id)arg1 ;
-(void)_updateBulletinBoardOfChangedCharacteristics:(id)arg1 changedByThisDevice:(char)arg2 homePresence:(id)arg3 ;
...
-(char)isAccessAllowedForCharacteristic:(id)arg1 withMessage:(id)arg2 ;
-(char)applyDeviceLockStatus:(id)arg1 ;
-(id)_getLogEventsForOperation:(char)arg1 accessories:(id)arg2 requestMap:(id)arg3 identifier:(id)arg4 source:(unsigned long long)arg5 bundleID:(id)arg6 ;
...
-(void)_notifyChangedCharacteristics:(id)arg1 identifier:(id)arg2 multiPartResponse:(char)arg3 moreMessagesInMultipart:(char)arg4 requestMessage:(id)arg5 withCompletionHandler:(/*^block*/id)arg6 ;
...
-(/*^block*/id)__readWriteResponseHandler:(id)arg1 ;
...
-(char)requiresUnlockToAccessCharacteristic:(id)arg1 withMessage:(id)arg2 ;
-(id)_prepareMultipleCharacteristicRead:(id)arg1 ;
-(char)isMigratingAfterResidentChange;
-(void)setMigratingAfterResidentChange:(char)arg1 ;
...
-(void)_subscribeForHomeNotificationsOnDirectTransports:(char)arg1 ;
...
-(char)_enqueueRetrievalCompletionTuple:(id)arg1 forAccessory:(id)arg2 ;
...
-(char)_isRegisteredForNotificationsWithRemoteGateway:(id)arg1 ;
-(char)_isEventTriggerOnRemoteGatewayForAccessory:(id)arg1 ;
-(char)_isRegisteredForNotificationsForClients:(id)arg1 ;
-(char)_isEventTriggerOnLocalDeviceForAccessory:(id)arg1 ;
-(void)_unconfigurePairedAccessoriesForServer:(id)arg1 updateReachability:(char)arg2 ;
-(id)_dequeueAllRetrievalCompletionTuplesForLinkType:(long long)arg1 accessory:(id)arg2 ;
-(void)_configurePairedAccessoriesForServer:(id)arg1 reAddServices:(char)arg2 ;
-(id)_createMediaSessionWithEndpoint:(id)arg1 ;
-(id)hmdHAPAccessoryWithHAPAccessory:(id)arg1 ;
-(void)_handleUpdatedCharacteristics:(id)arg1 accessoryServer:(id)arg2 stateNumber:(id)arg3 broadcast:(char)arg4 internal:(char)arg5 ;
-(id)_hmdCharacteristicsForUpdatedHAPcharacteristics:(id)arg1 accessoryServer:(id)arg2 ;
-(char)_isSecureClassTriggeredByCharactersitics:(id)arg1 ;
-(id)_changedHMDCharacteristicsForHAPCharacteristics:(id)arg1 stateNumber:(id)arg2 broadcast:(char)arg3 accessoryServer:(id)arg4 ;
...
-(void)_processUpdatedAccessoryServer:(id)arg1 reAddServices:(char)arg2 ;
...
-(void)_handlePendingResponserTimerFired:(char)arg1 ;
...
-(void)setActiveNetworkRouterInitialSetupNeeded:(char)arg1 ;
...
-(void)setMigrationNeeded:(char)arg1 ;
...
-(void)_migrateAppleMediaAccessoriesWithCloudZone:(id)arg1 migrationQueue:(id)arg2 completion:(/*^block*/id)arg3 ;
...
-(char)_ensureDevicesSymptomDiscoveryMessageCanBeHandled:(id)arg1 ;
...
-(char)isAnyBTLEAccessoryReachable;
...
-(char)isActiveNetworkRouterInitialSetupNeeded;
-(void)updateActionSetExecutionDates:(id)arg1 ;
-(char)_doesResidentExistInMyCircleWithAddress:(id)arg1 homeManager:(id)arg2 ;
-(char)watchSkipVersionCheck;
-(char)configureWithHomeManager:(id)arg1 accessoriesPresent:(id)arg2 source:(unsigned long long)arg3 ;
...
-(void)setCameraReachabilityEventNotificationsEnabled:(char)arg1 forAccessory:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)modifyCharacteristicNotifications:(id)arg1 mediaNotifications:(id)arg2 enableNotification:(char)arg3 withDevice:(id)arg4 ;
-(void)auditUsersForNotifications:(id)arg1 ;
-(void)saveSharedHomeToAccountWithReason:(id)arg1 postSyncNotification:(char)arg2 options:(id)arg3 ;
-(void)saveWithReason:(id)arg1 postSyncNotification:(char)arg2 objectChange:(char)arg3 ;
-(char)ownerTrustZoneCapable;
-(void)reEvaluateTriggers;
-(void)removeAllHomeContentsAndAccessoryPairings:(char)arg1 queue:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)getRunTimeStateUpdateWithOptions:(unsigned long long)arg1 includeMediaAccessorySessionState:(char)arg2 includeResidentDeviceState:(char)arg3 completion:(/*^block*/id)arg4 ;
...
-(char)containsRemovedUser:(id)arg1 ;
-(void)notifyRemoteUsersOfChangedProperties:(id)arg1 message:(id)arg2 ;
-(void)notifyOfChangedCharacteristic:(id)arg1 changedByThisDevice:(char)arg2 residentShouldNotifyPeers:(char)arg3 message:(id)arg4 ;
...
-(void)notifyNewRemotePeersFound:(char)arg1 remoteUsersRemoved:(id)arg2 forceRemoteNotificationRegistration:(char)arg3 ;
...
-(char)attemptToUpdateThreadNetworkID:(id)arg1 ;
-(void)configureNaturalLightingForDemoMode;
-(char)hasCharacteristicNotificationRegistrations;
...
-(void)setPrimaryResidentMessageRouter:(HMDPrimaryResidentMessageRouter *)arg1 ;
...
-(void)_updateActiveNetworkRouterAccessory:(id)arg1 isReplacement:(char)arg2 withTransaction:(id)arg3 ;
...
-(NSUUID *)assistantUniqueIdentifier;
