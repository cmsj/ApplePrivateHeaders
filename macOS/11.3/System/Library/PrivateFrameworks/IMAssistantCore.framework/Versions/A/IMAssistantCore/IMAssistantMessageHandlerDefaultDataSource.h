...
@interface IMAssistantMessageHandlerDefaultDataSource : NSObject <IMAssistantMessageHandlerDataSource> {
	...
	char _didRegisterForContactStoreChangeNotifications;
	CNContactStore* _contactStore;

}

@property (assign,nonatomic) char didRegisterForContactStoreChangeNotifications;                                                      //@synthesize didRegisterForContactStoreChangeNotifications=_didRegisterForContactStoreChangeNotifications - In the implementation block
...
-(char)didRegisterForContactStoreChangeNotifications;
-(void)setDidRegisterForContactStoreChangeNotifications:(char)arg1 ;
@end
