...
-(char)canSendLocationMessageWithLocationManager:(id)arg1 withError:(long long*)arg2 ;
-(id)sendMessageWithText:(id)arg1 currentLocation:(char)arg2 audioMessageAttachment:(id)arg3 expressiveSendStyleID:(id)arg4 idsIdentifier:(id)arg5 executionContext:(long long)arg6 toChat:(id)arg7 ;
-(char)updateSenderIdentityForNewlyCreatedChat:(id)arg1 ;
-(void)resolveRecipients:(id)arg1 forIntent:(id)arg2 completion:(/*^block*/id)arg3 ;
-(id)resolveMessageContentWithString:(id)arg1 ;
-(char)isMemberOfChat:(id)arg1 ;
-(id<IMAssistantMessageSendHandlerDelegate>)messageSendHandlerDelegate;
-(id)resolvedRecipientsFromChat:(id)arg1 ;
-(char)recipientHandleResolutionResultsAllowedByScreentime:(id)arg1 error:(id*)arg2 ;
...
-(char)shouldContinueToExamineRelevantChatsWithMatches:(id)arg1 nextChat:(id)arg2 ;
