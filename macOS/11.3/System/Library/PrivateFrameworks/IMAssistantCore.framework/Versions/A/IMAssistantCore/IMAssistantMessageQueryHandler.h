...
-(char)resolvePersons:(id)arg1 forIntent:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)SPIQueryMessagesForChatsWithIdentifiers:(id)arg1 services:(id)arg2 onlyUnread:(char)arg3 limit:(long long)arg4 completion:(/*^block*/id)arg5 ;
...
-(char)messageIsFromBlackholedChat:(id)arg1 ;
-(id)chatParticipantsForSPIHandles:(id)arg1 ;
-(void)messagesMatchingMessageIdentifiers:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)SPIQueryMessagesForChats:(id)arg1 onlyUnread:(char)arg2 limit:(long long)arg3 completion:(/*^block*/id)arg4 ;
-(id)chatsWithConversationIdentifiers:(id)arg1 ;
-(id)chatsContainingRequiredParticipants:(id)arg1 ;
-(void)SPIQueryMessagesForSenders:(id)arg1 onlyUnread:(char)arg2 limit:(long long)arg3 completion:(/*^block*/id)arg4 ;
