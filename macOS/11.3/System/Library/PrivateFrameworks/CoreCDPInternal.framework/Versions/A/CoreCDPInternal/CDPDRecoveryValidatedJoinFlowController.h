...
-(id)recoveryValidatorWithDevices:(id)arg1 forMultipleICSC:(char)arg2 withCompletionHandler:(/*^block*/id)arg3 ;
-(void)beginInteractiveRecoveryForDevices:(id)arg1 isUsingMultipleICSC:(char)arg2 usingValidator:(id)arg3 ;
...
-(char)secretValidator:(id)arg1 shouldAcceptRecoveryError:(id*)arg2 ;
-(void)secretValidator:(id)arg1 didFailRecovery:(id)arg2 withError:(id)arg3 completion:(/*^block*/id)arg4 ;
-(unsigned long long)_escapeOfferForDevices:(id)arg1 remoteApproval:(char)arg2 forMultipleICSC:(char)arg3 ;
