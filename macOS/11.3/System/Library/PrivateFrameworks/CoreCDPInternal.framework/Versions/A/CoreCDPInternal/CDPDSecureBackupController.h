...
@interface CDPDSecureBackupController : NSObject {
	...
	char _fakeNearlyDepletedRecords;
	CDPContext* _context;
...
@property (assign,nonatomic) char fakeNearlyDepletedRecords;                             //@synthesize fakeNearlyDepletedRecords=_fakeNearlyDepletedRecords - In the implementation block
...
-(void)getBackupRecordDevicesWithOptionForceFetch:(char)arg1 completion:(/*^block*/id)arg2 ;
-(void)recoverSecureBackupWithContext:(id)arg1 completion:(/*^block*/id)arg2 ;
-(char)supportsRecoveryKey;
...
-(void)_getOctagonEscrowBackupRecordDevicesWithOptionForceFetch:(char)arg1 completion:(/*^block*/id)arg2 ;
-(char)fakeNearlyDepletedRecords;
-(id)handleCDPDevices:(id)arg1 ;
-(void)fetchAllEscrowRecordsWithOptionForceFetch:(char)arg1 completion:(/*^block*/id)arg2 ;
-(void)fetchEscrowRecordsWithOptionForceFetch:(char)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)checkForExistingRecordMatchingPredicate:(id)arg1 forceFetch:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_authenticatedEnableSecureBackupWithContext:(id)arg1 completion:(/*^block*/id)arg2 ;
-(char)authenticatedEnableSecureBackupWithRecoveryKey:(id)arg1 error:(id*)arg2 ;
-(id)_clientMetadataWithSecretType:(unsigned long long)arg1 length:(unsigned long long)arg2 ;
-(id)_currentAnisetteData;
-(char)_disableThenEnableWithInfo:(id)arg1 error:(id*)arg2 ;
-(char)_disableSecureBackup:(id*)arg1 ;
...
-(char)_disableRecoveryKey:(id*)arg1 ;
...
-(void)setFakeNearlyDepletedRecords:(char)arg1 ;
