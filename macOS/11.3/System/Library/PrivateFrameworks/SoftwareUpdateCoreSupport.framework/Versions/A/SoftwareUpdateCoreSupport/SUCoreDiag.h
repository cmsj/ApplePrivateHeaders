...
@property (assign,nonatomic) char isSharedDiag;                                         //@synthesize isSharedDiag=_isSharedDiag - In the implementation block
+(id)sharedDiag;
...
-(void)setIsSharedDiag:(char)arg1 ;
...
-(void)_dumpTracked:(id)arg1 dumpingTo:(long long)arg2 usingFilename:(id)arg3 clearingStatistics:(char)arg4 clearingHistory:(char)arg5 ;
-(void)setLastReportedUUID:(NSString *)arg1 ;
-(id)_copyTrackedStatsClearingAfter:(char)arg1 ;
...
-(id)copyTrackedStatsClearingAfter:(char)arg1 ;
-(void)collectTrackedStatsClearingAfter:(char)arg1 completion:(/*^block*/id)arg2 ;
-(id)loadDump:(id)arg1 ;
...
-(void)dumpTracked:(id)arg1 dumpingTo:(long long)arg2 usingFilename:(id)arg3 clearingStatistics:(char)arg4 clearingHistory:(char)arg5 ;
