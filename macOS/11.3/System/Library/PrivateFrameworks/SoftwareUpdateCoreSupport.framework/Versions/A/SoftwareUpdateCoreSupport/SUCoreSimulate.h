...
@property (nonatomic,readonly) char simulatorEnabled;                                   //@synthesize simulatorEnabled=_simulatorEnabled - In the implementation block
...
-(char)_parseOptionalEntriesInLineFromWords:(id)arg1 argStartAt:(int*)arg2 argEndAt:(int*)arg3 argDuration:(int*)arg4 argUntilStop:(id*)arg5 argAssetBuildVersions:(id*)arg6 argAssetProductVersions:(id*)arg7 argAssetAttributesPlist:(id*)arg8 argAssetState:(id*)arg9 argUpdateInfoPlist:(id*)arg10 argErrorDomain:(id*)arg11 argErrorCode:(long long*)arg12 argErrorRecoverable:(long long*)arg13 ;
-(char)_parseIntFromString:(id)arg1 destination:(int*)arg2 ;
-(char)_parseErrorCodeFromString:(id)arg1 destination:(long long*)arg2 ;
-(char)_parseEventBooleanFromString:(id)arg1 destination:(long long*)arg2 ;
...
-(char)_isImmediateEvent:(id)arg1 ;
