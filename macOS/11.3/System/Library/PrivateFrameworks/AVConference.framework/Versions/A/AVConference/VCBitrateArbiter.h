...
-(unsigned)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(char)arg2 operatingMode:(int)arg3 encodeRule:(id)arg4 ;
...
-(unsigned)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(char)arg2 encodeRule:(id)arg3 ;
...
-(void)updateMaxAllowedBitrate:(unsigned*)arg1 key:(CFStringRef)arg2 type:(id)arg3 isAudio:(char)arg4 carrierBundleBitrates:(CFDictionaryRef)arg5 ;
