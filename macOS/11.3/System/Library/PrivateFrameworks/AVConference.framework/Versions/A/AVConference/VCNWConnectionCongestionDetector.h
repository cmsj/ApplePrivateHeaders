...
-(char)processNWConnectionNotification:(ifnet_interface_advisory*)arg1 ;
-(char)processNWConnectionPacketEvent:(packet_id*)arg1 eventType:(int)arg2 ;
@end
