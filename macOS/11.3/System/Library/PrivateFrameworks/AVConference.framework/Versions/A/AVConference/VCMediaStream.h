...
@property (nonatomic,readonly) char isSendingMedia; 
...
-(char)initializeTransportSessionWithSocketDictionary:(id)arg1 error:(id*)arg2 ;
-(void)initializeTransportSetupInfoWithSocketDictionary:(id)arg1 ;
-(void)handleTransportSessionEvent:(unsigned)arg1 info:(id)arg2 ;
-(void)handleStartDidSucceed:(char)arg1 withError:(id)arg2 ;
-(char)initializeTransportSetupInfoWithTransportSession:(id*)arg1 ;
-(void)initializeTransportSetupInfoWithRTPSocket:(int)arg1 RTCPSocket:(int)arg2 ;
-(void)cleanupNWConnection:(id*)arg1 ;
-(char)initializeTransportSessionWithNWConnectionID:(id)arg1 error:(id*)arg2 ;
-(char)setupNWConnectionWithID:(id)arg1 ;
...
-(char)initializeTransportSessionWithIDSDestination:(id)arg1 error:(id*)arg2 ;
-(char)initializeTransportSetupInfoWithIDSDestination:(id)arg1 error:(id*)arg2 ;
...
-(char)updateRemoteAddressWithConfig:(id)arg1 error:(id*)arg2 ;
-(char)startMediaTransportsWithError:(id*)arg1 ;
-(void)startRTCPSendHeartbeat;
-(void)startTimeoutHeartbeat;
-(void)notifyDelegateStartDidSucceed:(char)arg1 withError:(id)arg2 ;
-(void)stopInternal;
