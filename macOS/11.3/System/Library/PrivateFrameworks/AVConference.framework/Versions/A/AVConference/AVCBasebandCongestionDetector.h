...
-(char)isRadioAccessTechnologyOnCellular:(unsigned)arg1 ;
-(char)processBasebandNotification:(SCD_Struct_VC128*)arg1 arrivalTime:(double)arg2 error:(id*)arg3 ;
-(void)processBasebandAck:(SCD_Struct_VC128*)arg1 ;
...
-(char)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id*)arg3 ;
@end
