...
@property (nonatomic,readonly) char hasMaxNetworkBitrate; 
...
@property (nonatomic,readonly) char hasMaxMediaBitrate; 
...
@property (nonatomic,readonly) char hasMaxIDSStreamIdCount; 
...
@property (nonatomic,readonly) char hasRepairedStreamID; 
...
@property (nonatomic,readonly) char hasRepairedMaxNetworkBitrate; 
@property (assign,nonatomic) char startOnDemand;                                     //@synthesize startOnDemand=_startOnDemand - In the implementation block
@property (nonatomic,readonly) NSArray * streamIds; 
@property (assign,nonatomic) char isOneToOne;                                        //@synthesize isOneToOne=_isOneToOne - In the implementation block
-(void)dealloc;
...
-(char)hasQualityIndex;
-(void)setIdsStreamID:(unsigned short)arg1 ;
-(char)startOnDemand;
-(void)setStartOnDemand:(char)arg1 ;
-(char)hasMaxIDSStreamIdCount;
-(void)setParticipantId:(NSString *)arg1 ;
-(void)setIsOneToOne:(char)arg1 ;
@end
