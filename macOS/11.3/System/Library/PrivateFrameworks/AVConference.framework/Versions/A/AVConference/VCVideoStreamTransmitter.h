...
-(char)prependSPSPPS:(unsigned long long*)arg1 dataPointer:(char*)arg2 ;
...
-(void)startVideo;
-(void)stopVideo;
-(char)enqueueVideoFrame:(opaqueCMSampleBufferRef)arg1 frameTime:(SCD_Struct_VC63)arg2 cameraStatusBits:(unsigned char)arg3 ;
