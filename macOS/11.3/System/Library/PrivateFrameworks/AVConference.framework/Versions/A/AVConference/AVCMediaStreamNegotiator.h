...
-(char)processOffererInitOptions:(id)arg1 errorReason:(id*)arg2 ;
-(char)initNegotiatorLocalConfiguration:(id*)arg1 ;
-(char)createOffer;
-(id)initWithMode:(long long)arg1 options:(id)arg2 error:(id*)arg3 ;
-(char)addLocalCallInfoBlobToOutgoingDictionary:(id)arg1 ;
-(id)initWithOffer:(id)arg1 options:(id)arg2 error:(id*)arg3 ;
-(char)processOfferWithError:(id*)arg1 errorReason:(id*)arg2 ;
-(char)processAnswererInitOptions:(id)arg1 errorReason:(id*)arg2 ;
-(char)createAnswer;
-(char)processAnswerWithError:(id*)arg1 errorReason:(id*)arg2 ;
-(unsigned)pickBestPixelFormatFromSet:(id)arg1 ;
-(unsigned)pickBestPixelFormatFromSet:(id)arg1 preferenceList:(unsigned*)arg2 count:(int)arg3 acceptDefault:(char)arg4 ;
-(id)initWithMode:(long long)arg1 error:(id*)arg2 ;
-(id)initWithOffer:(id)arg1 error:(id*)arg2 ;
-(char)setAnswer:(id)arg1 withError:(id*)arg2 ;
