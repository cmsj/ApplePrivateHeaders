...
+(void)recordConversationTurnWithContact:(id)arg1 received:(char)arg2 curated:(char)arg3 throughApp:(id)arg4 withDetailName:(id)arg5 withDetailExtraction:(id)arg6 ;
-(id)init;
