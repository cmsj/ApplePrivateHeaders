...
@property (assign,nonatomic) char hasChangesWhilePaused;                                                          //@synthesize hasChangesWhilePaused=_hasChangesWhilePaused - In the implementation block
...
-(void)setHasChangesWhilePaused:(char)arg1 ;
-(char)hasChangesWhilePaused;
...
-(char)_messageListItemChangeAffectsSorting:(id)arg1 ;
-(void)_prepareToSendUpdates;
-(char)_reportChanges:(id)arg1 ;
-(char)_mergeInThreads:(id)arg1 forMove:(char)arg2 ;
-(void)_didSendUpdates;
-(void)_messagesWereChanged:(id)arg1 forKeyPaths:(id)arg2 deleted:(char)arg3 ;
-(char)_reportDeletes:(id)arg1 ;
-(id<EMMessageListItemQueryResultsObserver>)resultsObserverIfNotPaused;
-(char)_removeThreadsForInMemoryThreads:(id)arg1 forMove:(char)arg2 ;
-(char)_didMergeInThreads:(id)arg1 ;
-(EDThreadReloadSummaryHelper *)reloadSummaryHelper;
-(EMMailboxScope *)mailboxScope;
-(char)_threadsWereDeleted;
-(char)_updateOldestThreadsForMailboxes:(id)arg1 ;
-(char)_updateCurrentOldestThreadWithThreadIfApplicable:(id)arg1 forMailbox:(id)arg2 ;
