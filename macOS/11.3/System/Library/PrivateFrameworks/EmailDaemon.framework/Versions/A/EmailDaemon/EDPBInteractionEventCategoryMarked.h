...
@property (assign,nonatomic) char hasRemoveAllUserOverrides; 
@property (assign,nonatomic) char removeAllUserOverrides;                 //@synthesize removeAllUserOverrides=_removeAllUserOverrides - In the implementation block
...
-(char)hasPositive;
-(void)setRemoveAllUserOverrides:(char)arg1 ;
-(void)setHasRemoveAllUserOverrides:(char)arg1 ;
-(char)hasRemoveAllUserOverrides;
-(char)removeAllUserOverrides;
@end
