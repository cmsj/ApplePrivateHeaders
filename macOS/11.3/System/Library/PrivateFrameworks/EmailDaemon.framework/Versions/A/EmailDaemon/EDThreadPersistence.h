...
-(char)beginMigratingThreadScope:(id)arg1 ;
-(char)addThreads:(id)arg1 ;
-(char)endMigratingThreadScope:(id)arg1 ;
-(char)deleteThreadsWithObjectIDs:(id)arg1 ;
...
-(char)_isThreadScopePrecomputed:(id)arg1 shouldMigrate:(char*)arg2 ;
-(char)_enumerateThreadObjectIDsForThreadScope:(id)arg1 filterClause:(id)arg2 sortDescriptors:(id)arg3 batchBlock:(/*^block*/id)arg4 ;
...
-(char)_addThreadScopeToDatabaseWithMailboxType:(id)arg1 needsUpdate:(char)arg2 lastViewedDate:(id)arg3 connection:(id)arg4 ;
...
-(char)_addThreadScopeToDatabase:(id)arg1 withMailboxDatabaseID:(long long)arg2 needsUpdate:(char)arg3 lastViewedDate:(id)arg4 updateThreadScopeManager:(char)arg5 connection:(id)arg6 ;
-(void)_addPersistedMessages:(id)arg1 journaled:(char)arg2 generationWindow:(id)arg3 ;
...
-(char)_updateNewestReadMessageWithWrappedMessage:(id)arg1 threadExpression:(id)arg2 ;
-(id)_recalculateDisplayMessageForThreadObjectID:(id)arg1 threadScopeDatabaseID:(long long)arg2 ;
-(char)_recalculateNewestReadMessageForThreadObjectID:(id)arg1 threadScopeDatabaseID:(long long)arg2 ;
...
-(char)_deleteMailboxesFromWrappedMessages:(id)arg1 fromThreadWithDatabaseID:(id)arg2 messageThreadExpression:(id)arg3 ;
-(id)_updateBasicPropertiesAfterDeleteForThreadObjectID:(id)arg1 threadScopeDatabaseID:(long long)arg2 ;
-(char)_deleteSendersFromThreadWithDatabaseID:(id)arg1 messageThreadExpression:(id)arg2 ;
-(char)_deleteRecipientsOfType:(unsigned long long)arg1 fromThreadWithDatabaseID:(id)arg2 messageThreadExpression:(id)arg3 ;
...
-(char)_canResetThreadScope:(id)arg1 ;
...
-(char)_messagesAreJournaledForThreadWithObjectID:(id)arg1 ;
...
-(char)setPriorityForDisplayMessageSenderForThreadObjectID:(id)arg1 ;
...
-(char)_addThreadScopeToDatabase:(id)arg1 needsUpdate:(char)arg2 lastViewedDate:(id)arg3 updateThreadScopeManager:(char)arg4 ;
-(id)_statementForOldestThreadInMailbox:(id)arg1 threadScope:(id)arg2 createMailboxDatabaseIDIfNecessary:(char)arg3 ;
...
-(char)_updateDisplayMessageWithUnreadWrappedMessages:(id)arg1 threadExpression:(id)arg2 ;
-(char)addThreadScopeToDatabase:(id)arg1 needsUpdate:(char)arg2 lastViewedDate:(id)arg3 ;
