...
-(char)isLanguageCorrectionSupportedForLanguage:(id)arg1 revision:(unsigned long long)arg2 ;
...
-(char)preferAllUppercase:(id)arg1 ;
-(char)preferAllLowercase:(id)arg1 ;
-(id)initWithRevision:(unsigned long long)arg1 localeCode:(id)arg2 customWords:(id)arg3 ;
-(id)correctTextFeature:(id)arg1 inImage:(id)arg2 withTextPieces:(id)arg3 withMaxWidthPerRegion:(double)arg4 withMedianCharSpacing:(double)arg5 withBreakpoints:(const vector<std::__1::vector<BreakPoint, std::__1::allocator<BreakPoint>>, std::__1::allocator<std::__1::vector<BreakPoint, std::__1::allocator<BreakPoint>>>>*)arg6 segmenter:(Segmenter*)arg7 options:(id)arg8 numCharCandidates:(int)arg9 downscaleSpaceRatio:(char)arg10 latticePresetIdx:(int)arg11 latticeResults:(id)arg12 ;
