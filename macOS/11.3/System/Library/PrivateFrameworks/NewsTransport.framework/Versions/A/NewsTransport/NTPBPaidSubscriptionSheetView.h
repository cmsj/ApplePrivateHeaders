...
@property (assign,nonatomic) char hasPaidSubscriptionSheetViewPresentationReason; 
...
-(void)setHasPaidSubscriptionSheetViewPresentationReason:(char)arg1 ;
-(char)hasPaidSubscriptionSheetViewPresentationReason;
@end
