...
@property (nonatomic,readonly) char hasIosActivityType; 
...
@property (nonatomic,readonly) char hasExternalWeblinkUrl; 
...
@property (assign,nonatomic) char hasIsNotificationArticle; 
@property (assign,nonatomic) char isNotificationArticle;                                    //@synthesize isNotificationArticle=_isNotificationArticle - In the implementation block
...
@property (assign,nonatomic) char hasIsSearchResult; 
...
-(void)setHasShareMethod:(char)arg1 ;
-(char)hasShareMethod;
-(int)shareLocation;
-(void)setShareLocation:(int)arg1 ;
-(void)setHasShareLocation:(char)arg1 ;
-(char)hasShareLocation;
-(char)hasIosActivityType;
-(char)hasExternalWeblinkUrl;
-(void)setIsNotificationArticle:(char)arg1 ;
-(void)setHasIsNotificationArticle:(char)arg1 ;
-(char)hasIsNotificationArticle;
-(void)setIsSearchResult:(char)arg1 ;
-(void)setHasIsSearchResult:(char)arg1 ;
-(char)hasIsSearchResult;
-(NSString *)iosActivityType;
-(NSString *)externalWeblinkUrl;
-(char)isNotificationArticle;
@end
