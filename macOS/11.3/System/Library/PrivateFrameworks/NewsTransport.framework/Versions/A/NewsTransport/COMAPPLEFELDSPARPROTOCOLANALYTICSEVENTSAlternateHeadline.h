...
@property (assign,nonatomic) char hasArticleHeadlineTreatmentState; 
...
@property (assign,nonatomic) char hasArticleHeadlineTreatmentId; 
...
-(void)setHasArticleHeadlineTreatmentState:(char)arg1 ;
-(char)hasArticleHeadlineTreatmentState;
-(void)setArticleHeadlineTreatmentId:(int)arg1 ;
-(void)setHasArticleHeadlineTreatmentId:(char)arg1 ;
-(char)hasArticleHeadlineTreatmentId;
