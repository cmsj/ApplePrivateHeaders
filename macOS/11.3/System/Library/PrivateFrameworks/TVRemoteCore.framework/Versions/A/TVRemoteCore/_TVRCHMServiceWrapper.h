...
@property (assign,nonatomic) char sentWakeKey;                                               //@synthesize sentWakeKey=_sentWakeKey - In the implementation block
@property (assign,nonatomic) char volumeControlSupported;                                    //@synthesize volumeControlSupported=_volumeControlSupported - In the implementation block
...
-(char)sentWakeKey;
-(void)setSentWakeKey:(char)arg1 ;
-(char)volumeControlSupported;
-(void)setVolumeControlSupported:(char)arg1 ;
@end
