...
-(id)initWithUInt32s:(const unsigned*)arg1 forKeys:(const char*)arg2 count:(unsigned long long)arg3 ;
-(void)enumerateKeysAndUInt32sUsingBlock:(/*^block*/id)arg1 ;
-(char)getUInt32:(unsigned*)arg1 forKey:(char)arg2 ;
-(void)setUInt32:(unsigned)arg1 forKey:(char)arg2 ;
-(void)removeUInt32ForKey:(char)arg1 ;
