...
#import <DesktopServicesPriv/DeviceCollectionDelegate.h>
...
@interface DSITunesObserver : NSObject <DeviceCollectionDelegate> {
	...
	TNSRef<NSMutableArray<AMPDevice *>, void> fDevices;
	TNSRef<DeviceCollection, void> fCollection;
...
-(void)stopObserving;
-(id)copyCollection;
-(TNSRef<NSArray<AMPDevice *>, void>)iTuneDevices;
-(void)syncDeviceList;
