...
@interface VSIdentityProviderRequestManager : NSObject <VSApplicationControllerDelegate> {
	...
	char _canIssuePrivacyVouchers;
	char _didCreateAccount;
	char _allowsApplicationControllerTimer;
...
@property (assign,nonatomic) char allowsApplicationControllerTimer;                                       //@synthesize allowsApplicationControllerTimer=_allowsApplicationControllerTimer - In the implementation block
...
@property (assign,nonatomic) char canIssuePrivacyVouchers;                                                //@synthesize canIssuePrivacyVouchers=_canIssuePrivacyVouchers - In the implementation block
...
-(void)setAllowsApplicationControllerTimer:(char)arg1 ;
-(char)_requestRequiresApplicationController:(id)arg1 ;
...
-(char)allowsApplicationControllerTimer;
...
-(char)_handleAuthenticationRequest:(id)arg1 didCompleteWithResponse:(id)arg2 ;
-(char)_handleSilentAuthenticationRequest:(id)arg1 didCompleteWithResponse:(id)arg2 ;
-(char)_handleLogoutRequestDidComplete:(id)arg1 ;
-(char)_handleSTBOptOutDidComplete:(id)arg1 ;
-(char)_handleAccountMetadataRequest:(id)arg1 didCompleteWithResponse:(id)arg2 ;
-(void)_notifyDidAuthenticateAccount:(id)arg1 ;
-(void)_completeAuthenticationRequestWithApplicationControllerResponse:(id)arg1 ;
-(char)_requestRequiresApplicationControllerIgnoringAuthentication:(id)arg1 ;
...
-(void)setCanIssuePrivacyVouchers:(char)arg1 ;
