...
@interface VSIdentityProviderRequestContext : NSObject {
	...
	char _attemptedVerificationStateReset;
...
@property (assign,nonatomic) char attemptedVerificationStateReset;              //@synthesize attemptedVerificationStateReset=_attemptedVerificationStateReset - In the implementation block
-(VSIdentityProviderRequest *)request;
-(void)setRequest:(VSIdentityProviderRequest *)arg1 ;
-(char)attemptedVerificationStateReset;
-(void)setAttemptedVerificationStateReset:(char)arg1 ;
@end
