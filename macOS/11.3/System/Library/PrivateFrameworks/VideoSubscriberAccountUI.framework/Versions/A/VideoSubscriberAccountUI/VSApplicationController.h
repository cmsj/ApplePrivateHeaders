...
@interface VSApplicationController : NSObject <VSAppDocumentControllerDelegate, VSApplicationDelegate, VSStateMachineDelegate> {
	...
	char _applicationMustSelfValidate;
	char _allowUI;
...
@property (assign,nonatomic) char applicationMustSelfValidate;                                      //@synthesize applicationMustSelfValidate=_applicationMustSelfValidate - In the implementation block
@property (assign,nonatomic) char allowUI;                                                          //@synthesize allowUI=_allowUI - In the implementation block
...
-(void)_applicationReadyWithSuccess:(char)arg1 javascriptErrorValue:(id)arg2 ;
...
-(char)applicationMustSelfValidate;
...
-(void)setApplicationMustSelfValidate:(char)arg1 ;
