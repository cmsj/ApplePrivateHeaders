...
@property (nonatomic,readonly) char attemptedCGImage;                         //@synthesize attemptedCGImage=_attemptedCGImage - In the implementation block
