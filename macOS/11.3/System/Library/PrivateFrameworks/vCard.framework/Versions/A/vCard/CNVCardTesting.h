...
+(id)complexValueWithValue:(id)arg1 label:(id)arg2 isPrimary:(char)arg3 ;
...
+(id)resultWithProperty:(id)arg1 value:(id)arg2 label:(id)arg3 isPrimary:(char)arg4 ;
+(id)unknownPropertyWithName:(id)arg1 line:(id)arg2 ;
+(char)version30CardForPerson:(id)arg1 containsLine:(id)arg2 ;
+(char)version30CardForPerson:(id)arg1 containsString:(id)arg2 ;
+(char)version30DataUsingAdapter:(id)arg1 containsData:(id)arg2 ;
+(char)version21DataUsingAdapter:(id)arg1 containsData:(id)arg2 ;
