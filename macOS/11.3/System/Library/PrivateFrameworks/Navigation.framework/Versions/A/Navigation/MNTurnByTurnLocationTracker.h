...
-(char)_allowRerouteForLocation:(id)arg1 outError:(out id*)arg2 ;
-(char)_isRoadFeatureInOppositeDirection:(SCD_Struct_MN5*)arg1 ofCoordinate:(SCD_Struct_MN6)arg2 course:(double)arg3 ;
-(char)_shouldAdvanceGuidanceToRouteMatch:(id)arg1 ;
-(int)_routeHintTypeFromGEOTransportType:(int)arg1 ;
-(id)_evInfoForRoute:(id)arg1 ;
-(char)_isCameraTestMode;
...
-(char)_hasArrivedAtFinalDestination;
