...
@property (assign,nonatomic) char copyToCrashReporterDirectory; 
...
-(char)_isTracePathValid:(id)arg1 ;
...
-(void)startWritingTraceToFileAtPath:(id)arg1 shouldPrepareStatements:(char)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)_recordLocationEvent:(long long)arg1 recordingTimestamp:(double)arg2 coordinate:(CLLocationCoordinate2D)arg3 rawCoordinate:(CLLocationCoordinate2D)arg4 timestamp:(double)arg5 horizontalAccuracy:(double)arg6 verticalAccuracy:(double)arg7 altitude:(double)arg8 speed:(double)arg9 speedAccuracy:(double)arg10 course:(double)arg11 rawCourse:(double)arg12 type:(int)arg13 courseAccuracy:(double)arg14 correctedCoordinate:(CLLocationCoordinate2D)arg15 correctedCourse:(double)arg16 matchType:(int)arg17 activeTransportType:(int)arg18 correctedLocation:(id)arg19 speedLimit:(int)arg20 shieldText:(id)arg21 shieldType:(int)arg22 ;
...
-(char)copyToCrashReporterDirectory;
-(void)setCopyToCrashReporterDirectory:(char)arg1 ;
...
-(void)recordAudioSetting:(char)arg1 volume:(long long)arg2 ;
