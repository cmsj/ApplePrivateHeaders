...
-(void)_handleResult:(id)arg1 forDestination:(id)arg2 error:(id)arg3 fromNetwork:(char)arg4 requestingClientID:(id)arg5 handlerID:(id)arg6 completed:(char)arg7 ;
