...
-(void)navigationSessionManager:(id)arg1 displayPrimaryStep:(id)arg2 instructions:(id)arg3 shieldType:(int)arg4 shieldText:(id)arg5 drivingSide:(int)arg6 maneuverStepIndex:(unsigned long long)arg7 isSynthetic:(char)arg8 ;
...
-(void)navigationSessionManager:(id)arg1 usePersistentDisplay:(char)arg2 ;
...
-(void)navigationSessionManager:(id)arg1 didEnableGuidancePrompts:(char)arg2 ;
