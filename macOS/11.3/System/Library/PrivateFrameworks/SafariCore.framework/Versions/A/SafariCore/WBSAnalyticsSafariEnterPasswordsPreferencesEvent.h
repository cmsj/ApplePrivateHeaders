...
@property (assign,nonatomic) char hasPercentageOfDuplicatedPasswords; 
...
-(void)setHasPercentageOfDuplicatedPasswords:(char)arg1 ;
-(char)hasPercentageOfDuplicatedPasswords;
