...
@property (assign,nonatomic) char hasGeneratedPasswordInteractionType; 
...
-(void)setHasGeneratedPasswordInteractionType:(char)arg1 ;
-(char)hasGeneratedPasswordInteractionType;
