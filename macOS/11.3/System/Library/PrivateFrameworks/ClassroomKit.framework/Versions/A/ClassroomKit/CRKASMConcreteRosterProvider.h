...
@property (assign,getter=isPopulated,nonatomic) char populated;                                 //@synthesize populated=_populated - In the implementation block
...
-(void)updateRoster:(id)arg1 outTrustedPersonIDsChanged:(char*)arg2 ;
