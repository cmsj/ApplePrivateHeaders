...
@property (assign,nonatomic) char allowUnenrolledSessions;                                                          //@synthesize allowUnenrolledSessions=_allowUnenrolledSessions - In the implementation block
@property (getter=isBrowsing,nonatomic,readonly) char browsing; 
@property (nonatomic,copy,readonly) NSSet * inRangeClassSessionIdentifiers; 
...
-(char)isEndpointWhitelisted:(id)arg1 forSessionClass:(Class)arg2 ;
...
-(void)setAllowUnenrolledSessions:(char)arg1 ;
...
-(char)hasConnectionToClassWithIdentifier:(id)arg1 ;
