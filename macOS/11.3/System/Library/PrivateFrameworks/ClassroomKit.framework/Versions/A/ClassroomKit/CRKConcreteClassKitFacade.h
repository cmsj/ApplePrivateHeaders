...
+(id)makePersonSortDescriptorsSortingGivenNameFirst:(char)arg1 ;
...
-(id)makeQueryForPersonsWithRole:(long long)arg1 locationIDs:(id)arg2 searchString:(id)arg3 sortingGivenNameFirst:(char)arg4 pageSize:(long long)arg5 ;
