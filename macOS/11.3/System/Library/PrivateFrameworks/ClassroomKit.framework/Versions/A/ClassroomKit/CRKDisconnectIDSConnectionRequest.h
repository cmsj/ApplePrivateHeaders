...
@property (nonatomic,copy) NSString * instructorIdentifier;                             //@synthesize instructorIdentifier=_instructorIdentifier - In the implementation block
...
-(void)setInstructorIdentifier:(NSString *)arg1 ;
@end
