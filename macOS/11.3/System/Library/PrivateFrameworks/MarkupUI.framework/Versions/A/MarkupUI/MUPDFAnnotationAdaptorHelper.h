...
+(char)_shouldUseAKAnnotation:(id)arg1 toRepresentCGPDFAnnotation:(CGPDFAnnotationRef)arg2 ;
...
+(void)addTextOfAnnotation:(id)arg1 toDictionary:(id)arg2 forKey:(id)arg3 canUsePlaceholder:(char)arg4 ;
