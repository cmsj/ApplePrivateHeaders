...
@property (nonatomic,readonly) char hasArrivalRegion; 
@property (nonatomic,retain) GEOMapRegion * arrivalRegion; 
@property (assign,nonatomic) char hasArrivalRegionAction; 
@property (assign,nonatomic) int arrivalRegionAction; 
@property (assign,nonatomic) char hasEndNavigationTimeoutThreshold; 
...
-(char)hasArrivalRegion;
-(int)arrivalRegionAction;
-(void)setHasArrivalRegionAction:(char)arg1 ;
-(char)hasArrivalRegionAction;
-(id)arrivalRegionActionAsString:(int)arg1 ;
-(int)StringAsArrivalRegionAction:(id)arg1 ;
-(unsigned)endNavigationTimeoutThreshold;
-(void)setHasEndNavigationTimeoutThreshold:(char)arg1 ;
-(char)hasEndNavigationTimeoutThreshold;
@end
