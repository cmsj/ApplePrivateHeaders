...
@property (nonatomic,readonly) char hasExtractedTerm; 
@property (nonatomic,retain) NSString * extractedTerm; 
@property (assign,nonatomic) char hasResolvedItemType; 
...
-(char)hasResolvedItemType;
-(int)resolvedItemType;
-(void)setResolvedItemType:(int)arg1 ;
-(char)hasExtractedTerm;
-(NSString *)extractedTerm;
-(unsigned)resultIndex;
-(char)hasResultIndex;
-(void)setHasResolvedItemType:(char)arg1 ;
