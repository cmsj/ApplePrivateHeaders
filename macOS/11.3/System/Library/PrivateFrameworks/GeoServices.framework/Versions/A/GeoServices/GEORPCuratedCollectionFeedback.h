...
@property (nonatomic,readonly) char hasCuratedCollectionContext; 
@property (nonatomic,retain) GEORPCuratedCollectionContext * curatedCollectionContext; 
@property (nonatomic,readonly) char hasCuratedCollectionCorrections; 
...
-(char)hasCuratedCollectionContext;
-(char)hasCuratedCollectionCorrections;
@end
