...
@property (nonatomic,readonly) char hasFeatureVenue; 
@property (nonatomic,retain) GEOPDFeatureVenue * featureVenue; 
@property (nonatomic,readonly) char hasFeatureBuilding; 
@property (nonatomic,retain) GEOPDFeatureBuilding * featureBuilding; 
@property (nonatomic,readonly) char hasFeaturePoi; 
...
-(char)hasFeatureVenue;
-(char)hasFeatureBuilding;
-(char)hasFeaturePoi;
@end
