...
@property (assign,nonatomic) char hasStartHeading; 
@property (assign,nonatomic) double startHeading; 
@property (assign,nonatomic) char hasEndHeading; 
...
-(double)startHeading;
-(void)setHasStartHeading:(char)arg1 ;
-(char)hasStartHeading;
-(double)endHeading;
-(void)setHasEndHeading:(char)arg1 ;
-(char)hasEndHeading;
@end
