...
@interface GEOLocalizationCapabilities : PBCodable <NSCopying> {
	...
	SCD_Struct_GE86* _supportedPhoneticTypes;
...
@property (assign,nonatomic) char hasSupportsLocalizedTrafficControlIcons; 
@property (assign,nonatomic) char supportsLocalizedTrafficControlIcons; 
...
-(void)setSupportsLocalizedTrafficControlIcons:(char)arg1 ;
...
-(char)supportsLocalizedTrafficControlIcons;
-(void)setHasSupportsLocalizedTrafficControlIcons:(char)arg1 ;
-(char)hasSupportsLocalizedTrafficControlIcons;
@end
