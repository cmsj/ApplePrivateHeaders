...
@property (assign,nonatomic) char hasSuppressSyntheticReviews; 
@property (assign,nonatomic) char suppressSyntheticReviews; 
...
-(void)setSuppressSyntheticReviews:(char)arg1 ;
-(char)suppressSyntheticReviews;
-(void)setHasSuppressSyntheticReviews:(char)arg1 ;
-(char)hasSuppressSyntheticReviews;
@end
