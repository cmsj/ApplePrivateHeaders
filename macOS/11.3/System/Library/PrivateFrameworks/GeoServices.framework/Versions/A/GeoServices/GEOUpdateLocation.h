...
@property (assign,nonatomic) char hasMetersFromStartOfRoute; 
@property (assign,nonatomic) unsigned metersFromStartOfRoute; 
@property (assign,nonatomic) char hasMinSecondsSinceLastUpdate; 
...
-(void)setHasMetersFromStartOfRoute:(char)arg1 ;
-(char)hasMetersFromStartOfRoute;
-(unsigned)minSecondsSinceLastUpdate;
-(void)setHasMinSecondsSinceLastUpdate:(char)arg1 ;
-(char)hasMinSecondsSinceLastUpdate;
@end
