...
@property (nonatomic,readonly) char hasSiriIncidentType; 
@property (nonatomic,retain) NSString * siriIncidentType; 
@property (nonatomic,readonly) char hasAdditionalDetails; 
...
-(void)setSiriIncidentType:(NSString *)arg1 ;
-(void)setAdditionalDetails:(NSString *)arg1 ;
-(char)hasSiriIncidentType;
-(char)hasAdditionalDetails;
@end
