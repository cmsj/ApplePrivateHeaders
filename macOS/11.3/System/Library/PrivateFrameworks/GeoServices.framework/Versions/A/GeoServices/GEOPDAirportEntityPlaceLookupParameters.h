...
@property (nonatomic,readonly) char hasAirportCode; 
@property (nonatomic,retain) NSString * airportCode; 
@property (nonatomic,readonly) char hasTerminalCode; 
@property (nonatomic,retain) NSString * terminalCode; 
@property (nonatomic,readonly) char hasGateCode; 
