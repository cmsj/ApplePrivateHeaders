...
+(id)URLForCoordinate:(GEOCoarseLocationLatLng)arg1 address:(id)arg2 label:(id)arg3 extraStorage:(id)arg4 useWebPlaceCard:(char)arg5 muninViewState:(id)arg6 ;
+(id)URLForDirectionsFrom:(id)arg1 to:(id)arg2 transport:(int)arg3 ;
+(id)URLForDirectionsFromHereTo:(id)arg1 transport:(int)arg2 ;
+(id)URLForInternalBusiness:(id)arg1 id:(unsigned long long)arg2 provider:(int)arg3 coordinate:(GEOCoarseLocationLatLng)arg4 address:(id)arg5 extraStorage:(id)arg6 useWebPlaceCard:(char)arg7 ;
+(id)URLForInternalBusiness:(id)arg1 id:(unsigned long long)arg2 provider:(int)arg3 coordinate:(GEOCoarseLocationLatLng)arg4 address:(id)arg5 extraStorage:(id)arg6 useWebPlaceCard:(char)arg7 muninViewState:(id)arg8 ;
...
+(id)URLForCoordinate:(GEOCoarseLocationLatLng)arg1 address:(id)arg2 label:(id)arg3 extraStorage:(id)arg4 useWebPlaceCard:(char)arg5 ;
