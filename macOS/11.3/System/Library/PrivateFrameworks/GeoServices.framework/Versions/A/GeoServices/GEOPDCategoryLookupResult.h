...
@property (nonatomic,readonly) char hasCategoryLookupParam; 
@property (nonatomic,retain) GEOPDCategoryLookupParameters * categoryLookupParam; 
@property (nonatomic,readonly) char hasCategoryInfo; 
...
-(char)hasCategoryLookupParam;
-(char)hasCategoryInfo;
@end
