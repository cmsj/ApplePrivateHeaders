...
-(id)init;
-(void)_reset;
-(char)shiftCoordinate:(GEOCoarseLocationLatLng)arg1 accuracy:(double)arg2 shiftedCoordinate:(GEOCoarseLocationLatLng*)arg3 shiftedAccuracy:(double*)arg4 ;
...
-(char)shiftLatLng:(id)arg1 accuracy:(double)arg2 shiftedCoordinate:(GEOCoarseLocationLatLng*)arg3 shiftedAccuracy:(double*)arg4 ;
