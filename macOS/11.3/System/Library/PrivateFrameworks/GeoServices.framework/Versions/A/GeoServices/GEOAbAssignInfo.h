...
@property (assign,nonatomic) char hasCreatedAtTimestamp; 
@property (assign,nonatomic) unsigned long long createdAtTimestamp; 
@property (nonatomic,readonly) char hasAbAssignId; 
...
-(void)setHasCreatedAtTimestamp:(char)arg1 ;
-(char)hasCreatedAtTimestamp;
@end
