...
@property (nonatomic,readonly) char hasLocalizedMapsCategoryName; 
@property (nonatomic,retain) GEOLocalizedString * localizedMapsCategoryName; 
@property (nonatomic,readonly) char hasMapsCategoryStyleAttributes; 
...
-(char)hasLocalizedMapsCategoryName;
-(char)hasMapsCategoryStyleAttributes;
@end
