...
-(id)lookupPlaceByIdentifier:(id)arg1 allowExpiredPlace:(char)arg2 placeIsExpired:(char*)arg3 ;
...
-(id)lookupPlaceByHandle:(id)arg1 allowExpiredPlace:(char)arg2 placeIsExpired:(char*)arg3 ;
-(id)lookupPlaceByRequest:(id)arg1 allowExpiredPlace:(char)arg2 placeIsExpired:(char*)arg3 ;
-(void)storePlace:(id)arg1 forRequest:(id)arg2 ;
-(void)evictAllEntries;
-(void)deletePhoneNumberMapping;
-(char)_deleteAndResetDB:(id)arg1 ;
-(char)_validateDBLocaleAndResetIfNecessary;
-(char)_meetsManifestVersionPolicyForPlace:(id)arg1 ;
...
-(id)_lookupPlaceByRequestKey:(id)arg1 allowExpiredPlace:(char)arg2 placeIsExpired:(char*)arg3 ;
...
-(id)lookupPlaceByPhoneNumber:(id)arg1 allowExpiredPlace:(char)arg2 placeIsExpired:(char*)arg3 ;
