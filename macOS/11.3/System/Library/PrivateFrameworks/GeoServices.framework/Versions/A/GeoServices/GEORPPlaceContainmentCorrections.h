...
@property (nonatomic,readonly) char hasParentContainment; 
@property (nonatomic,retain) GEORPContainmentCorrection * parentContainment; 
@property (nonatomic,readonly) char hasChildContainment; 
...
-(char)hasParentContainment;
-(char)hasChildContainment;
@end
