...
@property (assign,nonatomic) char hasCurrentlyFollowing; 
@property (assign,nonatomic) char currentlyFollowing; 
...
-(void)setCurrentlyFollowing:(char)arg1 ;
-(void)setPublisherIds:(unsigned long long*)arg1 count:(unsigned long long)arg2 ;
-(char)currentlyFollowing;
-(void)setHasCurrentlyFollowing:(char)arg1 ;
-(char)hasCurrentlyFollowing;
@end
