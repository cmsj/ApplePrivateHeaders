...
@property (assign,nonatomic) char hasIsTransitOnly; 
@property (assign,nonatomic) char isTransitOnly; 
...
-(char)hasLineMuid;
-(void)setIsTransitOnly:(char)arg1 ;
-(char)isTransitOnly;
-(void)setHasIsTransitOnly:(char)arg1 ;
-(char)hasIsTransitOnly;
@end
