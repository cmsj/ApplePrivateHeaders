...
@property (assign) char useSharing;                                                             //@synthesize useSharing=_useSharing - In the implementation block
@property (assign) char useIDS;                                                                 //@synthesize useIDS=_useIDS - In the implementation block
@property (assign) char embeddedInApp;                                                          //@synthesize embeddedInApp=_embeddedInApp - In the implementation block
...
-(void)setUseSharing:(char)arg1 ;
-(void)setUseIDS:(char)arg1 ;
-(void)setEmbeddedInApp:(char)arg1 ;
...
-(id)_deviceForIncomingDevice:(id)arg1 needsReady:(char)arg2 ;
...
-(char)induceTimeOutIfNeededAndReturnCanProceedWithDevice:(id)arg1 sessionId:(id)arg2 ;
-(char)hasCompletionBlockWithIdentifier:(id)arg1 ;
...
-(void)sessionWithIdentifier:(id)arg1 isActive:(char)arg2 ;
...
-(char)hasRecentlyFinishedSessionWithIdentifier:(id)arg1 ;
