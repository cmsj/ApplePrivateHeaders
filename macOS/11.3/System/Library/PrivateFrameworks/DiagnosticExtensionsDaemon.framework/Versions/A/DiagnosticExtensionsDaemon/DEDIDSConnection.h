...
-(char)sendMessage:(int)arg1 withData:(id)arg2 forIDSDeviceIDs:(id)arg3 isResponse:(BOOL)arg4 ;
-(char)sendMessage:(int)arg1 withData:(id)arg2 forIDSDeviceIDs:(id)arg3 localIDSDeviceIDs:(id)arg4 isResponse:(BOOL)arg5 ;
-(NSObject*<OS_dispatch_queue>)discovery_queue;
-(char)sendMessage:(int)arg1 withData:(id)arg2 forDevices:(id)arg3 isResponse:(BOOL)arg4 ;
-(id)deviceStatusCallback;
-(char)sendMessage:(int)arg1 withData:(id)arg2 forIDSDeviceID:(id)arg3 isResponse:(BOOL)arg4 ;
