...
-(void)_startDiagnosticWithIdentifier:(id)arg1 parameters:(id)arg2 session:(id)arg3 runSetup:(char)arg4 ;
...
-(void)_syncSessionStatusWithSessionID:(id)arg1 withIdentifiers:(char)arg2 ;
-(void)_syncSessionStatusWithSession:(id)arg1 withIdentifiers:(char)arg2 ;
