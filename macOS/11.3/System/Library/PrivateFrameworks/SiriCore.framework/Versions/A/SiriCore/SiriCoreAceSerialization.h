...
+(char)tryParsingPacketWithBytes:(const void*)arg1 length:(unsigned long long)arg2 rawPacket:(SCD_Struct_Si3*)arg3 object:(id*)arg4 bytesRead:(unsigned long long*)arg5 error:(id*)arg6 ;
