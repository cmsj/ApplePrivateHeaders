...
+(id)betweenQueryCriterionWithColumnName:(id)arg1 fromValue:(id)arg2 toValue:(id)arg3 negation:(char)arg4 ;
+(id)inQueryCriterionWithColumnName:(id)arg1 values:(id)arg2 negation:(char)arg3 ;
+(id)isQueryCriterionWithColumnName:(id)arg1 value:(id)arg2 negation:(char)arg3 ;
+(id)isNullQueryCriterionWithColumnName:(id)arg1 negation:(char)arg2 ;
+(id)likeQueryCriterionWithColumnName:(id)arg1 value:(id)arg2 negation:(char)arg3 ;
