...
-(void)setConnectionMetricsFromNWConnectionForDirect:(id)arg1 isMPTCP:(char)arg2 attemptedEndpoints:(id)arg3 withCompletion:(/*^block*/id)arg4 ;
...
-(void)setConnectionMetricsFromStream:(id)arg1 isPop:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
-(void)setConnectionMetricsFromConnection:(id)arg1 isPop:(char)arg2 isMPTCP:(char)arg3 attemptedEndpoints:(id)arg4 completion:(/*^block*/id)arg5 ;
