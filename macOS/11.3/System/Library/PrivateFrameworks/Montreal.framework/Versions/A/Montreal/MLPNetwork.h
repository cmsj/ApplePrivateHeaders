...
@property (assign) char computeLossOnInference;                                  //@synthesize computeLossOnInference=_computeLossOnInference - In the implementation block
...
-(void)setComputeLossOnInference:(char)arg1 ;
