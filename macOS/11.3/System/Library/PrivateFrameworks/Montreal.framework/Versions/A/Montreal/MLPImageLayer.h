...
-(void)updateInputToFirstKernel:(id)arg1 inference:(char)arg2 ;
-(void)updatePrimaryCurrentState:(id)arg1 inference:(char)arg2 ;
...
-(void)updateInputToFirstKernel:(id)arg1 index:(id)arg2 inference:(char)arg3 ;
-(void)updatePrimaryCurrentState:(id)arg1 index:(id)arg2 inference:(char)arg3 ;
-(NSMutableDictionary *)inputImagesToFirstKernel;
-(NSMutableDictionary *)primaryCurrentStates;
-(void)updateInputToSecondKernel:(id)arg1 inference:(char)arg2 ;
-(void)updateSecondaryCurrentState:(id)arg1 inference:(char)arg2 ;
...
-(void)updateInputToSecondKernel:(id)arg1 index:(id)arg2 inference:(char)arg3 ;
-(void)updateSecondaryCurrentState:(id)arg1 index:(id)arg2 inference:(char)arg3 ;
@end
