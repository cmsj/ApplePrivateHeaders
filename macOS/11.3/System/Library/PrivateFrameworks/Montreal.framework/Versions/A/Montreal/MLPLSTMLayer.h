...
-(void)updateSourceMatrix:(id)arg1 inference:(char)arg2 ;
...
-(void)exportWeightsWithWeightMatrix:(id)arg1 weightID:(unsigned long long)arg2 destination:(float*)arg3 recurrent:(char)arg4 ;
