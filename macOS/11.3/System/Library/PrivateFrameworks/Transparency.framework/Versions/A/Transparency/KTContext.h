...
+(char)hasAccountMismatch:(id)arg1 ;
...
-(char)verifyInclusionProofDownload:(id)arg1 error:(id*)arg2 ;
-(unsigned long long)verifyConsistencyProofDownload:(id)arg1 error:(id*)arg2 ;
-(void)failHeadDownload:(id)arg1 failure:(id)arg2 retry:(char)arg3 ;
-(char)verifySMTDownload:(id)arg1 error:(id*)arg2 ;
-(void)failSMTDownload:(id)arg1 failure:(id)arg2 retry:(char)arg3 ;
-(BOOL)verifyRequestDownload:(id)arg1 error:(id*)arg2 ;
-(void)failRequestDownload:(id)arg1 failure:(id)arg2 retry:(char)arg3 ;
...
-(char)runDutyCycleForActivity:(id)arg1 ;
...
-(void)downloadInclusionProofsForRevisions:(id)arg1 downloadType:(unsigned long long)arg2 retry:(char)arg3 error:(id*)arg4 ;
-(char)verifyInclusionProofDownloadRecord:(id)arg1 error:(id*)arg2 ;
-(void)failHeadDownloadRecord:(id)arg1 failure:(id)arg2 retry:(char)arg3 error:(id*)arg4 ;
...
-(void)downloadConsistencyProof:(id*)arg1 retry:(char)arg2 ;
-(void)downloadSMHInclusionProofs:(id*)arg1 retry:(char)arg2 ;
-(void)downloadSTHInclusionProofs:(id*)arg1 retry:(char)arg2 ;
-(void)handleDownloadOfType:(unsigned long long)arg1 retry:(char)arg2 error:(id*)arg3 ;
-(void)handleDownloadOfType:(unsigned long long)arg1 error:(id*)arg2 ;
-(void)handlePendingHeadInclusionProofs:(id*)arg1 ;
-(char)hasTooManyVRFRequests:(id)arg1 ;
...
-(void)downloadQueryForKTRequest:(id)arg1 retry:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
-(char)failExpiredRequest:(id)arg1 error:(id)arg2 ;
...
-(char)checkDeferActivity:(id)arg1 ;
-(void)handleKTRequestDownload:(id)arg1 ;
-(void)verifyRequestDownloadRecord:(id)arg1 error:(id*)arg2 ;
-(void)handleKTRequestDownload:(id)arg1 retry:(char)arg2 ;
-(void)failRequestDownloadRecord:(id)arg1 failure:(id)arg2 retry:(char)arg3 ;
-(void)handlePendingQueryRequests:(id)arg1 error:(id*)arg2 ;
-(void)downloadSMTQueryResponse:(id)arg1 retry:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)verifySMTQueryResponse:(id)arg1 request:(id)arg2 error:(id*)arg3 ;
-(void)failSMTRequest:(id)arg1 failure:(id)arg2 retry:(char)arg3 error:(id*)arg4 ;
-(void)handleSMTInclusionDownload:(id)arg1 request:(id)arg2 ;
-(void)verifySMTDownloadRecord:(id)arg1 error:(id*)arg2 ;
-(void)handleSMTInclusionDownload:(id)arg1 request:(id)arg2 retry:(char)arg3 ;
-(void)failSMTDownloadRecord:(id)arg1 failure:(id)arg2 retry:(char)arg3 error:(id*)arg4 ;
