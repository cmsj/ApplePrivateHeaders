...
+(char)verifyServerLoggableDatas:(id)arg1 againstSyncedLoggableDatas:(id)arg2 error:(id*)arg3 ;
...
+(char)verifyReceivedWitnessesForLoggableDatas:(id)arg1 error:(id*)arg2 ;
-(void)setApplicationID:(NSString *)arg1 ;
-(TransparencyManagedDataStore *)dataStore;
-(void)setDataStore:(TransparencyManagedDataStore *)arg1 ;
-(NSString *)applicationID;
-(KTLogClient *)logClient;
-(char)verifyRevisionLogInclusionProofResponse:(id)arg1 error:(id*)arg2 ;
...
-(char)verifyResponseAccountId:(id)arg1 requestAccountId:(id)arg2 error:(id*)arg3 ;
...
-(void)failSMTsIfOverMMD:(id)arg1 proof:(id)arg2 underlyingError:(id)arg3 errorCode:(long long)arg4 savePendingError:(char)arg5 serverHint:(id)arg6 ;
...
-(char)setInclusionVerifiedState:(unsigned long long)arg1 perApplicationTreeLogEntry:(id)arg2 failure:(id)arg3 error:(id*)arg4 ;
-(char)setInclusionVerifiedState:(unsigned long long)arg1 topLevelTreeLogEntry:(id)arg2 failure:(id)arg3 error:(id*)arg4 ;
-(char)setInclusionVerifiedState:(unsigned long long)arg1 logEntry:(id)arg2 failure:(id)arg3 error:(id*)arg4 ;
