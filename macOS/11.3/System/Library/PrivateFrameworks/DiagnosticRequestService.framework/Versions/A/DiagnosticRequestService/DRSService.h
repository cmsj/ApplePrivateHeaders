...
-(char)_connectionHasEntitlement:(id)arg1 ;
...
-(void)_sendAdminRequestReply:(char)arg1 rejectionReason:(const char*)arg2 requestMessage:(id)arg3 ;
-(char)_saveDampeningManager;
-(NSObject*<OS_dispatch_queue>)postReceiptWorkQueue;
-(void)_addRequestToDAFileList:(id)arg1 ;
-(void)_postReceiptProcessingWork:(id)arg1 wasAccepted:(char)arg2 ;
...
-(char)_persistEnableLogGatheringResult:(id)arg1 workingContext:(id)arg2 ;
