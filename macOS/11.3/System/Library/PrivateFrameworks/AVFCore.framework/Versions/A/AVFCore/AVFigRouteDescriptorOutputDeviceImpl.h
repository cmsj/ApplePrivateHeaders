...
-(id)initWithRouteDescriptor:(CFDictionaryRef)arg1 routeDiscoverer:(OpaqueFigRouteDiscovererRef)arg2 volumeController:(OpaqueFigVolumeControllerStateRef)arg3 routingContextFactory:(id)arg4 useRouteConfigUpdatedNotification:(char)arg5 ;
