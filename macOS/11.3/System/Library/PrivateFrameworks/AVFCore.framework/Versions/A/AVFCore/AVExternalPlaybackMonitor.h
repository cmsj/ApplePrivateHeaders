...
@property (getter=isAirPlayVideoActive,readonly) char airPlayVideoActive; 
@property (getter=isAirPlayVideoPlaying,readonly) char airPlayVideoPlaying; 
+(void)initialize;
+(id)longFormVideoExternalPlaybackMonitor;
-(void)dealloc;
-(id)description;
-(char)isAirPlayVideoActive;
-(char)isAirPlayVideoPlaying;
@end
