...
-(char)_hasXOverlap:(CGRect)arg1 obj2:(CGRect)arg2 ;
-(double)_getXOverlap:(CGRect)arg1 obj2:(CGRect)arg2 ;
-(char)_hasYOverlap:(CGRect)arg1 obj2:(CGRect)arg2 ;
...
-(char)_allTabGroupsHaveSingleSubfeature:(id)arg1 ;
-(char)_shouldBeTabBar:(char)arg1 groupedTabButtons:(id)arg2 ;
