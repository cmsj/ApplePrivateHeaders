...
-(char)_fetchEventCanBeManaged:(unsigned long long)arg1 ;
...
-(void)_notifyObserversDidFetchElementsForEvent:(unsigned long long)arg1 foundNewElements:(char)arg2 ;
...
-(id)initWithDelegate:(id)arg1 fetchEvents:(unsigned long long)arg2 enableEventManagement:(char)arg3 enableGrouping:(char)arg4 shouldIncludeNonScannerElements:(char)arg5 beginEnabled:(char)arg6 ;
