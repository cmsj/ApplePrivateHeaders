...
-(void)queryUsageDuringInterval:(id)arg1 partitionInterval:(double)arg2 focalOnly:(char)arg3 completionHandler:(/*^block*/id)arg4 ;
-(BMCoreDuetStream *)duetStream;
-(id)_getBundleIdentiersFromApplicationUsageEvents:(id)arg1 videoUsageEvents:(id)arg2 interval:(id)arg3 referenceDate:(id)arg4 focalOnly:(char)arg5 ;
-(id)_getWebDomainsFromWebUsageEvents:(id)arg1 videoUsageEvents:(id)arg2 interval:(id)arg3 referenceDate:(id)arg4 focalOnly:(char)arg5 ;
-(void)_computeUsageWithDisplayBacklitEvents:(id)arg1 applicationUsageEvents:(id)arg2 webUsageEvents:(id)arg3 nowPlayingEvents:(id)arg4 videoUsageEvents:(id)arg5 notificationEvents:(id)arg6 categoryByBundleIdentifier:(id)arg7 categoryByWebDomain:(id)arg8 interval:(id)arg9 partitionInterval:(double)arg10 referenceDate:(id)arg11 focalOnly:(char)arg12 completionHandler:(/*^block*/id)arg13 ;
-(id)_computeScreenTime:(char)arg1 withEvents:(id)arg2 intersectingScreenTimeIntervalsByDevice:(id*)arg3 longestSessionByDevice:(id*)arg4 timeZoneByDevice:(id)arg5 lastEventDateByDevice:(id)arg6 partition:(id)arg7 referenceDate:(id)arg8 ;
-(id)_computeApplicationUsageWithEvents:(id)arg1 unboundApplicationUsageIntervalsByDevice:(id*)arg2 timeZoneByDevice:(id)arg3 lastEventDateByDevice:(id)arg4 categoryUsageIntervalsByDevice:(id)arg5 aggregatedApplicationUsageIntervalsByDevice:(id)arg6 categoryByBundleIdentifier:(id)arg7 partition:(id)arg8 referenceDate:(id)arg9 focalOnly:(char)arg10 ;
...
-(void)_updateNotificationsWithEvent:(id)arg1 bundleIdentifier:(id)arg2 trustedNotification:(char)arg3 deviceIdentifier:(id)arg4 notificationsByDevice:(id)arg5 timeZoneByDevice:(id)arg6 lastEventDateByDevice:(id)arg7 ;
