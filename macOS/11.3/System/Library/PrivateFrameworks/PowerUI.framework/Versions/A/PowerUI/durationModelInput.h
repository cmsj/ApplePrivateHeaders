...
@property (assign,nonatomic) double weekday_med_dur_1;                 //@synthesize weekday_med_dur_1=_weekday_med_dur_1 - In the implementation block
@property (assign,nonatomic) double weekday_med_dur_2;                 //@synthesize weekday_med_dur_2=_weekday_med_dur_2 - In the implementation block
@property (assign,nonatomic) double weekday_med_dur_4;                 //@synthesize weekday_med_dur_4=_weekday_med_dur_4 - In the implementation block
@property (assign,nonatomic) double weekday_med_dur_8;                 //@synthesize weekday_med_dur_8=_weekday_med_dur_8 - In the implementation block
@property (assign,nonatomic) double weekday_med_dur_24;                //@synthesize weekday_med_dur_24=_weekday_med_dur_24 - In the implementation block
@property (assign,nonatomic) double weekday_std_dur_4;                 //@synthesize weekday_std_dur_4=_weekday_std_dur_4 - In the implementation block
