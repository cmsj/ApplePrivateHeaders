...
-(char)deviceHasAtLeastOneLongConnection:(id)arg1 forReferenceDate:(id)arg2 ;
...
-(id)getBTConnectionEventsUpTo:(id)arg1 withMinimumDuration:(double)arg2 withLimit:(unsigned)arg3 ascending:(char)arg4 forDevice:(id)arg5 ;
-(id)chargingDecisionForDate:(id)arg1 forAudioAccessory:(id)arg2 ;
-(char)isSufficientDataAvailableForEngagementForDevice:(id)arg1 ;
