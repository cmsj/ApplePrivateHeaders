...
* Image Source: /System/Library/PrivateFrameworks/MobileStorage.framework/Versions/A/MobileStorage
...
@interface PersonalizedImage : NSObject {
	...
	char _useCredentials;
	char _skipLoadingLaunchDaemons;
...
@property (assign,nonatomic) char useCredentials;                                 //@synthesize useCredentials=_useCredentials - In the implementation block
...
@property (assign,nonatomic) char skipLoadingLaunchDaemons;                       //@synthesize skipLoadingLaunchDaemons=_skipLoadingLaunchDaemons - In the implementation block
...
-(char)initializeDeviceAttributes:(id*)arg1 ;
-(char)initializeImageProperties:(id*)arg1 ;
...
-(void)setUseCredentials:(char)arg1 ;
...
-(char)skipLoadingLaunchDaemons;
-(void)setSkipLoadingLaunchDaemons:(char)arg1 ;
@end
