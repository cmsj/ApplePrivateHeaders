...
@property (assign,nonatomic) char internalBuildOnly;                                       //@synthesize internalBuildOnly=_internalBuildOnly - In the implementation block
...
+(id)artifactFromCKRecordResult:(id)arg1 withNamespaceDescriptorProvider:(id)arg2 container:(int)arg3 teamId:(id)arg4 paths:(id)arg5 requireDeploymentId:(char)arg6 ;
-(id)init;
-(id)data;
-(char)isValid;
...
-(char)hasNamespacesAvailableForExperimentWithDatabase:(id)arg1 ;
-(int)experimentType;
...
-(char)internalBuildOnly;
-(void)setInternalBuildOnly:(char)arg1 ;
...
-(char)isCompatibleWithNamespaceDescriptorProvider:(id)arg1 ;
-(char)saveWithDatabase:(id)arg1 paths:(id)arg2 ;
@end
