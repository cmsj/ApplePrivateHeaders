...
-(void)_fetchExperimentsWithCursor:(id)arg1 withNamespaceNames:(id)arg2 sinceDate:(id)arg3 fetchRollbacksOnly:(char)arg4 options:(id)arg5 resultsHandler:(/*^block*/id)arg6 ;
