...
-(char)_cleanupExperimentWithDeployment:(id)arg1 paths:(id)arg2 ;
-(char)_cleanupTreatmentWithTreatmentId:(id)arg1 paths:(id)arg2 ;
...
-(char)_cleanupUnusedContentWithContext:(id)arg1 ;
@end
