...
-(id)initWithTaskAttribution:(id)arg1 isRepeatedInstance:(char)arg2 ;
-(char)_experimentsExistUsingContext:(id)arg1 ;
-(char)_shouldScheduleUsingContext:(id)arg1 withTaskQueue:(id)arg2 ;
