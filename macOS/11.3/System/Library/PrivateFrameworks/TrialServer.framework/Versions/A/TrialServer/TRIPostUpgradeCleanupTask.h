...
-(char)_validateRolloutDescriptorsWithNamespaceCompatibilityVersions:(id)arg1 usingPaths:(id)arg2 ;
-(char)_validateExperimentDescriptorsWithNamespaceCompatibilityVersions:(id)arg1 database:(id)arg2 ;
-(char)_validateDynamicNamespaceRolloutsWithDatabase:(id)arg1 usingPaths:(id)arg2 ;
