...
+(id)taskWithStartingFetchDateOverride:(id)arg1 namespaceNames:(id)arg2 taskAttributing:(id)arg3 rollbacksOnly:(char)arg4 ;
...
-(id)initWithStartingFetchDateOverride:(id)arg1 namespaceNames:(id)arg2 taskAttributing:(id)arg3 rollbacksOnly:(char)arg4 ;
...
-(char)_processExperiment:(id)arg1 experimentDatabase:(id)arg2 namespaceDatabase:(id)arg3 taskQueue:(id)arg4 paths:(id)arg5 ;
-(void)updateStatusForNamespacesWithContext:(id)arg1 ;
-(char)_checkIfAnyTreatmentPresent:(id)arg1 usingContext:(id)arg2 ;
-(id)initWithStartingFetchDateOverride:(id)arg1 container:(int)arg2 team:(id)arg3 rollbacksOnly:(char)arg4 withNamespaceNames:(id)arg5 ;
