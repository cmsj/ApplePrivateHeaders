...
-(void)resetWithSamplingRate:(unsigned)arg1 language:(id)arg2 taskType:(id)arg3 userId:(id)arg4 sessionId:(id)arg5 deviceId:(id)arg6 farField:(char)arg7 audioSource:(id)arg8 maxAudioBufferSizeSeconds:(unsigned)arg9 ;
