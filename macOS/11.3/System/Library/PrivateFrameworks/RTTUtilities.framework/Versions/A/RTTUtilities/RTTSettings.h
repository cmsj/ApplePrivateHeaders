...
@property (assign,nonatomic) char continuityRTTIsSupported; 
@property (assign,nonatomic) char supportsRelayCalling; 
@property (assign,nonatomic) char isRelayCallingEnabled; 
...
-(void)setIsRelayCallingEnabled:(char)arg1 ;
-(void)setContinuityRTTIsSupported:(char)arg1 ;
