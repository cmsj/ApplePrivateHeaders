...
@property (assign,getter=isStreamOutputDone,nonatomic) char streamOutputDone;                  //@synthesize streamOutputDone=_streamOutputDone - In the implementation block
...
-(void)setStreamOutputDone:(char)arg1 ;
