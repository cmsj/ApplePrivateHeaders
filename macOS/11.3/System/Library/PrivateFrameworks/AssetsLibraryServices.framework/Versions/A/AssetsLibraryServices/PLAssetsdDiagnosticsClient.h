...
-(char)dumpCloudPhotosStatusIncludingDaemon:(char)arg1 error:(id*)arg2 ;
-(char)dumpPhotoAnalysisStatusWithOutputFilePath:(id*)arg1 error:(id*)arg2 ;
-(char)incompleteRestoreProcesses:(id*)arg1 error:(id*)arg2 ;
-(char)getPhotosXPCEndpoint:(id*)arg1 error:(id*)arg2 ;
