...
-(void)addIsFavoriteQuery:(char)arg1 ;
-(void)addIsHiddenQuery:(char)arg1 ;
-(void)addIsAdjustedQuery:(char)arg1 ;
-(void)addIsRawQuery:(char)arg1 ;
-(void)addAssetTypeQuery:(int)arg1 exclude:(char)arg2 ;
-(void)addIsInAlbumQuery:(id)arg1 ;
-(void)addIsInAnyAlbumQuery;
-(void)addIsReferencedMediaQuery:(char)arg1 ;
-(char)_isValidDateKey:(int)arg1 ;
-(void)addIsDateQueryKey:(int)arg1 withDate:(id)arg2 exclude:(char)arg3 ;
-(void)addIsAfterDateQueryKey:(int)arg1 withDate:(id)arg2 ;
-(void)addIsBeforeDateQueryKey:(int)arg1 withDate:(id)arg2 ;
-(void)addInTheLastDaysQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(char)arg3 ;
-(void)addInTheLastWeeksQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(char)arg3 ;
-(void)addInTheLastMonthsQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(char)arg3 ;
-(void)addInTheLastYearsQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(char)arg3 ;
-(void)addInTheLastSecondsQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(char)arg3 ;
-(void)_addDateUnitQueryForKey:(int)arg1 withValue:(id)arg2 withType:(int)arg3 withUnit:(int)arg4 exclude:(char)arg5 ;
...
-(char)_isValidStringComparator:(int)arg1 ;
...
-(char)_validIsEmptyQueryKey:(int)arg1 ;
-(void)addIsEmptyQueryForKey:(int)arg1 isEmpty:(char)arg2 ;
-(char)_isValidNumericComparator:(int)arg1 ;
...
-(void)addHasLocationQuery:(char)arg1 ;
...
-(void)addKeywordQuery:(id)arg1 exclude:(char)arg2 ;
