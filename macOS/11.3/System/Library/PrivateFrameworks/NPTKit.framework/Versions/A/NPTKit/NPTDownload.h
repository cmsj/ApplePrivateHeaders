...
-(id)initWithNetworkActivityParent:(id)arg1 concurrentStreams:(unsigned long long)arg2 timedDownloadLength:(unsigned long long)arg3 endWhenStable:(char)arg4 stopAtFileSize:(char)arg5 ;
