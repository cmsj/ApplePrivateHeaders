...
-(void)startWithNumberOfPings:(unsigned long long)arg1 forcingIPv4:(char)arg2 forcingIPv6:(char)arg3 completion:(/*^block*/id)arg4 ;
-(void)sendPing;
...
-(void)startWithNumberOfPings:(unsigned long long)arg1 forcingIPv4:(char)arg2 forcingIPv6:(char)arg3 ;
@end
