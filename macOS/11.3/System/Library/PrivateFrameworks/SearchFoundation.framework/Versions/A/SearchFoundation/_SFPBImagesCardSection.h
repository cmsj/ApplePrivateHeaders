...
@property (assign,nonatomic) char borderless; 
...
@property (assign,nonatomic) char borderless;                                 //@synthesize borderless=_borderless - In the implementation block
@property (nonatomic,readonly) NSData * jsonData; 
