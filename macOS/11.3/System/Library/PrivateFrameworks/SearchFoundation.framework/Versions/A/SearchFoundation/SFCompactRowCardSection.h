...
@property (assign,nonatomic) char isSubtitleDetatched; 
...
-(int)separatorStyle;
-(char)isSubtitleDetatched;
-(void)setIsSubtitleDetatched:(char)arg1;
...
@property (assign,nonatomic) char isSubtitleDetatched;                               //@synthesize isSubtitleDetatched=_isSubtitleDetatched - In the implementation block
