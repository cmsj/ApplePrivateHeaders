...
@property (assign,nonatomic) char playbackRouteUniqueIdentifierIsEncrypted; 
...
-(void)setPlaybackRouteUniqueIdentifierIsEncrypted:(char)arg1;
-(void)setPlaybackBundleIdentifier:(id)arg1;
-(NSString *)playbackRouteUniqueIdentifier;
-(char)playbackRouteUniqueIdentifierIsEncrypted;
...
@interface _SFPBMediaRemoteControlCardSection : PBCodable <_SFPBMediaRemoteControlCardSection, NSSecureCoding> {
	...
	char _playbackRouteUniqueIdentifierIsEncrypted;
	int _separatorStyle;
...
@property (assign,nonatomic) char playbackRouteUniqueIdentifierIsEncrypted;              //@synthesize playbackRouteUniqueIdentifierIsEncrypted=_playbackRouteUniqueIdentifierIsEncrypted - In the implementation block
