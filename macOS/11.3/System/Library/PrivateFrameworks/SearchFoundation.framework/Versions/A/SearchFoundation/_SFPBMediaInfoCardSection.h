...
@property (assign,nonatomic) char isMediaContainer; 
...
-(void)setIsMediaContainer:(char)arg1;
...
@property (assign,nonatomic) char isMediaContainer;                                //@synthesize isMediaContainer=_isMediaContainer - In the implementation block
