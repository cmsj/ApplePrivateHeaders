...
-(char)registerSchema:(id)arg1 error:(out id*)arg2 ;
-(char)_registerSchema:(id)arg1 error:(out id*)arg2 ;
-(char)_registerVersion:(id)arg1 withOriginalIdentifier:(id)arg2 error:(out id*)arg3 ;
-(char)registerSchemas:(id)arg1 error:(out id*)arg2 ;
