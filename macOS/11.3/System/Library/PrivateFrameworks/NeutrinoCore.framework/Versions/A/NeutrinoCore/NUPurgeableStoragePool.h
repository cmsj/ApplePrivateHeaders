...
-(id)newStorageWithMinimumSize:(SCD_Struct_NU8)arg1 format:(id)arg2 ;
-(id)newStorageWithSize:(SCD_Struct_NU8)arg1 format:(id)arg2 exactMatch:(char)arg3 ;
-(id)_allocateStorageWithSize:(SCD_Struct_NU8)arg1 format:(id)arg2 ;
-(void)_reclaimSharedStorages;
-(id)_storageFromPoolWithSize:(SCD_Struct_NU8)arg1 format:(id)arg2 exactMatch:(char)arg3 ;
