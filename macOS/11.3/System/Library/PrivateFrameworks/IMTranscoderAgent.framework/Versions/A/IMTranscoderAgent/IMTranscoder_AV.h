...
-(void)_transcodeVideoAsync:(id)arg1 target:(long long)arg2 maxBytes:(unsigned long long)arg3 removeAlpha:(char)arg4 preserveHEVC:(char)arg5 userInfo:(id)arg6 completionHandler:(/*^block*/id)arg7 ;
