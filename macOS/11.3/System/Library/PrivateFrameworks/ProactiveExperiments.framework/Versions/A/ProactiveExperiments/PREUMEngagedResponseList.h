...
-(void)setHasEngagedItem:(char)arg1 ;
-(char)hasEngagedItem;
-(void)setTimeToTap:(unsigned long long)arg1 ;
-(void)setHasTimeToTap:(char)arg1 ;
-(char)hasTimeToTap;
