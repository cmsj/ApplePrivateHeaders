...
@property (assign) char metaDataDirty;                                     //@synthesize metaDataDirty=_metaDataDirty - In the implementation block
...
@property (nonatomic,readonly) char hasDirtyLock;                          //@synthesize hasDirtyLock=_hasDirtyLock - In the implementation block
@property (readonly) char isOpened;                                        //@synthesize opened=_opened - In the implementation block
...
-(char)doWriting:(/*^block*/id)arg1 ;
-(void)discardThumbnailDataBatchForReset:(id)arg1 ;
-(float)fragmentation;
-(id)reserveBufferWithLength:(unsigned long long)arg1 ;
-(char)validateReservedBuffer:(id)arg1 ;
-(char)discardReservedBuffer:(id)arg1 ;
-(void)_createDirtyLockInformDelegate:(char)arg1 ;
-(char)metaDataDirty;
-(NSString *)metaDataFilePath;
-(void)setMetaDataDirty:(char)arg1 ;
-(void)_removeDirtyLock;
-(char)_setThumbnailData:(id)arg1 ;
...
-(id)enumeratorForAllFilesUbiquitousFiles:(char)arg1 withExtraInfo:(char)arg2 ;
