...
@property (assign) char isCorrupted;                      //@synthesize isCorrupted=_isCorrupted - In the implementation block
...
-(id)newDataFromColumn:(int)arg1 inStatement:(sqlite3_stmtRef)arg2 copyBytes:(char)arg3 ;
-(id)newStringFromColumn:(int)arg1 inStatement:(sqlite3_stmtRef)arg2 uniqueInStringTable:(id)arg3 ;
-(void)do:(/*^block*/id)arg1 ;
-(char)isOpened;
-(char)stepStatement:(sqlite3_stmtRef)arg1 didReturnData:(char*)arg2 ;
-(char)isCorrupted;
...
-(void)executeWithCallback:(/*function pointer*/void*)arg1 context:(void*)arg2 rollbackOnError:(char)arg3 sql:(const char*)arg4 arguments:(_va_list_tag*)arg5 ;
-(id)_crapPath;
