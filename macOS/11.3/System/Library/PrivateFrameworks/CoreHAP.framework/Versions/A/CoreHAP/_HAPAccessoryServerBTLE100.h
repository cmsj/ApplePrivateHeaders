...
+(id)serializeCharacteristicWriteValue:(id)arg1 characteristicFormat:(unsigned long long)arg2 supportsAdditonalAuthentication:(char)arg3 authenticationData:(id)arg4 error:(id*)arg5 ;
+(id)deserializeCharacteristicReadData:(id)arg1 characteristicFormat:(unsigned long long)arg2 supportsAdditonalAuthentication:(char)arg3 error:(id*)arg4 ;
...
-(void)_enqueueOperation:(long long)arg1 identifier:(id)arg2 publicKey:(id)arg3 admin:(char)arg4 queue:(id)arg5 completion:(/*^block*/id)arg6 ;
