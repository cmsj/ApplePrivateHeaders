...
@property (assign,getter=isVerifying,nonatomic) char verifying;                                        //@synthesize verifying=_verifying - In the implementation block
...
+(char)shouldVerifyCharacteristic:(id)arg1 ;
-(void)invalidate;
-(id)uniqueIdentifier;
-(id)shortDescription;
