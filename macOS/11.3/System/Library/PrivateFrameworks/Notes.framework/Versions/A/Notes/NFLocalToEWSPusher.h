...
-(char)_addNoteToRemote:(id)arg1 inFolder:(id)arg2 accountProxy:(id)arg3 responseCode:(long long*)arg4 ;
-(char)_deleteNoteFromRemoteWithId:(id)arg1 accountProxy:(id)arg2 responseCode:(long long*)arg3 ;
-(char)_addFolderToRemote:(id)arg1 inParent:(id)arg2 accountProxy:(id)arg3 responseCode:(long long*)arg4 ;
@end
