...
@class NSString, NSMutableSet, NSMachPort, NSInvocation, ICNFMCError, NSArray;
...
@property (nonatomic,readonly) double unifiedFractionDone; 
...
-(id<ICNFMCActivityTarget>)activityTarget;
-(void)setActivityTarget:(id<ICNFMCActivityTarget>)arg1 ;
