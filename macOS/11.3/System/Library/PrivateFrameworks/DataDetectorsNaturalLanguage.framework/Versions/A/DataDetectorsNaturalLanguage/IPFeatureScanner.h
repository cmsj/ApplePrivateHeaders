...
-(char)isDateRoundedTo5Minutes:(id)arg1 ;
...
-(id)decoratedTitleFromEventType:(id)arg1 title:(id)arg2 sender:(id)arg3 recipients:(id)arg4 isSent:(char)arg5 ;
-(double)confidenceForEvent:(id)arg1 baseConfidence:(double)arg2 ;
-(id)analyzeFeatures:(id)arg1 messageUnit:(id)arg2 checkPolarity:(char)arg3 polarity:(unsigned long long)arg4 ;
-(char)isEventProposalOrConfirmationFromFeatures:(id)arg1 fromFeatureAtIndex:(unsigned long long)arg2 messageUnit:(id)arg3 eventIsTenseDependent:(char)arg4 extractedFromSubject:(char)arg5 extractedPolarity:(unsigned long long*)arg6 polarityInfluencedByIpsosPlistRef:(char*)arg7 ;
...
-(char)dataFeatures:(id)arg1 containDateOlderThan:(id)arg2 preciseTimeOnly:(char)arg3 ;
