...
@property (assign) char followProposal;                                                           //@synthesize followProposal=_followProposal - In the implementation block
...
-(void)scanEventsInMessageUnits:(id)arg1 contextMessageUnits:(id)arg2 synchronously:(char)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)setFollowProposal:(char)arg1 ;
