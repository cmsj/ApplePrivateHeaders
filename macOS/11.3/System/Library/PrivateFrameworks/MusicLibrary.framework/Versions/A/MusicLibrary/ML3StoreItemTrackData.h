...
-(char)_platformMetadataItemIsMusicKind:(id)arg1 ;
-(char)_platformMetadataItemIsAUCKind:(id)arg1 ;
-(char)_platformMetadataItemIsVideoKind:(id)arg1 ;
-(char)_platformMetadataItemIsMusicVideoKind:(id)arg1 ;
-(char)_platformMetadataItemIsAUCVideoKind:(id)arg1 ;
-(char)_platformMetadataItemIsTVShowKind:(id)arg1 ;
-(char)_platformMetadataItemIsMovieKind:(id)arg1 ;
...
-(char)_platformMetadataItemIsSongKind:(id)arg1 ;
-(char)_platformMetadataItem:(id)arg1 matchesKind:(id)arg2 ;
-(char)_platformMetadataItemIsAUCAudioKind:(id)arg1 ;
