...
+(char)_visitObject:(id)arg1 handleBoolean:(/*^block*/id)arg2 handleInt64:(/*^block*/id)arg3 handleFloat64:(/*^block*/id)arg4 handleTimeInterval:(/*^block*/id)arg5 handleData:(/*^block*/id)arg6 handleString:(/*^block*/id)arg7 handleDict:(/*^block*/id)arg8 handleArray:(/*^block*/id)arg9 handleOther:(/*^block*/id)arg10 ;
+(char)_scanPlist:(id)arg1 recursionDepth:(unsigned long long)arg2 sizeUpperBound:(unsigned long long*)arg3 allDictionaryKeys:(id)arg4 error:(id*)arg5 ;
