...
+(char)isLazyPlistLikelyContainedInData:(id)arg1 format:(unsigned long long*)arg2 ;
+(char)isLazyPlistLikelyContainedInFileAtPath:(id)arg1 format:(unsigned long long*)arg2 ;
