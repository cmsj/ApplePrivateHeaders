...
@property (assign,getter=isPhysicalFormatSettable,nonatomic) char physicalFormatSettable;              //@synthesize physicalFormatSettable=_physicalFormatSettable - In the implementation block
...
@property (assign,nonatomic) char isTapStream; 
...
-(char)deviceChangedToSamplingRate:(double)arg1 ;
-(char)isTapStream;
-(void)setIsTapStream:(char)arg1 ;
...
-(void)setPhysicalFormatSettable:(char)arg1 ;
