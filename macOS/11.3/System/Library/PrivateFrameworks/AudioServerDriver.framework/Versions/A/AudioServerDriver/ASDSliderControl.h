...
+(id)sliderControlWithValue:(unsigned)arg1 andRange:(ASDSliderRange)arg2 isSettable:(char)arg3 forElement:(unsigned)arg4 inScope:(unsigned)arg5 withPlugin:(id)arg6 ;
...
-(id)initWithValue:(unsigned)arg1 andRange:(ASDSliderRange)arg2 isSettable:(char)arg3 forElement:(unsigned)arg4 inScope:(unsigned)arg5 withPlugin:(id)arg6 andObjectClassID:(unsigned)arg7 ;
-(id)initWithValue:(unsigned)arg1 andRange:(ASDSliderRange)arg2 isSettable:(char)arg3 forElement:(unsigned)arg4 inScope:(unsigned)arg5 withPlugin:(id)arg6 ;
-(unsigned)value;
