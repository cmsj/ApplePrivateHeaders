...
@class NSMapTable, FUStyleProvider, FUFlight, FUFlightLeg, FULabel, FUSeparator, NSLayoutConstraint, FUFlightProgressView, NSButton;
...
@property (__weak) NSButton * flightButton;                                                 //@synthesize flightButton=_flightButton - In the implementation block
...
@property (__weak) FUFlightProgressView * progressView;                                     //@synthesize progressView=_progressView - In the implementation block
@property (assign,nonatomic) unsigned long long style;                                      //@synthesize style=_style - In the implementation block
+(id)flightViewForStyle:(unsigned long long)arg1 compact:(char)arg2 ;
-(void)dealloc;
...
-(FUFlightLeg *)leg;
-(FUFlight *)flight;
-(FUFlightProgressView *)progressView;
-(void)setProgressView:(FUFlightProgressView *)arg1 ;
...
-(NSButton *)flightButton;
-(void)updateForFollowupContent:(char)arg1 ;
...
-(void)addDateTimeAttributesToString:(id)arg1 striked:(char)arg2 alignment:(long long)arg3 ;
-(void)updateDateTimeForDeparture:(char)arg1 ;
-(void)setFlight:(id)arg1 legIndex:(unsigned long long)arg2 multiFlights:(char)arg3 spotlightMode:(char)arg4 ;
...
-(void)setFlightButton:(NSButton *)arg1 ;
@end
