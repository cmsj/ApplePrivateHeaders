...
@property (assign,getter=isBackgroundRadioRequest,nonatomic) char backgroundRadioRequest;                                      //@synthesize backgroundRadioRequest=_backgroundRadioRequest - In the implementation block
...
-(char)isBackgroundRadioRequest;
-(void)setBackgroundRadioRequest:(char)arg1 ;
