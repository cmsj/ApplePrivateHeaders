...
@interface ICUserIdentity : NSObject <ML3AccountInformationProviding, NSCopying, NSSecureCoding> {
	...
	char _allowsDelegation;
	char _allowsAccountEstablishment;
	long long _type;
...
@property (nonatomic,readonly) char allowsDelegation;                         //@synthesize allowsDelegation=_allowsDelegation - In the implementation block
@property (nonatomic,readonly) char allowsAccountEstablishment;               //@synthesize allowsAccountEstablishment=_allowsAccountEstablishment - In the implementation block
...
-(char)isEqualToIdentity:(id)arg1 inStore:(id)arg2 ;
-(id)identityAllowingDelegation:(char)arg1 ;
-(id)identityAllowingEstablishment:(char)arg1 ;
...
-(void)_performEncodingTaskUsingSpecificIdentityStore:(id)arg1 encodingHandler:(/*^block*/id)arg2 ;
-(char)_isComparableUsingResolvedDSID;
-(id)_resolvedDSIDUsingSpecificIdentityStore:(id)arg1 ;
-(char)allowsDelegation;
-(char)allowsAccountEstablishment;
@end
