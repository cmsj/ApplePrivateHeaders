...
+(void)_issueSpaceCheckCompletion:(/*^block*/id)arg1 withCompletionQueue:(id)arg2 haveEnoughSpace:(char)arg3 haveTotalRequired:(char)arg4 freeSpaceAvailable:(unsigned long long)arg5 error:(id)arg6 releasingTransaction:(id)arg7 ;
+(void)checkAvailableFreeSpace:(unsigned long long)arg1 checkingFromBase:(id)arg2 withIdentifier:(id)arg3 userInitiated:(char)arg4 completion:(/*^block*/id)arg5 ;
