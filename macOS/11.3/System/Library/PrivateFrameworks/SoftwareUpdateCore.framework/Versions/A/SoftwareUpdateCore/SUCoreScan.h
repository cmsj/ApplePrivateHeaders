...
@interface SUCoreScan : NSObject {
	...
	char _cancelingOperation;
	char _downloadDocumentation;
	char _slowReleaseScanPerformed;
	int _operation;
...
@property (assign,nonatomic) char cancelingOperation;                                           //@synthesize cancelingOperation=_cancelingOperation - In the implementation block
...
@property (assign,nonatomic) char downloadDocumentation;                                        //@synthesize downloadDocumentation=_downloadDocumentation - In the implementation block
...
@property (assign,nonatomic) char slowReleaseScanPerformed;                                     //@synthesize slowReleaseScanPerformed=_slowReleaseScanPerformed - In the implementation block
...
-(void)_scanCompleteFoundPrimary:(id)arg1 foundSecondary:(id)arg2 majorPrimary:(id)arg3 majorSecondary:(id)arg4 minorPrimary:(id)arg5 minorSecondary:(id)arg6 clearingOperation:(char)arg7 error:(id)arg8 ;
-(MAAsset *)secondaryUpdateAsset;
-(MAAsset *)primaryUpdateAsset;
-(void)_invalidOperation:(id)arg1 ;
-(char)cancelingOperation;
...
-(void)_checkEndComplete:(/*^block*/id)arg1 scanPolicy:(id)arg2 primary:(id)arg3 secondary:(id)arg4 error:(id)arg5 clearingTransaction:(char)arg6 ;
...
-(void)_checkMajorMinorEndComplete:(/*^block*/id)arg1 scanPolicy:(id)arg2 majorPrimary:(id)arg3 majorSecondary:(id)arg4 minorPrimary:(id)arg5 minorSecondary:(id)arg6 error:(id)arg7 clearingTransaction:(char)arg8 ;
-(void)setCheckMajorMinorCompletion:(id)arg1 ;
-(void)_checkSlowReleaseEndComplete:(/*^block*/id)arg1 scanPolicy:(id)arg2 primary:(id)arg3 secondary:(id)arg4 error:(id)arg5 clearingTransaction:(char)arg6 ;
-(void)setCheckSlowReleaseCompletion:(id)arg1 ;
-(void)_verifyEndComplete:(/*^block*/id)arg1 scanPolicy:(id)arg2 active:(id)arg3 primary:(id)arg4 secondary:(id)arg5 error:(id)arg6 clearingTransaction:(char)arg7 ;
...
-(void)_collectEndComplete:(/*^block*/id)arg1 scanPolicy:(id)arg2 active:(id)arg3 error:(id)arg4 clearingTransaction:(char)arg5 ;
-(NSObject*<OS_os_transaction>)scanCollectTransaction;
-(void)setScanCollectTransaction:(NSObject*<OS_os_transaction>)arg1 ;
-(void)setDownloadDocumentation:(char)arg1 ;
-(void)setCollectCompletion:(id)arg1 ;
-(void)_locateEndComplete:(/*^block*/id)arg1 scanPolicy:(id)arg2 primary:(id)arg3 secondary:(id)arg4 error:(id)arg5 clearingTransaction:(char)arg6 ;
...
-(void)_cancelEndComplete:(/*^block*/id)arg1 error:(id)arg2 clearingTransaction:(char)arg3 ;
-(NSObject*<OS_os_transaction>)scanCancelTransaction;
-(void)setScanCancelTransaction:(NSObject*<OS_os_transaction>)arg1 ;
-(void)setCancelingOperation:(char)arg1 ;
-(int)operationSPIType;
-(id)checkCompletion;
-(id)checkMajorMinorCompletion;
-(char)_decideAndProcessSlowReleaseUpdateFoundPrimary:(id)arg1 foundSecondary:(id)arg2 error:(id)arg3 ;
-(id)verifyCompletion;
...
-(void)_operationCompleting:(id)arg1 error:(id)arg2 clearingTransaction:(char)arg3 ;
-(NSObject*<OS_dispatch_queue>)clientCompletionQueue;
-(void)_trackScanEnd:(id)arg1 withResult:(long long)arg2 withError:(id)arg3 ;
-(char)slowReleaseScanPerformed;
-(char)_shouldPerformAlternateScanFromFoundDescriptor:(id)arg1 policy:(id)arg2 ;
...
-(void)setSlowReleaseScanPerformed:(char)arg1 ;
...
-(void)collectDocumentationMetadataWithPolicy:(id)arg1 descriptor:(id)arg2 downloadDocumentation:(char)arg3 completion:(/*^block*/id)arg4 ;
