...
-(void)processVimageNoRotation:(const vImage_Buffer*)arg1 tex:(id)arg2 doBGRA2RGBA:(char)arg3 ;
-(void)autoResizeForAspectRatio:(float)arg1 useLowPriorityMode:(char)arg2 gpuPriority:(unsigned)arg3 ;
-(void)setContextMetal:(id)arg1 ;
-(void)setContextCpu:(id)arg1 ;
-(void)autoSetupNetBaseName:(id)arg1 weights:(id)arg2 scaleConfig:(int)arg3 setupMode:(int)arg4 computePath:(int)arg5 autoAspectRatio:(float)arg6 forceReset:(char)arg7 useLowPriorityMode:(char)arg8 gpuPriority:(unsigned)arg9 ;
