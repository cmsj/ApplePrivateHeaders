...
@interface EspressoImage2Image : NSObject {
	...
	map<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, float, std::__1::less<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>, std::__1::allocator<std::__1::pair<const std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, float>>>* tweaks;
...
+(char)loadStylesConfigAtPath:(id)arg1 ;
+(char)loadStylesConfigAtDefaultsKey:(id)arg1 ;
+(id)getStylesKeys;
+(int)featureVersion;
...
-(int)load:(id)arg1 ;
-(int)reload;
-(SCD_Struct_ET44*)getEspressoNetwork;
...
-(int)encodeToCommandBuffer:(id)arg1 sourceTexture:(id)arg2 destinationTexture:(id)arg3 cropRect:(SCD_Struct_Es83)arg4 destinationRect:(SCD_Struct_Es83)arg5 ;
-(int)submitToQueueWithSourceTexture:(id)arg1 destinationTexture:(id)arg2 ;
-(void)tweak:(id)arg1 value:(float)arg2 ;
-(int)submitToQueueWithSourceTexture:(id)arg1 destinationTexture:(id)arg2 cropRect:(SCD_Struct_Es83)arg3 ;
-(int)encodeToCommandBuffer:(id)arg1 sourceTexture:(id)arg2 destinationTexture:(id)arg3 cropRect:(SCD_Struct_Es83)arg4 ;
