...
@property (readonly) char optimizingAlignment;                                                           //@synthesize optimizingAlignment=_optimizingAlignment - In the implementation block
...
+(id)_getQueue;
+(void)_applyWordLanguageModelProbabilityToPath:(id)arg1 stemmedFromPath:(id)arg2 isCommittingToken:(char)arg3 ;
-(void)dealloc;
-(id)description;
-(id)debugDescription;
...
-(id)initWithLanguageResourceBundle:(id)arg1 scoringFunction:(/*^block*/id)arg2 initialCharacterLMState:(CVNLPLanguageModelWithStateRef)arg3 characterTokenIDs:(vector<unsigned int, std::__1::allocator<unsigned int>>*)arg4 wordTokenIDs:(vector<unsigned int, std::__1::allocator<unsigned int>>*)arg5 optimizingAlignment:(char)arg6 hasContext:(char)arg7 ;
...
-(id)tokensWithTimestep:(long long)arg1 isFinalTimestep:(char)arg2 ;
