...
@property (nonatomic,readonly) char satModelAvailable;                    //@synthesize satModelAvailable=_satModelAvailable - In the implementation block
...
-(char)resetScorerWithModelFilePath:(id)arg1 ;
