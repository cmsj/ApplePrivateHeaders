...
-(id)_updateScoreCardForFinalResult:(char)arg1 ;
-(id)_getAnalyzedResult;
-(id)_getSuperVectorWithEndPoint:(unsigned long long)arg1 ;
-(id)_processSuperVector:(id)arg1 withSize:(unsigned long long)arg2 processedAudioDurationMs:(unsigned long long)arg3 isFinal:(char)arg4 ;
-(NSArray *)satScorers;
