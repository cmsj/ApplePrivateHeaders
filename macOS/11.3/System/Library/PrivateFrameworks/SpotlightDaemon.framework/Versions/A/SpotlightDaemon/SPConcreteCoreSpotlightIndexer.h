...
+(id)fetchParentsForItemID:(id)arg1 recursively:(char)arg2 timeout:(unsigned long long)arg3 ;
...
-(void)setProperty:(id)arg1 forKey:(id)arg2 sync:(char)arg3 ;
-(void)mergeWithCompletionHandler:(/*^block*/id)arg1 ;
-(char)_startInternalQueryWithIndex:(SIRef)arg1 query:(id)arg2 fetchAttributes:(id)arg3 forBundleIds:(id)arg4 resultsHandler:(/*^block*/id)arg5 ;
-(id)_indexMaintenanceActivityName;
-(void)closeIndex;
-(id)_cancelIdleTimer;
-(void)dirty:(char)arg1 ;
...
-(void)_expireCorruptIndexFilesWithPath:(id)arg1 keepLatest:(char)arg2 ;
...
-(void)fixupMessageAttachmentsWithCompletionHandler:(/*^block*/id)arg1 ;
...
-(void)fetchAttributes:(id)arg1 bundleID:(id)arg2 identifiers:(id)arg3 includeParents:(char)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(void)deleteAllSearchableItemsForBundleID:(id)arg1 shouldGC:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)fetchAttributes:(id)arg1 bundleID:(id)arg2 identifiers:(id)arg3 includeParents:(char)arg4 completion:(/*^block*/id)arg5 ;
