...
+(id)attributesFromCIFilter:(id)arg1 fromSourceSize:(CGSize)arg2 ;
...
+(SCD_Struct_MP4)scaledFilterPresetVectorValue:(SCD_Struct_MP4)arg1 withKey:(id)arg2 forFilterID:(id)arg3 andPresetID:(id)arg4 ;
