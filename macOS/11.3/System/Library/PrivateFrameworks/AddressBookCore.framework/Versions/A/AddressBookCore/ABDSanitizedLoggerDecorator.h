...
@property (nonatomic,retain) id<ABSuggestionLogging> logger;              //@synthesize logger=_logger - In the implementation block
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(void)dealloc;
-(id<ABSuggestionLogging>)logger;
-(id)initWithLogger:(id)arg1 ;
-(void)logPairs:(id)arg1 withMessage:(id)arg2 ;
-(void)setLogger:(id<ABSuggestionLogging>)arg1 ;
@end
