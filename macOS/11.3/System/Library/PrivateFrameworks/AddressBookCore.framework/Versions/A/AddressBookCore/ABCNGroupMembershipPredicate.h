...
@property (copy,readonly) ABCNGroupIdentifier * groupIdentifier;              //@synthesize groupIdentifier=_groupIdentifier - In the implementation block
-(void)dealloc;
-(ABCNGroupIdentifier *)groupIdentifier;
