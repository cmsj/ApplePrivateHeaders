...
@interface GKMatchmaker : NSObject {
	...
	char _generatingCompatiblityHashes;
	char _serverHosted;
	char _nearbyDiscoverySetup;
	int _matching;
...
@property (nonatomic,readonly) char allInviteesDidRespond; 
...
@property (assign,nonatomic) char serverHosted;                                            //@synthesize serverHosted=_serverHosted - In the implementation block
...
@property (assign,nonatomic) char nearbyDiscoverySetup;                                    //@synthesize nearbyDiscoverySetup=_nearbyDiscoverySetup - In the implementation block
...
@property (assign,nonatomic) char generatingCompatiblityHashes;                            //@synthesize generatingCompatiblityHashes=_generatingCompatiblityHashes - In the implementation block
...
-(char)canPlayMultiplayerGameWithPlayers:(id)arg1 ;
...
-(void)setServerHosted:(char)arg1 ;
-(void)invitePlayersWithRequest:(id)arg1 serverHosted:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)_request:(id)arg1 match:(id)arg2 rematchID:(id)arg3 serverHosted:(char)arg4 playerCount:(long long)arg5 connectionData:(id)arg6 completionHandler:(/*^block*/id)arg7 ;
-(void)setShareInvitees:(NSMutableArray *)arg1 ;
-(void)matchWithRequest:(id)arg1 currentMatch:(id)arg2 hostedCurrentPlayerCount:(long long)arg3 serverHosted:(char)arg4 rematchID:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
...
-(void)setShareInvitees:(id)arg1 propogateToDaemon:(char)arg2 ;
...
-(char)generatingCompatiblityHashes;
-(void)setGeneratingCompatiblityHashes:(char)arg1 ;
...
-(char)nearbyDiscoverySetup;
-(void)setNearbyDiscoverySetup:(char)arg1 ;
