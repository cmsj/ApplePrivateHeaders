...
-(char)sendData:(id)arg1 toPlayers:(id)arg2 dataMode:(long long)arg3 error:(id*)arg4 ;
-(NSString *)rematchID;
...
-(char)sendData:(id)arg1 toPlayers:(id)arg2 withDataMode:(long long)arg3 error:(id*)arg4 ;
-(char)sendDataToAllPlayers:(id)arg1 withDataMode:(long long)arg2 error:(id*)arg3 ;
