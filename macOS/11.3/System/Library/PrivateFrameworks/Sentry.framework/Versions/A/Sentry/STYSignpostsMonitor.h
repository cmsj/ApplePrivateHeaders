...
@property (assign) char autoUploadThroughAbc;                                           //@synthesize autoUploadThroughAbc=_autoUploadThroughAbc - In the implementation block
@property (assign) char seedUserMode;                                                   //@synthesize seedUserMode=_seedUserMode - In the implementation block
...
-(char)autoUploadThroughAbc;
-(void)setAutoUploadThroughAbc:(char)arg1 ;
