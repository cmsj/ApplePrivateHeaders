...
@interface IMDCKMessageSyncController : IMDCKAbstractSyncController {
	...
	char _encounteredIncompatibleMessage;
...
@property (assign,nonatomic) char encounteredIncompatibleMessage;                                  //@synthesize encounteredIncompatibleMessage=_encounteredIncompatibleMessage - In the implementation block
+(id)sharedInstance;
-(void)dealloc;
-(id)init;
...
-(char)_isValidCKRecordToSync:(id)arg1 ;
...
-(void)_processModifyRecordsCompletion:(id)arg1 deletedRecordIDs:(id)arg2 operationError:(id)arg3 isLastBatchOfWrite:(char)arg4 writeCompletionBlock:(/*^block*/id)arg5 ;
...
-(char)_isCoreDuetSyncForMaxBatchCount:(long long)arg1 ;
-(char)_shouldDeferCoreDuetMessagesSync;
...
-(void)_fetchArchivedRecordsIfNeeded:(char)arg1 currentBatchCount:(long long)arg2 maxNumberOfBatches:(long long)arg3 WithCompletionBlock:(/*^block*/id)arg4 ;
-(void)_resetArvchivedRecordSyncToken;
-(CKServerChangeToken *)archivedRecordSyncToken;
-(void)_processRecordChange:(id)arg1 ;
-(void)_processArchivedRecordsFetchCompletionZoneID:(id)arg1 serverChangeToken:(id)arg2 moreComing:(char)arg3 currentBatchCount:(long long)arg4 maxNumberOfBatches:(long long)arg5 NSError:(id)arg6 completionBlock:(/*^block*/id)arg7 ;
...
-(char)_doesAnyRecordZoneIDHavePendingArchivedRecords:(long long)arg1 ;
-(unsigned long long)_numberOfRecordsToFetchForSyncType:(long long)arg1 ;
-(char)_isDiskSpaceAvailableForSyncType:(long long)arg1 currentBatchCount:(long long)arg2 ;
-(CKServerChangeToken *)latestSyncToken;
-(char)_shouldFetchArchivedRecords:(id)arg1 ;
-(void)_processRecordZoneFetchCompletionZoneID:(id)arg1 serverChangeToken:(id)arg2 clientChangeTokenData:(id)arg3 moreComing:(char)arg4 NSError:(id)arg5 syncType:(long long)arg6 currentBatchCount:(long long)arg7 maxNumberOfBatches:(long long)arg8 shouldFetchArchivedRecords:(char)arg9 completionBlock:(/*^block*/id)arg10 ;
-(void)_processFetchRecordZoneChangesCompletionWithError:(id)arg1 completionBlock:(/*^block*/id)arg2 ;
-(char)encounteredIncompatibleMessage;
-(void)setEncounteredIncompatibleMessage:(char)arg1 ;
