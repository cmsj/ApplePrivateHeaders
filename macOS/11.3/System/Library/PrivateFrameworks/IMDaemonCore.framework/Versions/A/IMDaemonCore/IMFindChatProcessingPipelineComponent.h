...
-(char)shouldDropDueToGroupSize:(id)arg1 ;
-(char)_participantsContainBizID:(id)arg1 ;
-(char)_shouldDropMessageGroupID:(id)arg1 participants:(id)arg2 fromIdentifier:(id)arg3 toIdentifier:(id)arg4 ;
