...
-(void)processNetworkDataAvailabilityChange:(char)arg1 ;
...
-(void)sendLogDumpMessageAtFilePath:(id)arg1 toRecipient:(id)arg2 shouldDeleteFile:(char)arg3 withCompletion:(/*^block*/id)arg4 ;
...
-(char)sendNicknameUpdatesToPeerDevices:(id)arg1 toDestinations:(id)arg2 ;
...
-(void)_blastDoorProcessingWithIMMessageItem:(id)arg1 chat:(id)arg2 account:(id)arg3 fromToken:(id)arg4 fromIDSID:(id)arg5 fromIdentifier:(id)arg6 toIdentifier:(id)arg7 participants:(id)arg8 groupName:(id)arg9 groupID:(id)arg10 isEncrypted:(char)arg11 isFromMe:(char)arg12 isLastFromStorage:(char)arg13 isFromStorage:(char)arg14 hideLockScreenNotification:(char)arg15 wantsCheckpointing:(char)arg16 needsDeliveryReceipt:(id)arg17 messageBalloonPayloadAttachmentDictionary:(id)arg18 inlineAttachments:(id)arg19 attributionInfoArray:(id)arg20 nicknameDictionary:(id)arg21 messageContext:(id)arg22 completionBlock:(/*^block*/id)arg23 ;
-(void)requestGroupPhotoIfNecessary:(id)arg1 incomingGroupPhotoCreationTime:(id)arg2 toIdentifier:(id)arg3 fromIdentifier:(id)arg4 messageIsFromStorage:(char)arg5 ;
...
-(id)broadcasterForBlackholeStatus:(char)arg1 ;
...
-(void)didJoinChat:(id)arg1 style:(unsigned char)arg2 displayName:(id)arg3 groupID:(id)arg4 handleInfo:(id)arg5 account:(id)arg6 isBlackholed:(char)arg7 ;
...
-(void)registerChat:(id)arg1 style:(unsigned char)arg2 displayName:(id)arg3 groupID:(id)arg4 lastAddressedHandle:(id)arg5 handleInfo:(id)arg6 account:(id)arg7 isBlackholed:(char)arg8 ;
-(void)registerChat:(id)arg1 style:(unsigned char)arg2 displayName:(id)arg3 groupID:(id)arg4 lastAddressedHandle:(id)arg5 lastAddressedSIMID:(id)arg6 handleInfo:(id)arg7 account:(id)arg8 isBlackholed:(char)arg9 ;
...
-(void)_messageStoreCompletion:(char)arg1 inputMessage:(id)arg2 outputMessage:(id)arg3 originalMessage:(id)arg4 completionBlock:(/*^block*/id)arg5 ;
-(void)_IMDStoreMessage:(id)arg1 inMessage:(id)arg2 forceReplace:(char)arg3 modifyError:(char)arg4 modifyFlags:(char)arg5 calculateUnreadCount:(char)arg6 flagMask:(unsigned long long)arg7 shouldStoreBlock:(/*^block*/id)arg8 didStoreBlock:(/*^block*/id)arg9 block:(/*^block*/id)arg10 ;
...
-(void)didUpdateChatStatus:(int)arg1 chat:(id)arg2 style:(unsigned char)arg3 displayName:(id)arg4 groupID:(id)arg5 handleInfo:(id)arg6 account:(id)arg7 isBlackholed:(char)arg8 ;
...
-(char)_didReceiveMessageDeliveryReceiptForMessageID:(id)arg1 attempts:(long long)arg2 date:(id)arg3 account:(id)arg4 ;
-(char)_hasSuppressedMessageID:(id)arg1 chatGUID:(id)arg2 ;
-(void)_didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 useMessageSuppression:(char)arg4 completionBlock:(/*^block*/id)arg5 ;
...
-(void)_didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 useMessageSuppression:(char)arg4 completionBlock:(/*^block*/id)arg5 ;
...
-(void)_didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(char)arg5 date:(id)arg6 attempts:(long long)arg7 useMessageSuppression:(char)arg8 account:(id)arg9 completionBlock:(/*^block*/id)arg10 ;
...
-(void)didSendMessage:(id)arg1 forChat:(id)arg2 style:(unsigned char)arg3 account:(id)arg4 forceDate:(id)arg5 itemIsComingFromStorage:(char)arg6 ;
...
-(char)didReceiveMessages:(id)arg1 forChat:(id)arg2 style:(unsigned char)arg3 account:(id)arg4 ;
-(void)_setReplyGUIDOnMessage:(id)arg1 forChat:(id)arg2 ;
-(void)_setSortIDForMessage:(id)arg1 forChat:(id)arg2 ;
-(char)_storeMessage:(id)arg1 chatIdentifier:(id)arg2 localChat:(id)arg3 style:(unsigned char)arg4 account:(id)arg5 messagesToPostArray:(id)arg6 ;
...
-(void)didUpdateChatStatus:(int)arg1 chat:(id)arg2 style:(unsigned char)arg3 displayName:(id)arg4 groupID:(id)arg5 lastAddressedHandle:(id)arg6 lastAddressedSIMID:(id)arg7 handleInfo:(id)arg8 account:(id)arg9 isBlackholed:(char)arg10 ;
-(void)didUpdateChatStatus:(int)arg1 chat:(id)arg2 style:(unsigned char)arg3 displayName:(id)arg4 groupID:(id)arg5 lastAddressedHandle:(id)arg6 lastAddressedSIMID:(id)arg7 handleInfo:(id)arg8 account:(id)arg9 category:(long long)arg10 spamExtensionName:(id)arg11 isBlackholed:(char)arg12 ;
...
-(void)updateChatGUID:(id)arg1 withLastReadTimeStamp:(long long)arg2 withLastSeenMessageGUID:(id)arg3 fromMe:(char)arg4 ;
...
-(char)_shouldBlackholeGroupChatFromSender:(id)arg1 toRecipient:(id)arg2 withOtherParticipants:(id)arg3 forAccount:(id)arg4 ;
