...
@property (nonatomic,readonly) char shouldGroupByBundleIdentifier; 
@property (nonatomic,readonly) char shouldCurateIfPerformed; 
...
+(id)itemWithType:(id)arg1 contactProperty:(id)arg2 bundleIdentifier:(id)arg3 userActivity:(id)arg4 isSuggested:(char)arg5 ;
...
+(id)itemWithType:(id)arg1 contactProperty:(id)arg2 bundleIdentifier:(id)arg3 url:(id)arg4 isSensitive:(char)arg5 group:(long long)arg6 options:(unsigned long long)arg7 ;
...
+(id)itemWithType:(id)arg1 contactProperty:(id)arg2 bundleIdentifier:(id)arg3 dialRequest:(id)arg4 isSuggested:(char)arg5 ;
...
-(char)shouldGroupByBundleIdentifier;
