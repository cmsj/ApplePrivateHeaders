...
@interface SGQuickResponsesPredictionParameters : NSObject {
	...
	char _isPersonalizationDisabled;
	char _isReplyTextRandomized;
	char _isPerCategory;
	char _dynamicLabelsEnabled;
	char _hasNegativeClass;
...
@property (nonatomic,readonly) char isPersonalizationDisabled;                                         //@synthesize isPersonalizationDisabled=_isPersonalizationDisabled - In the implementation block
@property (nonatomic,readonly) char isReplyTextRandomized;                                             //@synthesize isReplyTextRandomized=_isReplyTextRandomized - In the implementation block
@property (nonatomic,readonly) char isPerCategory;                                                     //@synthesize isPerCategory=_isPerCategory - In the implementation block
...
@property (nonatomic,readonly) char dynamicLabelsEnabled;                                              //@synthesize dynamicLabelsEnabled=_dynamicLabelsEnabled - In the implementation block
@property (nonatomic,readonly) char hasNegativeClass;                                                  //@synthesize hasNegativeClass=_hasNegativeClass - In the implementation block
...
-(char)hasNegativeClass;
-(NSString *)modelTypeName;
-(char)isPersonalizationDisabled;
-(char)isReplyTextRandomized;
-(char)isPerCategory;
