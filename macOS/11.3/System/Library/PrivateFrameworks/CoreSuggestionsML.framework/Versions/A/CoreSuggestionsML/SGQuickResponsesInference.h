...
+(id)proactiveTriggerForDynamicLabel:(id)arg1 context:(id)arg2 language:(id)arg3 useContactNames:(char)arg4 ;
...
+(id)quickResponsesForMessage:(id)arg1 conversationTurns:(id)arg2 maxResponses:(unsigned long long)arg3 localeIdentifier:(id)arg4 recipientHandles:(id)arg5 chunkPath:(id)arg6 plistPath:(id)arg7 espressoBinFilePath:(id)arg8 useContactNames:(char)arg9 ;
...
+(void)registerResponse:(id)arg1 position:(id)arg2 isCanned:(char)arg3 isUsingQuickResponses:(char)arg4 locale:(id)arg5 plistPath:(id)arg6 ;
...
-(id)quickResponsesForMessage:(id)arg1 maximumResponses:(unsigned long long)arg2 conversationHistory:(id)arg3 context:(id)arg4 time:(id)arg5 language:(id)arg6 locale:(id)arg7 recipients:(id)arg8 useContactNames:(char)arg9 ;
