...
@property (assign,nonatomic) char tableContainsRowHeaders;                       //@synthesize tableContainsRowHeaders=_tableContainsRowHeaders - In the implementation block
...
+(double)leadingSectionSpacingForView:(id)arg1 view2:(id)arg2 index:(unsigned long long)arg3 alignmentSchema:(id)arg4 allEqual:(char)arg5 ;
...
-(void)setTableContainsRowHeaders:(char)arg1 ;
