...
+(int)_openApplicationWithBundleID:(id)arg1 ;
+(int)_openItemWithURL:(id)arg1 ;
+(int)_openItemWithURL:(id)arg1 launchParameters:(id)arg2 ;
+(int)_openApplicationWithURL:(CFURLRef)arg1 ;
...
+(char)openAppleIDPrefWithLaunchParameters:(id)arg1 ;
@end
