...
@property (assign,nonatomic) char ownerIsWhitelisted;                 //@synthesize ownerIsWhitelisted=_ownerIsWhitelisted - In the implementation block
...
-(void)setOwnerIsWhitelisted:(char)arg1 ;
