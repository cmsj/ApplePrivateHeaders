...
@property (assign,nonatomic) char adornmentsHidden;                          //@synthesize adornmentsHidden=_adornmentsHidden - In the implementation block
...
-(void)setAdornmentsHidden:(char)arg1 ;
...
-(void)_applyUpdatesWithScale:(double)arg1 toLayers:(id)arg2 isLiveUpdate:(char)arg3 forceUpdate:(char)arg4 ;
