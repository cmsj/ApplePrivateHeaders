...
-(id)initWithMobileAssetController:(id)arg1 canUpdateConfiguration:(char)arg2 ;
-(char)_sendAssetToDelegateIfPossible:(id)arg1 ;
-(char)_sendAssetToDelegateIfPossible;
