...
@interface SidebarTableCellView : RolloverActionButtonTableCellView {
	...
	char _offscreenCellForMeasurements;
...
@property (assign,getter=isOffscreenCellForMeasurements,nonatomic) char offscreenCellForMeasurements;              //@synthesize offscreenCellForMeasurements=_offscreenCellForMeasurements - In the implementation block
...
-(char)isOffscreenCellForMeasurements;
...
-(void)setOffscreenCellForMeasurements:(char)arg1 ;
@end
