...
@property (nonatomic,readonly) id<WBSURLCompletionMatchData> historyMatchData;              //@synthesize historyMatchData=_historyMatchData - In the implementation block
...
-(id<WBSURLCompletionMatchData>)historyMatchData;
@end
