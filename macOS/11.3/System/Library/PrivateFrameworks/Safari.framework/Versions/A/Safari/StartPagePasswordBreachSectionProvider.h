...
#import <libobjc.A.dylib/StartPagePasswordBreachNotificationCollectionViewItemDelegate.h>
#import <libobjc.A.dylib/StartPageCollectionSectionProvider.h>

@protocol StartPageCollectionSectionProviderDelegate;
@class NSArray, StartPagePasswordBreachWarningCollectionViewItem, WBSPasswordBreachManager, NSString;
...
@interface StartPagePasswordBreachSectionProvider : NSObject <StartPagePasswordBreachNotificationCollectionViewItemDelegate, StartPageCollectionSectionProvider> {
	...
	WBSPasswordBreachManager* _passwordBreachManager;
...
-(void)_reloadDataWithPreviousBreachedPasswords:(id)arg1 ;
-(void)startPagePasswordBreachNotificationCollectionViewItemDidClose:(id)arg1 ;
@end
