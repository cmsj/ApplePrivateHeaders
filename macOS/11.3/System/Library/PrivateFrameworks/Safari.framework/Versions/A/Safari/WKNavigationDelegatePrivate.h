...
-(void)_webView:(id)arg1 contextMenuDidCreateDownload:(id)arg2;
...
-(void)_webView:(id)arg1 decidePolicyForPluginLoadWithCurrentPolicy:(long long)arg2 pluginInfo:(id)arg3 completionHandler:(/*^block*/id)arg4;
