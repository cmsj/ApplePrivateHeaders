...
@property (readonly) NSData * encodedSystemData;              //@synthesize encodedSystemData=_encodedSystemData - In the implementation block
-(id)copyWithZone:(NSZone*)arg1 ;
-(id)initWithEncodedSystemData:(id)arg1 ;
-(NSData *)encodedSystemData;
-(char)validEncodedSystemData:(id)arg1 ;
@end
