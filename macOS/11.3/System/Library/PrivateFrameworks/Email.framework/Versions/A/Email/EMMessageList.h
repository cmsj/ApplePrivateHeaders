...
@property (nonatomic,readonly) char isThreaded; 
...
+(id)log;
+(id)threadedMessageListForMailboxes:(id)arg1 withRepository:(id)arg2 shouldTrackOldestItems:(char)arg3 ;
+(id)simpleMessageListForMailboxes:(id)arg1 withRepository:(id)arg2 shouldTrackOldestItems:(char)arg3 ;
-(void)dealloc;
...
-(id)initWithMailboxes:(id)arg1 repository:(id)arg2 targetClass:(Class)arg3 shouldTrackOldestItems:(char)arg4 labelPrefix:(id)arg5 ;
...
-(char)anyExpandedThreadContainsItemID:(id)arg1 ;
-(char)recentlyCollapsedThreadContainsItemID:(id)arg1 ;
