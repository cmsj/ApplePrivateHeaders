...
@property (nonatomic,readonly) char hasVendedData; 
-(void)dealloc;
-(id)init;
...
-(void)_setHasVendedData:(char)arg1 ;
...
-(void)donateLikenessData:(id)arg1 forSenderID:(id)arg2 isPhoneNumber:(char)arg3 ;
