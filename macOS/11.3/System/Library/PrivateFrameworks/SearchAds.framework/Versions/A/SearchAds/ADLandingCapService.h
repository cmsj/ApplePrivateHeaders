...
@property (nonatomic,retain) ADLandingCapData * landingCapData;              //@synthesize landingCapData=_landingCapData - In the implementation block
-(id)init;
...
-(ADLandingCapData *)landingCapData;
-(void)updateDownloadData:(id)arg1 forType:(long long)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)cleanDownloadData;
-(void)setLandingCapData:(ADLandingCapData *)arg1 ;
@end
