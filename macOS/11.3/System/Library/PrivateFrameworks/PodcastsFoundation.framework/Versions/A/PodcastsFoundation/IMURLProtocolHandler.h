...
@interface IMURLProtocolHandler : AMSURLProtocolHandler {
	...
	char _followsRedirects;

}

@property (assign) char followsRedirects;              //@synthesize followsRedirects=_followsRedirects - In the implementation block
-(id)handleCompletionWithTask:(id)arg1 metrics:(id)arg2 decodedObject:(id)arg3 ;
-(char)followsRedirects;
-(void)setFollowsRedirects:(char)arg1 ;
@end
