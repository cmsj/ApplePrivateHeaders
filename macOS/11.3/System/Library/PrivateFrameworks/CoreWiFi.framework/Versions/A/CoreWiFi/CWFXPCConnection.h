...
-(id)__processPathFromAuditToken:(SCD_Struct_CW2)arg1 ;
-(id)__bundleIDFromAuditToken:(SCD_Struct_CW2)arg1 ;
-(id)registeredEventIDs;
-(void)__updateXPCTransactionCount;
-(char)__allowXPCRequestWithType:(long long)arg1 error:(id*)arg2 ;
