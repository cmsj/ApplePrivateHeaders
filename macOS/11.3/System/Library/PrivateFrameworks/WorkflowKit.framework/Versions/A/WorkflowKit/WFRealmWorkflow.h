...
@property (assign) char hiddenFromLibraryAndSync;                                                          //@synthesize hiddenFromLibraryAndSync=_hiddenFromLibraryAndSync - In the implementation block
...
@property (getter=isHiddenInComplication) char hiddenInComplication;                                       //@synthesize hiddenInComplication=_hiddenInComplication - In the implementation block
