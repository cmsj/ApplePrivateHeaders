...
@class WFWorkflow, WFContentCollection, NSProgress, WFWorkflowRunningContext, NSString, NSDictionary, NSObject, NSDate, NSMapTable, WFWorkflowControllerState, WFRemoteQuarantinePolicyEvaluator, RBSAssertion, WFOutOfProcessWorkflowController, WFAction;
...
@interface WFWorkflowController : NSObject <WFRemoteQuarantinePolicyEvaluatorDelegate, WFVariableDataSource, WFActionParameterInputProvider> {
	...
	char _acquiresAssertionWhileRunning;
	char _running;
	char _stepping;
	char _resumed;
	char _actionDidRunRemotely;
...
@property (assign,getter=isStepping,nonatomic) char stepping;                                        //@synthesize stepping=_stepping - In the implementation block
...
@property (assign,nonatomic) char actionDidRunRemotely;                                              //@synthesize actionDidRunRemotely=_actionDidRunRemotely - In the implementation block
...
@property (assign,nonatomic) char donateInteraction;                                                 //@synthesize donateInteraction=_donateInteraction - In the implementation block
...
@property (assign,nonatomic) char acquiresAssertionWhileRunning;                                     //@synthesize acquiresAssertionWhileRunning=_acquiresAssertionWhileRunning - In the implementation block
...
-(void)setFinishedRunningWithSuccess:(char)arg1 ;
-(void)queue_reset;
...
-(void)logStartEvent;
-(void)logFinishRunEvent:(char)arg1 ;
-(void)trackRunShortcutEventWithKey:(id)arg1 completed:(char)arg2 ;
-(void)logStartActionEventWithAction:(id)arg1 ;
-(void)logFinishActionEventWithAction:(id)arg1 completed:(char)arg2 ;
-(void)trackRunActionEventWithKey:(id)arg1 action:(id)arg2 completed:(char)arg3 ;
-(void)didFinishRunningWithError:(id)arg1 cancelled:(char)arg2 ;
...
-(void)handleActionCompletion:(id)arg1 actionGroupSkipped:(char)arg2 ;
...
-(void)setDonateInteraction:(char)arg1 ;
-(void)setRunningContext:(WFWorkflowRunningContext *)arg1 ;
-(NSString *)automationTrialID;
-(void)setAutomationTrialID:(NSString *)arg1 ;
-(char)acquiresAssertionWhileRunning;
-(void)setAcquiresAssertionWhileRunning:(char)arg1 ;
-(char)isStepping;
-(void)setStepping:(char)arg1 ;
...
-(char)actionDidRunRemotely;
-(void)setActionDidRunRemotely:(char)arg1 ;
@end
