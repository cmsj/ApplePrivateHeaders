...
@property (assign,nonatomic) char destroysOnDeallocation;                                            //@synthesize destroysOnDeallocation=_destroysOnDeallocation - In the implementation block
...
-(char)saveRecord:(id)arg1 withDescriptor:(id)arg2 error:(id*)arg3 ;
...
-(char)setShortcutSuggestions:(id)arg1 forAppWithBundleIdentifier:(id)arg2 error:(id*)arg3 ;
-(id)visibleReferencesForWorkflowName:(id)arg1 ;
-(char)deleteReference:(id)arg1 error:(id*)arg2 ;
...
-(char)hasConflictingReferenceForReference:(id)arg1 ;
-(id)conflictingReferenceForReference:(id)arg1 ;
-(id)collectionRecordForCollectionIdentifier:(id)arg1 createIfNecessary:(char)arg2 ;
-(void)addObjectObserver:(id)arg1 ;
-(void)setConflictingReference:(id)arg1 forReference:(id)arg2 ;
-(char)deleteReference:(id)arg1 tombstone:(char)arg2 deleteConflictIfPresent:(char)arg3 error:(id*)arg4 ;
...
-(char)createWorkflowWithIdentifier:(id)arg1 record:(id)arg2 error:(id*)arg3 ;
...
-(id)sortedTriggerEventsWithConfirmationOnly:(char)arg1 ;
-(void)setConfirmedForTriggerEventWithIdentifier:(id)arg1 error:(id*)arg2 ;
-(id)createTriggerEventWithTriggerID:(id)arg1 eventInfo:(id)arg2 confirmed:(char)arg3 error:(id*)arg4 ;
-(id)sortedRunEventsForTriggerID:(id)arg1 ;
-(id)initWithStoreDescription:(id)arg1 runMigrationsIfNecessary:(char)arg2 error:(id*)arg3 ;
-(id)latestRunEvent;
...
-(void)setTrustedToRunScripts:(char)arg1 forReference:(id)arg2 onDomain:(id)arg3 ;
-(char)isReference:(id)arg1 allowedToRunOnDomain:(id)arg2 ;
...
-(char)saveContextOrRollback:(id)arg1 error:(id*)arg2 ;
...
-(id)objectForDescriptor:(id)arg1 properties:(id)arg2 createIfNecessary:(char)arg3 ;
-(void)accessStorageForDescriptor:(id)arg1 forWriting:(char)arg2 readingRecordProperties:(id)arg3 usingBlock:(/*^block*/id)arg4 withError:(id*)arg5 ;
-(id)objectOfClass:(Class)arg1 withIdentifier:(id)arg2 forKey:(id)arg3 createIfNecessary:(char)arg4 properties:(id)arg5 ;
-(void)remoteContextDidSave:(id)arg1 ;
-(void)notifyResultsAboutChange:(id)arg1 ;
-(id)descriptorsForResult:(id)arg1 error:(id*)arg2 ;
-(char)startObservingChangesForResult:(id)arg1 ;
-(id)missingErrorForDescriptor:(id)arg1 ;
-(Class)recordClassForObjectType:(unsigned long long)arg1 ;
-(char)reloadRecord:(id)arg1 withDescriptor:(id)arg2 error:(id*)arg3 ;
...
-(char)destroysOnDeallocation;
-(void)setDestroysOnDeallocation:(char)arg1 ;
...
-(id)validateWorkflowName:(id)arg1 forCreation:(char)arg2 overwriting:(char)arg3 error:(id*)arg4 ;
-(char)hasVisibleWorkflowsWithName:(id)arg1 ;
...
-(id)workflowFetchRequestWithCollectionID:(id)arg1 includeTombstones:(char)arg2 limit:(unsigned long long)arg3 ;
...
-(char)moveReferences:(id)arg1 toIndex:(long long)arg2 ofCollection:(id)arg3 visible:(char)arg4 error:(id*)arg5 ;
-(char)moveReferences:(id)arg1 toIndexes:(id)arg2 ofCollection:(id)arg3 visible:(char)arg4 error:(id*)arg5 ;
-(char)moveCollections:(id)arg1 toIndexes:(id)arg2 ofCollectionWithIdentifier:(id)arg3 error:(id*)arg4 ;
...
-(char)moveReferences:(id)arg1 toIndex:(long long)arg2 ofCollection:(id)arg3 error:(id*)arg4 ;
-(char)moveReferences:(id)arg1 toIndexes:(id)arg2 ofCollection:(id)arg3 error:(id*)arg4 ;
-(char)prependReferences:(id)arg1 toCollection:(id)arg2 error:(id*)arg3 ;
-(char)prependReferences:(id)arg1 toCollectionWithType:(id)arg2 error:(id*)arg3 ;
-(char)removeReferences:(id)arg1 fromCollectionWithIdentifier:(id)arg2 error:(id*)arg3 ;
-(char)moveCollections:(id)arg1 toIndex:(unsigned long long)arg2 error:(id*)arg3 ;
-(char)moveCollections:(id)arg1 toIndexes:(id)arg2 error:(id*)arg3 ;
-(id)orphanedFolders;
