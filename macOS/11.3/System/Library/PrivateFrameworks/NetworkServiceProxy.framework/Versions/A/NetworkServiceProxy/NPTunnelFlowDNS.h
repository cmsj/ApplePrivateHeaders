...
@property (assign) char telemetryReported;                        //@synthesize telemetryReported=_telemetryReported - In the implementation block
-(NSPDNSPacket *)query;
...
-(char)checkAndReportTelemetry;
-(void)closeFromTunnel;
-(char)telemetryReported;
-(void)setTelemetryReported:(char)arg1 ;
