...
@property (assign,nonatomic) char isMultipath;                                                      //@synthesize isMultipath=_isMultipath - In the implementation block
...
@property (assign,nonatomic) char TFOSucceeded;                                                     //@synthesize TFOSucceeded=_TFOSucceeded - In the implementation block
...
@property (assign,nonatomic) char isTFOProbeSucceeded;                                              //@synthesize isTFOProbeSucceeded=_isTFOProbeSucceeded - In the implementation block
...
+(char)shouldMoveToNextEdgeForFallbackReason:(long long)arg1 ;
+(char)shouldResolveForFallbackReason:(long long)arg1 ;
...
-(void)setIsTFOProbeSucceeded:(char)arg1 ;
