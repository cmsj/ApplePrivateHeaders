...
@class NSString, _BlastDoorLPImage, _BlastDoorLPArtworkMetadata, NSURL, NSArray, _BlastDoorLPLyricExcerptMetadata;
...
@property (nonatomic,copy) _BlastDoorLPLyricExcerptMetadata * lyricExcerpt;              //@synthesize lyricExcerpt=_lyricExcerpt - In the implementation block
...
-(void)setLyricExcerpt:(_BlastDoorLPLyricExcerptMetadata *)arg1 ;
