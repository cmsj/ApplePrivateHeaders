...
@class NSURL, NSString, NSItemProvider, _BlastDoorLPImage, _BlastDoorLPIconMetadata, NSArray, _BlastDoorLPImageMetadata, _BlastDoorLPVideo, _BlastDoorLPVideoMetadata, _BlastDoorLPAudio, _BlastDoorLPAudioMetadata, _BlastDoorLPSpecializationMetadata;
