...
@property (assign,nonatomic) char hasSpineOnRight;                                     //@synthesize hasSpineOnRight=_hasSpineOnRight - In the implementation block
...
-(char)hasSpineOnRight;
-(void)setHasSpineOnRight:(char)arg1 ;
@end
