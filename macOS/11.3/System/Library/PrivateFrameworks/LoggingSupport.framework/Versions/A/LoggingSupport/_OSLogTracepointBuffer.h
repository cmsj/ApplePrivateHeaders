...
-(void)insertNonsparsePoint:(unsigned long long)arg1 uuid:(unsigned char)arg2 ttl:(unsigned char)arg3 inMemory:(char)arg4 ;
-(void)insertChunk:(tracev3_chunk_s*)arg1 timestamp:(unsigned long long)arg2 subchunk:(id)arg3 ;
-(void)insertSimpleChunk:(tracev3_chunk_s*)arg1 subchunk:(id)arg2 ;
