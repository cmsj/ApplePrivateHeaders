...
-(char)mergeLocalOrderingChangesWithRemoteOrderingChangesFromOrderingRecord:(id)arg1 ;
...
-(void)handleNameConflictsForFetchedWorkflowRecord:(id)arg1 identifier:(id)arg2 shouldMarkFetchedRecordAsTombstone:(char*)arg3 ;
