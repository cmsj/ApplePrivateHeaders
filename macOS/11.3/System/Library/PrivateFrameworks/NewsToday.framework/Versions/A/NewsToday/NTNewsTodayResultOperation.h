...
-(void)_assembleQueueDescriptorsWithConfig:(id)arg1 allowOnlyWatchEligibleSections:(char)arg2 respectsWidgetVisibleSectionsLimit:(char)arg3 personalizationTreatment:(id)arg4 aggregateStore:(id)arg5 appConfiguration:(id)arg6 todayData:(id)arg7 completion:(/*^block*/id)arg8 ;
...
-(char)_useForegroundMinimumUpdateInterval;
-(NSDate *)filterDate;
