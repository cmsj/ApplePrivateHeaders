...
@property (assign,nonatomic,__weak) id<AXKTextElementEditListener> listener;              //@synthesize listener=_listener - In the implementation block
-(char)isEqual:(id)arg1 ;
-(unsigned long long)hash;
-(id<AXKTextElementEditListener>)listener;
-(void)setListener:(id<AXKTextElementEditListener>)arg1 ;
