...
+(char)_modeFromRelativePath:(id)arg1 isPackageFault:(char)arg2 ;
...
-(NSNumber *)lostStamp;
-(void)updateFromFSAtPath:(id)arg1 itemID:(id)arg2 parentGlobalID:(id)arg3 isPackageFault:(char)arg4 readonlyShareChild:(char)arg5 ;
...
-(void)_updateMetadataFromFSAtPath:(id)arg1 itemID:(id)arg2 parentGlobalID:(id)arg3 isPackageFault:(char)arg4 readonlyShareChild:(char)arg5 ;
-(void)_markDead;
...
-(void)updateLocationAndMetaFromFSAtPath:(id)arg1 itemID:(id)arg2 parentGlobalID:(id)arg3 isPackageFault:(char)arg4 readonlyShareChild:(char)arg5 ;
-(void)_markReserved;
