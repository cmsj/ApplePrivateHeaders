...
-(void)setStorageOpimizationEnabled:(char)arg1 reply:(/*^block*/id)arg2 ;
...
-(void)startOperation:(id)arg1 toUnshareShare:(id)arg2 forceDelete:(char)arg3 reply:(/*^block*/id)arg4 ;
-(void)startOperation:(id)arg1 toLookupShareParticipants:(id)arg2 reply:(/*^block*/id)arg3 ;
-(void)startOperation:(id)arg1 toModifyRecordAccessAtURL:(id)arg2 allowAccess:(char)arg3 reply:(/*^block*/id)arg4 ;
...
-(void)startOperation:(id)arg1 toCopyDocumentURLForRecordID:(id)arg2 syncIfNeeded:(char)arg3 reply:(/*^block*/id)arg4 ;
...
-(void)startOperation:(id)arg1 toAcceptShareLink:(id)arg2 skipAcceptDialogs:(char)arg3 reply:(/*^block*/id)arg4 ;
-(void)startOperation:(id)arg1 toDownloadItemAtURL:(id)arg2 readingOptions:(unsigned long long)arg3 wantsCurrentVersion:(char)arg4 reply:(/*^block*/id)arg5 ;
-(oneway void)updateContainerMetadataForID:(id)arg1 ;
-(void)getContainerURLForID:(id)arg1 forProcess:(SCD_Struct_BR22)arg2 reply:(/*^block*/id)arg3 ;
...
-(void)dumpDatabaseTo:(id)arg1 containerID:(id)arg2 includeAllItems:(char)arg3 reply:(/*^block*/id)arg4 ;
...
-(void)getTheoreticalContainerURLWithID:(id)arg1 forProcess:(SCD_Struct_BR22)arg2 reply:(/*^block*/id)arg3 ;
-(void)getTheoreticalContainerURLWithID:(id)arg1 reply:(/*^block*/id)arg2 ;
-(void)getApplicationStatusForProcess:(SCD_Struct_BR22)arg1 reply:(/*^block*/id)arg2 ;
...
-(void)canImportFoldersWithStatsInCurrentAccount:(id)arg1 reply:(/*^block*/id)arg2 ;
-(void)openFileAtURL:(id)arg1 appURL:(id)arg2 reply:(/*^block*/id)arg3 ;
...
-(void)simulateHealthIssueWithContainer:(id)arg1 status:(id)arg2 brokenStructure:(char)arg3 reply:(/*^block*/id)arg4 ;
...
-(void)getContainerURLForID:(id)arg1 recreateDocumentsIfNeeded:(char)arg2 reply:(/*^block*/id)arg3 ;
-(void)deleteAllContentsOfContainerID:(id)arg1 onClient:(char)arg2 onServer:(char)arg3 wait:(char)arg4 reply:(/*^block*/id)arg5 ;
-(void)resolveConflictWithName:(id)arg1 atURL:(id)arg2 reply:(/*^block*/id)arg3 ;
-(void)jetsamCloudDocsAppsWithReply:(/*^block*/id)arg1 ;
-(void)getBookmarkDataForURL:(id)arg1 onlyAllowItemKnowByServer:(char)arg2 allowAccessByBundleID:(id)arg3 reply:(/*^block*/id)arg4 ;
...
-(char)_enumerateFoldersWithParent:(id)arg1 depth:(unsigned long long)arg2 session:(id)arg3 db:(id)arg4 handler:(/*^block*/id)arg5 ;
