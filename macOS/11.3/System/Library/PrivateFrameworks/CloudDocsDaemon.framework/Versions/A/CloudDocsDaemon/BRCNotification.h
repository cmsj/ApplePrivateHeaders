...
@interface BRCNotification : BRQueryItem {
	...
	char _isInDocumentScope;
	char _isInDataScope;
	char _isInTrashScope;
...
@property (nonatomic,readonly) char isInDocumentScope;                                    //@synthesize isInDocumentScope=_isInDocumentScope - In the implementation block
@property (nonatomic,readonly) char isInDataScope;                                        //@synthesize isInDataScope=_isInDataScope - In the implementation block
@property (nonatomic,readonly) char isInTrashScope;                                       //@synthesize isInTrashScope=_isInTrashScope - In the implementation block
