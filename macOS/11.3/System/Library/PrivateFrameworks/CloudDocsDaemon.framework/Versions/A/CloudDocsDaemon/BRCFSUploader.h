...
-(void)setIsDefaultOwnerOutOfQuota:(char)arg1 forceSignalContainers:(char)arg2 ;
...
-(char)_finishPackageUploadWithRecord:(id)arg1 item:(id)arg2 stageID:(id)arg3 error:(id*)arg4 ;
