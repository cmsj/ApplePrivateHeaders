...
-(float)distanceWithOverlapCheckBetweenPerson:(id)arg1 andPerson:(id)arg2 useCommonMoments:(char)arg3 minAgeType:(unsigned short*)arg4 updateBlock:(/*^block*/id)arg5 error:(id*)arg6 ;
-(float)distanceBetweenPerson:(id)arg1 andPerson:(id)arg2 useCommonMoments:(char)arg3 minAgeType:(unsigned short*)arg4 updateBlock:(/*^block*/id)arg5 error:(id*)arg6 ;
