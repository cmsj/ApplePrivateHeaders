...
@property (setter=earchExpressions,nonatomic,copy) NSArray * SearchExpressions;              //@synthesize SearchExpressions=_SearchExpressions - In the implementation block
...
-(void)setSearchExpressions:(NSArray *)arg1 ;
