...
-(char)setAsset:(id)arg1 forKey:(id)arg2 ;
...
-(char)setAsset:(id)arg1 forKey:(const void*)arg2 withLength:(unsigned long long)arg3 ;
-(void)removeAssetForKey:(const void*)arg1 withLength:(unsigned long long)arg2 ;
-(char)removeAssetNameKey:(const void*)arg1 withLength:(unsigned long long)arg2 ;
-(char)_writeOutKeyFormatWithWorkaround;
-(char)_saveBitmapInfo;
-(char)useBitmapIndex;
-(void)updateBitmapInfo;
-(char)removeAssetName:(id)arg1 ;
@end
