...
+(char)isValidLCRWithBytes:(const void*)arg1 length:(unsigned long long)arg2 ;
...
-(id)NS_appearanceNamesForVectorGlyphWithName:(id)arg1 ;
-(char)_IS_multiSizeImageExistsWithName:(id)arg1 ;
-(id)_IS_multisizedImageWithName:(id)arg1 size:(CGSize)arg2 scale:(double)arg3 ;
-(long long)_IS_deviceIdiomWithName:(id)arg1 ;
...
-(char)hasCustomizedAppearanceForWidget:(id)arg1 variant:(id)arg2 ;
...
-(SCD_Struct_CU1)styledInsetsForStylePresetName:(id)arg1 styleConfiguration:(id)arg2 foregroundColor:(CGColorRef)arg3 scale:(double)arg4 ;
...
-(char)_effectStyle:(unsigned long long*)arg1 state:(long long*)arg2 presentationState:(long long*)arg3 value:(long long*)arg4 resolution:(unsigned long long*)arg5 dimension1:(unsigned long long*)arg6 appearance:(long long*)arg7 fromStyleConfiguration:(id)arg8 ;
