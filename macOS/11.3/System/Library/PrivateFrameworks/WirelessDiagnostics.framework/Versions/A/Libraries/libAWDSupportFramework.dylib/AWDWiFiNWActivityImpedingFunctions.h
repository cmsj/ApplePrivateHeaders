...
@class NSMutableArray, AWDWiFiTDM;
...
@property (nonatomic,retain) AWDWiFiTDM * sdbtdm;                              //@synthesize sdbtdm=_sdbtdm - In the implementation block
+(Class)cTLMIndexType;
...
-(void)setSdbtdm:(AWDWiFiTDM *)arg1 ;
