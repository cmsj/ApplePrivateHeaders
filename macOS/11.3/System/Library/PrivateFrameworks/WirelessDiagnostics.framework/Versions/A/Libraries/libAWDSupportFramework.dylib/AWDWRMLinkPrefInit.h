...
-(void)setHasCountWifi:(char)arg1 ;
-(char)hasCountWifi;
-(void)setCountCellular:(unsigned)arg1 ;
-(void)setHasCountCellular:(char)arg1 ;
-(char)hasCountCellular;
-(unsigned)countWifi;
