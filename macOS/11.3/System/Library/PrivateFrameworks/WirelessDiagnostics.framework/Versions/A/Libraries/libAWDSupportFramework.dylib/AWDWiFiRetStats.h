...
-(void)setHasRetDuration:(char)arg1 ;
-(char)hasRetDuration;
-(void)setRxDuration:(unsigned long long)arg1 ;
-(void)setHasRxDuration:(char)arg1 ;
-(char)hasRxDuration;
