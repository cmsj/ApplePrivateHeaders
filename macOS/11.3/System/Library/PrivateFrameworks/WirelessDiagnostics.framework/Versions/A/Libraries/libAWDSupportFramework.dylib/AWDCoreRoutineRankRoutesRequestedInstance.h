...
@property (assign,nonatomic) char hasNumberOfInputRoutes; 
...
@property (assign,nonatomic) char hasHighestRankedRouteScore; 
...
-(void)setHasNumberOfInputRoutes:(char)arg1 ;
-(char)hasNumberOfInputRoutes;
-(void)setHighestRankedRouteScore:(int)arg1 ;
-(void)setHasHighestRankedRouteScore:(char)arg1 ;
-(char)hasHighestRankedRouteScore;
