...
@property (assign,nonatomic) char hasPrivateSuccess; 
...
@property (nonatomic,readonly) char hasPrivateOperationalErrorDomain; 
...
@property (assign,nonatomic) char hasPrivateOperationalErrorCode; 
...
-(void)setHasPrivateSuccess:(char)arg1 ;
-(char)hasPrivateSuccess;
...
-(char)hasPrivateOperationalErrorDomain;
-(void)setPrivateOperationalErrorCode:(unsigned)arg1 ;
-(void)setHasPrivateOperationalErrorCode:(char)arg1 ;
-(char)hasPrivateOperationalErrorCode;
-(unsigned)hasAvatar;
