...
@property (assign,nonatomic) char hasRealTimeSessionStateResultingInSubmission; 
...
-(void)setHasRealTimeSessionStateResultingInSubmission:(char)arg1 ;
-(char)hasRealTimeSessionStateResultingInSubmission;
