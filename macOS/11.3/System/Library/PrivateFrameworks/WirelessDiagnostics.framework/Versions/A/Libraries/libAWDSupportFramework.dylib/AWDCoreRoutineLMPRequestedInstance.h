...
@property (assign,nonatomic) char hasSuggested; 
@property (assign,nonatomic) char suggested;                            //@synthesize suggested=_suggested - In the implementation block
...
@property (assign,nonatomic) char hasOccurrences; 
...
-(void)setSuggested:(char)arg1 ;
-(char)hasSuggested;
-(void)setHasSuggested:(char)arg1 ;
-(char)hasReason;
-(void)setHasReason:(char)arg1 ;
-(void)setOccurrences:(int)arg1 ;
-(void)setHasOccurrences:(char)arg1 ;
-(char)hasOccurrences;
@end
