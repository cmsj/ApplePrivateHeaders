...
-(void)setHasTotalBranchCount:(char)arg1 ;
-(char)hasTotalBranchCount;
-(void)setCountDeviceLost:(int)arg1 ;
-(void)setHasCountDeviceLost:(char)arg1 ;
-(char)hasCountDeviceLost;
