...
@property (nonatomic,readonly) char hasHeartbeatTimerFiringCount; 
...
@property (nonatomic,readonly) char hasHeartbeatActiveRequestCount; 
...
@property (nonatomic,readonly) char hasHeartbeatValidLocationCount; 
...
-(char)hasHeartbeatTimerFiringCount;
-(char)hasHeartbeatActiveRequestCount;
-(char)hasHeartbeatValidLocationCount;
