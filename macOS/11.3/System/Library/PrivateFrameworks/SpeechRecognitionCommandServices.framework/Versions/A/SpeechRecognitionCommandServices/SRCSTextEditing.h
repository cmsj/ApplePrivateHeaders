...
-(id)actOnStrings:(id)arg1 ambiguityResolution:(id)arg2 substringSearchGranularity:(int)arg3 alwaysCallActionOnClosestMatch:(char)arg4 options:(id)arg5 actionBlock:(/*^block*/id)arg6 ;
...
-(id)orderedPhraseMatchesFromStrings:(id)arg1 forwardDirection:(char)arg2 referenceLocation:(long long)arg3 substringSearchGranularity:(int)arg4 ;
-(long long)_indexOfFirstPhraseMatchResultPairBeforeInsertion:(char)arg1 fromArray:(id)arg2 ;
...
-(void)deleteAll;
-(NSRange)_rangeOfWordBasedSearchString:(id)arg1 inString:(id)arg2 withRange:(NSRange)arg3 forwardSearchDirection:(char)arg4 ;
-(char)_range:(NSRange)arg1 includesRange:(NSRange)arg2 ;
