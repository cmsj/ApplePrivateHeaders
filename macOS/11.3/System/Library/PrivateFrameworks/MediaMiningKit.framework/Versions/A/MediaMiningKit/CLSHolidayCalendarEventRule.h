...
@property (nonatomic,readonly) char checkWeekends;                                                             //@synthesize checkWeekends=_checkWeekends - In the implementation block
...
@property (nonatomic,readonly) char allowSceneClassificationBasedEvaluation; 
...
-(char)evaluateWithLocalDate:(id)arg1 traits:(id)arg2 ;
...
-(char)evaluateOnlyTraits:(id)arg1 ;
-(char)_isMatchingOnlyLocalDate:(id)arg1 ;
