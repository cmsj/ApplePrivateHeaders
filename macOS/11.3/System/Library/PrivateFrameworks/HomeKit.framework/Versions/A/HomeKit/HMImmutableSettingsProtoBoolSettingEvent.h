...
@property (nonatomic,retain) HMImmutableSettingsProtoBoolValueEvent * value;              //@synthesize value=_value - In the implementation block
...
-(void)setValue:(HMImmutableSettingsProtoBoolValueEvent *)arg1 ;
