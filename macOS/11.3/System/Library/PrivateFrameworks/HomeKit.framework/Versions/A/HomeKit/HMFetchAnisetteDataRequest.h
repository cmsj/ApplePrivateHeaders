...
@interface HMFetchAnisetteDataRequest : HMRemoteLoginMessage <HMRemoteLoginMessageProtocol> {
	...
	char _shouldProvision;

}

@property (assign,nonatomic) char shouldProvision;                          //@synthesize shouldProvision=_shouldProvision - In the implementation block
...
-(char)shouldProvision;
-(void)setShouldProvision:(char)arg1 ;
@end
