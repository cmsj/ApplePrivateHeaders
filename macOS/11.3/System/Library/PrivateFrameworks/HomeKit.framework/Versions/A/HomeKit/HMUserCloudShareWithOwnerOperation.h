...
@property (nonatomic,readonly) char allowWriteAccess;                //@synthesize allowWriteAccess=_allowWriteAccess - In the implementation block
...
-(id)logIdentifier;
-(HMUser *)ownerUser;
-(id)initWithShare:(id)arg1 container:(id)arg2 ownerUser:(id)arg3 allowWriteAccess:(char)arg4 currentUser:(id)arg5 ;
-(id)initWithShare:(id)arg1 container:(id)arg2 ownerUser:(id)arg3 allowWriteAccess:(char)arg4 currentUser:(id)arg5 analyticsEventSender:(/*^block*/id)arg6 ;
-(id)analyticsEventSender;
-(char)allowWriteAccess;
