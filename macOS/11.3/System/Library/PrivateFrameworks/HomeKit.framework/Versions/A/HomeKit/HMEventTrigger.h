...
@property (nonatomic,readonly) char executeOnce;                                       //@synthesize executeOnce=_executeOnce - In the implementation block
...
+(char)isActionAffectedByEndEvents:(id)arg1 ;
...
-(void)_updateEvents:(id)arg1 endEvent:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)_updateEventsFromResponse:(id)arg1 responsePayload:(id)arg2 ;
-(char)_updateCharacterisiticReferenceInNewEvent:(id)arg1 ;
...
-(void)_updateExecuteOnce:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)updateExecuteOnce:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
