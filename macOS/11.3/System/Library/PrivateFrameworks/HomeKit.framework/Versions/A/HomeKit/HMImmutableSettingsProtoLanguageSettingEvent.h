...
@property (nonatomic,retain) HMImmutableSettingsProtoLanguageValueEvent * value;              //@synthesize value=_value - In the implementation block
...
-(void)setValue:(HMImmutableSettingsProtoLanguageValueEvent *)arg1 ;
