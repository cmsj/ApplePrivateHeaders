...
@interface AXMDataSonifier : NSObject {
	...
	SCD_Struct_AX4* _xData;
	SCD_Struct_AX4* _yData;
	char _usesBinauralPanning;
	char _playing;
	char _paused;
	char _scrubbing;
	char _isEndingScrubbing;
	char _isInLiveContinuousToneSession;
	int _dataMode;
...
@property (nonatomic,readonly) char isEndingScrubbing;                                             //@synthesize isEndingScrubbing=_isEndingScrubbing - In the implementation block
...
@property (nonatomic,readonly) char isPlaying;                                                     //@synthesize playing=_playing - In the implementation block
@property (nonatomic,readonly) char isPaused;                                                      //@synthesize paused=_paused - In the implementation block
@property (nonatomic,readonly) char isScrubbing;                                                   //@synthesize scrubbing=_scrubbing - In the implementation block
@property (nonatomic,readonly) char isInLiveContinuousToneSession;                                 //@synthesize isInLiveContinuousToneSession=_isInLiveContinuousToneSession - In the implementation block
...
@property (assign,nonatomic) char usesBinauralPanning;                                             //@synthesize usesBinauralPanning=_usesBinauralPanning - In the implementation block
...
-(char)hasContinuousDataForXPosition:(double)arg1 ;
...
-(char)_initializeAudioComponent;
-(char)_setAudioFormat;
-(char)_setOutputCallback;
...
-(char)usesBinauralPanning;
-(void)setUsesBinauralPanning:(char)arg1 ;
-(char)isInLiveContinuousToneSession;
