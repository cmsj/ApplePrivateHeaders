...
-(char)_eventQueue_addDetectedIOElement:(id)arg1 withDriverIdentifier:(id)arg2 ;
...
-(void)_eventQueue_brailleDisplay:(id)arg1 isSleeping:(char)arg2 ;
...
-(void)_eventQueue_setMainAttributedString:(id)arg1 shouldDisplay:(char)arg2 forceUpdate:(char)arg3 ;
...
-(void)_eventQueue_panDisplayLeft:(char)arg1 token:(int)arg2 ;
...
-(void)_eventQueue_setAlwaysUsesNemethCodeForTechnicalText:(char)arg1 ;
-(void)_eventQueue_setContractionMode:(int)arg1 ;
-(void)_eventQueue_setShowEightDotBraille:(char)arg1 ;
-(void)_eventQueue_setInputEightDotBraille:(char)arg1 ;
-(void)_refreshEightDotEnabledOnDisplays;
-(void)_eventQueue_setAutomaticBrailleTranslationEnabled:(char)arg1 ;
-(void)_eventQueue_setWordWrapEnabled:(char)arg1 ;
-(void)_eventQueue_setAutoAdvanceEnabled:(char)arg1 ;
...
-(void)_eventQueue_showDotsSevenAndEight:(char)arg1 ;
-(void)_eventQueue_showNextAnnouncement:(char)arg1 ;
-(void)_eventQueue_setLineDescriptorCallbackEnabled:(char)arg1 ;
...
-(void)_eventQueue_prepareToMemorizeNextKey:(char)arg1 immediately:(char)arg2 forDisplayWithToken:(int)arg3 ;
-(void)_eventQueue_setBatchUpdates:(char)arg1 ;
-(void)_eventQueue_setSingleLetterInputIsOn:(char)arg1 ;
-(void)_eventQueue_setTextSearchModeIsOn:(char)arg1 ;
