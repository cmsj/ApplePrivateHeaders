...
@property (assign,nonatomic) char isEnumeratorActive;                  //@synthesize isEnumeratorActive=_isEnumeratorActive - In the implementation block
@property (assign,nonatomic) char isFrontmost;                         //@synthesize isFrontmost=_isFrontmost - In the implementation block
...
-(id)filePresenterID;
-(id)_presentedItemDescription:(char)arg1 ;
-(void)setIsEnumeratorActive:(char)arg1 ;
...
-(char)isEnumeratorActive;
-(void)becomeFrontmost:(char)arg1 inWindow:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
