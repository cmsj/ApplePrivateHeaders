...
@class NSArray, NSFileProviderDomainVersion, NSURL, FPDDomain, NSObject, NSMutableDictionary, NSString;
...
-(NSArray *)rootURLs;
-(id)newFileProviderProxyWithTimeout:(char)arg1 request:(id)arg2 ;
