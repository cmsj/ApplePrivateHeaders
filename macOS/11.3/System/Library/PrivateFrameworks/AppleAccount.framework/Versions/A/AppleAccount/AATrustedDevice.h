...
@property (nonatomic,readonly) char fmipEnabled;                               //@synthesize fmipEnabled=_fmipEnabled - In the implementation block
@property (nonatomic,readonly) char currentDevice;                             //@synthesize currentDevice=_currentDevice - In the implementation block
@property (nonatomic,readonly) char showFMIPLink;                              //@synthesize showFMIPLink=_showFMIPLink - In the implementation block
@property (nonatomic,readonly) char showBackupRow;                             //@synthesize showBackupRow=_showBackupRow - In the implementation block
@property (nonatomic,readonly) char showFMIPRow;                               //@synthesize showFMIPRow=_showFMIPRow - In the implementation block
@property (nonatomic,readonly) char injectNativeHeader;                        //@synthesize injectNativeHeader=_injectNativeHeader - In the implementation block
