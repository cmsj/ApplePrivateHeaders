...
@interface AALoginResponseAppleAccountInfo : NSObject {
	...
	char _sandboxAccount;
	char _optionalTerms;
	char _familyEligible;
	NSString* _personID;
	NSString* _altDSID;
	NSString* _appleID;
...
@property (getter=isSandboxAccount,nonatomic,readonly) char sandboxAccount;              //@synthesize sandboxAccount=_sandboxAccount - In the implementation block
@property (getter=hasOptionalTerms,nonatomic,readonly) char optionalTerms;               //@synthesize optionalTerms=_optionalTerms - In the implementation block
@property (getter=isFamilyEligible,nonatomic,readonly) char familyEligible;              //@synthesize familyEligible=_familyEligible - In the implementation block
