...
-(char)_ignoreTriggersForDeviceProfile:(unsigned long long)arg1 node:(id)arg2 ;
-(char)_evaluateTriggersForBlacklisting:(id)arg1 reason:(unsigned long long)arg2 reasonData:(long long)arg3 bssid:(id)arg4 ssid:(id)arg5 state:(unsigned long long)arg6 ;
...
-(char)_meetsThresholds:(unsigned long long)arg1 count:(unsigned)arg2 perSsid:(char)arg3 bssid:(id)arg4 ssid:(id)arg5 ;
-(void)_setBlacklistedState:(id)arg1 state:(unsigned long long)arg2 reason:(unsigned long long)arg3 reasonData:(long long)arg4 ;
-(char)isNetworkInBlacklistedState:(id)arg1 state:(unsigned long long)arg2 ;
-(double)autojoinBlacklistExpiry;
-(double)bssBlacklistExpiry;
-(double)wowBlacklistExpiry;
-(void)removeBlacklistedStates;
-(char)_evaluateTriggersForUnblacklisting:(id)arg1 unblacklistReason:(unsigned long long)arg2 ssid:(id)arg3 ;
...
-(char)changeBlacklistingThresholds:(unsigned long long)arg1 value:(unsigned)arg2 perSsid:(char)arg3 ;
-(void)setTriggerForNetworkWithReason:(id)arg1 reason:(unsigned long long)arg2 reasonData:(long long)arg3 bssid:(id)arg4 ;
-(char)removeBlacklistedStateForNetworkWithReason:(id)arg1 state:(unsigned long long)arg2 reason:(unsigned long long)arg3 ;
...
-(char)isNetworkBlacklistedForAutoJoinDueToTrigDisc:(id)arg1 rssi:(long long*)arg2 timestamp:(double*)arg3 ;
