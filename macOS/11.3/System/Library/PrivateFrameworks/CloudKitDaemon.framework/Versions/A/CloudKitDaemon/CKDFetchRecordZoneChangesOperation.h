...
@interface CKDFetchRecordZoneChangesOperation : CKDFetchBatchedRecordsOperation {
	...
	char _clientIsUsingLegacyCKFetchRecordChangesOperationAPI;
...
@property (assign,nonatomic) char clientIsUsingLegacyCKFetchRecordChangesOperationAPI;              //@synthesize clientIsUsingLegacyCKFetchRecordChangesOperationAPI=_clientIsUsingLegacyCKFetchRecordChangesOperationAPI - In the implementation block
...
-(char)clientIsUsingLegacyCKFetchRecordChangesOperationAPI;
-(id)serverChangeTokenUpdatedBlock;
-(id)recordDeletedBlock;
-(void)setClientIsUsingLegacyCKFetchRecordChangesOperationAPI:(char)arg1 ;
@end
