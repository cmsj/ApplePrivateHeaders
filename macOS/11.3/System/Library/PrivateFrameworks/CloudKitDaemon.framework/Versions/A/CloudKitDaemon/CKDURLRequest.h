...
@interface CKDURLRequest : NSObject <C2RequestDelegate, CKDZoneGatekeeperWaiter, CKDFlowControllable> {
	...
	char _isWaitingOnAuthRenew;
	char _isHandlingAuthRetry;
	char _didRetryAuth;
	char _cancelled;
	char _haveCachedServerType;
	char _haveCachedPartitionType;
	char _didReceiveResponseBodyData;
	char _didFetchNilAuthToken;
...
@property (assign,nonatomic) char didRetryAuth;                                                          //@synthesize didRetryAuth=_didRetryAuth - In the implementation block
...
@property (assign,nonatomic) char didReceiveResponseBodyData;                                            //@synthesize didReceiveResponseBodyData=_didReceiveResponseBodyData - In the implementation block
...
@property (assign,nonatomic) char didFetchNilAuthToken;                                                  //@synthesize didFetchNilAuthToken=_didFetchNilAuthToken - In the implementation block
...
@property (nonatomic,readonly) char sendRequestAnonymously; 
...
@property (nonatomic,readonly) char requestGETPreAuth; 
...
@property (assign) char isWaitingOnAuthRenew;                                                            //@synthesize isWaitingOnAuthRenew=_isWaitingOnAuthRenew - In the implementation block
...
-(void)setIsWaitingOnAuthRenew:(char)arg1 ;
-(NSString *)cloudKitAuthToken;
-(char)didRetryAuth;
-(void)setDidRetryAuth:(char)arg1 ;
-(void)setIsHandlingAuthRetry:(char)arg1 ;
-(void)tearDownResourcesAndReleaseTheZoneLocks:(char)arg1 ;
...
-(void)setDidReceiveResponseBodyData:(char)arg1 ;
...
-(char)didFetchNilAuthToken;
-(void)setDidFetchNilAuthToken:(char)arg1 ;
...
-(char)didReceiveResponseBodyData;
-(char)isWaitingOnAuthRenew;
