...
@interface CKDPCSFetchAggregator : NSObject {
	...
	char _skipQueuedFetchCycleDetection;
...
@property (assign,nonatomic) char skipQueuedFetchCycleDetection;                     //@synthesize skipQueuedFetchCycleDetection=_skipQueuedFetchCycleDetection - In the implementation block
-(void)dealloc;
-(id)init;
...
-(char)fetchRequestForExistingOperation:(id)arg1 isDependentOnOperation:(id)arg2 ;
...
-(char)skipQueuedFetchCycleDetection;
...
-(void)setSkipQueuedFetchCycleDetection:(char)arg1 ;
