...
@interface CKDPipeliningInfo : NSObject {
	...
	char _perRequestCallbackQueueSuspended;
	char _isCancelled;
...
@property (assign,nonatomic) char perRequestCallbackQueueSuspended;                             //@synthesize perRequestCallbackQueueSuspended=_perRequestCallbackQueueSuspended - In the implementation block
...
-(char)perRequestCallbackQueueSuspended;
-(void)setPerRequestCallbackQueueSuspended:(char)arg1 ;
