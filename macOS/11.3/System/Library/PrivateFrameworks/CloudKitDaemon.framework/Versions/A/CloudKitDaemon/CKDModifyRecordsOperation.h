...
@property (assign,nonatomic) char haveOutstandingHandlers;                                                    //@synthesize haveOutstandingHandlers=_haveOutstandingHandlers - In the implementation block
...
@property (nonatomic,readonly) char hasDecryptOperation; 
...
@property (assign,nonatomic) char requestNeedsUserPublicKeys;                                                 //@synthesize requestNeedsUserPublicKeys=_requestNeedsUserPublicKeys - In the implementation block
...
@property (assign,nonatomic) char trustProtectionData;                                                        //@synthesize trustProtectionData=_trustProtectionData - In the implementation block
@property (assign,nonatomic) char shouldModifyRecordsInDatabase;                                              //@synthesize shouldModifyRecordsInDatabase=_shouldModifyRecordsInDatabase - In the implementation block
...
+(char)_claimPackagesInRecord:(id)arg1 error:(id*)arg2 ;
-(int)operationType;
...
-(void)setTrustProtectionData:(char)arg1 ;
...
-(void)setShouldModifyRecordsInDatabase:(char)arg1 ;
...
-(char)shouldModifyRecordsInDatabase;
-(void)_continueRecordsModify;
-(char)_hasHandlerInState:(unsigned long long)arg1 ;
-(void)_fetchShareParticipants;
-(char)haveOutstandingHandlers;
...
-(void)setHaveOutstandingHandlers:(char)arg1 ;
...
-(char)requestNeedsUserPublicKeys;
...
-(char)_shouldToposortInContainerID:(id)arg1 ;
...
-(void)setRequestNeedsUserPublicKeys:(char)arg1 ;
@end
