...
@property (nonatomic,readonly) char hasRecordDecryptOperation; 
...
@property (assign,nonatomic) char shouldRollSharePCSOnFetch;                                                 //@synthesize shouldRollSharePCSOnFetch=_shouldRollSharePCSOnFetch - In the implementation block
...
@property (assign,nonatomic) char skipDecryption;                                                            //@synthesize skipDecryption=_skipDecryption - In the implementation block
...
-(void)setSkipDecryption:(char)arg1 ;
