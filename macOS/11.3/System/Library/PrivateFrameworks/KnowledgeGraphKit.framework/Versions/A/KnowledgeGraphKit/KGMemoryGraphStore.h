...
@property (nonatomic,readonly) char hasMarker;                                            //@synthesize hasMarker=_hasMarker - In the implementation block
...
-(char)_removeMemoryEdge:(id)arg1 fromSourNode:(char)arg2 fromTargetNode:(char)arg3 error:(id*)arg4 ;
-(char)_removeEdgesForMemoryNode:(id)arg1 error:(id*)arg2 ;
-(char)_removeNode:(unsigned long long)arg1 error:(id*)arg2 ;
