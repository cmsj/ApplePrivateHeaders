...
@property (assign,nonatomic) char added;                                                           //@synthesize added=_added - In the implementation block
...
@property (getter=isLowPowerModeEnabled,nonatomic,readonly) char lowPowerModeEnabled;              //@synthesize lowPowerModeEnabled=_lowPowerModeEnabled - In the implementation block
...
@property (nonatomic,readonly) char wirelessCharging; 
