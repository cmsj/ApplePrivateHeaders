...
@class NSMutableDictionary, NSData, QSSStartSpeechRequest, NSArray;
...
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 root:(const StartMultilingualSpeechRequest*)arg2 verify:(char)arg3 ;
