...
@class NSMutableDictionary, NSData, NSString, QSSServerEndpointFeatures;
...
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 root:(const SpeechTranslationServerEndpointFeatures*)arg2 verify:(char)arg3 ;
