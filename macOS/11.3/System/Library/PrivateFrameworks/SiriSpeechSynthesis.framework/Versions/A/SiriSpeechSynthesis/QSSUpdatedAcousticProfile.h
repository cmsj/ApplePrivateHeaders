...
@class NSMutableDictionary, NSData, NSString, QSSUserAcousticProfile;
...
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 root:(const UpdatedAcousticProfile*)arg2 verify:(char)arg3 ;
