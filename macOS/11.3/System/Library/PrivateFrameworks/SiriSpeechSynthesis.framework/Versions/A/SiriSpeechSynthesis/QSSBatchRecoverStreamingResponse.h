...
@class NSMutableDictionary, NSData, QSSPronGuessResponse, QSSBatchRecoverFinalResponse;
...
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 root:(const BatchRecoverStreamingResponse*)arg2 verify:(char)arg3 ;
