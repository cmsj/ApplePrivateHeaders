...
@class NSMutableDictionary, NSData, QSSBatchTranslationResponse, QSSFinalBlazarResponse;
...
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 root:(const BatchTranslationStreamingResponse*)arg2 verify:(char)arg3 ;
