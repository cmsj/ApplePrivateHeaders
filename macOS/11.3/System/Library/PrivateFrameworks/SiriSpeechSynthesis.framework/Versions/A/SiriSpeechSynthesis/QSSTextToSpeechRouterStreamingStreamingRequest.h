...
@class NSMutableDictionary, NSData, QSSStartTextToSpeechStreamingRequest;
...
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 root:(const TextToSpeechRouterStreamingStreamingRequest*)arg2 verify:(char)arg3 ;
