...
@class NSMutableDictionary, NSData, QSSTextToSpeechVoice, QSSTextToSpeechResource;
...
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 root:(const TextToSpeechMeta*)arg2 verify:(char)arg3 ;
