...
@property (readonly) char isTranslocated;                                //@synthesize isTranslocated=_isTranslocated - In the implementation block
...
-(char)addSelfToBuffer:(SCD_Struct_SA26*)arg1 bufferLength:(unsigned long long)arg2 withCompletedSerializationDictionary:(id)arg3 ;
...
-(unsigned long long)indexOfFirstTaskStateOnOrAfterTime:(id)arg1 withSampleIndex:(char)arg2 ;
-(unsigned long long)indexOfLastTaskStateOnOrBeforeTime:(id)arg1 withSampleIndex:(char)arg2 ;
-(int)rpid;
-(char)isTranslocated;
...
-(id)lastTaskStateOnOrBeforeTime:(id)arg1 withSampleIndex:(char)arg2 ;
-(id)firstTaskStateOnOrAfterTime:(id)arg1 withSampleIndex:(char)arg2 ;
-(void)dealloc;
...
-(char)isUnresponsive;
-(void)enumerateTaskStatesBetweenStartTime:(id)arg1 endTime:(id)arg2 reverseOrder:(char)arg3 withSampleIndex:(char)arg4 block:(/*^block*/id)arg5 ;
