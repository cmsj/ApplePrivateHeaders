...
-(char)addSelfToBuffer:(SCD_Struct_SA25*)arg1 bufferLength:(unsigned long long)arg2 withCompletedSerializationDictionary:(id)arg3 ;
...
-(char)hasUnresponsiveMountsForThreadID:(unsigned long long)arg1 ;
