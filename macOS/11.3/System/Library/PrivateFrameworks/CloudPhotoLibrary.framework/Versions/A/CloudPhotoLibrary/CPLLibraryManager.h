...
-(char)_setStatus:(unsigned long long)arg1 andError:(id)arg2 ;
...
-(void)_getMappedScopedIdentifiersForScopedIdentifiers:(id)arg1 inAreLocalIdentifiers:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)setShouldOverrideSystemBudgetsForSyncSession:(char)arg1 ;
-(void)getStatusForRecordsWithIdentifiers:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)addStatusChangesForRecordsWithIdentifiers:(id)arg1 persist:(char)arg2 ;
...
-(void)reportSetting:(id)arg1 hasBeenEnabled:(char)arg2 ;
@end
