...
-(id)setupTaskUpdateDisabledFeatures:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(void)cancelBlockedTasksIncludingBackground:(char)arg1 ;
...
-(char)isResourceDynamic:(id)arg1 ;
