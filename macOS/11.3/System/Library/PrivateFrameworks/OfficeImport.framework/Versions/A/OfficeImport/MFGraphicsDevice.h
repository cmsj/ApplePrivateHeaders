...
-(id)recolor:(unsigned char)arg1 in_green:(unsigned char)arg2 in_blue:(unsigned char)arg3 fill:(char)arg4 ;
-(int)removeClip;
-(id)getCurrentFont;
...
-(int)createPatternBrush:(id)arg1 index:(unsigned)arg2 usePaletteForBilevel:(char)arg3 ;
-(int)abortPath;
-(int)beginPath;
-(int)widenPath;
-(int)endPath;
...
-(int)stretchBlt:(int)arg1 in_yDest:(int)arg2 in_widthDest:(int)arg3 in_heightDest:(int)arg4 in_sourceImage:(id)arg5 in_xSrc:(int)arg6 in_ySrc:(int)arg7 in_widthSrc:(int)arg8 in_heightSrc:(int)arg9 in_rop:(unsigned)arg10 in_xform:(CGAffineTransform*)arg11 in_colour:(unsigned)arg12 usePaletteForBilevel:(char)arg13 ;
-(int)alphaBlend:(int)arg1 in_yDest:(int)arg2 in_widthDest:(int)arg3 in_heightDest:(int)arg4 in_sourceImage:(id)arg5 in_xSrc:(int)arg6 in_ySrc:(int)arg7 in_widthSrc:(int)arg8 in_heightSrc:(int)arg9 in_sourceConstantOpacity:(unsigned char)arg10 in_useSourceAlphaChannel:(char)arg11 in_xform:(CGAffineTransform*)arg12 in_colour:(unsigned)arg13 ;
