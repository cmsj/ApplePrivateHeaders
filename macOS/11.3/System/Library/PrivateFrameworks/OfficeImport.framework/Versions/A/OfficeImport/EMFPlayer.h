...
-(void)done;
-(int)playPolyBezier:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
-(int)playPolygon:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
-(int)playPolyLine:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
-(int)playPolyBezierTo:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
-(int)playPolyLineTo:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
-(int)playPolyPolyLine:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
-(int)playPolyPolygon:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
...
-(int)playAngleArc:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
-(int)playArcTo:(unsigned)arg1 in_pRecord:(const char*)arg2 ;
-(int)playPolyDraw:(unsigned)arg1 in_pRecord:(const char*)arg2 in_is16bit:(char)arg3 ;
...
-(int)playStrokeAndFillPath:(unsigned)arg1 in_pRecord:(const char*)arg2 in_stroke:(char)arg3 in_fill:(char)arg4 ;
...
-(int)playExtTextOut:(unsigned)arg1 in_pRecord:(const char*)arg2 wideChars:(char)arg3 ;
-(id)getGdi;
