...
@class EDSheet, EDFormula, EDName, EDRowBlocks, NSMutableDictionary, OITSUPointerKeyDictionary;
...
-(char)isArrayedFormulaSupported:(id)arg1 allowSimpleRanges:(char)arg2 formulasBeingEvaluated:(id)arg3 ;
-(char)doesNameIndexContainCircularReferences:(unsigned)arg1 sheetIndex:(unsigned long long)arg2 previousNameIndexes:(set<unsigned int, std::__1::less<unsigned int>, std::__1::allocator<unsigned int>>*)arg3 ;
