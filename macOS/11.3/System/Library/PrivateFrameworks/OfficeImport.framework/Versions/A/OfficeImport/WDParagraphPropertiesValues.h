...
@property (assign) SCD_Struct_WD113 dropCap;                                      //@synthesize dropCap=_dropCap - In the implementation block
...
-(SCD_Struct_WD113)dropCap;
-(void)setDropCap:(SCD_Struct_WD113)arg1 ;
