...
+(char)isValidDataDetectorsMatch:(_DDResult*)arg1 addressComponents:(id*)arg2 ;
+(char)_components:(id)arg1 haveHongKongAtKey:(id)arg2 ;
+(char)_componentsHaveStreetAndCityOrZip:(id)arg1 ;
@end
