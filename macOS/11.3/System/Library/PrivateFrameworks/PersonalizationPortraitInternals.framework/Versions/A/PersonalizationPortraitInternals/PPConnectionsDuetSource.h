...
-(id)locationItemsWithCriteria:(id)arg1 earliest:(id)arg2 latest:(id)arg3 limit:(unsigned long long)arg4 duetLimit:(long long)arg5 consumer:(unsigned long long)arg6 richLocationItems:(char)arg7 resolveEKLocations:(char)arg8 explanationSet:(id)arg9 ;
-(id)supportedLocationFields;
-(char)testMetadataForValidAddressAndNameWithEvent:(id)arg1 ;
-(char)isDuetEventAuthorized:(id)arg1 bundleID:(id)arg2 ;
