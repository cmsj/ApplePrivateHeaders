...
-(void)navigationListener:(id)arg1 didUpdatePositionFromSign:(SCD_Struct_PP27)arg2;
-(void)navigationListener:(id)arg1 didUpdatePositionFromManeuver:(SCD_Struct_PP27)arg2;
