...
@interface SignpostEvent : SignpostObject <SignpostSupportLoggingSupportArchiveEvent> {
	...
	char __hasTotalFrames;
	char _isAnimationStart;
	int _tv_usec;
	int _tz_minuteswest;
	int _tz_dsttime;
	int _processID;
...
@property (assign,nonatomic) char _hasTotalFrames;                                              //@synthesize _hasTotalFrames=__hasTotalFrames - In the implementation block
...
@property (assign,nonatomic) char isAnimationStart;                                             //@synthesize isAnimationStart=_isAnimationStart - In the implementation block
...
@property (nonatomic,readonly) char overridesTime; 
@property (nonatomic,readonly) char _overridesOwnTime; 
...
@property (nonatomic,readonly) char overridesBeginTime; 
@property (nonatomic,readonly) char overridesEndTime; 
@property (nonatomic,readonly) char overridesEmitTime; 
...
@property (nonatomic,readonly) char isSyntheticIntervalEvent; 
...
-(char)_processName:(id)arg1 formatterName:(id)arg2 formatType:(id)arg3 value:(id)arg4 ;
...
-(char)isAnimationStart;
-(void)set_totalFrameCount:(unsigned long long)arg1 ;
-(char)isSyntheticIntervalEvent;
...
-(void)setIsAnimationStart:(char)arg1 ;
...
-(void)set_hasTotalFrames:(char)arg1 ;
