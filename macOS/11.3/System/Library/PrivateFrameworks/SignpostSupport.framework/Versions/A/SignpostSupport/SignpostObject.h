...
@property (assign,nonatomic) char telemetryEnabled;                      //@synthesize telemetryEnabled=_telemetryEnabled - In the implementation block
...
-(void)setTelemetryEnabled:(char)arg1 ;
