...
-(id)initWithAnimationBeginEvent:(id)arg1 shouldTrackComposites:(char)arg2 ;
-(void)_handleCommitInterval:(id)arg1 isLong:(char)arg2 isConcise:(char)arg3 ;
-(void)_handleTransactionLifetimeInterval:(id)arg1 isLong:(char)arg2 isConcise:(char)arg3 ;
-(void)_handleHIDLatency:(id)arg1 isLong:(char)arg2 isConcise:(char)arg3 ;
-(void)_handleRenderServerRender:(id)arg1 isLong:(char)arg2 isConcise:(char)arg3 ;
-(void)_handleFrameLatency:(id)arg1 isLong:(char)arg2 isConcise:(char)arg3 ;
-(void)_handleFrameLifetime:(id)arg1 isLong:(char)arg2 isConcise:(char)arg3 ;
