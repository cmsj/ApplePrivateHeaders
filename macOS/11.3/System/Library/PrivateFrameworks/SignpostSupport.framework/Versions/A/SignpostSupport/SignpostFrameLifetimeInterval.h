...
@property (nonatomic,readonly) char hidLatencyIsLong; 
@property (nonatomic,readonly) char renderIntervalIsLong; 
@property (nonatomic,readonly) char frameLatencyIsLong; 
...
@property (nonatomic,readonly) char mayBeFirstFrame; 
