...
-(void)addObject:(id)arg1 retained:(char)arg2 purgeable:(char)arg3 ;
-(void)addReferencedObject:(id)arg1 internallyRetained:(char)arg2 ;
-(void)addPurgeableObject:(id)arg1 ;
-(void)lockPurgeableObjects;
-(void)unlockPurgeableObjects;
-(void)removeAllReferencedObjects:(char)arg1 ;
...
-(char)testObjectReferenced:(id)arg1 wasInternallyRetained:(char*)arg2 ;
-(void)addActiveRenderTargets:(id)arg1 ;
-(void)addActiveRenderTarget:(id)arg1 ;
-(char)renderTargetInActiveRenderTargets:(id)arg1 ;
@end
