...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT105 _vertexBuffers[36];
	SCD_Struct_MT105 _vertexTextures[128];
	SCD_Struct_MT105 _vertexSamplers[16];
	SCD_Struct_MT105 _fragmentBuffers[31];
	SCD_Struct_MT105 _fragmentTextures[128];
	SCD_Struct_MT105 _fragmentSamplers[16];
	SCD_Struct_MT105 _tileBuffers[31];
	SCD_Struct_MT105 _tileTextures[128];
	SCD_Struct_MT105 _tileSamplers[16];
	SCD_Struct_MT105 _threadgroupMemoryArguments[31];
	...
	SCD_Struct_MT105 _tessellationFactorBufferArgument;
...
@property (nonatomic,readonly) SCD_Struct_MT105 tessellationFactorBufferArgument;                      //@synthesize tessellationFactorBufferArgument=_tessellationFactorBufferArgument - In the implementation block
...
-(void)dispatchThreadsPerTile:(SCD_Struct_MT106)arg1 ;
...
-(SCD_Struct_MT105)tessellationFactorBufferArgument;
