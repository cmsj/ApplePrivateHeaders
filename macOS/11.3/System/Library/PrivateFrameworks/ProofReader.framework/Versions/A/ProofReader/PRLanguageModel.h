...
-(char)tokenSequenceIsBlocklisted:(const unsigned*)arg1 length:(unsigned long long)arg2 ;
...
-(char)getUnigramProbabilityForString:(id)arg1 probability:(double*)arg2 ;
-(char)getFirstDynamicTokenID:(unsigned*)arg1 lastDynamicTokenID:(unsigned*)arg2 ;
...
-(char)addTokenForString:(id)arg1 tokenID:(unsigned*)arg2 ;
-(char)shouldAdaptToTokenSequence:(const unsigned*)arg1 length:(unsigned long long)arg2 ;
