...
@property (nonatomic,readonly) unsigned long long requestFeedType;              //@synthesize requestFeedType=_requestFeedType - In the implementation block
@property (nonatomic,readonly) NSString * requestCacheKey;                      //@synthesize requestCacheKey=_requestCacheKey - In the implementation block
