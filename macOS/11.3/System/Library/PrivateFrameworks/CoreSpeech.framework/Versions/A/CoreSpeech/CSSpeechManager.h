...
@class NSObject, CSAudioRecorder, NSMutableDictionary, CSFallbackAudioSessionReleaseProvider, CSBuiltInVoiceTrigger, CSVoiceTriggerEventsCoordinator, CSVoiceTriggerFileLogger, CSSelfTriggerDetector, CSKeywordDetector, CSMyriadPHash, CSMyriadSelfTriggerCoordinator, CSVoiceTriggerFidesClient, CSVoiceTriggerFirstPassJarvis, CSVoiceTriggerFirstPassHearst, CSVoiceTriggerFirstPassHearstAP, CSVoiceProfileRetrainManager, CSAcousticSLProxy, CSOpportuneSpeakListnerTestService, CSPostBuildInstallService, CSSmartSiriVolumeManager, NSString;
...
@property (nonatomic,retain) CSVoiceTriggerEventsCoordinator * voiceTriggerEventNotifier;                              //@synthesize voiceTriggerEventNotifier=_voiceTriggerEventNotifier - In the implementation block
...
@property (nonatomic,retain) CSAcousticSLProxy * acousticSL;                                                           //@synthesize acousticSL=_acousticSL - In the implementation block
...
-(id)_voiceTriggerEventNotifierCreateIfNeeded:(char)arg1 ;
-(void)_startVoiceTrigger;
-(id)_voiceTriggerFileLoggerCreateIfNeeded:(char)arg1 ;
-(id)_myriadSelfTriggerCoordinatorIfNeeded:(char)arg1 ;
...
-(char)_prepareForBluetoothDeviceWithDeviceType:(unsigned long long)arg1 ;
...
-(CSVoiceTriggerEventsCoordinator *)voiceTriggerEventNotifier;
...
-(void)setVoiceTriggerEventNotifier:(CSVoiceTriggerEventsCoordinator *)arg1 ;
...
-(CSAcousticSLProxy *)acousticSL;
-(void)setAcousticSL:(CSAcousticSLProxy *)arg1 ;
