...
@property (assign,nonatomic) char endPointNotified;                                   //@synthesize endPointNotified=_endPointNotified - In the implementation block
...
-(char)endPointNotified;
-(void)setEndPointNotified:(char)arg1 ;
