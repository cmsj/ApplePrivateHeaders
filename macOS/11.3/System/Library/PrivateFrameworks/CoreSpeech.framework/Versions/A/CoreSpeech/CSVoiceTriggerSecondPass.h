...
@interface CSVoiceTriggerSecondPass : NSObject <CSKeywordAnalyzerNDEAPIScoreDelegate, CSVoiceTriggerEnabledMonitorDelegate, CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSMediaPlayingMonitorDelegate, CSVolumeMonitorDelegate, SSRSpeakerRecognitionControllerDelegate, CSSelfTriggerDetectorDelegate> {
	...
	char _isSecondChanceHot;
	char _shouldUsePHS;
	char _hasPendingNearMiss;
	char _didWakeAP;
	char _hasTriggerCandidate;
	char _isStartSampleCountMarked;
	char _secondPassHasMadeDecision;
...
@property (assign,nonatomic) char isSecondChanceHot;                                                      //@synthesize isSecondChanceHot=_isSecondChanceHot - In the implementation block
...
@property (assign,nonatomic) char shouldUsePHS;                                                           //@synthesize shouldUsePHS=_shouldUsePHS - In the implementation block
...
@property (assign,nonatomic) char hasPendingNearMiss;                                                     //@synthesize hasPendingNearMiss=_hasPendingNearMiss - In the implementation block
...
@property (assign,nonatomic) char didWakeAP;                                                              //@synthesize didWakeAP=_didWakeAP - In the implementation block
...
@property (assign,nonatomic) char isStartSampleCountMarked;                                               //@synthesize isStartSampleCountMarked=_isStartSampleCountMarked - In the implementation block
...
@property (assign,nonatomic) char secondPassHasMadeDecision;                                              //@synthesize secondPassHasMadeDecision=_secondPassHasMadeDecision - In the implementation block
...
-(id)initWithPHSEnabled:(char)arg1 ;
...
-(id)initWithPHSEnabled:(char)arg1 speechManager:(id)arg2 ;
-(void)setAudioProviderUUID:(NSString *)arg1 ;
-(void)_prepareStartAudioStream;
-(void)_didStartAudioStream:(char)arg1 ;
...
-(void)_mpAnalyzeForTriggerDetection:(id)arg1 forceMaximized:(char)arg2 ;
-(void)_analyzeForKeywordDetection:(id)arg1 forChannel:(unsigned long long)arg2 forceMaximized:(char)arg3 ;
...
-(void)_logUptimeWithVTSwitchChanged:(char)arg1 VTEnabled:(char)arg2 ;
-(char)_shouldLogMediaplayState:(unsigned long long)arg1 ;
...
-(char)_supportTwoShotFeedbackDelay;
-(void)_resetUpTime;
...
-(char)isSecondChanceHot;
-(void)setIsSecondChanceHot:(char)arg1 ;
...
-(char)shouldUsePHS;
-(void)setShouldUsePHS:(char)arg1 ;
...
-(char)hasPendingNearMiss;
-(void)setHasPendingNearMiss:(char)arg1 ;
...
-(char)didWakeAP;
-(void)setDidWakeAP:(char)arg1 ;
-(char)isStartSampleCountMarked;
-(void)setIsStartSampleCountMarked:(char)arg1 ;
...
-(char)secondPassHasMadeDecision;
-(void)setSecondPassHasMadeDecision:(char)arg1 ;
