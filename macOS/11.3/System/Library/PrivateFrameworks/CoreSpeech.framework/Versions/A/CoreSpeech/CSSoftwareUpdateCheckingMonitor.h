...
-(void)_didReceiveSoftwareUpdateCheckingStateChanged:(char)arg1 ;
-(unsigned char)_softwareUpdateCheckingState;
-(void)_notifyObserver:(id)arg1 withSoftwareUpdateCheckingRunning:(char)arg2 ;
-(char)isSoftwareUpdateCheckingRunning;
-(void)_didReceiveSoftwareUpdateCheckingStateChangedInQueue:(char)arg1 ;
@end
