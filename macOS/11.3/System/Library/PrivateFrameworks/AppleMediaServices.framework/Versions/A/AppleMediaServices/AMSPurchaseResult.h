...
@property (copy) NSString * correlationID;                       //@synthesize correlationID=_correlationID - In the implementation block
@property (copy) NSError * error;                                //@synthesize error=_error - In the implementation block
@property (copy) AMSPurchase * purchase;                         //@synthesize purchase=_purchase - In the implementation block
