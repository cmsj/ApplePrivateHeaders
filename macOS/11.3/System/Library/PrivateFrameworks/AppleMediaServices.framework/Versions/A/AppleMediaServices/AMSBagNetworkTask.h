...
+(char)_shouldReloadDataForOriginalCookies:(id)arg1 newCookies:(id)arg2 ;
...
-(char)_shouldRetryForResult:(id)arg1 cookieNames:(id)arg2 urlCookies:(id)arg3 newStorefront:(id)arg4 ;
