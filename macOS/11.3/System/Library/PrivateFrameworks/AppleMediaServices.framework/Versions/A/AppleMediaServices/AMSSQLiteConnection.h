...
-(char)finalizePreparedStatement:(id)arg1 error:(id*)arg2 ;
-(char)truncate;
...
-(char)_openAndAllowRetry:(char)arg1 ;
-(void)_finalizeAllStatements;
-(char)_executeWithError:(id*)arg1 usingBlock:(/*^block*/id)arg2 ;
-(char)_resetAfterCorruptionError;
-(char)_resetAfterIOError;
...
-(char)executeWithError:(id*)arg1 usingBlock:(/*^block*/id)arg2 ;
@end
