...
@interface MRTransportExternalDevice : MRExternalDevice <MRProtocolClientConnectionDelegate> {
	...
	char _wantsNowPlayingNotifications;
	char _wantsNowPlayingArtworkNotifications;
	char _wantsVolumeNotifications;
	char _wantsOutputDeviceNotifications;
	char _wantsSystemEndpointNotifications;
	...
	char _forceReconnectOnConnectionFailure;
	char _disconnecting;
	char _isClientSyncActive;
	MROSTransaction* _transaction;
	NSArray* _subscribedPlayerPaths;
	char _isCallingClientCallback;
...
@property (assign,nonatomic) char isCallingClientCallback;                                                     //@synthesize isCallingClientCallback=_isCallingClientCallback - In the implementation block
...
-(void)setIsCallingClientCallback:(char)arg1 ;
...
-(void)_onWorkerQueue_connectWithOptions:(unsigned)arg1 isRetry:(char)arg2 clientBundleIdentifier:(id)arg3 userInfo:(id)arg4 ;
...
-(id)_createPlaybackQueue:(char)arg1 ;
