...
@interface MRDistantExternalDevice : MRExternalDevice <MRAVDistantExternalDeviceClientProtocol> {
	...
	NSNumber* _isPaired;
	char _hasEverAttemptedToConnect;
...
@property (nonatomic,readonly) char hasEverAttemptedToConnect;                                       //@synthesize hasEverAttemptedToConnect=_hasEverAttemptedToConnect - In the implementation block
...
-(char)hasEverAttemptedToConnect;
@end
