...
@property (assign,nonatomic) char shouldFadeAudio;                               //@synthesize shouldFadeAudio=_shouldFadeAudio - In the implementation block
-(NSString *)password;
...
-(void)setShouldFadeAudio:(char)arg1 ;
