...
@property (nonatomic,readonly) char hasMaxQuotaTier;                         //@synthesize hasMaxQuotaTier=_hasMaxQuotaTier - In the implementation block
+(id)storageInfoWithTotal:(long long)arg1 available:(long long)arg2 used:(long long)arg3 cameraRollBackupBytes:(long long)arg4 photosMediaUsage:(long long)arg5 hasMaxQuotaTier:(char)arg6 ;
-(id)description;
...
-(char)hasMaxQuotaTier;
-(id)initWithTotalQuotaBytes:(long long)arg1 totalAvailableBytes:(long long)arg2 totalUsedBytes:(long long)arg3 cameraRollBackupBytes:(long long)arg4 photosMediaUsage:(long long)arg5 hasMaxQuotaTier:(char)arg6 ;
@end
