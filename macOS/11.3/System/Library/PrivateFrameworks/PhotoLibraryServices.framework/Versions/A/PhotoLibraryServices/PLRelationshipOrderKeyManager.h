...
@interface PLRelationshipOrderKeyManager : NSObject {
	...
	char _inWriteStashedLocationMode;

}

@property (assign) char inWriteStashedLocationMode;                                        //@synthesize inWriteStashedLocationMode=_inWriteStashedLocationMode - In the implementation block
...
-(char)inWriteStashedLocationMode;
...
-(id)_inq_orderingStateForRelationship:(id)arg1 onObjectWithID:(id)arg2 invalidateCache:(char)arg3 ;
...
-(id)objectIDsAndOrderValuesForRelationship:(id)arg1 onObjectWithID:(id)arg2 invalidateCache:(char)arg3 ;
...
-(char)writeStashedLocationValuesInContext:(id)arg1 error:(id*)arg2 ;
...
-(void)setInWriteStashedLocationMode:(char)arg1 ;
