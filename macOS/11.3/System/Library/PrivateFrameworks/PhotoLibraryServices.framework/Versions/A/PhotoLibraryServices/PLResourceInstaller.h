...
+(char)installInternalResourcesForExistingAsset:(id)arg1 assumeNoExistingResources:(char)arg2 referencedResourceURLs:(id)arg3 error:(id*)arg4 ;
+(id)onDemand_installPrimaryImageResourceWithRecipe:(id)arg1 version:(unsigned)arg2 forAsset:(id)arg3 ;
+(char)installSupplementalResourceForExistingFileAtURL:(id)arg1 ptpTrashedState:(long long)arg2 index:(id)arg3 forAsset:(id)arg4 imageOrientation:(id)arg5 resultingResource:(id*)arg6 error:(id*)arg7 ;
+(id)generateValidatedExternalImageResourceOfType:(unsigned)arg1 forFilePath:(id)arg2 requireFileToBePresent:(char)arg3 version:(unsigned)arg4 basedOnFullSizeWidth:(long long)arg5 andHeight:(long long)arg6 isNativeColorSpace:(char)arg7 isLosslessEncoding:(char)arg8 recipe:(id)arg9 assetKind:(short)arg10 context:(id)arg11 ;
+(void)_recipeAndDerivativeStateFromCPLResourceType:(unsigned long long)arg1 fromAdjustedSet:(char)arg2 assetType:(short)arg3 recipeID:(unsigned*)arg4 ;
...
+(char)_isPenultimateVersionFromCPLType:(unsigned long long)arg1 ;
+(id)validatedExternalResourceFromExternalResourceCloudAttributes:(id)arg1 cplType:(unsigned long long)arg2 assetType:(short)arg3 uti:(id)arg4 originalOrientation:(unsigned)arg5 orientation:(unsigned)arg6 originalColorSpace:(id)arg7 resourceWidth:(unsigned long long)arg8 resourceHeight:(unsigned long long)arg9 assetWidth:(unsigned long long)arg10 assetHeight:(unsigned long long)arg11 resourceFingerprint:(id)arg12 resourceSize:(unsigned long long)arg13 isAvailable:(char)arg14 fromAdjustedSet:(char)arg15 resourceURL:(id)arg16 cloudMaster:(id)arg17 isForMigration:(char)arg18 context:(id)arg19 ;
...
+(char)isValidCPLResourceTypeForPersistence:(unsigned long long)arg1 ;
+(id)generateExternalResourceFromCPLResource:(id)arg1 cloudMaster:(id)arg2 masterResources:(id)arg3 ;
+(id)generateExternalResourceFromCPLResource:(id)arg1 asset:(id)arg2 fromAdjustedSet:(char)arg3 ;
+(unsigned)recipeIDFromCPLResourceType:(unsigned long long)arg1 assetType:(short)arg2 fromAdjustedSet:(char)arg3 ;
+(unsigned)resourceVersionFromCPLType:(unsigned long long)arg1 fromAdjustedSet:(char)arg2 ;
...
+(char)resetInternalResourcesInStore:(id)arg1 resetUTIs:(char)arg2 resetCodecs:(char)arg3 resetMasters:(char)arg4 migrator:(id)arg5 ;
+(char)resetImageRequestHintsInStore:(id)arg1 migrator:(id)arg2 ;
+(char)removeLegacyCloudResourcesInStore:(id)arg1 migrator:(id)arg2 ;
+(char)createInternalResourcesForExistingAssetsWithNoExistingResourcesInStore:(id)arg1 migrator:(id)arg2 ;
+(char)reconsiderSavedAssetTypeInStore:(id)arg1 migrator:(id)arg2 ;
...
+(char)recoverSupplementalResourcesForAsset:(id)arg1 usingSidecarFinder:(id)arg2 outResourcesStoreCount:(unsigned long long*)arg3 error:(id*)arg4 ;
+(char)_installInternalResourcesForExistingAsset:(id)arg1 assumeNoExistingResources:(char)arg2 referencedResourceURLs:(id)arg3 includeLegacyCloudResources:(char)arg4 outResourcesStoreCount:(unsigned long long*)arg5 error:(id*)arg6 ;
...
+(id)generateAdjustedFullSizeRenderResourceForFilePath:(id)arg1 requireFileToBePresent:(char)arg2 basedOnFullSizeWidth:(long long)arg3 andHeight:(long long)arg4 context:(id)arg5 ;
...
+(char)installInternalResourcesForExistingAssetsWithNoExistingResourcesInManagedObjectContext:(id)arg1 migrator:(id)arg2 ;
+(id)generateValidatedExternalOtherResourceOfType:(unsigned)arg1 forFilePath:(id)arg2 uti:(id)arg3 requireFileToBePresent:(char)arg4 version:(unsigned)arg5 ;
@end
