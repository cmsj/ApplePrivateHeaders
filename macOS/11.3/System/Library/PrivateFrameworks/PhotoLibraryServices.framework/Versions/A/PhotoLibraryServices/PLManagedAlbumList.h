...
+(char)restoreAlbumListFromPersistedDataAtPath:(id)arg1 library:(id)arg2 ;
...
+(void)persistAlbumListUUIDs:(id)arg1 type:(short)arg2 pathManager:(id)arg3 allowsOverwrite:(char)arg4 ;
