...
@property (nonatomic,readonly) char preservesCurrentBalance;                         //@synthesize preservesCurrentBalance=_preservesCurrentBalance - In the implementation block
