...
@property (assign,nonatomic) char isInDisasterRecovery;                                                                   //@synthesize isInDisasterRecovery=_isInDisasterRecovery - In the implementation block
...
-(char)isInDisasterRecovery;
-(void)setIsInDisasterRecovery:(char)arg1 ;
