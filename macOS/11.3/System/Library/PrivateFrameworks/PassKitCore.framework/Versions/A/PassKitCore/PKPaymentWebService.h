...
-(char)registrationSetupSupportedInRegion;
...
-(char)_needsRegistrationShouldCheckSecureElementOwnership:(char)arg1 ;
...
-(char)isChinaRegionIdentifier:(id)arg1 ;
...
-(unsigned long long)physicalCardsWithRequest:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(unsigned long long)accountUsersWithRequest:(id)arg1 completion:(/*^block*/id)arg2 ;
-(unsigned long long)deleteAccountUserWithRequest:(id)arg1 completion:(/*^block*/id)arg2 ;
-(unsigned long long)updateAccountUserPreferencesWithRequest:(id)arg1 completion:(/*^block*/id)arg2 ;
-(unsigned long long)sharedAccountCloudStoreWithRequest:(id)arg1 completion:(/*^block*/id)arg2 ;
-(unsigned long long)createdZoneWithRequest:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)_deviceProvisioningDataIncludingDeviceMetadata:(char)arg1 withCompletion:(/*^block*/id)arg2 ;
...
-(void)_handleRemoteCloudStoreAssetForRecordName:(id)arg1 taskRecord:(id)arg2 data:(id)arg3 shouldWriteData:(char)arg4 ;
-(void)_handleRemoteAssetDownloadForManifestItem:(id)arg1 taskPassURL:(id)arg2 data:(id)arg3 shouldWriteData:(char)arg4 ;
...
-(unsigned long long)sendOwnershipTokensForReason:(unsigned long long)arg1 completion:(/*^block*/id)arg2 ;
...
-(unsigned long long)devicePassesSinceLastUpdatedTag:(char)arg1 withCompletion:(/*^block*/id)arg2 ;
