...
@property (assign,nonatomic) char supportsTransitOnly;                                                                 //@synthesize supportsTransitOnly=_supportsTransitOnly - In the implementation block
...
-(void)setSupportsTransitOnly:(char)arg1 ;
