...
-(void)performRequest:(id)arg1 taskIdentifier:(unsigned long long)arg2 retries:(unsigned long long)arg3 authHandling:(char)arg4 cacheResponse:(char)arg5 completionHandler:(/*^block*/id)arg6 ;
...
-(void)performRequest:(id)arg1 taskIdentifier:(unsigned long long)arg2 cacheResponse:(char)arg3 completionHandler:(/*^block*/id)arg4 ;
-(void)performRequest:(id)arg1 taskIdentifier:(unsigned long long)arg2 retries:(unsigned long long)arg3 authHandling:(char)arg4 completionHandler:(/*^block*/id)arg5 ;
