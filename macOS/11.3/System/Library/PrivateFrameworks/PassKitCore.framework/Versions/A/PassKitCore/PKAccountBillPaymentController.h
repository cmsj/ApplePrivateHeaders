...
@interface PKAccountBillPaymentController : NSObject <PKPaymentAuthorizationCoordinatorDelegate, PKPaymentAuthorizationCoordinatorPrivateDelegate> {
	...
	char _accountPaymentSupportsPeerPaymentBalance;
	char _peerPaymentAccountSupportsAccountPayments;
...
-(char)_accountPaymentSupportsPeerPaymentForDate:(id)arg1 ;
...
-(void)_updateUseApplePayCashSetting:(char)arg1 ;
...
-(id)_achPayment;
-(id)_apcPayment;
-(char)_shouldUsePeerPaymentBalance;
