...
-(id)objectForContextualKeyPath:(id)arg1 synchronous:(char)arg2 responseQueue:(id)arg3 withCompletion:(/*^block*/id)arg4 ;
...
-(id)lastModifiedDateForContextualKeyPath:(id)arg1 synchronous:(char)arg2 responseQueue:(id)arg3 withCompletion:(/*^block*/id)arg4 ;
...
-(char)setObject:(id)arg1 forContextualKeyPath:(id)arg2 synchronous:(char)arg3 responseQueue:(id)arg4 withCompletion:(/*^block*/id)arg5 ;
-(char)addObjects:(id)arg1 toArrayAtKeyPath:(id)arg2 synchronous:(char)arg3 responseQueue:(id)arg4 withCompletion:(/*^block*/id)arg5 ;
-(char)removeObjects:(id)arg1 fromArrayAtKeyPath:(id)arg2 synchronous:(char)arg3 responseQueue:(id)arg4 withCompletion:(/*^block*/id)arg5 ;
-(id)removeObjectsMatchingPredicate:(id)arg1 fromArrayAtKeyPath:(id)arg2 synchronous:(char)arg3 responseQueue:(id)arg4 withCompletion:(/*^block*/id)arg5 ;
-(char)addObjects:(id)arg1 andRemoveObjects:(id)arg2 fromArrayAtKeyPath:(id)arg3 synchronous:(char)arg4 responseQueue:(id)arg5 withCompletion:(/*^block*/id)arg6 ;
-(id)valuesForKeyPaths:(id)arg1 synchronous:(char)arg2 responseQueue:(id)arg3 withCompletion:(/*^block*/id)arg4 ;
...
-(char)setObject:(id)arg1 lastModifiedDate:(id)arg2 forContextualKeyPath:(id)arg3 ;
