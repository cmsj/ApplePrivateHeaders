...
@class NSMutableArray, NSString, CBABCurve, CBDisplayModuleSKL;
...
@property (readonly) CBDisplayModuleSKL * displayModule;              //@synthesize displayModule=_displayModule - In the implementation block
...
-(void)endFastRamp;
-(CBDisplayModuleSKL *)displayModule;
-(char)handleDisplayPowerStateUpdate:(id)arg1 ;
-(id)newStatusInfo;
-(void)usableBrightnessRangeChangedHandler:(id)arg1 ;
-(char)handleChargerStateUpdate:(id)arg1 ;
-(void)updateBrightnessForce:(char)arg1 periodOverride:(char)arg2 period:(float)arg3 properties:(id)arg4 ;
-(char)brightnessUpdatePermitted;
-(void)updateSuspend:(float)arg1 ;
-(void)userBrightnessChangeHandler:(id)arg1 ;
-(void)userBrightnessCommitHandler:(id)arg1 ;
@end
