...
@class GraphManager, SystemStateManager, VolumeManager, DatabaseController, ADMNotificationManager, ConfigurationPolicyManager, ConfigurationChangeRequestTransaction, DSPModuleManager, NSString;

@interface AudioDSPManager : NSObject <dspd_DSPDelegate, NSSecureCoding> {

	set<unsigned long long, std::__1::less<unsigned long long>, std::__1::allocator<unsigned long long>>* _hwStreamsCurrentlyCaptured;
	...
	ConfigurationPolicyManager* _configurationPolicyManager;
	ConfigurationChangeRequestTransaction* _pendingConfigRequestTransaction;
	DSPModuleManager* _dspModuleManager;

}

@property (nonatomic,readonly) GraphManager * graphManager;                                                          //@synthesize graphManager=_graphManager - In the implementation block
@property (nonatomic,readonly) SystemStateManager * systemStateManager;                                              //@synthesize systemStateManager=_systemStateManager - In the implementation block
@property (nonatomic,readonly) VolumeManager * volumeManager;                                                        //@synthesize volumeManager=_volumeManager - In the implementation block
@property (nonatomic,readonly) DatabaseController * databaseController;                                              //@synthesize databaseController=_databaseController - In the implementation block
@property (nonatomic,readonly) ADMNotificationManager * notificationManager;                                         //@synthesize notificationManager=_notificationManager - In the implementation block
@property (nonatomic,readonly) ConfigurationPolicyManager * configurationPolicyManager;                              //@synthesize configurationPolicyManager=_configurationPolicyManager - In the implementation block
@property (nonatomic,readonly) ConfigurationChangeRequestTransaction * pendingConfigRequestTransaction;              //@synthesize pendingConfigRequestTransaction=_pendingConfigRequestTransaction - In the implementation block
@property (nonatomic,readonly) DSPModuleManager * dspModuleManager;                                                  //@synthesize dspModuleManager=_dspModuleManager - In the implementation block
...
-(ADMNotificationManager *)notificationManager;
-(id)initWithProductID:(id)arg1 ;
-(char)areConfigChangeRequestsRedundant:(id)arg1 ;
-(GraphManager *)graphManager;
-(SystemStateManager *)systemStateManager;
-(VolumeManager *)volumeManager;
-(DatabaseController *)databaseController;
-(ConfigurationPolicyManager *)configurationPolicyManager;
-(ConfigurationChangeRequestTransaction *)pendingConfigRequestTransaction;
-(DSPModuleManager *)dspModuleManager;
@end
