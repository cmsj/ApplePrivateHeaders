...
@property (assign) char canUseCachingServer;                                      //@synthesize canUseCachingServer=_canUseCachingServer - In the implementation block
...
+(id)sharedSession;
+(id)sessionWithConfiguration:(id)arg1 canUseCachingServer:(char)arg2 locateOptions:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 ;
+(id)sessionWithConfiguration:(id)arg1 canUseCachingServer:(char)arg2 locateOptions:(id)arg3 ;
-(id)downloadTaskWithResumeData:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)set_phase:(int)arg1 ;
-(id)initWithConfiguration:(id)arg1 canUseCachingServer:(char)arg2 locateOptions:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 ;
-(NSOperationQueue *)_clientDelegateOpQueue;
-(NSURLSession *)_nsurlSession;
-(NSDictionary *)_locateOptions;
-(char)canUseCachingServer;
-(id)_onqueue_uniqueTasks;
-(id)_downloadTaskWithResumeData:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)setCanUseCachingServer:(char)arg1 ;
...
-(char)_resumeData:(id)arg1 toNSURLResumeData:(id*)arg2 originalRequest:(id*)arg3 currentRequest:(id*)arg4 error:(id*)arg5 ;
...
-(void)_onqueue_task:(id)arg1 willUseCachingServer:(char)arg2 newRequest:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
-(void)_locateCachingServerForURL:(id)arg1 isUpload:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
