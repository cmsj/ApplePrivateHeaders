...
@property (assign,nonatomic) char hasVoiceTrigger;                                    //@synthesize hasVoiceTrigger=_hasVoiceTrigger - In the implementation block
...
-(NSData *)jsonData;
-(char)hasVoiceTrigger;
-(void)setHasVoiceTrigger:(char)arg1 ;
@end
