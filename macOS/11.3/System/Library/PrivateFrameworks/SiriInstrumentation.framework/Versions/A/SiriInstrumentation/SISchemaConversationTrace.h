...
@interface SISchemaConversationTrace : SISchemaInstrumentationMessage {
	...
	char _hasPreviousTurnID;

}

@property (nonatomic,copy) NSData * previousTurnID;               //@synthesize previousTurnID=_previousTurnID - In the implementation block
@property (assign,nonatomic) char hasPreviousTurnID;              //@synthesize hasPreviousTurnID=_hasPreviousTurnID - In the implementation block
...
-(char)hasPreviousTurnID;
-(void)setHasPreviousTurnID:(char)arg1 ;
@end
