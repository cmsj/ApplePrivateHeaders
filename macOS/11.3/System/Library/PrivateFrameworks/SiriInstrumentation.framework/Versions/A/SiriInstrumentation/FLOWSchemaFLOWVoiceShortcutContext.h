...
@property (nonatomic,copy) NSArray * voiceShortcutActions;              //@synthesize voiceShortcutActions=_voiceShortcutActions - In the implementation block
...
-(void)setVoiceShortcutActions:(NSArray *)arg1 ;
@end
