...
@property (assign,nonatomic) char hasServerGeneratedDismissalReason; 
...
-(char)hasServerGeneratedDismissalReason;
-(void)setHasServerGeneratedDismissalReason:(char)arg1 ;
@end
