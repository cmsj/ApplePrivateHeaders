...
@property (assign,nonatomic) char hasTestName;                 //@synthesize hasTestName=_hasTestName - In the implementation block
@property (assign,nonatomic) int testType;                     //@synthesize testType=_testType - In the implementation block
@property (assign,nonatomic) char hasTestType; 
...
-(char)hasTestName;
-(char)hasTestType;
-(void)setHasTestType:(char)arg1 ;
-(void)setHasTestName:(char)arg1 ;
@end
