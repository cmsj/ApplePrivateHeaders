...
@property (assign,nonatomic) char hasFullyQualifiedPath;               //@synthesize hasFullyQualifiedPath=_hasFullyQualifiedPath - In the implementation block
...
-(char)hasFullyQualifiedPath;
-(void)setHasFullyQualifiedPath:(char)arg1 ;
@end
