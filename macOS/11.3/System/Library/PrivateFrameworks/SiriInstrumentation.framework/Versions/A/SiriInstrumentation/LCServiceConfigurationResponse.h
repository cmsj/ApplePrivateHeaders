...
@property (assign,nonatomic) char hasConfiguration;                                      //@synthesize hasConfiguration=_hasConfiguration - In the implementation block
...
-(void)setHasConfiguration:(char)arg1 ;
@end
