...
@property (nonatomic,readonly) char oneTimeTask;                                                                //@synthesize oneTimeTask=_oneTimeTask - In the implementation block
+(id)dataSourceForTask;
+(id)taskWithClientIdentifier:(id)arg1 oneTimeTask:(char)arg2 ;
-(char)isCancelled;
...
-(id)initWithClientIdentifier:(id)arg1 oneTimeTask:(char)arg2 ;
...
-(char)incrementUsageCountsForMessages:(id)arg1 withHandle:(id)arg2 ;
-(void)enumerateHandlesForLanguage:(id)arg1 withBlock:(/*^block*/id)arg2 ;
-(char)incrementUsageCountsForMessages:(id)arg1 forLanguage:(id)arg2 adaptationContext:(id)arg3 ;
-(char)oneTimeTask;
@end
