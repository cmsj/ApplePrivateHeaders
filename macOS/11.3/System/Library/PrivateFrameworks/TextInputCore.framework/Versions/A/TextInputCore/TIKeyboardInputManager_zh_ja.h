...
@interface TIKeyboardInputManager_zh_ja : TIKeyboardInputManager {
	...
	char _hasCommittedPartialCandidate;
	char _hasBackspacedIntoInputString;
	char _preservesComposingInput;
...
@property (assign,nonatomic) char hasCommittedPartialCandidate;                                                      //@synthesize hasCommittedPartialCandidate=_hasCommittedPartialCandidate - In the implementation block
@property (assign,nonatomic) char hasBackspacedIntoInputString;                                                      //@synthesize hasBackspacedIntoInputString=_hasBackspacedIntoInputString - In the implementation block
...
@property (assign,nonatomic) char preservesComposingInput;                                                           //@synthesize preservesComposingInput=_preservesComposingInput - In the implementation block
...
@property (nonatomic,readonly) char supportsPerRecipientLearning; 
...
@property (nonatomic,readonly) char usesComposingInput; 
...
-(void)logCommittedCandidate:(id)arg1 partial:(char)arg2 ;
...
-(void)updateUsageStatisticsForCandidate:(id)arg1 isPartial:(char)arg2 ;
...
-(id)segmentsFromCandidate:(id)arg1 phraseBoundary:(char)arg2 ;
...
-(char)_adjustPhraseBoundaryInForwardDirection:(char)arg1 granularity:(int)arg2 ;
...
-(char)hasCommittedPartialCandidate;
-(void)setHasCommittedPartialCandidate:(char)arg1 ;
-(char)hasBackspacedIntoInputString;
-(void)setHasBackspacedIntoInputString:(char)arg1 ;
-(int)lastCommittedCandidateType;
-(void)setLastCommittedCandidateType:(int)arg1 ;
-(char)preservesComposingInput;
-(void)setPreservesComposingInput:(char)arg1 ;
