...
-(void)addContextCandidate:(void*)arg1 accept:(char)arg2 ;
...
-(id)contextString:(id)arg1 forRightContext:(char)arg2 ;
-(char)predictionCandidatesWithOptions:(unsigned long long)arg1 maxNumberOfCandidates:(unsigned long long)arg2 ;
