...
-(void)updateActiveInputModesSuppressingNotification:(char)arg1 ;
...
-(char)bufferIsCompatibleWithContext:(const TITokenID*)arg1 contextLength:(unsigned long long)arg2 ;
