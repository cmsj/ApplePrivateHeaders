...
-(char)validateCaseAttachmentsForDiagnosticCaseStorage:(id)arg1 record:(id)arg2 ;
...
-(char)logUploadRequiresConsent:(id)arg1 ;
-(id)uploadOperationWithRecordsToSave:(id)arg1 recordIDsToDelete:(id)arg2 allowCellular:(char)arg3 activity:(id)arg4 ;
-(void)operationCompletedWithID:(id)arg1 savedRecords:(id)arg2 deletedRecords:(id)arg3 error:(id)arg4 activity:(id)arg5 ;
-(char)shouldDeferFromCloudKitError:(id)arg1 ;
-(void)recordOperationCompleteForOperationID:(id)arg1 completionTime:(id)arg2 success:(char)arg3 ;
