...
-(id)fetchRowFromStatement:(sqlite3_stmtRef)arg1 skip:(char*)arg2 updatedSequenceColumn:(id*)arg3 error:(id*)arg4 ;
-(char)bindPropertiesToStatement:(sqlite3_stmtRef)arg1 currentSequence:(id)arg2 error:(id*)arg3 ;
@end
