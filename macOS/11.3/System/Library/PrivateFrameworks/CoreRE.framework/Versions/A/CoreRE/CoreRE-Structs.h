...
typedef struct _compressed_pair<re::audio::FixedSpscAudioQueue<GainRampCommand> *, std::__1::default_delete<re::audio::FixedSpscAudioQueue<GainRampCommand>>> {
	FixedSpscAudioQueue<GainRampCommand> __value_;
} compressed_pair<re::audio::FixedSpscAudioQueue<GainRampCommand> *, std::__1::default_delete<re::audio::FixedSpscAudioQueue<GainRampCommand>>>;

typedef struct unique_ptr<re::audio::FixedSpscAudioQueue<GainRampCommand>, std::__1::default_delete<re::audio::FixedSpscAudioQueue<GainRampCommand>>> {
	compressed_pair<re::audio::FixedSpscAudioQueue<GainRampCommand> *, std::__1::default_delete<re::audio::FixedSpscAudioQueue<GainRampCommand>>> __ptr_;
} unique_ptr<re::audio::FixedSpscAudioQueue<GainRampCommand>, std::__1::default_delete<re::audio::FixedSpscAudioQueue<GainRampCommand>>>;
