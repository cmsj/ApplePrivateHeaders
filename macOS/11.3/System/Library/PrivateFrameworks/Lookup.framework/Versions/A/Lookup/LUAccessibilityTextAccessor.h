...
@property (nonatomic,retain) id accessibilityElement;              //@synthesize accessibilityElement=_accessibilityElement - In the implementation block
+(char)canAccessTextAtLocation:(CGPoint)arg1 ;
+(char)canAccessTextInView:(id)arg1 ;
-(void)dealloc;
-(void)setAccessibilityElement:(id)arg1 ;
