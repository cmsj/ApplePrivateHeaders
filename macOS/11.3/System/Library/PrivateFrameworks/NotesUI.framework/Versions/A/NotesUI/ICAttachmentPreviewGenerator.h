...
@class ICAttachmentPreviewGeneratorOperationQueue, NSMapTable, NSMutableSet, NSMutableDictionary, NSMutableOrderedSet, NSObject, NSString;

@interface ICAttachmentPreviewGenerator : NSObject <ICProgressIndicatorTrackerDelegate> {

	Ac _shouldGenerateAttachmentsWhenReachable;
...
@property (assign,nonatomic) Ac shouldGenerateAttachmentsWhenReachable;                                      //@synthesize shouldGenerateAttachmentsWhenReachable=_shouldGenerateAttachmentsWhenReachable - In the implementation block
@property (nonatomic,readonly) char previewOperationsIdle; 
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
+(id)sharedGenerator;
+(char)ocrGenerationEnabled;
+(char)imageClassificationEnabled;
+(void)setImageClassificationTemporarilyDisabled:(char)arg1 ;
...
-(void)beginPostProcessingAfterDelayIfNecessaryWithForceDelay:(char)arg1 ;
-(char)previewOperationsIdle;
...
-(void)setShouldGenerateAttachmentsWhenReachable:(Ac)arg1 ;
...
-(Ac)shouldGenerateAttachmentsWhenReachable;
@end
