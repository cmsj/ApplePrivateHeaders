...
@property (assign,nonatomic) char isThrowaway;                                                     //@synthesize isThrowaway=_isThrowaway - In the implementation block
@property (nonatomic,readonly) NSArray * failedSketches; 
+(id)sharedConverter;
+(char)canUpdateFullscreenSketchAttachment:(id)arg1 ;
+(char)canUpdateInlineDrawingAttachment:(id)arg1 ;
...
-(char)compareDrawingAttachment:(id)arg1 withConvertedDrawing:(id)arg2 ;
-(void)convertDrawingsInNote:(id)arg1 waitUntilFinished:(char)arg2 ;
...
-(char)shouldAutoConvertNote:(id)arg1 ;
-(id)addOperationForAttachment:(id)arg1 automatic:(char)arg2 ;
