...
@interface ICSearchResult : NSObject {
	...
	char _isDisplayingParticipantMatch;
...
@property (assign,nonatomic) char isDisplayingParticipantMatch;                                                  //@synthesize isDisplayingParticipantMatch=_isDisplayingParticipantMatch - In the implementation block
...
+(char)canFitAttributedString:(id)arg1 ellipses:(id)arg2 shouldPrefixWithEllipses:(char)arg3 insideFrame:(CGRect)arg4 centered:(char)arg5 ;
...
+(id)attributedStringWithMatchHighlighted:(id)arg1 textCheckingResult:(id)arg2 usingAttributes:(id)arg3 highlightColor:(id)arg4 insideFrame:(CGRect)arg5 isSnippetForParticipantMatch:(char)arg6 finishingUpRegexMatchFinder:(id)arg7 ;
...
-(void)setIsDisplayingParticipantMatch:(char)arg1 ;
...
-(char)isDisplayingParticipantMatch;
