...
-(void)chunkFile:(const char*)arg1 withIoPolicy:(unsigned)arg2 withSchedPolicy:(unsigned)arg3 reply:(/*^block*/id)arg4;
-(void)chunkFileRemove:(const char*)arg1 reply:(/*^block*/id)arg2;
-(void)chunkStorageCompact:(const char*)arg1 requestedSize:(unsigned long long)arg2 reply:(/*^block*/id)arg3;
