...
+(id)interactionsFromStore:(id)arg1 referenceDate:(id)arg2 withMechanisms:(id)arg3 withAccount:(id)arg4 withBundleIds:(id)arg5 withTargetBundleIds:(id)arg6 withDirections:(id)arg7 singleRecipient:(char)arg8 fetchLimit:(unsigned long long)arg9 ;
+(id)interactionsFromStore:(id)arg1 startDate:(id)arg2 tillDate:(id)arg3 withMechanisms:(id)arg4 withAccount:(id)arg5 withBundleIds:(id)arg6 withTargetBundleIds:(id)arg7 withDirections:(id)arg8 singleRecipient:(char)arg9 fetchLimit:(unsigned long long)arg10 ;
+(id)mostRecentInteractionWithSenderOrRecipientMatchingContactIdentifier:(id)arg1 bundleIds:(id)arg2 store:(id)arg3 singleRecipient:(char)arg4 ;
