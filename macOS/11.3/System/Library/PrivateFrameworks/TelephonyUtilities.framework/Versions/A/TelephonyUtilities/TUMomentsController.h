...
+(char)isFaceTimePhotosRestricted;
+(char)isFaceTimePhotosEnabled;
+(char)isFaceTimePhotosEnabledByDefault;
+(/*^block*/id)faceTimePhotosEnabledDeterminer;
+(void)setFaceTimePhotosEnabledDeterminer:(/*^block*/id)arg1 ;
+(char)isFaceTimePhotosXPCServiceEnabled;
+(void)setFaceTimePhotosEnabled:(char)arg1 ;
-(void)dealloc;
-(id)init;
