...
@interface TUAnswerRequest : NSObject <NSSecureCoding, TUCallRequest, TUVideoRequest> {
	...
	char _pauseVideoToStart;
	char _downgradeToAudio;
	char _allowBluetoothAnswerWithoutDowngrade;
...
@property (assign,nonatomic) char allowBluetoothAnswerWithoutDowngrade;                    //@synthesize allowBluetoothAnswerWithoutDowngrade=_allowBluetoothAnswerWithoutDowngrade - In the implementation block
...
@property (assign,nonatomic) char pauseVideoToStart;                                       //@synthesize pauseVideoToStart=_pauseVideoToStart - In the implementation block
...
-(char)wantsHoldMusic;
-(char)pauseVideoToStart;
-(char)downgradeToAudio;
-(CGSize)localLandscapeAspectRatio;
-(CGSize)localPortraitAspectRatio;
-(NSDate *)dateAnswered;
-(char)allowBluetoothAnswerWithoutDowngrade;
...
-(void)setPauseVideoToStart:(char)arg1 ;
-(void)setDowngradeToAudio:(char)arg1 ;
-(void)setDateAnswered:(NSDate *)arg1 ;
-(void)setAllowBluetoothAnswerWithoutDowngrade:(char)arg1 ;
@end
