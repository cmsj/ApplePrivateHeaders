...
@property (nonatomic,readonly) char isSleepAlarm;                         //@synthesize isSleepAlarm=_isSleepAlarm - In the implementation block
...
-(id)jsonDict;
-(id)initWithEventType:(unsigned long long)arg1 alarmID:(id)arg2 isSleepAlarm:(char)arg3 ;
@end
