...
@property (assign,nonatomic) char triedAccessory;                        //@synthesize triedAccessory=_triedAccessory - In the implementation block
@property (assign,nonatomic) char triedHAP;                              //@synthesize triedHAP=_triedHAP - In the implementation block
...
-(void)setTriedAccessory:(char)arg1 ;
-(void)setTriedHAP:(char)arg1 ;
