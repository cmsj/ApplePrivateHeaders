...
-(char)_hasEnoughAssetsWithMinimumSceneAnalysisVersion;
-(id)_preferredPotentialMemoriesFromPotentialMemories:(id)arg1 ;
-(id)_assetUUIDsFromAssets:(id)arg1 ;
-(id)_potentialMemoriesFromMomentNodes:(id)arg1 atLocationCoordinate:(CLLocationCoordinate2D)arg2 atLocationNode:(id)arg3 requireMinimumTimeInterval:(char)arg4 includeSingleYearMemories:(char)arg5 features:(id)arg6 featuredNode:(id)arg7 kind:(unsigned long long)arg8 cancelled:(char*)arg9 ;
...
-(char)_aggregationMeetsMinimumTimeIntervalForMomentNodes:(id)arg1 ;
-(id)_momentNodesByYearFromMomentNodes:(id)arg1 ;
-(id)_potentialGenericMemoriesWithGraph:(id)arg1 cancelled:(char*)arg2 ;
-(id)_potentialMemoriesForTripsWithGraph:(id)arg1 cancelled:(char*)arg2 ;
-(id)_potentialMemoriesForPeopleWithGraph:(id)arg1 cancelled:(char*)arg2 ;
-(id)_cityNodesForMomentNode:(id)arg1 ;
-(id)_potentialMemoriesForCitiesWithGraph:(id)arg1 cancelled:(char*)arg2 ;
-(id)_potentialMemoriesForRestaurantsWithGraph:(id)arg1 cancelled:(char*)arg2 ;
-(id)_potentialMemoriesForHomeWithGraph:(id)arg1 cancelled:(char*)arg2 ;
...
-(id)_assetsCloseInTimeAndLocationToAsset:(id)arg1 inAssets:(id)arg2 stopAtFirstMatch:(char)arg3 ;
