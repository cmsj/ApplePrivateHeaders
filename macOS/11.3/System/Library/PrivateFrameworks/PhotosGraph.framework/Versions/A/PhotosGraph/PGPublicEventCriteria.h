...
@interface PGPublicEventCriteria : NSObject {
	...
	char _allowsExpandingTimeAttendance;
...
@property (assign,nonatomic) char allowsExpandingTimeAttendance;              //@synthesize allowsExpandingTimeAttendance=_allowsExpandingTimeAttendance - In the implementation block
...
@property (nonatomic,readonly) char hasMinimumAttendance; 
-(double)maximumDistance;
-(void)setMaximumDistance:(double)arg1 ;
-(NSString *)eventCategory;
-(char)_hasSufficientTimeOverlapForEvent:(id)arg1 matchingOptions:(id)arg2 ;
-(char)_isMatchingMeaningDisambiguationForEvent:(id)arg1 matchingOptions:(id)arg2 withHighConfidence:(char*)arg3 ;
-(char)isMatchingEvent:(id)arg1 matchingOptions:(id)arg2 withHighConfidence:(char*)arg3 matchingDistance:(double*)arg4 ;
-(char)hasMinimumAttendance;
...
-(char)allowsExpandingTimeAttendance;
-(void)setAllowsExpandingTimeAttendance:(char)arg1 ;
