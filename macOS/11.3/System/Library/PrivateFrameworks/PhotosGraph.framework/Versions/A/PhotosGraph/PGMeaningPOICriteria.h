...
@property (assign,nonatomic) char mustBeSpecial;                                  //@synthesize mustBeSpecial=_mustBeSpecial - In the implementation block
...
-(void)setMustBeSpecial:(char)arg1 ;
-(void)setMinimumNumberOfPOIs:(unsigned long long)arg1 ;
-(void)setPositivePOIs:(NSArray *)arg1 ;
-(char)_parkIsLargerThanMaximumDiameterForMomentNode:(id)arg1 ;
