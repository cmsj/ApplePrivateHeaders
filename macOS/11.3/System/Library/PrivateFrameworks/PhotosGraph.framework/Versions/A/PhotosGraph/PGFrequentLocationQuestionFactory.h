...
-(char)_addIfNeededFrequentLocationQuestionForAsset:(id)arg1 withLocationTypeName:(id)arg2 toQuestions:(id)arg3 ;
-(char)_distanceTooCloseBetweenCoordinate:(CLLocationCoordinate2D)arg1 otherCoordinate:(CLLocationCoordinate2D)arg2 ;
