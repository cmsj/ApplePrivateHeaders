...
@interface PGHobbyMemoryGenerator : PGFeaturedMemoryGenerator {
	...
	char _onlyOverTheYears;
	char _keepsOnlyIsInteresting;
...
@property (assign,nonatomic) char onlyOverTheYears;                    //@synthesize onlyOverTheYears=_onlyOverTheYears - In the implementation block
@property (assign,nonatomic) char keepsOnlyIsInteresting;              //@synthesize keepsOnlyIsInteresting=_keepsOnlyIsInteresting - In the implementation block
...
-(char)onlyOverTheYears;
-(void)setOnlyOverTheYears:(char)arg1 ;
-(char)keepsOnlyIsInteresting;
-(void)setKeepsOnlyIsInteresting:(char)arg1 ;
@end
