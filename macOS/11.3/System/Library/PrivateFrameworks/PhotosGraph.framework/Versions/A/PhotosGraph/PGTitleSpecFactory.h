...
+(id)specCollectionForFoodieMemoryWithPersonNodes:(id)arg1 locationName:(id)arg2 tripTitleLocationType:(unsigned long long)arg3 allowInspiredTastesTitle:(char)arg4 genericOnly:(char)arg5 ;
...
+(id)_specForFoodieWithPersonNodes:(id)arg1 locationName:(id)arg2 tripTitleLocationType:(unsigned long long)arg3 allowInspiredTastesTitle:(char)arg4 genericOnly:(char)arg5 ;
