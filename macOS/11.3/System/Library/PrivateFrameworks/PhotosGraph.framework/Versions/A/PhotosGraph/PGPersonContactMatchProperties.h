...
@property (assign,nonatomic) char contactFaceprintMatch;                                                             //@synthesize contactFaceprintMatch=_contactFaceprintMatch - In the implementation block
...
-(void)setContactFaceprintMatch:(char)arg1 ;
