...
@property (nonatomic,readonly) char contactFaceprintMatch;                                                             //@synthesize contactFaceprintMatch=_contactFaceprintMatch - In the implementation block
...
@property (nonatomic,readonly) char personContactBiologicalSexMatch; 
@property (nonatomic,readonly) char personContactBiologicalSexMismatch; 
...
-(char)personContactBiologicalSexMatch;
-(char)personContactBiologicalSexMismatch;
