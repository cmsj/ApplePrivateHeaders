...
-(void)fetchRecordsFor:(id)arg1 predicate:(id)arg2 fetchLimit:(unsigned long long)arg3 fetchOffset:(unsigned long long)arg4 randomizeOrder:(char)arg5 withCompletion:(/*^block*/id)arg6 ;
-(NSDictionary *)converterFromEntity;
-(void)saveRecords:(id)arg1 andFlush:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
