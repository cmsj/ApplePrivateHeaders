...
@property (assign,nonatomic) char hasRemoteUser; 
@property (assign,nonatomic) char remoteUser;                                   //@synthesize remoteUser=_remoteUser - In the implementation block
@property (assign,nonatomic) char hasDaysSinceLastView; 
...
-(char)hasPasscode;
-(void)setRemoteUser:(char)arg1 ;
-(void)setHasRemoteUser:(char)arg1 ;
-(char)hasRemoteUser;
-(void)setDaysSinceLastView:(unsigned long long)arg1 ;
-(void)setHasDaysSinceLastView:(char)arg1 ;
-(char)hasDaysSinceLastView;
-(char)remoteUser;
