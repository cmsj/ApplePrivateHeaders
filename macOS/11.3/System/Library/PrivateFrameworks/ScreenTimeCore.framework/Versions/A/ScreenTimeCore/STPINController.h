...
-(char)_isPINValid:(id)arg1 ;
-(char)_setPasscode:(id)arg1 recoveryAppleID:(id)arg2 forUser:(id)arg3 error:(id*)arg4 ;
-(char)_saveChangesForUser:(id)arg1 error:(id*)arg2 ;
-(char)_authenticateWithPIN:(id)arg1 forUser:(id)arg2 allowPasscodeRecovery:(char)arg3 error:(id*)arg4 ;
-(void)authenticateWithPIN:(id)arg1 allowPasscodeRecovery:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
-(char)canRecoveryAuthenticate;
...
-(char)authenticateWithPIN:(id)arg1 error:(id*)arg2 ;
