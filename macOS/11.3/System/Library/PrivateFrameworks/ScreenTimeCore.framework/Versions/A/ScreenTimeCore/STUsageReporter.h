...
@interface STUsageReporter : NSObject <NSFetchedResultsControllerDelegate> {
	...
	char _includeTotalUsageDetailItem;
...
@property (assign) char includeTotalUsageDetailItem;                                            //@synthesize includeTotalUsageDetailItem=_includeTotalUsageDetailItem - In the implementation block
...
-(char)includeTotalUsageDetailItem;
...
-(id)_ratiosForCategory:(id)arg1 perCalendarUnit:(unsigned long long)arg2 useTotalScreenTime:(char)arg3 ;
...
-(void)setIncludeTotalUsageDetailItem:(char)arg1 ;
