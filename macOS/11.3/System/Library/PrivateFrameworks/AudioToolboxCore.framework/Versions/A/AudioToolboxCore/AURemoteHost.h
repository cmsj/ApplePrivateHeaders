...
@property (readonly) NSUUID * audioUnitUUID;                                                    //@synthesize audioUnitUUID=_audioUnitUUID - In the implementation block
+(void)_staticInit;
-(void)dealloc;
...
-(void)valueForProperty:(id)arg1 propagateError:(char)arg2 reply:(/*^block*/id)arg3 ;
-(void)setValue:(id)arg1 forProperty:(id)arg2 propagateError:(char)arg3 reply:(/*^block*/id)arg4 ;
