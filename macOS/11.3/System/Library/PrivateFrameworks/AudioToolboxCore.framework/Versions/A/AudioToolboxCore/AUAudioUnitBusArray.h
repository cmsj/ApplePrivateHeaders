...
@property (getter=isCountChangeable,readonly) char countChangeable;              //@synthesize countChangeable=_countChangeable - In the implementation block
...
-(unsigned long long)countByEnumeratingWithState:(SCD_Struct_AU72*)arg1 objects:(id*)arg2 count:(unsigned long long)arg3 ;
