...
-(id)initWithConfiguration:(id)arg1 useManateeContainer:(char)arg2 ;
...
-(void)_batchSaveRecords:(id)arg1 useLongLivedOperation:(char)arg2 longLivedOperationPersistenceCompletion:(/*^block*/id)arg3 completion:(/*^block*/id)arg4 ;
