...
-(char)queryVisitCounts:(id)arg1 outVisitCountScore:(long long*)arg2 outDailyVisitCounts:(id*)arg3 outWeeklyVisitCounts:(id*)arg4 ;
-(void)recordVisit:(id)arg1 sourceVisit:(id)arg2 title:(id)arg3 loadSuccessful:(char)arg4 visitWasFromThisDevice:(char)arg5 increaseVisitCount:(char)arg6 score:(int)arg7 ;
