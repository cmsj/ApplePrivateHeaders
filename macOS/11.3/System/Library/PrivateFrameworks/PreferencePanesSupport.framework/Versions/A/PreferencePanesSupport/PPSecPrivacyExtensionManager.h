...
@class AdminAuthenticator, NSObject, PPSecPrivacyViewController, NSXPCConnection, NSString;
...
@property (__weak) PPSecPrivacyViewController * viewController;              //@synthesize viewController=_viewController - In the implementation block
...
-(void)setViewController:(PPSecPrivacyViewController *)arg1 ;
-(PPSecPrivacyViewController *)viewController;
