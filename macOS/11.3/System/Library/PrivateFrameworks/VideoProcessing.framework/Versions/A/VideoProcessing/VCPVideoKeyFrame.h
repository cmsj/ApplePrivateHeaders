...
@property (assign,nonatomic) char isHeadingFrame;                             //@synthesize isHeadingFrame=_isHeadingFrame - In the implementation block
...
-(float)semanticScore;
-(id)initWithLivePhoto:(char)arg1 ;
...
-(void)setIsHeadingFrame:(char)arg1 ;
-(void)resetStatsFlag;
-(void)setFaceStatsFlag:(char)arg1 detectedFaces:(id)arg2 ;
-(void)setExpressionChangeScore:(float)arg1 ;
-(void)setMotionStatsFlag:(char)arg1 cameraMotion:(float)arg2 subjectAction:(float)arg3 interestingness:(float)arg4 obstruction:(float)arg5 colorfulness:(float)arg6 exposureScore:(float)arg7 humanActionStatsFlag:(char)arg8 humanPoseScore:(float)arg9 humanActionScore:(float)arg10 subMb:(char)arg11 ;
@end
