...
-(float)sumOfScore;
-(id)initWithTimestamp:(SCD_Struct_VC6)arg1 score:(float)arg2 valid:(char)arg3 ;
-(void)updateWithFirstFrame:(SCD_Struct_VC7)arg1 score:(float)arg2 valid:(char)arg3 ;
-(void)updateSegment:(SCD_Struct_VC7)arg1 score:(float)arg2 valid:(char)arg3 ;
-(void)updateDuration:(SCD_Struct_VC6)arg1 ;
-(void)trimSegment:(SCD_Struct_VC6)arg1 fromStart:(char)arg2 ;
