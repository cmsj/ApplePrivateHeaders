...
+(id)detector:(int)arg1 forceCPU:(char)arg2 sharedModel:(char)arg3 inputConfig:(id)arg4 ;
...
-(int)drawLine:(char*)arg1 width:(int)arg2 height:(int)arg3 stride:(int)arg4 point0:(CGPoint)arg5 point1:(CGPoint)arg6 drawPoint:(unsigned)arg7 ;
