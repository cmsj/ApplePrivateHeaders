...
@interface MapsSyncFakeHistoryItem : MapsSyncFakeBaseItem <MapsSyncHistoryItem> {
	...
	char _test_isDeleted;

}

@property (assign,nonatomic) char test_isDeleted;                     //@synthesize test_isDeleted=_test_isDeleted - In the implementation block
...
-(void)setTest_isDeleted:(char)arg1 ;
-(char)test_isDeleted;
@end
