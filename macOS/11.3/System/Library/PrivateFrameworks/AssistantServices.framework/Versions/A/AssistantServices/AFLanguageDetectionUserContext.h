...
@property (assign,setter=setWasLanguageToggled:,getter=wasLanguageToggled,nonatomic) char languageToggled;              //@synthesize languageToggled=_languageToggled - In the implementation block
...
-(void)setShouldSimulateLanguageDetectorAssetsAvailability:(char)arg1 ;
