...
@class NSObject, NSXPCListener, AFNotifyObserver, NSString;
...
-(void)_deliverButtonEventFromContext:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_myriadEventWithRequestInfo:(id)arg1 context:(id)arg2 completion:(/*^block*/id)arg3 ;
@end
