...
-(id)_initWithItem:(id)arg1 parentItem:(id)arg2 replyMessageGUID:(id)arg3 replyIsFromMe:(char)arg4 initialPayload:(id)arg5 index:(long long)arg6 messagePartRange:(NSRange)arg7 parentChatHasKnownParticipants:(char)arg8 ;
@end
