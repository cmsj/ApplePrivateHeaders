...
-(id)_initWithItem:(id)arg1 parentItem:(id)arg2 replyMessageGUID:(id)arg3 replyIsFromMe:(char)arg4 text:(id)arg5 index:(long long)arg6 messagePartRange:(NSRange)arg7 transferGUID:(id)arg8 parentChatIsSpam:(char)arg9 ;
-(id)_initWithItem:(id)arg1 parentItem:(id)arg2 replyMessageGUID:(id)arg3 replyIsFromMe:(char)arg4 text:(id)arg5 index:(long long)arg6 messagePartRange:(NSRange)arg7 transferGUID:(id)arg8 parentChatIsSpam:(char)arg9 visibleAssociatedMessageChatItems:(id)arg10 ;
@end
