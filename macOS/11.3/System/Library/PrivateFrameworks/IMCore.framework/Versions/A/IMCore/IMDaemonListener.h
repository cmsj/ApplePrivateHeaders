...
-(void)didAttemptToSetEnabledTo:(char)arg1 result:(char)arg2 ;
...
-(void)networkDataAvailabilityChanged:(char)arg1 ;
...
-(void)didPerformAdditionalStorageRequiredCheckWithSuccess:(char)arg1 additionalStorageRequired:(unsigned long long)arg2 forAccountId:(id)arg3 error:(id)arg4 ;
-(void)didAttemptToDisableAllDevicesResult:(char)arg1 ;
