...
@property (assign,nonatomic) SCD_Struct_Fi8 maxDuration;                   //@synthesize maxDuration=_maxDuration - In the implementation block
...
-(SCD_Struct_Fi8)maxDuration;
-(long long)settingsID;
-(void)setSettingsID:(long long)arg1 ;
-(void)setMaxDuration:(SCD_Struct_Fi8)arg1 ;
