...
-(char)_removeContainerForCaptureRequestIdentifier:(id)arg1 array:(id)arg2 ;
-(void)_reportCoreAnalyticsDataWithError:(int)arg1 container:(id)arg2 ;
-(char)_removeInflightContainerForCaptureRequestIdentifier:(id)arg1 ;
-(int)_handleExpiryTimer;
-(char)_removeCachedContainerForCaptureRequestIdentifier:(id)arg1 ;
...
-(char)_removeStagedContainerForCaptureRequestIdentifier:(id)arg1 ;
-(void)_updateCacheEntryForContainer:(id)arg1 release:(char)arg2 ;
-(id)_inflightContainerForCaptureRequestIdentifier:(id)arg1 ;
-(int)_enumerateManifestsForApplicationID:(id)arg1 manifestArray:(id)arg2 deleteInvalidContainers:(char)arg3 ;
