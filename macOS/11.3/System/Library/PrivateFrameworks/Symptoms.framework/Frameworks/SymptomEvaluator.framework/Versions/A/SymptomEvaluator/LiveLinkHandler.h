...
-(char)startTrackingLiveLinkOnInterface:(id)arg1 ;
-(char)stopTrackingLiveLinkOnInterface:(id)arg1 ;
-(char)includeLocalFlowsTrackingOnInterface:(id)arg1 ;
-(char)excludeLocalFlowsTrackingOnInterface:(id)arg1 ;
@end
