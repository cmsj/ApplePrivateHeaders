...
@property (assign,nonatomic) char measurementsEnabled;                             //@synthesize measurementsEnabled=_measurementsEnabled - In the implementation block
...
-(id)initWithName:(id)arg1 measurementsEnabled:(char)arg2 orEnabledByEnvironmentVariables:(id)arg3 ;
-(void)setEnabledByEnvironmentVariables:(NSArray *)arg1 ;
-(void)setChildMetrics:(NSMutableArray *)arg1 ;
-(void)setMeasurementsEnabled:(char)arg1 ;
...
-(id)initWithName:(id)arg1 measurementsEnabled:(char)arg2 ;
-(id)generateReport;
@end
