...
@interface REMRemindersDataViewInvocation_fetchByObjectID : REMStoreInvocation <NSSecureCoding> {
	...
	char _showMarkedForDeleteObjects;
	NSArray* _objectIDs;

}

@property (nonatomic,readonly) NSArray * objectIDs;                        //@synthesize objectIDs=_objectIDs - In the implementation block
@property (assign,nonatomic) char showMarkedForDeleteObjects;              //@synthesize showMarkedForDeleteObjects=_showMarkedForDeleteObjects - In the implementation block
...
-(NSArray *)objectIDs;
-(void)setShowMarkedForDeleteObjects:(char)arg1 ;
-(char)showMarkedForDeleteObjects;
@end
