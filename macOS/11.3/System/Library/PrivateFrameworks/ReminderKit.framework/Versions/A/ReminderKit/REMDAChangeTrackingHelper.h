...
+(char)shouldIgnoreChangeOfModelClassProperties:(Class)arg1 withChangeObject:(id)arg2 ;
-(NSString *)entityName;
...
-(void)markChangesConsumed:(char)arg1 ;
...
-(id)_fetchModelObjectOfClass:(Class)arg1 withObjectID:(id)arg2 includeLazyDeleteObjects:(char)arg3 ;
...
-(char)compareCurrentChangeTokenToLastConsumedWithResult:(long long*)arg1 error:(id*)arg2 ;
