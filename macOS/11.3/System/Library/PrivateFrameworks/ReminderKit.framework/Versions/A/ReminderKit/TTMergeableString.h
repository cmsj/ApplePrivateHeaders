...
-(unsigned long long)mergeWithString:(id)arg1 mergeTimestamps:(char)arg2 ;
...
-(char)shouldInvalidateCachedSubstringsWithTimestamp:(id)arg1 ;
-(void)updateClock;
...
-(char)textEitherSideOfSelectionAnchor:(TopoID)arg1 wasModifiedAfter:(id)arg2 ;
-(void)updateCache;
-(char)isFragment;
...
-(void)generateIdsForLocalChangesSafeForSharedTimestamp:(char)arg1 ;
...
-(void)checkTimestampLogStyleErrors:(char)arg1 ;
-(char)canMergeString:(id)arg1 ;
-(void)sortSplitNodes;
-(void)updateAttributedStringAfterMerge;
-(char)graphIsEqual:(id)arg1 ;
...
-(char)selection:(id)arg1 wasModifiedAfter:(id)arg2 ;
