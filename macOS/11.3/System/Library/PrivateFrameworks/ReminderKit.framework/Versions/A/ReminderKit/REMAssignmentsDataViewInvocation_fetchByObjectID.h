...
@interface REMAssignmentsDataViewInvocation_fetchByObjectID : REMStoreInvocation <NSSecureCoding> {
	...
	char _showLazyDeleteObjects;
	NSArray* _objectIDs;

}

@property (nonatomic,readonly) NSArray * objectIDs;                   //@synthesize objectIDs=_objectIDs - In the implementation block
@property (assign,nonatomic) char showLazyDeleteObjects;              //@synthesize showLazyDeleteObjects=_showLazyDeleteObjects - In the implementation block
...
-(NSArray *)objectIDs;
-(void)setShowLazyDeleteObjects:(char)arg1 ;
-(char)showLazyDeleteObjects;
@end
