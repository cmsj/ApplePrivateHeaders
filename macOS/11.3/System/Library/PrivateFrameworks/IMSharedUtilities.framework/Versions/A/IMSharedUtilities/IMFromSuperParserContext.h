...
@property (nonatomic,readonly) char foundBreadcrumbText;                                  //@synthesize foundBreadcrumbText=_foundBreadcrumbText - In the implementation block
-(void)dealloc;
-(id)name;
