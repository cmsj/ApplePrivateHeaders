...
-(void)setHasShareStatus:(char)arg1 ;
-(char)hasShareStatus;
-(void)setShareDirection:(long long)arg1 ;
-(void)setHasShareDirection:(char)arg1 ;
-(char)hasShareDirection;
