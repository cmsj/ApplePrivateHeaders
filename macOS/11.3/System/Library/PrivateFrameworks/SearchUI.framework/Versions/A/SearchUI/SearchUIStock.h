...
@class SearchUIStockChartData, NSString, SearchUIExchange, NSURL, SearchUIStockDataSource;
...
@property (nonatomic,retain) SearchUIExchange * exchange;                       //@synthesize exchange=_exchange - In the implementation block
...
@property (nonatomic,retain) SearchUIStockDataSource * dataSource;              //@synthesize dataSource=_dataSource - In the implementation block
...
-(NSString *)volume;
-(NSString *)symbol;
-(SearchUIStockDataSource *)dataSource;
-(void)setDataSource:(SearchUIStockDataSource *)arg1 ;
...
-(SearchUIExchange *)exchange;
-(void)setExchange:(SearchUIExchange *)arg1 ;
-(NSString *)peRatio;
