...
@interface VMUObjectIdentifier : NSObject {
	...
	char _needToValidateAddressRange;
...
@property (readonly) char needToValidateAddressRange;                                                //@synthesize needToValidateAddressRange=_needToValidateAddressRange - In the implementation block
...
-(char)_isValidInstanceLength:(unsigned long long)arg1 expectedLength:(unsigned long long)arg2 ;
-(id)_classInfoWithPthreadType:(id)arg1 ;
-(char)hasSwiftReflection;
...
-(id)labelForNSString:(void*)arg1 mappedSize:(unsigned long long)arg2 remoteAddress:(unsigned long long)arg3 printDetail:(char)arg4 ;
...
-(id)labelForNSCFStringAtRemoteAddress:(unsigned long long)arg1 printDetail:(char)arg2 ;
-(id)labelForObjectOfClass:(id)arg1 atOffset:(unsigned)arg2 ofObject:(void*)arg3 ;
-(char)_remoteAddressIsOKtoRead:(unsigned long long)arg1 ;
...
-(char)_dlopenLibSwiftRemoteMirrorFromDir:(id)arg1 ;
-(char)_dlopenLibSwiftRemoteMirrorNearLibSwiftCoreWithSymbolicator:(CSTypeRef)arg1 avoidSystem:(char)arg2 ;
-(char)_dlopenLibSwiftRemoteMirrorNearExecutable;
-(char)_dlopenLibSwiftRemoteMirrorWithSymbolicator:(CSTypeRef)arg1 ;
...
-(char)needToValidateAddressRange;
