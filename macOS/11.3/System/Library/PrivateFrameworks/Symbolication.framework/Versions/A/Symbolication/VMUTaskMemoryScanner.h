...
@interface VMUTaskMemoryScanner : NSObject <VMUCommonGraphInterface> {
	...
	char _recordRuntimeMetadataChunkInfo;
...
@property (nonatomic,readonly) VMURegionMap* regionMap;                               //@synthesize regionMap=_regionMap - In the implementation block
...
@property (assign,nonatomic) char abandonedMarkingEnabled;                            //@synthesize abandonedMarkingEnabled=_abandonedMarkingEnabled - In the implementation block
...
@property (assign,nonatomic) char recordRuntimeMetadataChunkInfo;                     //@synthesize recordRuntimeMetadataChunkInfo=_recordRuntimeMetadataChunkInfo - In the implementation block
...
-(void)setAbandonedMarkingEnabled:(char)arg1 ;
...
-(void)_orderedScanWithScanner:(/*^block*/id)arg1 recorder:(/*^block*/id)arg2 keepMapped:(int)arg3 actions:(/*^block*/id)arg4 ;
...
-(char)validateAddressRange:(VMURange)arg1 ;
-(char)addressIsInDataSegment:(unsigned long long)arg1 ;
...
-(char)abandonedMarkingEnabled;
-(VMUDebugTimer *)debugTimer;
-(char)showRawClassNames;
-(char)recordRuntimeMetadataChunkInfo;
-(void)setRecordRuntimeMetadataChunkInfo:(char)arg1 ;
