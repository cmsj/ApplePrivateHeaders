...
+(void)initialize;
+(id)columnHeadersWithOptions:(unsigned long long)arg1 maximumLength:(unsigned long long)arg2 memorySizeDivisor:(unsigned)arg3 hasFractionalPageSizes:(char)arg4 ;
...
-(char)isSubmap;
-(id)descriptionWithOptions:(unsigned long long)arg1 maximumLength:(unsigned long long)arg2 memorySizeDivisor:(unsigned)arg3 hasFractionalPageSizes:(char)arg4 ;
