...
@property (nonatomic,readonly) char usesSwiftRefcounting;                    //@synthesize usesSwiftRefcounting=_usesSwiftRefcounting - In the implementation block
...
-(char)isRootClass;
-(id)_initWithClass:(unsigned long long)arg1 type:(unsigned)arg2 realizedOnly:(char)arg3 infoMap:(id)arg4 objectIdentifier:(id)arg5 reader:(/*^block*/id)arg6 ;
-(void)_determineBinaryPathUsingObjectIdentifier:(id)arg1 remoteClassNameLoc:(unsigned long long)arg2 ;
-(void)_setBinaryPath:(id)arg1 sanitize:(char)arg2 ;
-(void)_freeLocalIvarList;
-(id)_copyWithInstanceSize:(unsigned)arg1 superclassOffset:(unsigned)arg2 asVariant:(char)arg3 mutable:(char)arg4 ;
-(void)_identifyObjCClassStructureBlocksForIsa:(unsigned long long)arg1 isMetaclass:(char)arg2 withScanner:(id)arg3 addressIdentifierBlock:(/*^block*/id)arg4 ;
