...
@property (readonly) char needInitialSync;                                               //@synthesize needInitialSync=_needInitialSync - In the implementation block
...
-(void)setSOSMessageFailForTesting:(char)arg1 ;
-(void)setOctagonMessageFailForTesting:(char)arg1 ;
