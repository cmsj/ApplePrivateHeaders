...
@interface _MTLDeserializerObjectMapObjectDelegate : NSObject <MTLDeserializationContext, MTLDeserializerObjectDelegate> {
	...
	MTLDeserializerObjectMap* _commandQueueMap;
	MTLDeserializerObjectMap* _functionMap;
	MTLDeserializerObjectMap* _computePipelineMap;
	MTLDeserializerObjectMap* _renderPipelineMap;
	MTLDeserializerObjectMap* _bufferMap;
	MTLDeserializerObjectMap* _textureMap;
	MTLDeserializerObjectMap* _samplerMap;
	MTLDeserializerObjectMap* _depthStencilMap;
	MTLDeserializerObjectMap* _fenceMap;
	MTLDeserializerObjectMap* _argumentBufferLayoutMap;
	MTLDeserializerObjectMap* _argumentEncoderMap;
	MTLDeserializerObjectMap* _heapMap;
	MTLDeserializerObjectMap* _eventMap;
