...
#import <libobjc.A.dylib/MTLDeserializer.h>
#import <libobjc.A.dylib/MTLDeserializationContext.h>
...
-(void)dealloc;
-(id<MTLDevice>)device;
-(id)newTextureWithDescriptor:(SCD_Struct_MT8*)arg1 ;
-(id)newHeapWithDescriptor:(SCD_Struct_MT10*)arg1 ;
-(id)newDepthStencilStateWithDescriptor:(SCD_Struct_MT13*)arg1 ;
-(id)newSamplerStateWithDescriptor:(SCD_Struct_MT15*)arg1 ;
...
-(char)newTextureWithDescriptor:(SCD_Struct_MT8*)arg1 allocator:(id)arg2 ;
-(char)newSamplerStateWithDescriptor:(SCD_Struct_MT15*)arg1 allocator:(id)arg2 ;
-(char)newDepthStencilStateWithDescriptor:(SCD_Struct_MT13*)arg1 allocator:(id)arg2 ;
-(char)newHeapWithDescriptor:(SCD_Struct_MT10*)arg1 allocator:(id)arg2 ;
-(char)newTextureViewWithPixelFormat:(SCD_Struct_MT16*)arg1 allocator:(id)arg2 ;
-(char)newTextureViewWithTextureType:(SCD_Struct_MT18*)arg1 allocator:(id)arg2 ;
-(char)newTextureViewWithSwizzle:(SCD_Struct_MT19*)arg1 allocator:(id)arg2 ;
-(char)newTextureViewWithBuffer:(SCD_Struct_MT20*)arg1 allocator:(id)arg2 ;
-(char)newTextureWithHeap:(SCD_Struct_MT21*)arg1 allocator:(id)arg2 ;
-(char)newBufferWithHeap:(SCD_Struct_MT22*)arg1 allocator:(id)arg2 ;
...
-(char)newFence:(SCD_Struct_MT23*)arg1 allocator:(id)arg2 ;
-(char)newSharedEvent:(SCD_Struct_MT23*)arg1 allocator:(id)arg2 ;
...
-(char)newArgumentBufferLayoutWithStructType:(SCD_Struct_MT24*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)newArgumentEncoderWithBufferLayout:(SCD_Struct_MT1*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)argumentBufferLayoutConstantAtIndex:(SCD_Struct_MT24*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)argumentEncoderConstantAtIndex:(SCD_Struct_MT25*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)argumentEncoderSetValues:(SCD_Struct_MT26*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)heapTextureSizeAndAlign:(SCD_Struct_MT27*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)heapBufferSizeAndAlign:(SCD_Struct_MT28*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)makeAliasiableResource:(SCD_Struct_MT23*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)doResourcesAlias:(SCD_Struct_MT29*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)sharedEventSignaledValue:(SCD_Struct_MT23*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)sharedEventSetSignaledValue:(SCD_Struct_MT24*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)sizeInfoForHeap:(SCD_Struct_MT23*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)heapMaxAvailableSizeWithAlignment:(SCD_Struct_MT24*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)minimumLinearTextureAlignment:(SCD_Struct_MT23*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)minimumTextureBufferAlignment:(SCD_Struct_MT23*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)newTiledTextureViewWithBuffer:(SCD_Struct_MT20*)arg1 allocator:(id)arg2 ;
-(char)computeInfo:(SCD_Struct_MT23*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)bufferGPUAddress:(SCD_Struct_MT23*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
-(char)uniqueIdentifier:(SCD_Struct_MT30*)arg1 serializedDataSize:(unsigned long long)arg2 allocator:(id)arg3 ;
