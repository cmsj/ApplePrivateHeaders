...
#import <libobjc.A.dylib/MTLBlitCommandEncoderSPI.h>
...
-(void)copyFromBuffer:(id)arg1 sourceOffset:(unsigned long long)arg2 sourceBytesPerRow:(unsigned long long)arg3 sourceBytesPerImage:(unsigned long long)arg4 sourceSize:(SCD_Struct_MT2)arg5 toTexture:(id)arg6 destinationSlice:(unsigned long long)arg7 destinationLevel:(unsigned long long)arg8 destinationOrigin:(SCD_Struct_MT2)arg9 ;
-(void)copyFromBuffer:(id)arg1 sourceOffset:(unsigned long long)arg2 sourceBytesPerRow:(unsigned long long)arg3 sourceBytesPerImage:(unsigned long long)arg4 sourceSize:(SCD_Struct_MT2)arg5 toTexture:(id)arg6 destinationSlice:(unsigned long long)arg7 destinationLevel:(unsigned long long)arg8 destinationOrigin:(SCD_Struct_MT2)arg9 options:(unsigned long long)arg10 ;
-(void)copyFromTexture:(id)arg1 sourceSlice:(unsigned long long)arg2 sourceLevel:(unsigned long long)arg3 sourceOrigin:(SCD_Struct_MT2)arg4 sourceSize:(SCD_Struct_MT2)arg5 toBuffer:(id)arg6 destinationOffset:(unsigned long long)arg7 destinationBytesPerRow:(unsigned long long)arg8 destinationBytesPerImage:(unsigned long long)arg9 ;
-(void)copyFromTexture:(id)arg1 sourceSlice:(unsigned long long)arg2 sourceLevel:(unsigned long long)arg3 sourceOrigin:(SCD_Struct_MT2)arg4 sourceSize:(SCD_Struct_MT2)arg5 toBuffer:(id)arg6 destinationOffset:(unsigned long long)arg7 destinationBytesPerRow:(unsigned long long)arg8 destinationBytesPerImage:(unsigned long long)arg9 options:(unsigned long long)arg10 ;
...
-(void)getTextureAccessCounters:(id)arg1 region:(SCD_Struct_MT3)arg2 mipLevel:(unsigned long long)arg3 slice:(unsigned long long)arg4 resetCounters:(char)arg5 countersBuffer:(id)arg6 countersBufferOffset:(unsigned long long)arg7 ;
-(void)resetTextureAccessCounters:(id)arg1 region:(SCD_Struct_MT3)arg2 mipLevel:(unsigned long long)arg3 slice:(unsigned long long)arg4 ;
...
-(void)optimize:(id)arg1 withCommand:(unsigned)arg2 ;
-(void)optimize:(id)arg1 slice:(unsigned long long)arg2 level:(unsigned long long)arg3 withCommand:(unsigned)arg4 ;
-(void)optimizeReset:(id)arg1 withRange:(NSRange)arg2 withCommand:(unsigned)arg3 ;
@end
