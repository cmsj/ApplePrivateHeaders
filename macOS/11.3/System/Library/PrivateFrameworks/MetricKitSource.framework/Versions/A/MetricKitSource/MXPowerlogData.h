...
@property (assign) char includesMultipleApplicationVersions;                                  //@synthesize includesMultipleApplicationVersions=_includesMultipleApplicationVersions - In the implementation block
...
-(id)initPayloadDataWithMutipleAppVersions:(char)arg1 withTimeStampBegin:(id)arg2 withTimeStampEnd:(id)arg3 withMetrics:(id)arg4 ;
-(void)setIncludesMultipleApplicationVersions:(char)arg1 ;
@end
