...
-(char)validatePayload:(id)arg1 ;
-(id)setupSourceDirectoryForSource:(long long)arg1 ;
-(void)removeFilesForSourceID:(long long)arg1 dateString:(id)arg2 ;
-(char)validatePowerlogData:(id)arg1 ;
-(char)validateHangTracerData:(id)arg1 ;
-(char)validateSpinTracerData:(id)arg1 ;
-(char)validateReportCrashData:(id)arg1 ;
