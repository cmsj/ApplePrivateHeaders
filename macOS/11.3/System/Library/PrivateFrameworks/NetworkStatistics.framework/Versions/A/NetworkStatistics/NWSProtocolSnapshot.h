...
@interface NWSProtocolSnapshot : NWSSnapshot {
	...
	char _countsIncludeHeaderOverhead;
...
@property (readonly) char interfaceUnknown;                                       //@synthesize interfaceUnknown=_interfaceUnknown - In the implementation block
@property (readonly) char interfaceLoopback;                                      //@synthesize interfaceLoopback=_interfaceLoopback - In the implementation block
@property (readonly) char interfaceCellular;                                      //@synthesize interfaceCellular=_interfaceCellular - In the implementation block
@property (readonly) char interfaceCellularViaFallback;                           //@synthesize interfaceCellularViaFallback=_interfaceCellularViaFallback - In the implementation block
@property (readonly) char interfaceWifi;                                          //@synthesize interfaceWifi=_interfaceWifi - In the implementation block
@property (readonly) char interfaceWired;                                         //@synthesize interfaceWired=_interfaceWired - In the implementation block
@property (readonly) char interfaceAWDL;                                          //@synthesize interfaceAWDL=_interfaceAWDL - In the implementation block
@property (readonly) char interfaceExpensive;                                     //@synthesize interfaceExpensive=_interfaceExpensive - In the implementation block
@property (readonly) char interfaceCompanionLink;                                 //@synthesize interfaceCompanionLink=_interfaceCompanionLink - In the implementation block
@property (readonly) char countsIncludeHeaderOverhead;                            //@synthesize countsIncludeHeaderOverhead=_countsIncludeHeaderOverhead - In the implementation block
